...
public class frmPhotoTypes : frmGrid
{
	...
	public frmPhotoTypes()
	{
		InitializeComponent();
		TableName = "PHO_PhotoTypes";
		IDCol = "PhotoTypeID";
	}
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtCode).Text = PhotoTypes.GetCode(IsFromServer: true);
	}

	public override void FillData()
	{
		dataTable = PhotoTypes.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		InitGrid();
	}
	...
	public override void InitGrid()
	{
		...
		base.InitGrid();
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeID"].DefaultCellValue = -1;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeCode"].Header).Caption = (GlobalVariables.IsArabic ? "الكود" : "Code");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeCode"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeNameAr"].Header).Caption = (GlobalVariables.IsArabic ? "الإسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "الإسم بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PhotoTypeNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtCode).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["PhotoTypeCode"].Value.ToString();
		((Control)(object)txtNameAr).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["PhotoTypeNameAr"].Value.ToString();
		((Control)(object)txtNameEn).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["PhotoTypeNameEn"].Value.ToString();
	}
	...
	{
		PhotoTypes.Insert_Update("-1", ((Control)(object)txtCode).Text, ((Control)(object)txtNameAr).Text, (((Control)(object)txtNameEn).Text == "") ? "Null" : ((Control)(object)txtNameEn).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
		FillData();
	}

	public override void UpdateData()
	{
		PhotoTypes.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["PhotoTypeID"].Value.ToString(), ((Control)(object)txtCode).Text, ((Control)(object)txtNameAr).Text, (((Control)(object)txtNameEn).Text == "") ? "Null" : ((Control)(object)txtNameEn).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
		FillData();
	}

	public override void DeleteData()
	{
		PhotoTypes.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["PhotoTypeID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
		ClearControls();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Photos.MasterData.frmPhotoTypes));
