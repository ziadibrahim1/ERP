...
public class frmMain2010Dev : frmBase
{
	...
	private void UGBFill_ControlRemoved(object sender, ControlEventArgs e)
	{
		...
		{
			((Control)(object)UTM).Controls.Clear();
			CreateTabs();
		}
	...
	private void CreateTabs()
	{
		...
		UTM.RibbonStyle = (RibbonControlStyle)1;
		UTM.ApplicationIcon = Resources.RibbonIcon;
		UTM.ApplicationCaption = "Mohamed Fouad";
		UTM.RibbonCaptionAlignment = (RibbonCaptionAlignment)3;
		((CollectionBase)(object)UTM.Pages).Clear();
		((Control)(object)UTM).Controls.Clear();
		DataView dataView = new DataView(GlobalVariables.dtForms);
		dataView.RowFilter = " ParentID is Null ";
		for (int i = 0; i < dataView.Count; i++)
		{
			if (dataView[i]["Form"].Equals("Help") || (bool)GlobalVariables.dtSystemModules.Select(string.Concat("ModuleEnName='", dataView[i]["Form"], "'"))[0]["Installed"])
			{
				RibbonPage val = new RibbonPage();
				val.Text = (GlobalVariables.IsArabic ? dataView[i]["FormNameAr"].ToString() : dataView[i]["FormNameEn"].ToString());
				val.Name = dataView[i]["FormID"].ToString();
				val.Tag = dataView[i]["Form"].ToString();
				UTM.Pages.Add(val);
				CreateGroups(val);
			}
		}
	...
	private void CreateGroups(RibbonPage Page)
	{
		//IL_002e: Unknown result type (might be due to invalid IL or missing references)
		//IL_0034: Expected O, but got Unknown
		DataRow[] array = GlobalVariables.dtForms.Select("ParentID = '" + Page.Name.ToString() + "'");
		for (int i = 0; i < array.Length; i++)
		{
			RibbonPageGroup val = new RibbonPageGroup();
			val.Name = array[i]["FormID"].ToString();
			val.Text = (GlobalVariables.IsArabic ? array[i]["FormNameAr"].ToString() : array[i]["FormNameEn"].ToString());
			val.Tag = array[i]["Form"].ToString();
			val.Alignment = (RibbonPageGroupAlignment)0;
			val.AllowTextClipping = false;
			Page.Groups.Add(val);
	...
	private void CreateButtonTool(RibbonPageGroup Group)
	{
		//IL_002e: Unknown result type (might be due to invalid IL or missing references)
		//IL_0034: Expected O, but got Unknown
		//IL_008b: Unknown result type (might be due to invalid IL or missing references)
		//IL_0091: Expected O, but got Unknown
		DataRow[] array = GlobalVariables.dtForms.Select("ParentID = '" + Group.Name.ToString() + "'");
		for (int i = 0; i < array.Length; i++)
		{
			BarButtonItem val = new BarButtonItem();
			((BarItem)val).Name = array[i]["FormID"].ToString();
			((BarItem)val).Tag = array[i];
			((BarItem)val).Caption = (GlobalVariables.IsArabic ? array[i]["FormNameAr"].ToString() : array[i]["FormNameEn"].ToString());
			SuperToolTip val2 = new SuperToolTip();
			val2.Items.Add(GlobalVariables.IsArabic ? array[i]["FormNameEn"].ToString() : array[i]["FormNameAr"].ToString());
			((BarItem)val).SuperTip = val2;
			((StateAppearances)((BarItem)val).ItemAppearance).SetVAlignment((VertAlignment)2);
			((StateAppearances)((BarItem)val).ItemAppearance).Normal.Font = new Font("Tahoma", 10f, FontStyle.Regular);
			((BarItemLinkCollection)Group.ItemLinks).Add((BarItem)(object)val);
		}
	}
	...
	private void ChangeLanguage()
	{
		...
		((CollectionBase)(object)UTM.Items).Clear();
		((Control)(object)UTM).Controls.Clear();
		CreateTabs();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Company.frmMain2010Dev));
		...
		((System.Windows.Forms.Control)(object)this.UGBFill).SuspendLayout();
		base.SuspendLayout();
		...
		this.lblTitle2.Appearance = (AppearanceBase)(object)val;
		this.lblTitle2.BorderStyle = (GroupBoxBorderStyle)4;
		((AppearanceBase)val2).BorderColor = System.Drawing.Color.Black;
		this.lblTitle2.ContentAreaAppearance = (AppearanceBase)(object)val2;
		...
		val3.DataValue = "ISSDarkGreen";
		resources.ApplyResources(val3, "valueListItem7");
		((SubObjectBase)val3).ForceApplyResources = "";
		val4.DataValue = "ISSDarkBlue";
		resources.ApplyResources(val4, "valueListItem2");
		((SubObjectBase)val4).ForceApplyResources = "";
		val5.DataValue = "ISSOlive";
		resources.ApplyResources(val5, "valueListItem9");
		((SubObjectBase)val5).ForceApplyResources = "";
		val6.DataValue = "ISSDarkRed";
		resources.ApplyResources(val6, "valueListItem8");
		((SubObjectBase)val6).ForceApplyResources = "";
		val7.DataValue = "ISSGreen";
		resources.ApplyResources(val7, "valueListItem3");
		((SubObjectBase)val7).ForceApplyResources = "";
		val8.DataValue = "ISSRed";
		resources.ApplyResources(val8, "valueListItem4");
		((SubObjectBase)val8).ForceApplyResources = "";
		val9.DataValue = "ISSGray";
		resources.ApplyResources(val9, "valueListItem5");
		((SubObjectBase)val9).ForceApplyResources = "";
		val10.DataValue = "ISSPurple";
		resources.ApplyResources(val10, "valueListItem6");
		((SubObjectBase)val10).ForceApplyResources = "";
		val11.DataValue = "ISS";
		resources.ApplyResources(val11, "valueListItem1");
		((SubObjectBase)val11).ForceApplyResources = "";
		val12.DataValue = "ISSGold";
		resources.ApplyResources(val12, "valueListItem10");
		((SubObjectBase)val12).ForceApplyResources = "";
		this.cboHeader.Items.AddRange((ValueListItem[])(object)new ValueListItem[10] { val3, val4, val5, val6, val7, val8, val9, val10, val11, val12 });
		...
		((AppearanceBase)val13).BackColor = System.Drawing.Color.FromArgb(34, 62, 110);
		((AppearanceBase)val13).BackColor2 = System.Drawing.Color.FromArgb(79, 124, 165);
		((AppearanceBase)val13).BackGradientStyle = (GradientStyle)7;
		((AppearanceBase)val13).BorderColor = System.Drawing.Color.Transparent;
		((AppearanceBase)val13).Image = ERP.Properties.Resources.Minimize;
		((AppearanceBase)val13).ImageHAlign = (HAlign)2;
		((AppearanceBase)val13).ImageVAlign = (VAlign)2;
		((ControlBase)this.btnMinimize).Appearance = (AppearanceBase)(object)val13;
		...
		((AppearanceBase)val14).BackColor = System.Drawing.Color.FromArgb(192, 0, 0);
		((ControlBase)this.btnMinimize).HotTrackAppearance = (AppearanceBase)(object)val14;
		...
		((AppearanceBase)val15).BorderColor = System.Drawing.Color.Transparent;
		((AppearanceBase)val15).Image = ERP.Properties.Resources.exit;
		((AppearanceBase)val15).ImageHAlign = (HAlign)2;
		((AppearanceBase)val15).ImageVAlign = (VAlign)2;
		((ControlBase)this.btnExit).Appearance = (AppearanceBase)(object)val15;
		...
		((AppearanceBase)val16).BackColor = System.Drawing.Color.FromArgb(192, 0, 0);
		((AppearanceBase)val16).BackColor2 = System.Drawing.Color.FromArgb(192, 0, 0);
		((ControlBase)this.btnExit).HotTrackAppearance = (AppearanceBase)(object)val16;
		...
		((AppearanceBase)val17).BackColor2 = System.Drawing.Color.FromArgb(192, 0, 0);
		((UltraButtonBase)this.btnExit).PressedAppearance = (AppearanceBase)(object)val17;
		...
		((BarItem)this.UTM.ExpandCollapseItem).Id = 0;
		((BarItems)this.UTM.Items).AddRange((BarItem[])(object)new BarItem[2]
		{
			(BarItem)this.UTM.ExpandCollapseItem,
			(BarItem)this.UTM.SearchEditItem
		});
		resources.ApplyResources(this.UTM, "UTM");
		this.UTM.MaxItemId = 1;
		((System.Windows.Forms.Control)(object)this.UTM).Name = "UTM";
		resources.ApplyResources(this.lblTitle, "lblTitle");
		((AppearanceBase)val18).BackColor = System.Drawing.Color.Transparent;
		((AppearanceBase)val18).BackColor2 = System.Drawing.Color.Transparent;
		((AppearanceBase)val18).ForeColor = System.Drawing.Color.Beige;
		resources.ApplyResources(val18, "appearance8");
		((ControlBase)this.lblTitle).Appearance = (AppearanceBase)(object)val18;
		((System.Windows.Forms.Control)(object)this.lblTitle).Name = "lblTitle";
		((UltraControlBase)this.lblTitle).UseAppStyling = false;
		((AppearanceBase)val19).BackColor = System.Drawing.Color.FromArgb(234, 238, 255);
		((AppearanceBase)val19).BackColor2 = System.Drawing.Color.FromArgb(234, 238, 255);
		this.UGBFill.Appearance = (AppearanceBase)(object)val19;
		this.UGBFill.BorderStyle = (GroupBoxBorderStyle)4;
		((System.Windows.Forms.Control)(object)this.UGBFill).Controls.Add(this.pnlTaskBar);
		((System.Windows.Forms.Control)(object)this.UGBFill).Controls.Add((System.Windows.Forms.Control)(object)this.UTM);
		((System.Windows.Forms.Control)(object)this.UGBFill).Controls.Add((System.Windows.Forms.Control)(object)this.lblTitle);
		...
		((System.Windows.Forms.Control)(object)this.UGBFill).ResumeLayout(false);
		((System.Windows.Forms.Control)(object)this.UGBFill).PerformLayout();
