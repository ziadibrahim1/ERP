...
public class frmAllowances : frmGrid
{
	...
	{
		dataTable = Allowances.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AllowanceNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " اسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AllowanceNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AllowanceNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AllowanceNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "اسم  بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AllowanceNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AllowanceNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
	...
	{
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["AllowanceNameAr"].Value.ToString();
		((Control)(object)txtEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["AllowanceNameEn"].Value.ToString();
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال اسم البدل بالعربية", "Please Enter Allowance Arabic Name");
			return false;
		}
	...
	{
		Allowances.Insert_Update("-1", ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((UltraToggleEditorBase)chkIsMonthly).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInPenalty).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInAbsent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInVacation).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInOvertime).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInLatency).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInTax).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInInsurance).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInBonus).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInLeavePermission).Checked ? "1" : "0", "0", ((UltraToggleEditorBase)chkInServicePrecent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsPrecent).Checked ? "1" : "0", (((Control)(object)txtValue).Text == "") ? "0" : ((Control)(object)txtValue).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
		FillData();
	}

	public override void UpdateData()
	{
		Allowances.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["AllowanceID"].Value.ToString(), ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((UltraToggleEditorBase)chkIsMonthly).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInPenalty).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInAbsent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInVacation).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInOvertime).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInLatency).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInTax).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInInsurance).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInBonus).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInLeavePermission).Checked ? "1" : "0", "0", ((UltraToggleEditorBase)chkInServicePrecent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsPrecent).Checked ? "1" : "0", (((Control)(object)txtValue).Text == "") ? "0" : ((Control)(object)txtValue).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
		FillData();
	}

	public override void DeleteData()
	{
		Allowances.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["AllowanceID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public override void btnPrintClick()
	{
		...
		{
			GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_HR_Allowances_A.rpt" : "Rep_HR_Allowances_E.rpt"));
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.MasterData.frmAllowances));
