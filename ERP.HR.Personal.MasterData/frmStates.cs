...
public class frmStates : frmGrid
{
	...
	private UltraCheckEditor chkInSalary;
	...
	public override void SetControls(bool NavMode)
	{
		...
		((Control)(object)chkInSalary).Enabled = !NavMode;
	...
	{
		dataTable = States.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["StateNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " اسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["StateNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["StateNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.45) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["StateNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "اسم  بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["StateNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["StateNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.45);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InSalary"].Header).Caption = (GlobalVariables.IsArabic ? "بأجر" : "In Salary");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InSalary"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InSalary"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
	}

	public override void AfterRowActivate()
	{
		((UltraToggleEditorBase)chkInSalary).Checked = Convert.ToBoolean(((UltraGridBase)ULGData).ActiveRow.Cells["InSalary"].Value);
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["StateNameAr"].Value.ToString();
		((Control)(object)txtEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["StateNameEn"].Value.ToString();
	}
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال اسم الوظيفة بالعربية", "Please Enter Job Arabic Name");
			return false;
		}
	...
	{
		States.Insert_Update("-1", ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((UltraToggleEditorBase)chkInSalary).Checked ? "1" : "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		States.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["StateID"].Value.ToString(), ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((UltraToggleEditorBase)chkInSalary).Checked ? "1" : "0", bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		States.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["StateID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public override void btnPrintClick()
	{
		...
		{
			GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_HR_States_A.rpt" : "Rep_HR_States_E.rpt"));
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.MasterData.frmStates));
		...
		this.chkInSalary = new UltraCheckEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.chkInSalary).BeginInit();
		base.SuspendLayout();
		...
		resources.ApplyResources(this.chkInSalary, "chkInSalary");
		((System.Windows.Forms.Control)(object)this.chkInSalary).Name = "chkInSalary";
		base.AcceptButton = null;
		resources.ApplyResources(this, "$this");
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkInSalary);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkInSalary, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.chkInSalary).EndInit();
