...
public class frmAbsentRules : frmButtons
{
	...
	private UltraTextEditor txtSecondPenalty;

	private UltraLabel lblSecondPenalty;

	private UltraTextEditor txtFirstPenalty;

	private UltraLabel lblFirstPenalty;

	private UltraTextEditor txtFourthPenalty;

	private UltraLabel lblFourthPenalty;

	private UltraTextEditor txtThirdPenalty;

	private UltraLabel lblThirdPenalty;

	private UltraGroupBox UGBPeriods;

	private RadioButton rbAnnualy;

	private RadioButton rbBiannual;

	private RadioButton rbQuarterly;
	...
	public frmAbsentRules()
	{
		InitializeComponent();
		TableName = "HR_AbsentRules";
		IDCol = "AbsentRuleID";
		NoCol = "AbsentRuleNo";
		DateCol = "GetDate()";
	}

	public frmAbsentRules(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void FillData()
	{
		...
		{
			DataTable dataTable = AbsentRules.Select(RowID, "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			((Control)(object)txtCode).Text = drMaster["AbsentRuleNo"].ToString();
			((Control)(object)txtArabicName).Text = drMaster["AbsentRuleNameAr"].ToString();
			((Control)(object)txtEnglishName).Text = drMaster["AbsentRuleNameEn"].ToString();
			((Control)(object)txtFirstPenalty).Text = drMaster["FirstPenalty"].ToString();
			((Control)(object)txtSecondPenalty).Text = drMaster["SecondPenalty"].ToString();
			((Control)(object)txtThirdPenalty).Text = drMaster["ThirdPenalty"].ToString();
			((Control)(object)txtFourthPenalty).Text = drMaster["FourthPenalty"].ToString();
			rbMonthly.Checked = bool.Parse(drMaster["IsMonthly"].ToString());
			rbQuarterly.Checked = bool.Parse(drMaster["isQuarterly"].ToString());
			rbBiannual.Checked = bool.Parse(drMaster["IsSixMonth"].ToString());
			rbAnnualy.Checked = bool.Parse(drMaster["IsYearly"].ToString());
			...
			dtEmployeesDetails = Employees.SelectByAbsentRuleID(drMaster["AbsentRuleID"].ToString(), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)txtFirstPenalty).ReadOnly = NavMode;
		((EditorButtonControlBase)txtSecondPenalty).ReadOnly = NavMode;
		((EditorButtonControlBase)txtThirdPenalty).ReadOnly = NavMode;
		((EditorButtonControlBase)txtFourthPenalty).ReadOnly = NavMode;
		rbMonthly.Enabled = !NavMode;
		rbQuarterly.Enabled = !NavMode;
		rbBiannual.Enabled = !NavMode;
		rbAnnualy.Enabled = !NavMode;
	...
	public override void ClearControls()
	{
		...
		((TextEditorControlBase)txtFirstPenalty).Clear();
		((TextEditorControlBase)txtSecondPenalty).Clear();
		((TextEditorControlBase)txtThirdPenalty).Clear();
		((TextEditorControlBase)txtFourthPenalty).Clear();
		rbMonthly.Checked = true;
		rbQuarterly.Checked = false;
		rbBiannual.Checked = false;
		rbAnnualy.Checked = false;
		txtSalaryDays.Value = 30m;
		txtSalaryWorkHours.Value = 8m;
		((TextEditorControlBase)txtNotes).Clear();
		((Control)(object)txtCode).Text = (Adding ? AbsentRules.GetCode(IsFromServer: true) : "");
		TreeFunctions.SetAllTreeNodesCheckState(Checked: false, TreeEmployees);
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال كود لائحة الغياب", "Please Enter Absent Rule");
			((TextEditorControlBase)txtCode).Focus();
			return false;
		}
		if (((Control)(object)txtArabicName).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال إسم لائحة الغياب بالعربية", "Please Enter Absent Rule Arabic Name");
			((TextEditorControlBase)txtArabicName).Focus();
			return false;
		}
		if (((Control)(object)txtFirstPenalty).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال الجزاء الاول  ", "Please Enter First Penalty");
			((TextEditorControlBase)txtFirstPenalty).Focus();
			return false;
		}
		if (((Control)(object)txtSecondPenalty).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال الجزاء الثانى  ", "Please Enter Second Penalty");
			((TextEditorControlBase)txtSecondPenalty).Focus();
			return false;
		}
		if (((Control)(object)txtThirdPenalty).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال الجزاء الثالث  ", "Please Enter third Penalty");
			((TextEditorControlBase)txtThirdPenalty).Focus();
			return false;
		}
		if (((Control)(object)txtFourthPenalty).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال الجزاء الرابع  ", "Please Enter Fourth Penalty");
			((TextEditorControlBase)txtFourthPenalty).Focus();
			return false;
		}
		if (Main.CheckForValue("HR_AbsentRules", "AbsentRuleNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["AbsentRuleNo"].ToString(), IsFromServer: true) > 0)
		{
			string code = AbsentRules.GetCode(IsFromServer: true);
	...
	public override void AddData()
	{
		...
		try
		{
			int num = AbsentRules.Insert_Update("-1", ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((Control)(object)txtFirstPenalty).Text, ((Control)(object)txtSecondPenalty).Text, ((Control)(object)txtThirdPenalty).Text, ((Control)(object)txtFourthPenalty).Text, rbMonthly.Checked ? "1" : "0", rbQuarterly.Checked ? "1" : "0", rbBiannual.Checked ? "1" : "0", rbAnnualy.Checked ? "1" : "0", txtSalaryDays.Value.ToString(), txtSalaryWorkHours.Value.ToString(), ((Control)(object)txtNotes).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
			string nodeCheckedIDs = GetNodeCheckedIDs();
			if (nodeCheckedIDs != ",")
			{
				Employees.UpdateAbsentRuleIDBySubAccountIDs(nodeCheckedIDs, num.ToString(), IsFromServer: true);
			}
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = AbsentRules.Insert_Update(drMaster["AbsentRuleID"].ToString(), ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((Control)(object)txtFirstPenalty).Text, ((Control)(object)txtSecondPenalty).Text, ((Control)(object)txtThirdPenalty).Text, ((Control)(object)txtFourthPenalty).Text, rbMonthly.Checked ? "1" : "0", rbQuarterly.Checked ? "1" : "0", rbBiannual.Checked ? "1" : "0", rbAnnualy.Checked ? "1" : "0", txtSalaryDays.Value.ToString(), txtSalaryWorkHours.Value.ToString(), ((Control)(object)txtNotes).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
			string nodeCheckedIDs = GetNodeCheckedIDs();
			if (nodeCheckedIDs != ",")
			{
				Employees.UpdateAbsentRuleIDBySubAccountIDs(nodeCheckedIDs, num.ToString(), IsFromServer: true);
	...
	{
		AbsentRules.Delete(drMaster["AbsentRuleID"].ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public override void btnPrintClick()
	{
		if (RowID != "")
		{
			...
			{
				GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_HR_AbsentRules_A.rpt" : "Rep_HR_AbsentRules_E.rpt"));
			}
			frmReporViwer frmReporViwer2 = new frmReporViwer();
			GlobalVariables.ReportDocument.SetParameterValue("@AbsentRuleIDs", "," + RowID + ",");
	...
	{
		dtSearchResult = SearchFunctions.AbsentRulesReport(IsFromServer: true);
		if (dtSearchResult.Rows.Count > 0)
		{
			RowID = dtSearchResult.Rows[0]["AbsentRuleID"].ToString();
			FillData();
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.MasterData.frmAbsentRules));
		...
		this.txtSecondPenalty = new UltraTextEditor();
		this.lblSecondPenalty = new UltraLabel();
		this.txtFirstPenalty = new UltraTextEditor();
		this.lblFirstPenalty = new UltraLabel();
		this.txtFourthPenalty = new UltraTextEditor();
		this.lblFourthPenalty = new UltraLabel();
		this.txtThirdPenalty = new UltraTextEditor();
		this.lblThirdPenalty = new UltraLabel();
		this.UGBPeriods = new UltraGroupBox();
		this.rbAnnualy = new System.Windows.Forms.RadioButton();
		this.rbBiannual = new System.Windows.Forms.RadioButton();
		...
		((System.ComponentModel.ISupportInitialize)this.txtSecondPenalty).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.txtFirstPenalty).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.txtFourthPenalty).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.txtThirdPenalty).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.UGBPeriods).BeginInit();
		((System.Windows.Forms.Control)(object)this.UGBPeriods).SuspendLayout();
		...
		resources.ApplyResources(this.txtSecondPenalty, "txtSecondPenalty");
		((System.Windows.Forms.Control)(object)this.txtSecondPenalty).Name = "txtSecondPenalty";
		((System.Windows.Forms.Control)(object)this.txtSecondPenalty).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txt_KeyPress);
		resources.ApplyResources(this.lblSecondPenalty, "lblSecondPenalty");
		this.lblSecondPenalty.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblSecondPenalty).Name = "lblSecondPenalty";
		((ControlBase)this.lblSecondPenalty).WrapText = false;
		resources.ApplyResources(this.txtFirstPenalty, "txtFirstPenalty");
		((System.Windows.Forms.Control)(object)this.txtFirstPenalty).Name = "txtFirstPenalty";
		((System.Windows.Forms.Control)(object)this.txtFirstPenalty).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txt_KeyPress);
		resources.ApplyResources(this.lblFirstPenalty, "lblFirstPenalty");
		this.lblFirstPenalty.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblFirstPenalty).Name = "lblFirstPenalty";
		((ControlBase)this.lblFirstPenalty).WrapText = false;
		resources.ApplyResources(this.txtFourthPenalty, "txtFourthPenalty");
		((System.Windows.Forms.Control)(object)this.txtFourthPenalty).Name = "txtFourthPenalty";
		((System.Windows.Forms.Control)(object)this.txtFourthPenalty).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txt_KeyPress);
		resources.ApplyResources(this.lblFourthPenalty, "lblFourthPenalty");
		this.lblFourthPenalty.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblFourthPenalty).Name = "lblFourthPenalty";
		((ControlBase)this.lblFourthPenalty).WrapText = false;
		resources.ApplyResources(this.txtThirdPenalty, "txtThirdPenalty");
		((System.Windows.Forms.Control)(object)this.txtThirdPenalty).Name = "txtThirdPenalty";
		((System.Windows.Forms.Control)(object)this.txtThirdPenalty).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txt_KeyPress);
		resources.ApplyResources(this.lblThirdPenalty, "lblThirdPenalty");
		this.lblThirdPenalty.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblThirdPenalty).Name = "lblThirdPenalty";
		((ControlBase)this.lblThirdPenalty).WrapText = false;
		resources.ApplyResources(this.UGBPeriods, "UGBPeriods");
		((System.Windows.Forms.Control)(object)this.UGBPeriods).Controls.Add(this.rbAnnualy);
		((System.Windows.Forms.Control)(object)this.UGBPeriods).Controls.Add(this.rbBiannual);
		((System.Windows.Forms.Control)(object)this.UGBPeriods).Controls.Add(this.rbQuarterly);
		((System.Windows.Forms.Control)(object)this.UGBPeriods).Controls.Add(this.rbMonthly);
		((System.Windows.Forms.Control)(object)this.UGBPeriods).Name = "UGBPeriods";
		resources.ApplyResources(this.rbAnnualy, "rbAnnualy");
		this.rbAnnualy.BackColor = System.Drawing.Color.Transparent;
		this.rbAnnualy.Name = "rbAnnualy";
		this.rbAnnualy.TabStop = true;
		this.rbAnnualy.UseVisualStyleBackColor = false;
		resources.ApplyResources(this.rbBiannual, "rbBiannual");
		this.rbBiannual.BackColor = System.Drawing.Color.Transparent;
		this.rbBiannual.Name = "rbBiannual";
		this.rbBiannual.TabStop = true;
		this.rbBiannual.UseVisualStyleBackColor = false;
		resources.ApplyResources(this.rbQuarterly, "rbQuarterly");
		this.rbQuarterly.BackColor = System.Drawing.Color.Transparent;
		this.rbQuarterly.Name = "rbQuarterly";
		this.rbQuarterly.TabStop = true;
		this.rbQuarterly.UseVisualStyleBackColor = false;
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.UGBPeriods);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtFourthPenalty);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblFourthPenalty);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtThirdPenalty);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblThirdPenalty);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtSecondPenalty);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblSecondPenalty);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtFirstPenalty);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblFirstPenalty);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblFirstPenalty, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtFirstPenalty, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblSecondPenalty, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtSecondPenalty, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblThirdPenalty, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtThirdPenalty, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblFourthPenalty, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtFourthPenalty, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.UGBPeriods, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.txtSecondPenalty).EndInit();
		((System.ComponentModel.ISupportInitialize)this.txtFirstPenalty).EndInit();
		((System.ComponentModel.ISupportInitialize)this.txtFourthPenalty).EndInit();
		((System.ComponentModel.ISupportInitialize)this.txtThirdPenalty).EndInit();
		((System.ComponentModel.ISupportInitialize)this.UGBPeriods).EndInit();
		((System.Windows.Forms.Control)(object)this.UGBPeriods).ResumeLayout(false);
		((System.Windows.Forms.Control)(object)this.UGBPeriods).PerformLayout();
