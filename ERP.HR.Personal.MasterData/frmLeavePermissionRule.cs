...
public class frmLeavePermissionRule : frmButtons
{
	...
	private UltraLabel lblMaxHour;

	private UltraMaskedEdit txtMaxHour;

	private UltraLabel ultraLabel1;

	private UltraTextEditor txtMaxCount;
	...
	public frmLeavePermissionRule()
	{
		InitializeComponent();
		TableName = "HR_LeavePermissionRule";
		IDCol = "LeavePermissionRuleID";
		NoCol = "LeavePermissionRuleNo";
		DateCol = "GetDate()";
	}

	public frmLeavePermissionRule(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void FillData()
	{
		...
		{
			DataTable dataTable = LeavePermissionRule.Select(RowID, "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			((Control)(object)txtCode).Text = drMaster["LeavePermissionRuleNo"].ToString();
			((Control)(object)txtArabicName).Text = drMaster["LeavePermissionRuleNameAr"].ToString();
			((Control)(object)txtEnglishName).Text = drMaster["LeavePermissionRuleNameEn"].ToString();
			txtMaxHour.Value = drMaster["MaxHour"].ToString();
			((Control)(object)txtMaxCount).Text = drMaster["MaxCount"].ToString();
			...
			dtEmployeesDetails = Employees.SelectByLeavePermissionRuleID(drMaster["LeavePermissionRuleID"].ToString(), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void SetControls(bool NavMode)
	{
		...
		txtMaxHour.ReadOnly = NavMode;
		((EditorButtonControlBase)txtMaxCount).ReadOnly = NavMode;
	...
	public override void ClearControls()
	{
		...
		txtMaxHour.Value = null;
		((TextEditorControlBase)txtMaxCount).Clear();
		txtSalaryDays.Value = 30m;
		txtSalaryWorkHours.Value = 8m;
		((TextEditorControlBase)txtNotes).Clear();
		((Control)(object)txtCode).Text = (Adding ? LeavePermissionRule.GetCode(IsFromServer: true) : "");
		TreeFunctions.SetAllTreeNodesCheckState(Checked: false, TreeEmployees);
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال كود لائحة الاذونات", "Please Enter Leave permission Rule");
			((TextEditorControlBase)txtCode).Focus();
			return false;
		}
		if (((Control)(object)txtArabicName).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال إسم لائحة الاذونات", "Please Enter Leave permission Rule Arabic Name");
			((TextEditorControlBase)txtArabicName).Focus();
			return false;
		}
		if (txtMaxHour.Value == DBNull.Value)
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال الحد الاقصى لعدد الساعات  ", "Please Enter Max Hour");
			((Control)(object)txtMaxHour).Focus();
			return false;
		}
		if (((Control)(object)txtMaxCount).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال الحد الاقصى لعدد المرات  ", "Please Enter Max Count");
			((TextEditorControlBase)txtMaxCount).Focus();
			return false;
		}
		if (Main.CheckForValue("HR_LeavePermissionRule", "LeavePermissionRuleNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["LeavePermissionRuleNo"].ToString(), IsFromServer: true) > 0)
		{
			string code = LeavePermissionRule.GetCode(IsFromServer: true);
	...
	public override void AddData()
	{
		...
		try
		{
			int num = LeavePermissionRule.Insert_Update("-1", ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, txtMaxHour.Value.ToString(), ((Control)(object)txtMaxCount).Text, txtSalaryDays.Value.ToString(), txtSalaryWorkHours.Value.ToString(), ((Control)(object)txtNotes).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
			string nodeCheckedIDs = GetNodeCheckedIDs();
			if (nodeCheckedIDs != ",")
			{
				Employees.UpdateLeavePermissionRuleIDBySubAccountIDs(nodeCheckedIDs, num.ToString(), IsFromServer: true);
			}
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = LeavePermissionRule.Insert_Update(drMaster["LeavePermissionRuleID"].ToString(), ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, txtMaxHour.Value.ToString(), ((Control)(object)txtMaxCount).Text, txtSalaryDays.Value.ToString(), txtSalaryWorkHours.Value.ToString(), ((Control)(object)txtNotes).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
			string nodeCheckedIDs = GetNodeCheckedIDs();
			if (nodeCheckedIDs != ",")
			{
				Employees.UpdateLeavePermissionRuleIDBySubAccountIDs(nodeCheckedIDs, num.ToString(), IsFromServer: true);
	...
	{
		LeavePermissionRule.Delete(drMaster["LeavePermissionRuleID"].ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public override void btnPrintClick()
	{
		if (RowID != "")
		{
			...
			{
				GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_HR_LeavePermissionRule_A.rpt" : "Rep_HR_LeavePermissionRule_E.rpt"));
			}
			frmReporViwer frmReporViwer2 = new frmReporViwer();
			GlobalVariables.ReportDocument.SetParameterValue("@LeavePermissionRuleIDs", "," + RowID + ",");
	...
	{
		dtSearchResult = SearchFunctions.LeavePermissionRulesReport(IsFromServer: true);
		if (dtSearchResult.Rows.Count > 0)
		{
			RowID = dtSearchResult.Rows[0]["LeavePermissionRuleID"].ToString();
			FillData();
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.MasterData.frmLeavePermissionRule));
		...
		this.lblMaxHour = new UltraLabel();
		this.txtMaxHour = new UltraMaskedEdit();
		this.ultraLabel1 = new UltraLabel();
		this.txtMaxCount = new UltraTextEditor();
		...
		resources.ApplyResources(this.lblMaxHour, "lblMaxHour");
		this.lblMaxHour.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblMaxHour).Name = "lblMaxHour";
		((ControlBase)this.lblMaxHour).WrapText = false;
		resources.ApplyResources(this.txtMaxHour, "txtMaxHour");
		this.txtMaxHour.DisplayMode = (MaskMode)1;
		this.txtMaxHour.EditAs = (EditAsType)8;
		this.txtMaxHour.InputMask = "{LOC}hh:mm";
		((System.Windows.Forms.Control)(object)this.txtMaxHour).Name = "txtMaxHour";
		this.txtMaxHour.NonAutoSizeHeight = 24;
		resources.ApplyResources(this.ultraLabel1, "ultraLabel1");
		this.ultraLabel1.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.ultraLabel1).Name = "ultraLabel1";
		((ControlBase)this.ultraLabel1).WrapText = false;
		resources.ApplyResources(this.txtMaxCount, "txtMaxCount");
		((System.Windows.Forms.Control)(object)this.txtMaxCount).Name = "txtMaxCount";
		((System.Windows.Forms.Control)(object)this.txtMaxCount).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txtMaxCount_KeyPress);
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtMaxCount);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.ultraLabel1);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblMaxCount);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblMaxHour);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtMaxHour);
		...
		base.Name = "frmLeavePermissionRule";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtMaxHour, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblMaxHour, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblMaxCount, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.ultraLabel1, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtMaxCount, 0);
