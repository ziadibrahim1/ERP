...
public class frmFeedingRule : frmButtons
{
	...
	private UltraLabel lblMinWorkingHours;

	private UltraLabel ultraLabel1;

	private UltraTextEditor txtValue;

	private UltraTextEditor txtMinWorkingHours;
	...
	public frmFeedingRule()
	{
		InitializeComponent();
		TableName = "HR_FeedingRules";
		IDCol = "FeedingRuleID";
		NoCol = "FeedingRuleNo";
		DateCol = "GetDate()";
	}

	public frmFeedingRule(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void FillData()
	{
		...
		{
			DataTable dataTable = FeedingRules.Select(RowID, "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			((Control)(object)txtCode).Text = drMaster["FeedingRuleNo"].ToString();
			((Control)(object)txtArabicName).Text = drMaster["FeedingRuleNameAr"].ToString();
			((Control)(object)txtEnglishName).Text = drMaster["FeedingRuleNameEn"].ToString();
			((TextEditorControlBase)txtMinWorkingHours).Value = drMaster["MinWorkingHours"].ToString();
			((TextEditorControlBase)txtValue).Value = drMaster["Value"].ToString();
			...
			dtEmployeesDetails = Employees.SelectByFeedingRuleID(drMaster["FeedingRuleID"].ToString(), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)txtMinWorkingHours).ReadOnly = NavMode;
	...
	public override void ClearControls()
	{
		...
		((TextEditorControlBase)txtMinWorkingHours).Value = null;
		((TextEditorControlBase)txtValue).Value = null;
		txtSalaryDays.Value = 30m;
		txtSalaryWorkHours.Value = 8m;
		((TextEditorControlBase)txtNotes).Clear();
		((Control)(object)txtCode).Text = (Adding ? FeedingRules.GetCode(IsFromServer: true) : "");
		TreeFunctions.SetAllTreeNodesCheckState(Checked: false, TreeEmployees);
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال كود اللائحة ", "Please Enter Feeding Rule Code");
			((TextEditorControlBase)txtCode).Focus();
			return false;
		}
		if (((Control)(object)txtArabicName).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال إسم اللائحة بالعربية", "Please Enter Arabic Name");
			((TextEditorControlBase)txtArabicName).Focus();
			return false;
		}
		if (((TextEditorControlBase)txtMinWorkingHours).Value == DBNull.Value)
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال عدد ساعات العمل  ", "Please Enter Min Working Hour");
			((TextEditorControlBase)txtMinWorkingHours).Focus();
			return false;
		}
		if (((TextEditorControlBase)txtValue).Value == DBNull.Value)
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال القيمه  ", "Please Enter the Value");
			((TextEditorControlBase)txtValue).Focus();
			return false;
		}
		if (Main.CheckForValue("HR_FeedingRules", "FeedingRuleNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["FeedingRuleNo"].ToString(), IsFromServer: true) > 0)
		{
			string code = FeedingRules.GetCode(IsFromServer: true);
	...
	public override void AddData()
	{
		...
		try
		{
			int num = FeedingRules.Insert_Update("-1", ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((TextEditorControlBase)txtMinWorkingHours).Value.ToString(), ((TextEditorControlBase)txtValue).Value.ToString(), txtSalaryDays.Value.ToString(), txtSalaryWorkHours.Value.ToString(), ((Control)(object)txtNotes).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
			string nodeCheckedIDs = GetNodeCheckedIDs();
			if (nodeCheckedIDs != ",")
			{
				Employees.UpdateFeedingRuleIDBySubAccountIDs(nodeCheckedIDs, num.ToString(), IsFromServer: true);
			}
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = FeedingRules.Insert_Update(drMaster["FeedingRuleID"].ToString(), ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((TextEditorControlBase)txtMinWorkingHours).Value.ToString(), ((TextEditorControlBase)txtValue).Value.ToString(), txtSalaryDays.Value.ToString(), txtSalaryWorkHours.Value.ToString(), ((Control)(object)txtNotes).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
			string nodeCheckedIDs = GetNodeCheckedIDs();
			if (nodeCheckedIDs != ",")
			{
				Employees.UpdateFeedingRuleIDBySubAccountIDs(nodeCheckedIDs, num.ToString(), IsFromServer: true);
	...
	{
		FeedingRules.Delete(drMaster["FeedingRules"].ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public override void btnPrintClick()
	{
		if (RowID != "")
		{
			...
			{
				GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_HR_FeedingRules_A.rpt" : "Rep_HR_FeedingRules_E.rpt"));
			}
			frmReporViwer frmReporViwer2 = new frmReporViwer();
			GlobalVariables.ReportDocument.SetParameterValue("@FeedingRuleIDs", "," + RowID + ",");
	...
	{
		dtSearchResult = SearchFunctions.FeedingRulesReport(IsFromServer: true);
		if (dtSearchResult.Rows.Count > 0)
		{
			RowID = dtSearchResult.Rows[0]["FeedingRuleID"].ToString();
			FillData();
		}
	}
	...
	private void txtMinWorkingHours_KeyPress(object sender, KeyPressEventArgs e)
	{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.MasterData.frmFeedingRule));
		...
		this.lblMinWorkingHours = new UltraLabel();
		this.ultraLabel1 = new UltraLabel();
		this.txtValue = new UltraTextEditor();
		this.txtMinWorkingHours = new UltraTextEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.txtMinWorkingHours).BeginInit();
		...
		resources.ApplyResources(this.lblMinWorkingHours, "lblMinWorkingHours");
		this.lblMinWorkingHours.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblMinWorkingHours).Name = "lblMinWorkingHours";
		((ControlBase)this.lblMinWorkingHours).WrapText = false;
		...
		resources.ApplyResources(this.txtMinWorkingHours, "txtMinWorkingHours");
		((System.Windows.Forms.Control)(object)this.txtMinWorkingHours).Name = "txtMinWorkingHours";
		((System.Windows.Forms.Control)(object)this.txtMinWorkingHours).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txtMinWorkingHours_KeyPress);
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtMinWorkingHours);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.ultraLabel1);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblValue);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblMinWorkingHours);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblMinWorkingHours, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblValue, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.ultraLabel1, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtMinWorkingHours, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.txtMinWorkingHours).EndInit();
