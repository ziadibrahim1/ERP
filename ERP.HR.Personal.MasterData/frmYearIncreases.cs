...
public class frmYearIncreases : frmGrid
{
	...
	private UltraCheckEditor chkIsVariantIncluded;

	private UltraCheckEditor chkInLeavePermission;

	public frmYearIncreases()
	{
		InitializeComponent();
		TableName = "HR_YearIncreases";
		IDCol = "YearIncreaseID";
	}
	...
	public override void SetControls(bool NavMode)
	{
		...
		((Control)(object)chkIsVariantIncluded).Enabled = !NavMode;
	...
	public override void ClearControls()
	{
		...
		((UltraToggleEditorBase)chkIsVariantIncluded).Checked = false;
		((Control)(object)txtValue).Text = "0";
	}

	public override void FillData()
	{
		dataTable = YearIncreases.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["YearIncreaseNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " اسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["YearIncreaseNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["YearIncreaseNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["YearIncreaseNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "اسم  بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["YearIncreaseNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["YearIncreaseNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
	...
	{
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["YearIncreaseNameAr"].Value.ToString();
		((Control)(object)txtEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["YearIncreaseNameEn"].Value.ToString();
		...
		((UltraToggleEditorBase)chkIsVariantIncluded).Checked = bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["IsVariantIncluded"].Value.ToString());
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال اسم العلاوه بالعربية", "Please Enter YearIncrease Arabic Name");
			return false;
		}
	...
	{
		YearIncreases.Insert_Update("-1", ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((UltraToggleEditorBase)chkIsMonthly).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInPenalty).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInAbsent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInVacation).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInOvertime).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInLatency).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInTax).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInInsurance).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInBonus).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInLeavePermission).Checked ? "1" : "0", "0", ((UltraToggleEditorBase)chkInServicePrecent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsPrecent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsVariantIncluded).Checked ? "1" : "0", (((Control)(object)txtValue).Text == "") ? "0" : ((Control)(object)txtValue).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
		FillData();
	}

	public override void UpdateData()
	{
		YearIncreases.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["YearIncreaseID"].Value.ToString(), ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((UltraToggleEditorBase)chkIsMonthly).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInPenalty).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInAbsent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInVacation).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInOvertime).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInLatency).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInTax).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInInsurance).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInBonus).Checked ? "1" : "0", ((UltraToggleEditorBase)chkInLeavePermission).Checked ? "1" : "0", "0", ((UltraToggleEditorBase)chkInServicePrecent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsPrecent).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsVariantIncluded).Checked ? "1" : "0", (((Control)(object)txtValue).Text == "") ? "0" : ((Control)(object)txtValue).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
		FillData();
	}

	public override void DeleteData()
	{
		YearIncreases.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["YearIncreaseID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public override void btnPrintClick()
	{
		...
		{
			GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_HR_YearIncreases_A.rpt" : "Rep_HR_YearIncreases_E.rpt"));
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.MasterData.frmYearIncreases));
		...
		this.chkIsVariantIncluded = new UltraCheckEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.chkIsVariantIncluded).BeginInit();
		...
		resources.ApplyResources(this.chkIsVariantIncluded, "chkIsVariantIncluded");
		((System.Windows.Forms.Control)(object)this.chkIsVariantIncluded).Name = "chkIsVariantIncluded";
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkIsVariantIncluded);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkIsVariantIncluded, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.chkIsVariantIncluded).EndInit();
