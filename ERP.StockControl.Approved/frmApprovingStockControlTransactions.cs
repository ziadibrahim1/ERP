...
public class frmApprovingStockControlTransactions : frmPosted
{
	...
	public frmApprovingStockControlTransactions()
	{
		InitializeComponent();
		NoCol = "VoucherNo";
	...
	public override void FillGrid()
	{
		...
		{
			dtsource = OpeningBalances.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
		}
		else if (rbGoodReceiptNote.Checked)
		{
			dtsource = GoodReceiptNotes.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
		}
		else if (rbMaterialIssueVoucher.Checked)
		{
			dtsource = MaterialIssueVouchers.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
		}
		else if (rbStoreSettlementVoucher.Checked)
		{
			dtsource = StoresSettlementVouchers.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
		}
		else if (rbStoreTaking.Checked)
		{
			dtsource = StoreTakings.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
		}
		else if (rbClientDeptReturn.Checked)
		{
			dtsource = ClientsDepartmentsReturns.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
		}
		else if (rbSupplierReturn.Checked)
		{
			dtsource = SuppliersReturns.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
		}
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			if (rbOpennigBalance.Checked)
			{
				OpeningBalances.SetApprove("1", text);
			}
			else if (rbGoodReceiptNote.Checked)
			{
				GoodReceiptNotes.SetApprove("1", text);
			}
			else if (rbMaterialIssueVoucher.Checked)
			{
				MaterialIssueVouchers.SetApprove("1", text);
			}
			else if (rbStoreSettlementVoucher.Checked)
			{
				StoresSettlementVouchers.SetApprove("1", text);
			}
			else if (rbStoreTaking.Checked)
			{
				StoreTakings.SetApprove("1", text);
			}
			else if (rbClientDeptReturn.Checked)
			{
				ClientsDepartmentsReturns.SetApprove("1", text);
			}
			else if (rbSupplierReturn.Checked)
			{
				SuppliersReturns.SetApprove("1", text);
			}
			FillGrid();
		}
		else
	...
	public override void Search()
	{
		...
		{
			DataTable dataTable2 = SearchFunctions.GoodReceiptNotesReport(0, 0);
		...
		{
			DataTable dataTable3 = SearchFunctions.MaterialIssueVouchersReport(0, 0);
		...
		{
			DataTable dataTable4 = SearchFunctions.StoresSettlementVouchersReport(-1, 0, 0);
		...
		{
			DataTable dataTable5 = SearchFunctions.StoreTakingsReport(GlobalVariables.StoreIDs, 0, 0);
		...
		{
			DataTable dataTable6 = SearchFunctions.ClientsDepartmentsReturnsReport(0, 0, -1);
		...
		else
		{
			...
			DataTable dataTable7 = SearchFunctions.SuppliersReturnsReport(0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Approved.frmApprovingStockControlTransactions));
		...
		base.Name = "frmApprovingStockControlTransactions";
