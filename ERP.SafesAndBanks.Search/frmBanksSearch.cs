...
public class frmBanksSearch : frmSearch
{
	private IContainer components = null;

	public frmBanksSearch()
	{
		InitializeComponent();
	}

	public frmBanksSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BankCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.3) - GlobalVariables.ScrollWidth;
