...
public class frmPercentages : frmGrid
{
	...
	public frmPercentages()
	{
		InitializeComponent();
		TableName = "WH_Percentages";
		IDCol = "PercentageID";
	}
	...
	{
		dataTable = Percentages.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Percentage"].Header).Caption = (GlobalVariables.IsArabic ? " اسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Percentage"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Percentage"].Width = ((Control)(object)ULGData).Width - GlobalVariables.ScrollWidth;
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["Percentage"].Value.ToString();
	}
	...
	{
		Percentages.Insert_Update("-1", ((Control)(object)txtArabicName).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		Percentages.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["PercentageID"].Value.ToString(), ((Control)(object)txtArabicName).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		Percentages.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["PercentageID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.WareHouse.MasterData.frmPercentages));
