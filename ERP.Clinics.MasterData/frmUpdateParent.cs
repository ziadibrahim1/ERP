...
public class frmUpdateParent : frmDetails
{
	...
	{
		dtBioAnalysis = BioAnalysis.SelectGroups(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		GlobalFunctions.FillCombo(cboHeader, dtBioAnalysis, "BioAnalysisID", "BioAnalysisName");
	...
	public override void SaveData()
	{
		...
		try
		{
			BioAnalysis.UpdateParentID(RowID, ((TextEditorControlBase)cboHeader).Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Clinics.MasterData.frmUpdateParent));
