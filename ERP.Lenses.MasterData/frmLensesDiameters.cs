...
public class frmLensesDiameters : frmGrid
{
	...
	public frmLensesDiameters()
	{
		InitializeComponent();
		TableName = "Lns_LensesDiameters";
		IDCol = "LenseDiameterID";
	}
	...
	{
		dataTable = LensesDiameters.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		InitGrid();
	}
	...
	public override void InitGrid()
	{
		...
		base.InitGrid();
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["LenseDiameterID"].DefaultCellValue = -1;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Diameter"].Width = ((Control)(object)ULGData).Width - GlobalVariables.ScrollWidth;
	}
	...
	{
		if (((Control)(object)txtDiameter).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال القطر", "Please Insert Diameter");
	...
	{
		LensesDiameters.Insert_Update("-1", (((Control)(object)txtDiameter).Text == "") ? "Null" : ((Control)(object)txtDiameter).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		LensesDiameters.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["LenseDiameterID"].Value.ToString(), (((Control)(object)txtDiameter).Text == "") ? "Null" : ((Control)(object)txtDiameter).Text, ((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString().Equals("True") ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		LensesDiameters.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["LenseDiameterID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
		ClearControls();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.MasterData.frmLensesDiameters));
		...
		((TextEditorControlBase)this.txtDiameter).Appearance = (AppearanceBase)(object)val10;
