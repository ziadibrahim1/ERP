...
public class frmSubTrucksNumber : frmGrid
{
	...
	public frmSubTrucksNumber()
	{
		InitializeComponent();
		TableName = "Lns_SubTrucksNumber";
		IDCol = "SubTruckNumberID";
	}
	...
	{
		dataTable = SubTrucksNumber.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		InitGrid();
	}
	...
	public override void InitGrid()
	{
		...
		base.InitGrid();
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SubTruckNumberID"].DefaultCellValue = -1;
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال الرقم  ", "Please Insert Sub-Truck Number");
			((TextEditorControlBase)txtNumber).Focus();
			return false;
		}
		if ((Adding && dataTable.Select("Number='" + ((Control)(object)txtNumber).Text + "'").Length != 0) || (Updating && dataTable.Select("Number='" + ((Control)(object)txtNumber).Text + "' and SubTruckNumberID <> " + RowID).Length != 0))
		{
			GlobalVariables.InformationMB.Show("يوجد مقطورة بنفس الرقم", "A Sub-Truck with the same number already exists");
			((TextEditorControlBase)txtNumber).Focus();
			return false;
		}
	...
	{
		SubTrucksNumber.Insert_Update("-1", ((Control)(object)txtNumber).Text, (((Control)(object)txtMaxLoad).Text == "") ? "0" : ((Control)(object)txtMaxLoad).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		SubTrucksNumber.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["SubTruckNumberID"].Value.ToString(), ((Control)(object)txtNumber).Text, (((Control)(object)txtMaxLoad).Text == "") ? "0" : ((Control)(object)txtMaxLoad).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		SubTrucksNumber.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["SubTruckNumberID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
		ClearControls();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.MasterData.frmSubTrucksNumber));
