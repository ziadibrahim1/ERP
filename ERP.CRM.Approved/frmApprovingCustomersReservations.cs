...
public class frmApprovingCustomersReservations : frmPosted
{
	private IContainer components = null;

	public frmApprovingCustomersReservations()
	{
		InitializeComponent();
	...
	{
		dtsource = CustomersReservations.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			CustomersReservations.SetApprove("1", text);
			FillGrid();
		}
		else
		{
	...
	{
		DataTable dataTable = SearchFunctions.CustomersReservationsReport(0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CRM.Approved.frmApprovingCustomersReservations));
		...
		base.Name = "frmApprovingCustomersReservations";
