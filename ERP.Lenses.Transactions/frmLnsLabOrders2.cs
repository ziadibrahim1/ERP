...
public class frmLnsLabOrders2 : frmHeaderManyDetails
{
	...
	private decimal ClientDiscPercent = default(decimal);
	...
	private UltraTextEditor txtClientDiscPerc;

	public frmLnsLabOrders2()
	{
	...
	public frmLnsLabOrders2(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void PrepareData()
	{
		...
		vlGlassesType.ValueListItems.Add((object)6, GlobalVariables.IsArabic ? "أخرى" : "Others");
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[1].Columns["RLenseItemID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.18) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[1].Columns["RDiscount"].Width = (int)((double)((Control)(object)ULGData).Width * 0.05);
		((UltraGridBase)ULGData).DisplayLayout.Bands[1].Columns["LLenseItemID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.18);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[1].Columns["LDiscount"].Width = (int)((double)((Control)(object)ULGData).Width * 0.05);
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[1].Columns["RDiscount"].Header).Caption = (GlobalVariables.IsArabic ? "الخصم" : "Discount");
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[1].Columns["LDiscount"].Header).Caption = (GlobalVariables.IsArabic ? "الخصم" : "Discount");
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[1].Columns["RDiscount"].Hidden = false;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[1].Columns["LDiscount"].Hidden = false;
		...
		((UltraGridBase)ULGDataServices).DisplayLayout.Bands[0].Columns["Discount"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)txtClientDiscPerc).ReadOnly = NavMode;
		DiscountUserID = 0;
		((Control)(object)btnRTranspose).Visible = !NavMode;
		((Control)(object)btnLTranspose).Visible = !NavMode;
		((EditorButtonControlBase)txtDiscBeforeTaxValue).ReadOnly = true;
	...
	public override void ClearControls()
	{
		...
		dtpDate.ValueChanged += dtpDate_ValueChanged;
		ClientDiscPercent = default(decimal);
		DiscountUserID = 0;
		...
		((TextEditorControlBase)txtClientDiscPerc).ValueChanged -= txtClientDiscPerc_ValueChanged;
		((Control)(object)txtClientDiscPerc).Text = "0";
		((TextEditorControlBase)txtClientDiscPerc).ValueChanged += txtClientDiscPerc_ValueChanged;
		((TextEditorControlBase)txtClientDiscount).ValueChanged -= txtClientDiscount_ValueChanged;
	...
	public override bool ValidateData()
	{
		...
		if (decimal.Parse((((Control)(object)txtClientLoadAmount).Text == "" || ((Control)(object)txtClientLoadAmount).Text == ".") ? "0" : ((Control)(object)txtClientLoadAmount).Text) > decimal.Parse((((Control)(object)txtTotalContractAmount).Text == "" || ((Control)(object)txtTotalContractAmount).Text == ".") ? "0" : ((Control)(object)txtTotalContractAmount).Text))
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "قيمة التعاقد يجب ان تكون اكبر من قيمة التحمل" : "Total Contract Amuont Should Be Greater Than Client Load Amount");
			return false;
		}
	...
	public override void AddData()
	{
		...
		decimal num = ((decimal.Parse((((Control)(object)txtGrossValue).Text == "" || ((Control)(object)txtGrossValue).Text == ".") ? "0" : ((Control)(object)txtGrossValue).Text) == 0m) ? 0m : (decimal.Parse((((Control)(object)txtDiscBeforeTaxValue).Text == "" || ((Control)(object)txtDiscBeforeTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text) * 100m / decimal.Parse((((Control)(object)txtGrossValue).Text == "" || ((Control)(object)txtGrossValue).Text == ".") ? "0" : ((Control)(object)txtGrossValue).Text)));
		((UltraGridBase)ULGData).UpdateData();
		((DataSet)((UltraGridBase)ULGData).DataSource).Tables[0].AcceptChanges();
		((DataSet)((UltraGridBase)ULGData).DataSource).Tables[1].AcceptChanges();
		...
		try
		{
			int num2 = LabOrders.Insert_Update("-1", ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), (cboLabs.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboLabs).Value.ToString(), (cboClient.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboClient).Value.ToString(), "Null", (ClientsGlassesHistoryID == 0m) ? "Null" : ClientsGlassesHistoryID.ToString(), (dataRow["SubAccountID"] == DBNull.Value) ? dtPOSDefaultData.Rows[0]["DefaultSubAccountID"].ToString() : dataRow["SubAccountID"].ToString(), (dataRow["PriceTypeID"] == DBNull.Value) ? "Null" : dataRow["PriceTypeID"].ToString(), dtPOSDefaultData.Rows[0]["CurrencyID"].ToString(), dtCurrency.Select(" CurrencyID=  " + dtPOSDefaultData.Rows[0]["CurrencyID"].ToString())[0]["ExchangeRate"].ToString(), (cboSalesMan.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSalesMan).Value.ToString(), "Null", (cboSponsor.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSponsor).Value.ToString(), ((Control)(object)txtSponsorCompanyName).Text, ((Control)(object)txtSponsorApprovalNo).Text, (cboFamilyRelatives.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboFamilyRelatives).Value.ToString(), (LabContractID == "") ? "Null" : LabContractID, (((Control)(object)txtCompanyDiscount).Text == "") ? "0" : ((Control)(object)txtCompanyDiscount).Text, (((Control)(object)txtClientDiscount).Text == "") ? "0" : ((Control)(object)txtClientDiscount).Text, "0", dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), "0", dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((UltraToggleEditorBase)chkIsDeliverd).Checked ? "1" : "0", dtpDeliverdDate.DateTime.ToString(GlobalVariables.DateLongFormate), (((Control)(object)txtGrossValue).Text == "") ? "0" : ((Control)(object)txtGrossValue).Text, (((Control)(object)txtDiscBeforeTaxValue).Text == "") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text, num.ToString(), (cboTax.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboTax).Value.ToString(), (((Control)(object)txtTaxTotalValue).Text == "") ? "0" : ((Control)(object)txtTaxTotalValue).Text, "0", "0", "0", (((Control)(object)txtTotalContractAmount).Text == "") ? "0" : ((Control)(object)txtTotalContractAmount).Text, (((Control)(object)txtClientLoadAmount).Text == "") ? "0" : ((Control)(object)txtClientLoadAmount).Text, (((Control)(object)txtNetprice).Text == "") ? "0" : ((Control)(object)txtNetprice).Text, (((Control)(object)txtPaidAmount).Text == "") ? "0" : ((Control)(object)txtPaidAmount).Text, (((Control)(object)txtRestAmount).Text == "") ? "0" : ((Control)(object)txtRestAmount).Text, ((Control)(object)txtNotes).Text, ShiftDetailID, ShiftDetailUserID, GlobalVariables.UserID, "Null", (DiscountUserID > 0) ? DiscountUserID.ToString() : "Null", (dataRow["SubAccountID"] == DBNull.Value) ? GlobalVariables.CurrentBranchID : dataRow["SubAccountBranchID"].ToString(), "Null", "Null", "1", (dtLabs.Select(" LabID= " + ((TextEditorControlBase)cboLabs).Value.ToString())[0]["LabBranchID"] == DBNull.Value) ? "Null" : dtLabs.Select(" LabID= " + ((TextEditorControlBase)cboLabs).Value.ToString())[0]["LabBranchID"].ToString(), "Null", "Null", "Null", "Null", "Null", "0", "Null", "0", "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			for (int j = 0; j < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; j++)
			{
				int num3 = LabOrdersDetails.Insert_Update("-1", num2.ToString(), "Null", (((UltraGridBase)ULGData).Rows[j].Cells["FrameItemID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[j].Cells["FrameItemID"].Value.ToString(), (((UltraGridBase)ULGData).Rows[j].Cells["ColorID"].Value == DBNull.Value) ? "1" : ((UltraGridBase)ULGData).Rows[j].Cells["ColorID"].Value.ToString(), (((UltraGridBase)ULGData).Rows[j].Cells["ItemSizeID"].Value == DBNull.Value) ? "1" : ((UltraGridBase)ULGData).Rows[j].Cells["ItemSizeID"].Value.ToString(), (((UltraGridBase)ULGData).Rows[j].Cells["UnitID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[j].Cells["UnitID"].Value.ToString(), "0", (((UltraGridBase)ULGData).Rows[j].Cells["UnitPrice"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[j].Cells["UnitPrice"].Value.ToString(), (((UltraGridBase)ULGData).Rows[j].Cells["Notes"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[j].Cells["Notes"].Value.ToString(), (((UltraGridBase)ULGData).Rows[j].Cells["Discount"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[j].Cells["Discount"].Value.ToString(), (((UltraGridBase)ULGData).Rows[j].Cells["TaxValue"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[j].Cells["TaxValue"].Value.ToString(), (((UltraGridBase)ULGData).Rows[j].Cells["ActualUnitSalesPrice"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[j].Cells["ActualUnitSalesPrice"].Value.ToString(), (((UltraGridBase)ULGData).Rows[j].Cells["GlassesTypeID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[j].Cells["GlassesTypeID"].Value.ToString(), (((UltraGridBase)ULGData).Rows[j].Cells["LenseDiameterID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[j].Cells["LenseDiameterID"].Value.ToString(), (dtLabs.Select(" LabID= " + ((TextEditorControlBase)cboLabs).Value.ToString())[0]["StoreID"] == DBNull.Value) ? "Null" : dtLabs.Select(" LabID= " + ((TextEditorControlBase)cboLabs).Value.ToString())[0]["StoreID"].ToString(), (dtPOSDefaultData.Rows[0]["DefaultStoreID"] == DBNull.Value) ? "Null" : dtPOSDefaultData.Rows[0]["DefaultStoreID"].ToString(), ((UltraToggleEditorBase)chkIsDeliverd).Checked ? "1" : "0", dtpDeliverdDate.DateTime.ToString(GlobalVariables.DateLongFormate), "0", "1", "0", bool.Parse(((UltraGridBase)ULGData).Rows[j].Cells["IsDestroyed"].Value.ToString()) ? "1" : "0", (((UltraGridBase)ULGData).Rows[j].Cells["OnCostOfID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[j].Cells["OnCostOfID"].Value.ToString(), "0", (((UltraGridBase)ULGData).Rows[j].Cells["LabUnitPrice"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[j].Cells["LabUnitPrice"].Value.ToString(), "1", dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			...
			for (int l = 0; l < ((DisposableObjectCollectionBase)((UltraGridBase)ULGDataServices).Rows).Count; l++)
			{
				...
				CalculateGoss();
				LabOrdersServices.Insert_Update("-1", num2.ToString(), (((UltraGridBase)ULGDataServices).Rows[l].Cells["ServiceItemID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGDataServices).Rows[l].Cells["ServiceItemID"].Value.ToString(), (((UltraGridBase)ULGDataServices).Rows[l].Cells["Qty"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGDataServices).Rows[l].Cells["Qty"].Value.ToString(), (((UltraGridBase)ULGDataServices).Rows[l].Cells["UnitPrice"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGDataServices).Rows[l].Cells["UnitPrice"].Value.ToString(), (((UltraGridBase)ULGDataServices).Rows[l].Cells["TotalPrice"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGDataServices).Rows[l].Cells["TotalPrice"].Value.ToString(), ((UltraGridBase)ULGDataServices).Rows[l].Cells["Notes"].Value.ToString(), (((UltraGridBase)ULGDataServices).Rows[l].Cells["Discount"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGDataServices).Rows[l].Cells["Discount"].Value.ToString(), (((UltraGridBase)ULGDataServices).Rows[l].Cells["TaxValue"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGDataServices).Rows[l].Cells["TaxValue"].Value.ToString(), (((UltraGridBase)ULGDataServices).Rows[l].Cells["ActualUnitSalesPrice"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGDataServices).Rows[l].Cells["ActualUnitSalesPrice"].Value.ToString(), "0", ((UltraGridBase)ULGDataServices).Rows[l].Cells["LabUnitPrice"].Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			}
			for (int m = 0; m < ((DisposableObjectCollectionBase)((UltraGridBase)ULGDataContractsDetails).Rows).Count; m++)
			{
				LabOrdersContractsDetails.Insert_Update("-1", num2.ToString(), (((UltraGridBase)ULGDataContractsDetails).Rows[m].Cells["LabContractDetailID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGDataContractsDetails).Rows[m].Cells["LabContractDetailID"].Value.ToString(), ((UltraGridBase)ULGDataContractsDetails).Rows[m].Cells["Price"].Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			}
			LabOrders.GenerateSalesJvs("," + num2 + ",", GlobalVariables.UserID);
			LabOrders.GenerateBranchPurchaseJvs("," + num2 + ",", GlobalVariables.UserID);
			ItemsTransactions.ManagementInsertUpdateDelete();
			ItemsTransactions.RecalculateCurrentQtyOnly();
			string text = LabOrders.AllowedQty_Message(num2.ToString(), "0", "1", GlobalVariables.IsArabic ? "1" : "0");
			if (text != "")
			{
				GlobalVariables.InformationMB.Show(text);
				Main.RollbackBulkTrans(FromServer: false);
				DataSaved = false;
				MessageLog.DeleteByVoucherIDAndTransType(num2.ToString(), "LabMIV", "LabMIV");
			}
			else
			{
	...
	public override void UpdateData()
	{
		...
		try
		{
			...
			{
				int num3 = LabOrdersDetails.Insert_Update((int.Parse(((UltraGridBase)ULGData).Rows[k].Cells["LabOrderDetailID"].Value.ToString()) >= -100000 && int.Parse(((UltraGridBase)ULGData).Rows[k].Cells["LabOrderDetailID"].Value.ToString()) < -1) ? "-1" : ((UltraGridBase)ULGData).Rows[k].Cells["LabOrderDetailID"].Value.ToString(), num2.ToString(), "Null", (((UltraGridBase)ULGData).Rows[k].Cells["FrameItemID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[k].Cells["FrameItemID"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["ColorID"].Value == DBNull.Value) ? "1" : ((UltraGridBase)ULGData).Rows[k].Cells["ColorID"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["ItemSizeID"].Value == DBNull.Value) ? "1" : ((UltraGridBase)ULGData).Rows[k].Cells["ItemSizeID"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["UnitID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[k].Cells["UnitID"].Value.ToString(), "0", (((UltraGridBase)ULGData).Rows[k].Cells["UnitPrice"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[k].Cells["UnitPrice"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["Notes"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[k].Cells["Notes"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["Discount"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[k].Cells["Discount"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["TaxValue"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[k].Cells["TaxValue"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["ActualUnitSalesPrice"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[k].Cells["ActualUnitSalesPrice"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["GlassesTypeID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[k].Cells["GlassesTypeID"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["LenseDiameterID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[k].Cells["LenseDiameterID"].Value.ToString(), (dtLabs.Select(" LabID= " + ((TextEditorControlBase)cboLabs).Value.ToString())[0]["StoreID"] == DBNull.Value) ? "Null" : dtLabs.Select(" LabID= " + ((TextEditorControlBase)cboLabs).Value.ToString())[0]["StoreID"].ToString(), (dtPOSDefaultData.Rows[0]["DefaultStoreID"] == DBNull.Value) ? "Null" : dtPOSDefaultData.Rows[0]["DefaultStoreID"].ToString(), ((UltraToggleEditorBase)chkIsDeliverd).Checked ? "1" : "0", dtpDeliverdDate.DateTime.ToString(GlobalVariables.DateLongFormate), bool.Parse(((UltraGridBase)ULGData).Rows[k].Cells["IsReturned"].Value.ToString()) ? "1" : "0", "1", "0", bool.Parse(((UltraGridBase)ULGData).Rows[k].Cells["IsDestroyed"].Value.ToString()) ? "1" : "0", (((UltraGridBase)ULGData).Rows[k].Cells["OnCostOfID"].Value == DBNull.Value) ? "Null" : ((UltraGridBase)ULGData).Rows[k].Cells["OnCostOfID"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["FromLabStore"].Value == DBNull.Value) ? "0" : (bool.Parse(((UltraGridBase)ULGData).Rows[k].Cells["FromLabStore"].Value.ToString()) ? "1" : "0"), (((UltraGridBase)ULGData).Rows[k].Cells["LabUnitPrice"].Value == DBNull.Value) ? "0" : ((UltraGridBase)ULGData).Rows[k].Cells["LabUnitPrice"].Value.ToString(), (((UltraGridBase)ULGData).Rows[k].Cells["FromBranchStore"].Value == DBNull.Value) ? "1" : (bool.Parse(((UltraGridBase)ULGData).Rows[k].Cells["FromBranchStore"].Value.ToString()) ? "1" : "0"), dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			...
			if (((DisposableObjectCollectionBase)((UltraGridBase)ULGDataServices).Rows).Count > 0)
			{
				...
				{
					((UltraGridBase)ULGDataServices).Rows[m].Cells["LabOrderID"].Value = num2;
			...
			if (((DisposableObjectCollectionBase)((UltraGridBase)ULGDataContractsDetails).Rows).Count > 0)
			{
				...
				{
					((UltraGridBase)ULGDataContractsDetails).Rows[n].Cells["LabOrderID"].Value = num2;
			...
			LabOrders.GenerateSalesJvs("," + num2 + ",", GlobalVariables.UserID);
			LabOrders.GenerateBranchPurchaseJvs("," + num2 + ",", GlobalVariables.UserID);
			string text4 = MessageLog.SelectByVoucherIDAndTransType(num2.ToString(), "LabMIV", "LabMIV", GlobalVariables.IsArabic ? "1" : "0");
			if (text4 != "")
			{
	...
	private void ULGData_CellListSelect(object sender, CellEventArgs e)
	{
		...
		if (((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Band.Index == 0 && ULGData.ActiveCell != null)
		{
			if (((KeyedSubObjectBase)e.Cell.Column).Key == "FrameItemID" && e.Cell.Column.ValueList.SelectedItemIndex >= 0)
			{
				...
				((UltraGridBase)ULGData).ActiveRow.Cells["Discount"].Value = 0;
				if (dtItemPrices != null && dtItemPrices.Rows.Count > 0 && cboClient.SelectedIndex > -1)
				{
					...
					if (ClientDiscPercent != 0m)
					{
						((UltraGridBase)ULGData).ActiveRow.Cells["Discount"].Value = decimal.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["UnitPrice"].Value.ToString()) * ClientDiscPercent / 100m;
					}
					CalculateDiscount();
					CalculateGoss();
		...
		else if (((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Band.Index == 1 && ULGData.ActiveCell != null)
		{
			if (((KeyedSubObjectBase)e.Cell.Column).Key == "RLenseItemID" && (e.Cell.Column.ValueList.SelectedItemIndex >= 0 || e.Cell.ValueList.SelectedItemIndex >= 0))
			{
				...
				((UltraGridBase)ULGData).ActiveRow.Cells["RDiscount"].Value = 0;
				if (dtItemPrices != null && dtItemPrices.Rows.Count > 0 && cboClient.SelectedIndex > -1)
				{
					...
					if (ClientDiscPercent != 0m)
					{
						((UltraGridBase)ULGData).ActiveRow.Cells["RDiscount"].Value = decimal.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["RUnitPrice"].Value.ToString()) * ClientDiscPercent / 100m;
					}
					CalculateDiscount();
					CalculateGoss();
			...
			else if (((KeyedSubObjectBase)e.Cell.Column).Key == "LLenseItemID" && (e.Cell.Column.ValueList.SelectedItemIndex >= 0 || e.Cell.ValueList.SelectedItemIndex >= 0))
			{
				...
				((UltraGridBase)ULGData).ActiveRow.Cells["LDiscount"].Value = 0;
				if (dtItemPrices != null && dtItemPrices.Rows.Count > 0 && cboClient.SelectedIndex > -1)
				{
					...
					if (ClientDiscPercent != 0m)
					{
						((UltraGridBase)ULGData).ActiveRow.Cells["LDiscount"].Value = decimal.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["LUnitPrice"].Value.ToString()) * ClientDiscPercent / 100m;
					}
					CalculateDiscount();
					CalculateGoss();
					CalculateRow(e.Cell.Row.ParentRow);
	...
	private void ULGData_AfterCellUpdate(object sender, CellEventArgs e)
	{
		...
		if (ULGData.ActiveCell != null && ((UltraGridBase)ULGData).ActiveRow != null && ((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Band.Index == 0)
		{
			...
			{
				UltraGridCell obj = ((UltraGridBase)ULGData).ActiveRow.Cells["Discount"];
				UltraGridCell obj2 = ((UltraGridBase)ULGData).ActiveRow.Cells["UnitPrice"];
				object obj3 = (((UltraGridBase)ULGData).ActiveRow.Cells["LabUnitPrice"].Value = 0);
			...
			if (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "UnitPrice")
			{
				...
				if (decimal.Parse(ULGData.ActiveCell.Value.ToString()) == 0m)
				{
					((UltraGridBase)ULGData).ActiveRow.Cells["Discount"].Value = 0;
				}
				if (ClientDiscPercent != 0m)
				...
				CalculateFrameDiscountPercentage(ULGData.ActiveCell.Row);
				CalculateRow(((UltraGridBase)ULGData).ActiveRow);
				CalculateDiscount();
				CalculateGoss();
			}
			if (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "Discount")
			{
				ULGData.ActiveCell.Value = ((ULGData.ActiveCell.Value == DBNull.Value) ? ((object)0) : ULGData.ActiveCell.Value);
				CalculateFrameDiscountPercentage(ULGData.ActiveCell.Row);
				CalculateRow(((UltraGridBase)ULGData).ActiveRow);
		...
		else if (((UltraGridBase)ULGData).ActiveRow != null && ULGData.ActiveCell != null && ((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Band.Index == 1)
		{
			...
			{
				UltraGridCell obj6 = ((UltraGridBase)ULGData).ActiveRow.Cells["RDiscount"];
				UltraGridCell obj7 = ((UltraGridBase)ULGData).ActiveRow.Cells["RUnitPrice"];
				object obj3 = (((UltraGridBase)ULGData).ActiveRow.Cells["RLabUnitPrice"].Value = 0);
				object value = (obj7.Value = obj3);
				obj6.Value = value;
				UltraGridCell obj10 = ((UltraGridBase)ULGData).ActiveRow.Cells["RColorID"];
				UltraGridCell obj11 = ((UltraGridBase)ULGData).ActiveRow.Cells["RItemSizeID"];
				obj3 = (((UltraGridBase)ULGData).ActiveRow.Cells["RUnitID"].Value = DBNull.Value);
				value = (obj11.Value = obj3);
				obj10.Value = value;
			...
			{
				UltraGridCell obj13 = ((UltraGridBase)ULGData).ActiveRow.Cells["LDiscount"];
				UltraGridCell obj14 = ((UltraGridBase)ULGData).ActiveRow.Cells["LUnitPrice"];
				object obj3 = (((UltraGridBase)ULGData).ActiveRow.Cells["LLabUnitPrice"].Value = 0);
				object value = (obj14.Value = obj3);
				obj13.Value = value;
				UltraGridCell obj17 = ((UltraGridBase)ULGData).ActiveRow.Cells["LColorID"];
				UltraGridCell obj18 = ((UltraGridBase)ULGData).ActiveRow.Cells["LItemSizeID"];
				obj3 = (((UltraGridBase)ULGData).ActiveRow.Cells["LUnitID"].Value = DBNull.Value);
				value = (obj18.Value = obj3);
				obj17.Value = value;
				CalculateRow(((UltraGridBase)ULGData).ActiveRow.ParentRow);
				CalculateDiscount();
				CalculateGoss();
			...
			else if (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RUnitPrice" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "LUnitPrice")
			{
				...
				if (decimal.Parse(ULGData.ActiveCell.Value.ToString()) == 0m)
				{
					if (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RUnitPrice")
					{
						((UltraGridBase)ULGData).ActiveRow.Cells["RDiscount"].Value = 0;
					}
					else
				...
				if (ClientDiscPercent != 0m && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RUnitPrice")
				{
					((UltraGridBase)ULGData).ActiveRow.Cells["RDiscount"].Value = decimal.Parse(ULGData.ActiveCell.Value.ToString()) * ClientDiscPercent / 100m;
				}
				if (ClientDiscPercent != 0m && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "LUnitPrice")
				{
					((UltraGridBase)ULGData).ActiveRow.Cells["LDiscount"].Value = decimal.Parse(ULGData.ActiveCell.Value.ToString()) * ClientDiscPercent / 100m;
				}
				CalculateLenseDiscountPercentage(ULGData.ActiveCell.Row, ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RUnitPrice");
				CalculateRow(((UltraGridBase)ULGData).ActiveRow.ParentRow);
				CalculateDiscount();
				CalculateGoss();
			}
			else if (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RDiscount" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "LDiscount")
			{
				ULGData.ActiveCell.Value = ((ULGData.ActiveCell.Value == DBNull.Value) ? ((object)0) : ULGData.ActiveCell.Value);
				CalculateLenseDiscountPercentage(ULGData.ActiveCell.Row, ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RDiscount");
				CalculateRow(((UltraGridBase)ULGData).ActiveRow.ParentRow);
				CalculateDiscount();
				CalculateGoss();
			}
	...
	public override void SelectFullRow(object sender, EventArgs e)
	{
		...
		{
			if (ULGData.ActiveCell != null && (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "UnitPrice" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "Discount" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "ColorID" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "ItemSizeID") && ((UltraGridBase)ULGData).ActiveRow.Cells["FrameItemID"].Value == DBNull.Value)
			{
				((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
			}
			...
			else if (ULGData.ActiveCell != null && ((UltraGridBase)ULGData).ActiveRow != null && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "Discount" && ((UltraGridBase)ULGData).ActiveRow.Cells["FrameItemID"].Value != DBNull.Value && dtItemPrices != null && dtItemPrices.Rows.Count > 0 && decimal.Parse(dtItemPrices.Select(" ItemID =" + ((UltraGridBase)ULGData).ActiveRow.Cells["FrameItemID"].Value.ToString())[0]["DiscountPercentage"].ToString()) > 0m)
			{
				((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
			}
		}
		else if (((UltraGridBase)ULGData).ActiveRow != null && ((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Band.Index == 1)
		{
			...
			else if (ULGData.ActiveCell != null && ((UltraGridBase)ULGData).ActiveRow.Cells["LLenseItemID"].Value == DBNull.Value && (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "LUnitPrice" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "LDiscount" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "LColorID" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "LItemSizeID"))
			{
				((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
			}
			else if (ULGData.ActiveCell != null && ((UltraGridBase)ULGData).ActiveRow.Cells["RLenseItemID"].Value == DBNull.Value && (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RUnitPrice" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RDiscount" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RColorID" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RItemSizeID"))
			{
				((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
			}
			...
			else if (ULGData.ActiveCell != null && ((UltraGridBase)ULGData).ActiveRow != null && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "LDiscount" && ((UltraGridBase)ULGData).ActiveRow.Cells["LLenseItemID"].Value != DBNull.Value && dtItemPrices != null && dtItemPrices.Rows.Count > 0 && decimal.Parse(dtItemPrices.Select(" ItemID =" + ((UltraGridBase)ULGData).ActiveRow.Cells["LLenseItemID"].Value.ToString())[0]["DiscountPercentage"].ToString()) > 0m)
			{
				((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
			}
			else if (ULGData.ActiveCell != null && ((UltraGridBase)ULGData).ActiveRow != null && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "RDiscount" && ((UltraGridBase)ULGData).ActiveRow.Cells["RLenseItemID"].Value != DBNull.Value && dtItemPrices != null && dtItemPrices.Rows.Count > 0 && decimal.Parse(dtItemPrices.Select(" ItemID =" + ((UltraGridBase)ULGData).ActiveRow.Cells["RLenseItemID"].Value.ToString())[0]["DiscountPercentage"].ToString()) > 0m)
			{
				((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
			}
		}
	...
	private void CalculateRow(UltraGridRow Row)
	{
		if (cboTax.SelectedIndex > -1)
		{
			...
			for (int i = 0; i < ((DisposableObjectCollectionBase)Row.ChildBands[0].Rows).Count; i++)
			{
				if (i == 0)
				{
					Row.ChildBands[0].Rows[i].Cells["RTaxValue"].Value = decimal.Parse(dtTaxs.Select(" TaxID= " + ((TextEditorControlBase)cboTax).Value.ToString())[0]["TaxPercent"].ToString()) / 100m * (decimal.Parse(Row.ChildBands[0].Rows[i].Cells["RUnitPrice"].Value.ToString()) - decimal.Parse(Row.ChildBands[0].Rows[i].Cells["RDiscount"].Value.ToString()));
					Row.ChildBands[0].Rows[i].Cells["LTaxValue"].Value = decimal.Parse(dtTaxs.Select(" TaxID= " + ((TextEditorControlBase)cboTax).Value.ToString())[0]["TaxPercent"].ToString()) / 100m * (decimal.Parse(Row.ChildBands[0].Rows[i].Cells["LUnitPrice"].Value.ToString()) - decimal.Parse(Row.ChildBands[0].Rows[i].Cells["LDiscount"].Value.ToString()));
				}
			}
			return;
		}
		...
		for (int j = 0; j < ((DisposableObjectCollectionBase)Row.ChildBands[0].Rows).Count; j++)
		{
			if (j == 0)
			{
				Row.ChildBands[0].Rows[j].Cells["RTaxValue"].Value = 0;
				Row.ChildBands[0].Rows[j].Cells["LTaxValue"].Value = 0;
			}
		}
	}

	private void CalculateFrameDiscountPercentage(UltraGridRow row)
	{
		decimal num = default(decimal);
		if (decimal.Parse(row.Cells["UnitPrice"].Value.ToString()) > 0m)
		{
			decimal num2 = decimal.Parse(row.Cells["Discount"].Value.ToString()) * 100m / decimal.Parse(row.Cells["UnitPrice"].Value.ToString());
			if ((cboClient.SelectedIndex > -1 && num2 > decimal.Parse(dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString()) && num2 > UserSalesDiscount) || (cboClient.SelectedIndex == -1 && num2 > UserSalesDiscount))
			{
				frmChangeDiscount frmChangeDiscount2 = new frmChangeDiscount(decimal.Parse(row.Cells["UnitPrice"].Value.ToString()), decimal.Parse(row.Cells["Discount"].Value.ToString()), num2);
				frmChangeDiscount2.WindowState = FormWindowState.Normal;
				frmChangeDiscount2.ShowDialog();
				if (frmChangeDiscount2.Cancel)
				{
					num = decimal.Parse((cboClient.SelectedIndex > -1 && decimal.Parse(dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString()) > UserSalesDiscount) ? dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString() : UserSalesDiscount.ToString());
					row.Cells["Discount"].Value = num / 100m * decimal.Parse(row.Cells["UnitPrice"].Value.ToString());
					return;
				}
				num = frmChangeDiscount2.DiscountRatio;
				row.Cells["Discount"].Value = num / 100m * decimal.Parse(row.Cells["UnitPrice"].Value.ToString());
	...
	private void CalculateLenseDiscountPercentage(UltraGridRow row, bool Right)
	{
		decimal num = default(decimal);
		string text = (Right ? "RDiscount" : "LDiscount");
		string text2 = (Right ? "RUnitPrice" : "LUnitPrice");
		if (decimal.Parse(row.Cells[text2].Value.ToString()) > 0m)
		{
			decimal num2 = decimal.Parse(row.Cells[text].Value.ToString()) * 100m / decimal.Parse(row.Cells[text2].Value.ToString());
			if ((cboClient.SelectedIndex > -1 && num2 > decimal.Parse(dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString()) && num2 > UserSalesDiscount) || (cboClient.SelectedIndex == -1 && num2 > UserSalesDiscount))
			{
				frmChangeDiscount frmChangeDiscount2 = new frmChangeDiscount(decimal.Parse(row.Cells[text2].Value.ToString()), decimal.Parse(row.Cells[text].Value.ToString()), num2);
				frmChangeDiscount2.WindowState = FormWindowState.Normal;
				frmChangeDiscount2.ShowDialog();
				if (frmChangeDiscount2.Cancel)
				{
					num = decimal.Parse((cboClient.SelectedIndex > -1 && decimal.Parse(dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString()) > UserSalesDiscount) ? dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString() : UserSalesDiscount.ToString());
					row.Cells[text].Value = num / 100m * decimal.Parse(row.Cells[text2].Value.ToString());
					return;
				}
				num = frmChangeDiscount2.DiscountRatio;
				row.Cells[text].Value = num / 100m * decimal.Parse(row.Cells[text2].Value.ToString());
	...
	private void CalculateDiscount()
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			if (((UltraGridBase)ULGData).Rows[i].Cells["Discount"].Value != DBNull.Value)
			{
				num += decimal.Parse(((UltraGridBase)ULGData).Rows[i].Cells["Discount"].Value.ToString());
			}
			num += CalculateLenseDiscount(((UltraGridBase)ULGData).Rows[i]);
		}
		for (int j = 0; j < ((DisposableObjectCollectionBase)((UltraGridBase)ULGDataServices).Rows).Count; j++)
		{
			if (((UltraGridBase)ULGDataServices).Rows[j].Cells["Discount"].Value != DBNull.Value)
			{
				num += decimal.Parse(((UltraGridBase)ULGDataServices).Rows[j].Cells["Discount"].Value.ToString());
			}
		}
		((Control)(object)txtDiscBeforeTaxValue).Text = decimal.Parse(num.ToString()).ToString(GlobalVariables.txtDecimalFormate);
	}

	public decimal CalculateLenseDiscount(UltraGridRow Row)
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)Row.ChildBands[0].Rows).Count; i++)
		{
			if (i == 0)
			{
				if (Row.ChildBands[0].Rows[i].Cells["RDiscount"].Value != DBNull.Value)
				{
					result += decimal.Parse(Row.ChildBands[0].Rows[i].Cells["RDiscount"].Value.ToString());
				}
				if (Row.ChildBands[0].Rows[i].Cells["LDiscount"].Value != DBNull.Value)
				{
					result += decimal.Parse(Row.ChildBands[0].Rows[i].Cells["LDiscount"].Value.ToString());
				}
			}
		}
		return result;
	...
	private void cboClient_ValueChanged(object sender, EventArgs e)
	{
		...
		if (cboClient.SelectedIndex > -1)
		{
			...
			((TextEditorControlBase)cboMobile).ValueChanged += cboMobile_ValueChanged;
			((Control)(object)txtClientDiscPerc).Text = dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString();
			if (Updating || Adding)
			{
			...
			if (dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["PriceTypeID"] != DBNull.Value)
			{
				...
				for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
				{
					if (((UltraGridBase)ULGData).Rows[i].Cells["FrameItemID"].Value != DBNull.Value)
					{
						...
						{
							((UltraGridBase)ULGData).Rows[i].Cells["Discount"].Value = 0;
						}
					...
					for (int j = 0; j < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows).Count; j++)
					{
						...
						if (((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["RLenseItemID"].Value != DBNull.Value)
						{
							...
							if (decimal.Parse(dataRow2["DiscountPercentage"].ToString()) > 0m)
							{
								((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["RDiscount"].Value = 0;
							}
						...
						if (((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["LLenseItemID"].Value != DBNull.Value)
						{
							...
							{
								((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["LDiscount"].Value = 0;
							}
	...
	public decimal OpenChangeDiscountForm(decimal discountRatio, decimal discountValue)
	{
		decimal num = discountRatio;
		decimal totalamount = decimal.Parse((((Control)(object)txtGrossValue).Text == "" || ((Control)(object)txtGrossValue).Text == ".") ? "0" : ((Control)(object)txtGrossValue).Text);
		frmChangeDiscount frmChangeDiscount2 = new frmChangeDiscount(totalamount, discountValue, discountRatio);
		frmChangeDiscount2.WindowState = FormWindowState.Normal;
		frmChangeDiscount2.ShowDialog();
		if (frmChangeDiscount2.Cancel)
		{
			return decimal.Parse((cboClient.SelectedIndex > -1 && decimal.Parse(dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString()) > UserSalesDiscount) ? dtClients.Select(" ClientID= " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString() : UserSalesDiscount.ToString());
		}
		DiscountUserID = frmChangeDiscount2.UserID;
		frmChangeDiscount2.Dispose();
	...
	private void txtClientDiscount_ValueChanged(object sender, EventArgs e)
	{
		...
		((TextEditorControlBase)txtClientDiscount).ValueChanged -= txtClientDiscount_ValueChanged;
		decimal num = decimal.Parse((((Control)(object)txtClientDiscPerc).Text == "" || ((Control)(object)txtClientDiscPerc).Text == ".") ? "0" : ((Control)(object)txtClientDiscPerc).Text);
		decimal num2 = decimal.Parse((((Control)(object)txtClientDiscount).Text == "" || ((Control)(object)txtClientDiscount).Text == ".") ? "0" : ((Control)(object)txtClientDiscount).Text);
		if ((Adding || Updating) && num != num2)
		{
			GlobalVariables.QuestionMB.Show("نسبة الخصم لا تساوي نسبة خصم العميل هل تريد تغييرها؟ ", "Discount Percentage Is Not The Same As Client Discount, Woull You Like To Change? ");
			if (GlobalVariables.MessageBoxResult == 'Y')
			{
				ClientDiscPercent = num2;
				ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
				ULGDataServices.AfterCellUpdate -= new CellEventHandler(ULGDataServices_AfterCellUpdate);
				for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
				{
					if (((UltraGridBase)ULGData).Rows[i].Cells["FrameItemID"].Value == null)
					{
						continue;
					}
					((UltraGridBase)ULGData).Rows[i].Cells["Discount"].Value = num2 / 100m * decimal.Parse(((UltraGridBase)ULGData).Rows[i].Cells["UnitPrice"].Value.ToString());
					for (int j = 0; j < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows).Count; j++)
					{
						if (((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["LLenseItemID"].Value != null && ((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["LLenseItemID"].Value != DBNull.Value)
						{
							((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["LDiscount"].Value = num2 / 100m * decimal.Parse(((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["LUnitPrice"].Value.ToString());
						}
						if (((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["RLenseItemID"].Value != null)
						{
							((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["RDiscount"].Value = num2 / 100m * decimal.Parse(((UltraGridBase)ULGData).Rows[i].ChildBands[0].Rows[j].Cells["RUnitPrice"].Value.ToString());
						}
					}
					CalculateRow(((UltraGridBase)ULGData).Rows[i]);
				}
				for (int k = 0; k < ((DisposableObjectCollectionBase)((UltraGridBase)ULGDataServices).Rows).Count; k++)
				{
					if (((UltraGridBase)ULGDataServices).Rows[k].Cells["ServiceItemID"].Value != null)
					{
						((UltraGridBase)ULGDataServices).Rows[k].Cells["Discount"].Value = num2 / 100m * decimal.Parse(((UltraGridBase)ULGDataServices).Rows[k].Cells["TotalPrice"].Value.ToString());
						CalculateServiceRow(((UltraGridBase)ULGDataServices).Rows[k]);
					}
				}
				CalculateDiscount();
	...
	private void txtClientDiscPerc_ValueChanged(object sender, EventArgs e)
	{
		...
		((TextEditorControlBase)txtClientDiscPerc).ValueChanged -= txtClientDiscPerc_ValueChanged;
		decimal num = decimal.Parse((((Control)(object)txtClientDiscount).Text == "" || ((Control)(object)txtClientDiscount).Text == ".") ? "0" : ((Control)(object)txtClientDiscount).Text);
		decimal num2 = decimal.Parse((((Control)(object)txtClientDiscPerc).Text == "" || ((Control)(object)txtClientDiscPerc).Text == ".") ? "0" : ((Control)(object)txtClientDiscPerc).Text);
		if (((Control)(object)txtClientDiscPerc).Text != null)
		{
			if ((cboClient.SelectedIndex > -1 && decimal.Parse((((Control)(object)txtClientDiscPerc).Text == "" || ((Control)(object)txtClientDiscPerc).Text == ".") ? "0" : ((Control)(object)txtClientDiscPerc).Text) > decimal.Parse(dtClients.Select(" ClientID = " + ((TextEditorControlBase)cboClient).Value)[0]["DiscountPercentage"].ToString()) && decimal.Parse((((Control)(object)txtClientDiscPerc).Text == "" || ((Control)(object)txtClientDiscPerc).Text == ".") ? "0" : ((Control)(object)txtClientDiscPerc).Text) > UserSalesDiscount) || (cboClient.SelectedIndex == -1 && decimal.Parse((((Control)(object)txtClientDiscPerc).Text == "" || ((Control)(object)txtClientDiscPerc).Text == ".") ? "0" : ((Control)(object)txtClientDiscPerc).Text) > UserSalesDiscount))
			{
				((Control)(object)txtClientDiscPerc).Text = OpenChangeDiscountForm(num2, 0m).ToString(GlobalVariables.txtDecimalFormate);
			}
			num2 = decimal.Parse((((Control)(object)txtClientDiscPerc).Text == "" || ((Control)(object)txtClientDiscPerc).Text == ".") ? "0" : ((Control)(object)txtClientDiscPerc).Text);
		}
		ClientDiscPercent = num2;
		ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
		ULGDataServices.AfterCellUpdate -= new CellEventHandler(ULGDataServices_AfterCellUpdate);
	...
	private void ULGDataServices_AfterCellUpdate(object sender, CellEventArgs e)
	{
		...
		ULGDataServices.AfterCellUpdate -= new CellEventHandler(ULGDataServices_AfterCellUpdate);
		if (ULGDataServices.ActiveCell != null && ULGDataServices.ActiveCell.Value == DBNull.Value && (((KeyedSubObjectBase)e.Cell.Column).Key == "Qty" || ((KeyedSubObjectBase)e.Cell.Column).Key == "Discount" || ((KeyedSubObjectBase)e.Cell.Column).Key == "UnitPrice"))
		{
		...
		if (ULGDataServices.ActiveCell != null && (((KeyedSubObjectBase)e.Cell.Column).Key == "Qty" || ((KeyedSubObjectBase)e.Cell.Column).Key == "UnitPrice"))
		{
			...
			if (ClientDiscPercent != 0m)
			{
				((UltraGridBase)ULGDataServices).ActiveRow.Cells["Discount"].Value = decimal.Parse(((UltraGridBase)ULGDataServices).ActiveRow.Cells["TotalPrice"].Value.ToString()) * ClientDiscPercent / 100m;
			}
			CalculateServiceRow(((UltraGridBase)ULGDataServices).ActiveRow);
			CalculateDiscount();
			CalculateGoss();
		}
		if (ULGDataServices.ActiveCell != null && ((KeyedSubObjectBase)e.Cell.Column).Key == "Discount")
		{
			ULGDataServices.ActiveCell.Value = ((ULGDataServices.ActiveCell.Value == DBNull.Value) ? ((object)0) : ULGDataServices.ActiveCell.Value);
			CalculateServiceRow(((UltraGridBase)ULGDataServices).ActiveRow);
			CalculateDiscount();
			CalculateGoss();
		}
	...
	private void cboSponsor_ValueChanged(object sender, EventArgs e)
	{
		...
		if (((TextEditorControlBase)cboSponsor).Value == null)
		{
			return;
		}
		if (((UltraGridBase)ULGDataContractsDetails).DataSource != null)
		{
			((DataTable)((UltraGridBase)ULGDataContractsDetails).DataSource).Rows.Clear();
		}
		((Control)(object)txtTotalContractAmount).Text = "0";
		if (cboSponsor.SelectedIndex > -1)
		{
			...
			if (dtSponsorContract.Rows.Count == 0)
			{
				...
				string text = (((Control)(object)txtCompanyDiscount).Text = "0");
			...
			((Control)(object)txtClientDiscount).Text = decimal.Parse(dtSponsorContract.Rows[0]["ClientDiscount"].ToString()).ToString(GlobalVariables.txtDecimalFormate);
			ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				CalculateRow(((UltraGridBase)ULGData).Rows[i]);
		...
		else
		{
			...
			UltraTextEditor obj3 = txtCompanyDiscount;
			string text3 = (((Control)(object)txtTotalContractAmount).Text = "0");
			string text = (((Control)(object)obj3).Text = text3);
			((Control)(object)obj2).Text = text;
			if (((UltraGridBase)ULGDataContractsDetails).DataSource != null)
			{
				((DataTable)((UltraGridBase)ULGDataContractsDetails).DataSource).Rows.Clear();
			}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Transactions.frmLnsLabOrders2));
		...
		this.txtClientDiscPerc = new UltraTextEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.txtClientDiscPerc).BeginInit();
		base.SuspendLayout();
		...
		((TextEditorControlBase)this.txtClientDiscount).ValueChanged += new System.EventHandler(txtClientDiscount_ValueChanged);
		...
		((System.Windows.Forms.Control)(object)this.txtClientLoadAmount).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txt_KeyPress);
		...
		resources.ApplyResources(this.txtClientDiscPerc, "txtClientDiscPerc");
		((System.Windows.Forms.Control)(object)this.txtClientDiscPerc).Name = "txtClientDiscPerc";
		((EditorButtonControlBase)this.txtClientDiscPerc).ReadOnly = true;
		((TextEditorControlBase)this.txtClientDiscPerc).ValueChanged += new System.EventHandler(txtClientDiscPerc_ValueChanged);
		((System.Windows.Forms.Control)(object)this.txtClientDiscPerc).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txt_KeyPress);
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtClientDiscPerc);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtClientDiscPerc, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.txtClientDiscPerc).EndInit();
