...
public class frmReservationPaymentsReturns : frmHeaderDetails
{
	...
	private int ReservationPaymentReturnID;
	...
	public frmReservationPaymentsReturns()
	{
		InitializeComponent();
		TableName = "Lns_ReservationsPaymentsReturns";
		IDCol = "ReservationPaymentReturnID";
		NoCol = "ReservationPaymentReturnNo";
		DateCol = "ReservationPaymentReturnDate";
	}

	public frmReservationPaymentsReturns(int _ReservationPaymentReturnID)
		: this()
	{
		ReservationPaymentReturnID = _ReservationPaymentReturnID;
	}

	public frmReservationPaymentsReturns(int reservationID, decimal restamount)
		: this()
	{
	...
	{
		if (ReservationPaymentReturnID != 0)
		{
			DataTable dataTable = ReservationsPaymentsReturns.Select(ReservationPaymentReturnID.ToString(), GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
		...
		{
			DataTable dataTable2 = ReservationsPaymentsReturns.Select(RowID, GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((Control)(object)txtCode).Text = drMaster["ReservationPaymentReturnNo"].ToString();
			dtpDate.Value = (DateTime)drMaster["ReservationPaymentReturnDate"];
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtCode).Text = (Adding ? ReservationsPaymentsReturns.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "برجاء إدخال القيمة فى المبلغ المدفوع نقدا\u064b" : "Please Enter Amount in Cash Amount");
			return false;
		}
		...
		if (num != 0m)
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "إجمالي المردود لا يساوي القيمة المدفوعة" : "Total Return does not equal Paid Amount");
			return false;
		}
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("Lns_ReservationsPaymentsReturns", "ReservationPaymentReturnNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["ReservationPaymentReturnNo"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
			string codeByBranchID = ReservationsPaymentsReturns.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
	...
	public override void AddData()
	{
		...
		try
		{
			int num = ReservationsPaymentsReturns.Insert_Update("-1", ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), (cboReservationNo.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboReservationNo).Value.ToString(), ((UltraToggleEditorBase)chkCash).Checked ? "1" : "0", (((Control)(object)txtCashAmount).Text == "") ? "0" : ((Control)(object)txtCashAmount).Text, ((UltraToggleEditorBase)chkIsOnAccount).Checked ? "1" : "0", (((Control)(object)txtOnAccountAmount).Text == "") ? "0" : ((Control)(object)txtOnAccountAmount).Text, ((UltraToggleEditorBase)chkVisa).Checked ? "1" : "0", (cboVisaType.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboVisaType).Value.ToString(), (((Control)(object)txtVisaNo).Text == "") ? "Null" : ((Control)(object)txtVisaNo).Text, (((Control)(object)txtVisaAmount).Text == "") ? "0" : ((Control)(object)txtVisaAmount).Text, dtPOSDefaultData.Rows[0]["CurrencyID"].ToString(), dtCurrency.Select(" CurrencyID=  " + dtPOSDefaultData.Rows[0]["CurrencyID"].ToString())[0]["ExchangeRate"].ToString(), ((Control)(object)txtNotes).Text, ShiftDetailID, ShiftDetailUserID, GlobalVariables.UserID, "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			Reservations.UpdatePaidAmount(((TextEditorControlBase)cboReservationNo).Value.ToString(), GlobalVariables.UserID);
			ShiftsDetails.ReservationsPaymentsReturnsJVAdding(num.ToString(), ShiftDetailID, GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			Reservations.UpdatePaidAmount(((TextEditorControlBase)cboReservationNo).Value.ToString(), GlobalVariables.UserID);
			RowID = num.ToString();
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = ReservationsPaymentsReturns.Insert_Update(drMaster["ReservationPaymentReturnID"].ToString(), ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), (cboReservationNo.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboReservationNo).Value.ToString(), ((UltraToggleEditorBase)chkCash).Checked ? "1" : "0", (((Control)(object)txtCashAmount).Text == "") ? "0" : ((Control)(object)txtCashAmount).Text, ((UltraToggleEditorBase)chkIsOnAccount).Checked ? "1" : "0", (((Control)(object)txtOnAccountAmount).Text == "") ? "0" : ((Control)(object)txtOnAccountAmount).Text, ((UltraToggleEditorBase)chkVisa).Checked ? "1" : "0", (cboVisaType.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboVisaType).Value.ToString(), (((Control)(object)txtVisaNo).Text == "") ? "Null" : ((Control)(object)txtVisaNo).Text, (((Control)(object)txtVisaAmount).Text == "") ? "0" : ((Control)(object)txtVisaAmount).Text, dtPOSDefaultData.Rows[0]["CurrencyID"].ToString(), dtCurrency.Select(" CurrencyID=  " + dtPOSDefaultData.Rows[0]["CurrencyID"].ToString())[0]["ExchangeRate"].ToString(), ((Control)(object)txtNotes).Text, ShiftDetailID, ShiftDetailUserID, GlobalVariables.UserID, "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
	...
	public override void DeleteData()
	{
		...
		try
		{
			ReservationsPaymentsReturns.DeleteVirtual(drMaster["ReservationPaymentReturnID"].ToString(), GlobalVariables.UserID);
			Reservations.UpdatePaidAmount(drMaster["ReservationID"].ToString(), GlobalVariables.UserID);
	...
	public override void btnPrintClick()
	{
		if (RowID != "")
		{
			GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_Lns_ReservationsPaymentsReturns_A.rpt" : "Rep_Lns_ReservationsPaymentsReturns_E.rpt"));
			frmReporViwer frmReporViwer2 = new frmReporViwer();
			GlobalVariables.ReportDocument.SetParameterValue("@ReservationPaymentReturnIDs", "," + RowID + ",");
	...
	{
		dtSearchResult = SearchFunctions.ReservationsPaymentsReturnsReport(0);
		if (dtSearchResult.Rows.Count > 0)
		{
			RowID = dtSearchResult.Rows[0]["ReservationPaymentReturnID"].ToString();
			FillData();
		}
	}
	...
	private void dtpDate_ValueChanged(object sender, EventArgs e)
	{
		if (Adding)
		{
			((Control)(object)txtCode).Text = ReservationsPaymentsReturns.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Transactions.frmReservationPaymentsReturns));
		...
		base.Name = "frmReservationPaymentsReturns";
