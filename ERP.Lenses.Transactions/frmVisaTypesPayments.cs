...
public class frmVisaTypesPayments : frmHeaderDetails
{
	...
	public frmVisaTypesPayments()
	{
		InitializeComponent();
		TableName = "Lns_VisaTypesPayments";
		IDCol = "VisaTypePaymentID";
		NoCol = "VisaTypePaymentNo";
		DateCol = "VisaTypePaymentDate";
	}

	public frmVisaTypesPayments(int _VisaTypePaymentID)
		: this()
	{
		VisaTypePaymentID = _VisaTypePaymentID;
	}
	...
	{
		if (VisaTypePaymentID != 0)
		{
			DataTable dataTable = VisaTypesPayments.Select(VisaTypePaymentID.ToString(), GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
		...
		{
			DataTable dataTable2 = VisaTypesPayments.Select(RowID, GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((Control)(object)txtCode).Text = drMaster["VisaTypePaymentNo"].ToString();
			dtpDate.Value = (DateTime)drMaster["VisaTypePaymentDate"];
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtCode).Text = (Adding ? VisaTypesPayments.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
	...
	public override bool ValidateData()
	{
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("Lns_VisaTypesPayments", "VisaTypePaymentNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["VisaTypePaymentNo"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
			string codeByBranchID = VisaTypesPayments.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
	...
	public override void AddData()
	{
		...
		GlobalVariables.QuestionMB.Show("هل تريد طباعة سداد الفيزا؟", "Are You Sure You want to Print This Visa Payment?");
		if (GlobalVariables.MessageBoxResult != 'Y')
		{
			return;
		}
		...
		try
		{
			...
			{
				if (dtReports.Rows[0]["Rep" + (GlobalVariables.IsArabic ? "_A" : "_E")].ToString().Trim() == "Rep_Lns_VisaTypesPaymentsFastPrint")
				{
					RowID = num.ToString();
					FastPrint();
					return;
			...
			{
				reportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_Lns_VisaTypesPayments_A.rpt" : "Rep_Lns_VisaTypesPayments_E.rpt"));
			}
			GlobalFunctions.ConfigureReport(reportDocument);
			reportDocument.SetParameterValue("@VisaTypePaymentIDs", "," + num + ",");
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = VisaTypesPayments.Insert_Update(drMaster["VisaTypePaymentID"].ToString(), ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), (cboVisaType.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboVisaType).Value.ToString(), (((Control)(object)txtVisaNo).Text == "") ? "Null" : ((Control)(object)txtVisaNo).Text, drMaster["ShiftDetailID"].ToString(), drMaster["ShiftDetailUserID"].ToString(), "Null", (cboAccountName.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboAccountName).Value.ToString(), (cboSubAccountName.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSubAccountName).Value.ToString(), dtPOSDefaultData.Rows[0]["CurrencyID"].ToString(), dtCurrency.Select(" CurrencyID=  " + dtPOSDefaultData.Rows[0]["CurrencyID"].ToString())[0]["ExchangeRate"].ToString(), ((Control)(object)txtNotes).Text, (((Control)(object)txtTotal).Text == "") ? "0" : ((Control)(object)txtTotal).Text, dtSubAccounts.Select(" SubAccountID= " + ((TextEditorControlBase)cboSubAccountName).Value.ToString())[0]["BranchID"].ToString(), (drMaster["TransferJVID"] == DBNull.Value) ? "Null" : drMaster["TransferJVID"].ToString(), (drMaster["TransferJVID2"] == DBNull.Value) ? "Null" : drMaster["TransferJVID2"].ToString(), "1", "Null", "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
	...
	{
		if (Main.IsSynchronization && !GlobalVariables.dtSyncConn.Rows[0]["SyncBranchID"].Equals(DBNull.Value) && VisaTypesPayments.SyncCanUpdate(RowID) == 0)
		{
	...
	public override void DeleteData()
	{
		...
		try
		{
			VisaTypesPayments.DeleteVirtual(drMaster["VisaTypePaymentID"].ToString(), GlobalVariables.UserID);
			ShiftsDetails.RevenueJVRegenerate(ShiftDetailID, GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			Main.EndBulkTrans(FromServer: false);
		}
		catch
	...
	public override void btnPrintClick()
	{
		...
		{
			GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_Lns_VisaTypesPayments_A.rpt" : "Rep_Lns_VisaTypesPayments_E.rpt"));
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@VisaTypePaymentIDs", "," + RowID + ",");
	...
	{
		DataTable dataTable = Main.ExecuteQuery_DataTable(" Rep_Lns_VisaTypesPayments '," + RowID + ",'," + (GlobalVariables.IsArabic ? "1" : "0"));
		...
		instance.AcceptChanges();
		instance.AddTextCell(dataRow["VisaTypePaymentNo"].ToString(), font5, 0.7f, 4f, StringAlignment.Far, black, DrawRectangle: true, black2, lineWidth);
		instance.AddTextCell("سداد فيزا برقم", font5, 0.3f, 4f, StringAlignment.Near, darkBlue, DrawRectangle: true, black2, lineWidth);
		instance.AcceptChanges();
		instance.AddTextCell(((DateTime)dataRow["VisaTypePaymentDate"]).ToString("dd/MM/yyyy hh:mm:ss tt"), font, 0.7f, 4f, StringAlignment.Far, black, DrawRectangle: true, black2, lineWidth);
		instance.AddTextCell("بتاريخ", font, 0.3f, 4f, StringAlignment.Near, darkBlue, DrawRectangle: true, black2, lineWidth);
		instance.AcceptChanges();
		instance.AddTextCell(dataRow["VisaTypeName"].ToString(), font, 0.7f, 4f, StringAlignment.Near, black, DrawRectangle: true, black2, lineWidth);
		instance.AddTextCell("نوع الفيزا", font, 0.3f, 4f, StringAlignment.Near, darkBlue, DrawRectangle: true, black2, lineWidth);
		instance.AcceptChanges();
		instance.AddTextCell(dataRow["VisaNo"].ToString(), font, 0.7f, 4f, StringAlignment.Far, black, DrawRectangle: true, black2, lineWidth);
		instance.AddTextCell("رقم الفيزا", font, 0.3f, 4f, StringAlignment.Near, darkBlue, DrawRectangle: true, black2, lineWidth);
		instance.AcceptChanges();
	...
	{
		dtSearchResult = SearchFunctions.LnsVisaTypesPaymentsReport(-1, 0);
		if (dtSearchResult.Rows.Count > 0)
		{
			RowID = dtSearchResult.Rows[0]["VisaTypePaymentID"].ToString();
			FillData();
		}
	}
	...
	private void dtpDate_ValueChanged(object sender, EventArgs e)
	{
		if (Adding)
		{
			((Control)(object)txtCode).Text = VisaTypesPayments.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Transactions.frmVisaTypesPayments));
		...
		base.Name = "frmVisaTypesPayments";
