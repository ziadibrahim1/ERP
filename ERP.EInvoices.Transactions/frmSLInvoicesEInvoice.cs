...
public class frmSLInvoicesEInvoice : frmHeaderManyDetails
{
	...
	public frmSLInvoicesEInvoice(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void PrepareData()
	{
		...
		dtEINVStates = BusinessLayer.EInvoices.States.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtInternalCode).Text = (Adding ? SLInvoices.GetEInvoiceInternalCode(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
	...
	public override bool ValidateData()
	{
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("SL_SLInvoices", "EInvoiceInternalCode", ((Control)(object)txtInternalCode).Text, Adding ? "0" : drMaster["EInvoiceInternalCode"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
			string eInvoiceInternalCode = SLInvoices.GetEInvoiceInternalCode(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = SLInvoices.Insert_Update(drMaster["SLInvoiceID"].ToString(), ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), rbIsDirectInvoice.Checked ? "1" : "0", rbIsQuotation.Checked ? "1" : "0", rbIsMaterialIssueVoucher.Checked ? "1" : "0", rbIsProductionRequest.Checked ? "1" : "0", "0", ((TextEditorControlBase)cboClient).Value.ToString(), ((TextEditorControlBase)cboCurrency).Value.ToString(), ((Control)(object)txtExchangeRate).Text, (cboQuotation.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboQuotation).Value.ToString(), (cboRequestNo.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboRequestNo).Value.ToString(), "Null", (cboSalesMan.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSalesMan).Value.ToString(), (cboCostCenter.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboCostCenter).Value.ToString(), (cboPaymentMethod.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboPaymentMethod).Value.ToString(), ((Control)(object)txtTruckNo).Text, ((Control)(object)txtSubTruckNo).Text, "Null", "Null", bool.Parse(drMaster["IsTruckPolicy"].ToString()) ? "1" : "0", (((Control)(object)txtGrossValue).Text == "") ? "0" : ((Control)(object)txtGrossValue).Text, (((Control)(object)txtDiscBeforeTaxValue).Text == "") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text, (((Control)(object)txtDiscBeforeTaxRatio).Text == "") ? "0" : ((Control)(object)txtDiscBeforeTaxRatio).Text, (((Control)(object)txtTaxTotalValue).Text == "") ? "0" : ((Control)(object)txtTaxTotalValue).Text, (((Control)(object)txtDiscAfterTaxValue).Text == "") ? "0" : ((Control)(object)txtDiscAfterTaxValue).Text, (((Control)(object)txtDiscAfterTaxRatio).Text == "") ? "0" : ((Control)(object)txtDiscAfterTaxRatio).Text, (((Control)(object)txtCommercialTax).Text == "") ? "0" : ((Control)(object)txtCommercialTax).Text, (((Control)(object)txtStampValue).Text == "") ? "0" : ((Control)(object)txtStampValue).Text, (((Control)(object)txtGrowthFees).Text == "") ? "0" : ((Control)(object)txtGrowthFees).Text, (((Control)(object)txtNetprice).Text == "") ? "0" : ((Control)(object)txtNetprice).Text, "Null", ((Control)(object)txtNotes).Text, "0", ((UltraToggleEditorBase)chkWithoutMIV).Checked ? "1" : "0", (((Control)(object)txtInternalCode).Text == "") ? "Null" : ((Control)(object)txtInternalCode).Text, (((Control)(object)txtUUID).Text == "") ? "Null" : ((Control)(object)txtUUID).Text, (dtpSendDate.Value == null) ? "Null" : dtpSendDate.DateTime.ToString(GlobalVariables.DateLongFormate), (cboSendUserName.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSendUserName).Value.ToString(), (cboCanceledUserName.SelectedIndex == -1) ? "0" : "1", (dtpCanceledDate.Value == null) ? "Null" : dtpCanceledDate.DateTime.ToString(GlobalVariables.DateLongFormate), (cboCanceledUserName.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboCanceledUserName).Value.ToString(), (drMaster["EINVStateID"] == DBNull.Value) ? "Null" : drMaster["EINVStateID"].ToString(), (drMaster["SalesJVID"] == DBNull.Value) ? "Null" : drMaster["SalesJVID"].ToString(), bool.Parse(drMaster["Approved"].ToString()) ? "1" : "0", bool.Parse(drMaster["Deleted"].ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			string text = ",";
			ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
			decimal invoiceExpense = CalculateInvoiceExpense();
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
	...
	public override void btnDeleteClick()
	{
		...
		if (((Control)(object)txtUUID).Text != "")
		{
			GlobalVariables.InformationMB.Show("لا يمكن حذف هذه الحركة لإنها تم رفعها على موقع الضرائب", "Cannot Delete This Transaction Because It Already Uploaded To Tax Portal ");
			return;
		}
	...
	{
		dtSearchResult = SearchFunctions.ESLInvoicesReport(-1, 0, -1, -1);
	...
	private void dtpDate_ValueChanged(object sender, EventArgs e)
	{
		...
		if (Adding)
		{
			...
			((Control)(object)txtInternalCode).Text = SLInvoices.GetEInvoiceInternalCode(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		}
	}
	...
	private async void btnSendInvoice_Click(object sender, EventArgs e)
	{
		...
		string Message = EINV.ValidationBySLInvoiceIDs("," + RowID + ",", GlobalVariables.IsArabic);
		if (Message != "")
		{
		...
		{
			int State = await EINV.GetDocumentState(GlobalFunctions.GetDefault("EINVClientID"), GlobalFunctions.GetDefault("EINVClientSecret1"), UseEInvoiceProductionEnvirnoment, ((Control)(object)txtUUID).Text, RowID);
			if (State > -1)
			{
		...
		{
			int State2 = await EINV.DocumentSubmission(GlobalFunctions.GetDefault("EINVClientID"), GlobalFunctions.GetDefault("EINVClientSecret1"), UseEInvoiceProductionEnvirnoment, "," + RowID + ",", GlobalVariables.UserID, GlobalVariables.IsArabic);
			if (State2 > -1)
			{
	...
	private async void btnCancelInvoice_Click(object sender, EventArgs e)
	{
		...
		if (int.Parse(Main.ExecuteQuery_DataTable(" Select Count(*) AS Counter From SC_MaterialIssueVouchers Where Deleted=0 AND SLInvoiceID = " + RowID).Rows[0]["Counter"].ToString()) > 0 && !rbIsMaterialIssueVoucher.Checked)
		{
			GlobalVariables.InformationMB.Show("لا يمكن الغاء هذه الحركة لانه تمت صرفها من المخازن", "Cannot Cancel This Transaction Because It Added in The Store ");
			((Control)(object)btnCancelInvoice).Enabled = true;
			return;
		}
		if (int.Parse(Main.ExecuteQuery_DataTable(" Select Count(*) AS Counter From SC_ClientsDepartmentsReturns Where Deleted=0 AND SLInvoiceID = " + RowID).Rows[0]["Counter"].ToString()) > 0)
		{
			GlobalVariables.InformationMB.Show("لا يمكن الغاء هذه الحركة لانه تم ارتجاعها فى المخازن", "Cannot Cancel This Transaction Because It Returned in The Store ");
			((Control)(object)btnCancelInvoice).Enabled = true;
			return;
		}
		if (int.Parse(Main.ExecuteQuery_DataTable(" Select Count(*) AS Counter From SL_SLInvoicesGroupDetails Where Deleted=0 AND SLInvoiceID = " + RowID).Rows[0]["Counter"].ToString()) > 0)
		{
			GlobalVariables.InformationMB.Show("لا يمكن الغاء هذه الحركة لانه موجوده في فاتورة مجمعه", "Cannot Cancel This Transaction Because It Is On a Group Invoice ");
			((Control)(object)btnCancelInvoice).Enabled = true;
			return;
		}
		...
		if (GlobalVariables.MessageBoxResult == 'Y')
		{
			...
			if (await EINV.DocumentCancellation(GlobalFunctions.GetDefault("EINVClientID"), GlobalFunctions.GetDefault("EINVClientSecret1"), UseEInvoiceProductionEnvirnoment, lstInvoices, GlobalVariables.UserID) > -1)
			{
				Main.ExecuteQuery_DataTable(" Update SL_SLInvoices Set  EINVStateID=5,EInvoiceIsCanceled=1,EInvoiceCanceledDate='" + DateTime.Now.ToString("MM'/'dd'/'yyyy HH: mm:ss") + " ',EInvoiceCanceledUserID=" + GlobalVariables.UserID + "  Where SLInvoiceID = " + RowID);
				JV.DeleteVirtual(drMaster["SalesJVID"].ToString(), GlobalVariables.UserID, IsFromServer: false);
				if (rbIsMaterialIssueVoucher.Checked)
				{
					Main.ExecuteNonQuery(" Update SC_MaterialIssueVouchers set SLInvoiceID=null Where SLInvoiceID =" + drMaster["SLInvoiceID"].ToString());
	...
	private async void btnPrintEInvoice_Click(object sender, EventArgs e)
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إرسال الفاتورة أولا ", "Please Send invoice First ");
	...
	private void lblTruckNo_Click(object sender, EventArgs e)
	{
	}
	...
	private void chkAll_CheckedChanged(object sender, EventArgs e)
	{
		...
		if (materialIssueVouchersIds != "")
		{
			...
			if (dtItemPrices != null && dtItemPrices.Rows.Count > 0 && cboClient.SelectedIndex > -1)
			{
				...
				for (int j = 0; j < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; j++)
				{
					((UltraGridBase)ULGData).Rows[j].Cells["UnitPrice"].Value = decimal.Parse(dtItemPrices.Select(" ItemID= " + ((UltraGridBase)ULGData).Rows[j].Cells["ItemID"].Value.ToString())[0]["Price"].ToString()) - decimal.Parse(dtItemPrices.Select(" ItemID= " + ((UltraGridBase)ULGData).Rows[j].Cells["ItemID"].Value.ToString())[0]["Price"].ToString()) * decimal.Parse(dtItemPrices.Select(" ItemID= " + ((UltraGridBase)ULGData).Rows[j].Cells["ItemID"].Value.ToString())[0]["DiscountPercentage"].ToString()) / 100m;
					((UltraGridBase)ULGData).Rows[j].Cells["TotalPrice"].Value = decimal.Parse(((UltraGridBase)ULGData).Rows[j].Cells["UnitPrice"].Value.ToString()) * decimal.Parse(((UltraGridBase)ULGData).Rows[j].Cells["Qty"].Value.ToString());
					CalculateRow(((UltraGridBase)ULGData).Rows[j]);
				}
				CalculateGoss();
	...
	public override void txtCode_KeyUp(object sender, KeyEventArgs e)
	{
		...
		if (e.KeyCode == Keys.Return && TableName.Length > 0 && NoCol.Length > 0 && ((Control)(object)txtCode).Text.Length > 0)
		{
			...
			DataTable comboData = Main.GetComboData(TableName, "*", NoCol + "=''" + ((Control)(object)txtCode).Text.Trim() + "'' And Deleted=0 And EInvoiceInternalCode is Not null Order by year(" + DateCol + ") Desc");
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.EInvoices.Transactions.frmSLInvoicesEInvoice));
		...
		this.pnlCheckType.Appearance = (AppearanceBase)(object)val11;
		...
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.btnPrintEInvoice);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.btnCancelInvoice);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.btnSendInvoice);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.lblCanceledDate);
		...
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.dtpCanceledDate);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.dtpSendDate);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.lblUUID);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.lblInternalCode);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.txtUUID);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.txtInternalCode);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.lblEINVState);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.cboState);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.lblCanceledUser);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.cboCanceledUserName);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.lblSendUser);
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl3).Controls.Add((System.Windows.Forms.Control)(object)this.cboSendUserName);
		...
		((System.Windows.Forms.Control)(object)this.lblBarCode).Click += new System.EventHandler(lblBarCode_Click);
		...
		((ControlBase)this.btnQuotationSearch).Appearance = (AppearanceBase)(object)val18;
		...
		((ControlBase)this.btnPaymentMethodSearch).Appearance = (AppearanceBase)(object)val19;
		...
		((System.Windows.Forms.Control)(object)this.lblSerial).Click += new System.EventHandler(lblSerial_Click);
		...
		((ControlBase)this.btnRequestSearch).Appearance = (AppearanceBase)(object)val21;
		...
		((System.Windows.Forms.Control)(object)this.lblTruckNo).Click += new System.EventHandler(lblTruckNo_Click);
		...
		((ControlBase)this.btnSalesManSearch).Appearance = (AppearanceBase)(object)val22;
		...
		((ControlBase)this.btnCostCenterSearch).Appearance = (AppearanceBase)(object)val24;
		...
		((ControlBase)this.btnStoreSearch).Appearance = (AppearanceBase)(object)val25;
		...
		((ControlBase)this.btnBranchesSearch).Appearance = (AppearanceBase)(object)val26;
		...
		base.Name = "frmSLInvoicesEInvoice";
