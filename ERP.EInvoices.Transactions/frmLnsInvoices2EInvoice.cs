...
public class frmLnsInvoices2EInvoice : frmHeaderManyDetails
{
	...
	public frmLnsInvoices2EInvoice()
	{
	...
	public frmLnsInvoices2EInvoice(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtInternalCode).Text = (Adding ? Invoices.GetEInvoiceInternalCode(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
	...
	{
		dtSearchResult = SearchFunctions.LnsInvoicesReport(-1, 0, -1, 1);
	...
	public override bool ValidateData()
	{
		...
		dtCurrency = BusinessLayer.Accounting.Currency.FillCurrencyByDate(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("Lns_Invoices", "EInvoiceInternalCode", ((Control)(object)txtInternalCode).Text, Adding ? "0" : drMaster["EInvoiceInternalCode"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
			string eInvoiceInternalCode = Invoices.GetEInvoiceInternalCode(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
	...
	public bool ValidateForShift()
	{
		...
		DataTable dataTable3 = BusinessLayer.Accounting.Currency.FillCurrencyByDate(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		if (dtPOSDefaultData.Rows.Count > 0 && dtPOSDefaultData.Rows[0]["CurrencyID"] == DBNull.Value)
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال عملة الفرع من إعدادات البيع المباشر ", "Please Enter Default Currency From POS Settings");
			return false;
	...
	private void dtpDate_ValueChanged(object sender, EventArgs e)
	{
		...
		if (Adding)
		{
			...
			((Control)(object)txtInternalCode).Text = Invoices.GetEInvoiceInternalCode(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.EInvoices.Transactions.frmLnsInvoices2EInvoice));
		...
		((KeyedSubObjectBase)val).Key = "E-Invoice";
		...
		resources.ApplyResources(val4, "appearance3");
		...
		((System.Windows.Forms.Control)(object)this.ultraTabPageControl2).Controls.Add((System.Windows.Forms.Control)(object)this.ultraLabel2);
		...
		((ControlBase)this.btnSalesMan2Search).Appearance = (AppearanceBase)(object)val15;
		...
		resources.ApplyResources(val16, "appearance23");
		((ControlBase)this.btnLineSearch).Appearance = (AppearanceBase)(object)val16;
		...
		((AppearanceBase)val17).Image = resources.GetObject("appearance24.Image");
		resources.ApplyResources(val17, "appearance24");
		((ControlBase)this.btnSelectLenses).Appearance = (AppearanceBase)(object)val17;
		...
		base.Name = "frmLnsInvoices2EInvoice";
