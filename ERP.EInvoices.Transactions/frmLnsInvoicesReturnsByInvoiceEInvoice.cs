...
public class frmLnsInvoicesReturnsByInvoiceEInvoice : frmHeaderManyDetails
{
	...
	public frmLnsInvoicesReturnsByInvoiceEInvoice()
	{
	...
	public frmLnsInvoicesReturnsByInvoiceEInvoice(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtInternalCode).Text = (Adding ? InvoicesReturns.GetEInvoiceInternalCode(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
	...
	public override bool ValidateData()
	{
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("Lns_InvoicesReturns", "EInvoiceInternalCode", ((Control)(object)txtInternalCode).Text, Adding ? "0" : drMaster["EInvoiceInternalCode"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
			string eInvoiceInternalCode = InvoicesReturns.GetEInvoiceInternalCode(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
	...
	public bool ValidateForShift()
	{
		...
		DataTable dataTable4 = BusinessLayer.Accounting.Currency.FillCurrencyByDate(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	{
		dtSearchResult = SearchFunctions.LnsInvoicesReturnsReport(-1, 0, 1);
	...
	private void dtpDate_ValueChanged(object sender, EventArgs e)
	{
		if (Adding)
		{
			...
			((Control)(object)txtInternalCode).Text = InvoicesReturns.GetEInvoiceInternalCode(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.EInvoices.Transactions.frmLnsInvoicesReturnsByInvoiceEInvoice));
		...
		((ControlBase)this.btnLnsInvoiceSearch).Appearance = (AppearanceBase)(object)val10;
		...
		base.Name = "frmLnsInvoicesReturnsByInvoiceEInvoice";
