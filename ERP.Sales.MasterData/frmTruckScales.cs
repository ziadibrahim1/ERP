...
public class frmTruckScales : frmGrid
{
	...
	public frmTruckScales()
	{
		InitializeComponent();
		TableName = "SL_TruckScales";
		IDCol = "TruckScaleID";
	}
	...
	public override void ClearControls()
	{
		...
		((TextEditorControlBase)txtPort).Clear();
	}

	public override void FillData()
	{
		dataTable = TruckScales.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TruckScaleNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " اسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TruckScaleNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TruckScaleNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TruckScaleNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "اسم  بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TruckScaleNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TruckScaleNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.3);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Port"].Header).Caption = (GlobalVariables.IsArabic ? "Port" : "Port");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Port"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Port"].Width = (int)((double)((Control)(object)ULGData).Width * 0.3);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["TruckScaleNameAr"].Value.ToString();
		((Control)(object)txtEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["TruckScaleNameEn"].Value.ToString();
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال اسم الوزن بالعربية", "Please Enter Scale Arabic Name");
			return false;
		}
		if (((Control)(object)txtPort).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال البورت", "Please Enter Scale Port");
			return false;
		}
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			if (((UltraGridBase)ULGData).Rows[i].Cells["TruckScaleNameAr"].Value.ToString() == ((Control)(object)txtArabicName).Text && (Adding || i != ((UltraGridBase)ULGData).ActiveRow.Index))
			{
				GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "إسم الميزان متواجد من قبل" : "Scale Name Already Exists");
				return false;
			}
			if (((UltraGridBase)ULGData).Rows[i].Cells["Port"].Value.ToString() == ((Control)(object)txtPort).Text && (Adding || i != ((UltraGridBase)ULGData).ActiveRow.Index))
			{
				GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "بورت الميزان متواجد من قبل" : "Scale Port Already Exists");
				return false;
			}
		}
	...
	{
		TruckScales.Insert_Update("-1", ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? ((Control)(object)txtArabicName).Text : ((Control)(object)txtEnglishName).Text, (((Control)(object)txtPort).Text == "") ? "Null" : ((Control)(object)txtPort).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		TruckScales.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["TruckScaleID"].Value.ToString(), ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, (((Control)(object)txtPort).Text == "") ? "Null" : ((Control)(object)txtPort).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		TruckScales.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["TruckScaleID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.MasterData.frmTruckScales));
