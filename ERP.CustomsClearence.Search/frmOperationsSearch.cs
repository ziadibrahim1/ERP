...
public class frmOperationsSearch : frmSearch
{
	private IContainer components = null;

	public frmOperationsSearch()
	{
		InitializeComponent();
	}

	public frmOperationsSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.085) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CertificateOpeningSeaPortName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.085);
