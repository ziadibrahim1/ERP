...
public class frmExpensesSearchReport : frmSearchReport
{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExpenseNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExpenseNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OnClientAccount"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
	}
