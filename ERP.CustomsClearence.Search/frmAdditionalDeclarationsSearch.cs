...
public class frmAdditionalDeclarationsSearch : frmSearch
{
	private IContainer components = null;

	public frmAdditionalDeclarationsSearch()
	{
		InitializeComponent();
	}

	public frmAdditionalDeclarationsSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AdditionalDeclarationCode"].Header).Caption = (GlobalVariables.IsArabic ? "إقرارات إضافية" : "Code");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AdditionalDeclarationCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
