...
public class frmMessagesLogSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmMessagesLogSearchReport()
	{
		InitializeComponent();
	}

	public frmMessagesLogSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["MessageDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["MessageText"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AddedByUserName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentByUserName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.08);
