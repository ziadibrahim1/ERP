...
public class frmBlankLensesReturnRep : frmReportTree2010
{
	private IContainer components = null;

	public frmBlankLensesReturnRep()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى خامة  ", "There is no chosen Blank Type to be shown in the report, please check Blank Types to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.LensesProductions.Reports.frmBlankLensesReturnRep));
		...
		base.Name = "frmBlankLensesReturnRep";
