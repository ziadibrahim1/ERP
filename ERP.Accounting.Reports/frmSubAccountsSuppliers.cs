...
public class frmSubAccountsSuppliers : frmReportTree2010
{
	private IContainer components = null;

	public frmSubAccountsSuppliers()
	{
		InitializeComponent();
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "بيانات الموردين" : "Suppliers Information");
	}
	...
	public override string GetReportName()
	{
		...
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_A_SubAccountsSuppliers_A.rpt" : "Rep_A_SubAccountsSuppliers_E.rpt");
		}
		return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_A_SubAccountsSuppliers_A_nologo.rpt" : "Rep_A_SubAccountsSuppliers_E_nologo.rpt");
	}
	...
	private void InitializeComponent()
	{
		...
		base.Name = "frmSubAccountsSuppliers";
