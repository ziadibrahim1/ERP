...
public class frmBanksReturnedChecksRep : frmReportTree2010
{
	private IContainer components = null;

	public frmBanksReturnedChecksRep()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "طباعه الشيكات المرتدة" : "Print Returned Check");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksReturnedChecks_A.rpt" : "Rep_SB_BanksReturnedChecks_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksReturnedChecks_A_nologo.rpt" : "Rep_SB_BanksReturnedChecks_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SafesAndBanks.Reports.frmBanksReturnedChecksRep));
		...
		base.Name = "frmBanksReturnedChecksRep";
