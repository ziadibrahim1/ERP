...
public class frmCheckFollowUpRep : frmReportTree2010
{
	private IContainer components = null;

	private UltraCheckEditor chkCollected;

	private UltraCheckEditor chkBinderSafe;

	private UltraCheckEditor chkUnderCollection;

	private UltraCheckEditor chkReturned;

	public frmCheckFollowUpRep()
	{
		TreeItems2IDCol = "BankID";
		TreeItems2NameCol = "BankName";
		InitializeComponent();
	}

	public override void FormLoad()
	{
		dtItems2 = Banks.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		if (dtItems2 != null)
		{
			TreeFunctions.FillTreeOneLevel(TreeItems2, dtItems2, "BankID", "BankName");
		}
	}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى بنك ليتم عرضه ", "There is no chosen Bank to be shown in the report, please Bank Vouchers to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@BranchIDs", Branches);
		GlobalVariables.ReportDocument.SetParameterValue("@BankIDs", Items2);
		...
		if (dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("CheckStatus"))
		{
			GlobalVariables.ReportDocument.SetParameterValue("@UnderCollection", ((UltraToggleEditorBase)chkUnderCollection).Checked ? "1" : "0");
			GlobalVariables.ReportDocument.SetParameterValue("@Collected", ((UltraToggleEditorBase)chkCollected).Checked ? "1" : "0");
			GlobalVariables.ReportDocument.SetParameterValue("@BinderSafe", ((UltraToggleEditorBase)chkBinderSafe).Checked ? "1" : "0");
			GlobalVariables.ReportDocument.SetParameterValue("@Returned", ((UltraToggleEditorBase)chkReturned).Checked ? "1" : "0");
		}
	...
	public override void btnItems2Search_Click(object sender, EventArgs e)
	{
		...
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["BAnkID"].ToString()).CheckedState = CheckState.Checked;
		}
	}

	private void cboReportType_ValueChanged(object sender, EventArgs e)
	{
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("CheckStatus"))
		{
			((Control)(object)chkBinderSafe).Visible = true;
			((Control)(object)chkUnderCollection).Visible = true;
			((Control)(object)chkReturned).Visible = true;
			((Control)(object)chkCollected).Visible = true;
		}
		else
		{
			((Control)(object)chkBinderSafe).Visible = false;
			((Control)(object)chkUnderCollection).Visible = false;
			((Control)(object)chkReturned).Visible = false;
			((Control)(object)chkCollected).Visible = false;
		}
	}

	private void frmCheckFollowUpRep_Load(object sender, EventArgs e)
	{
		if (base.DesignMode)
		{
			return;
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SafesAndBanks.Reports.frmCheckFollowUpRep));
		...
		this.chkCollected = new UltraCheckEditor();
		this.chkBinderSafe = new UltraCheckEditor();
		this.chkUnderCollection = new UltraCheckEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.chkCollected).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.chkBinderSafe).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.chkUnderCollection).BeginInit();
		...
		resources.ApplyResources(this.chkCollected, "chkCollected");
		((System.Windows.Forms.Control)(object)this.chkCollected).Name = "chkCollected";
		resources.ApplyResources(this.chkBinderSafe, "chkBinderSafe");
		((System.Windows.Forms.Control)(object)this.chkBinderSafe).Name = "chkBinderSafe";
		resources.ApplyResources(this.chkUnderCollection, "chkUnderCollection");
		((System.Windows.Forms.Control)(object)this.chkUnderCollection).Name = "chkUnderCollection";
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkCollected);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkBinderSafe);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkUnderCollection);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkReturned);
		base.Name = "frmCheckFollowUpRep";
		base.Load += new System.EventHandler(frmCheckFollowUpRep_Load);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkUnderCollection, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkBinderSafe, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkCollected, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.chkCollected).EndInit();
		((System.ComponentModel.ISupportInitialize)this.chkBinderSafe).EndInit();
		((System.ComponentModel.ISupportInitialize)this.chkUnderCollection).EndInit();
