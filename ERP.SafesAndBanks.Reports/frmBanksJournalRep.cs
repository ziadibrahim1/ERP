...
public class frmBanksJournalRep : frmReportTree2010
{
	private IContainer components = null;

	private UltraCheckEditor chkCollectedOnly;

	public frmBanksJournalRep()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "طباعه يومية بنك بتاريخ الإذن" : "Print Bank Journal By Voucher Date");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? "طباعه يومية بنك بتاريخ الشيك" : "Print Bank Journal By Check Date");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksJournalByVoucherDate_A.rpt" : "Rep_SB_BanksJournalByVoucherDate_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksJournalByVoucherDate_A_nologo.rpt" : "Rep_SB_BanksJournalByVoucherDate_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksJournalByCheckDate_A.rpt" : "Rep_SB_BanksJournalByCheckDate_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksJournalByCheckDate_A_nologo.rpt" : "Rep_SB_BanksJournalByCheckDate_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@Collected", ((UltraToggleEditorBase)chkCollectedOnly).Checked ? 1 : (-1));
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SafesAndBanks.Reports.frmBanksJournalRep));
		Appearance val2 = new Appearance();
		Appearance val3 = new Appearance();
		Appearance val4 = new Appearance();
		Appearance val5 = new Appearance();
		this.chkCollectedOnly = new UltraCheckEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.chkCollectedOnly).BeginInit();
		base.SuspendLayout();
		...
		base.dtpFromDate.DateTime = new System.DateTime(2017, 1, 22, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2017, 1, 22, 0, 0, 0, 0);
		...
		resources.ApplyResources(this.chkCollectedOnly, "chkCollectedOnly");
		((UltraToggleEditorBase)this.chkCollectedOnly).Checked = true;
		((UltraToggleEditorBase)this.chkCollectedOnly).CheckState = System.Windows.Forms.CheckState.Checked;
		((System.Windows.Forms.Control)(object)this.chkCollectedOnly).Name = "chkCollectedOnly";
		resources.ApplyResources(this, "$this");
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkCollectedOnly);
		base.Name = "frmBanksJournalRep";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkCollectedOnly, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.chkCollectedOnly).EndInit();
