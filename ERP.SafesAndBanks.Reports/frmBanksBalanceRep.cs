...
public class frmBanksBalanceRep : frmReportTree2010
{
	private IContainer components = null;

	private UltraCheckEditor chkCollectedOnly;

	public frmBanksBalanceRep()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "طباعه الارصده بتاريخ الإذن" : "Print Bank Balance By Voucher Date");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? "طباعه الارصده بتاريخ الشيك" : "Print Bank Balance By Check Date");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksBalanceByVoucherDate_A.rpt" : "Rep_SB_BanksBalanceByVoucherDate_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksBalanceByVoucherDate_A_nologo.rpt" : "Rep_SB_BanksBalanceByVoucherDate_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksBalanceByCheckDate_A.rpt" : "Rep_SB_BanksBalanceByCheckDate_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_BanksBalanceByCheckDate_A_nologo.rpt" : "Rep_SB_BanksBalanceByCheckDate_E_nologo.rpt");
		}
	...
	private void frmBanksBalanceRep_Load(object sender, EventArgs e)
	{
		if (base.DesignMode)
		{
			return;
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SafesAndBanks.Reports.frmBanksBalanceRep));
		...
		base.Name = "frmBanksBalanceRep";
		base.Load += new System.EventHandler(frmBanksBalanceRep_Load);
