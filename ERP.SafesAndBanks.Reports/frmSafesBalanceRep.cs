...
public class frmSafesBalanceRep : frmReportTree2010
{
	private IContainer components = null;

	public frmSafesBalanceRep()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "طباعه ارصدة الخزائن" : "Print Safes Balance");
		cboReportType.SelectedIndex = 0;
	}

	public override void FormLoad()
	{
		dtItems = Safes.FillComboBySafeIDsWithBalance(GlobalVariables.SafeIDs, GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_SafesBalance_A.rpt" : "Rep_SB_SafesBalance_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SB_SafesBalance_A_nologo.rpt" : "Rep_SB_SafesBalance_E_nologo.rpt");
		}
	...
	private void frmSafesBalanceRep_Load(object sender, EventArgs e)
	{
		if (base.DesignMode)
		{
			return;
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SafesAndBanks.Reports.frmSafesBalanceRep));
		...
		base.Name = "frmSafesBalanceRep";
		base.Load += new System.EventHandler(frmSafesBalanceRep_Load);
