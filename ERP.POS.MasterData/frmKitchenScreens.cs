...
public class frmKitchenScreens : frmButtons
{
	...
	private UltraLabel lblMaxCount;

	private UltraCheckEditor chkPackingScreen;

	private UltraComboEditor cboChecksCount;

	private UltraCheckEditor chkIsDineIn;

	private UltraCheckEditor chkIsDelivery;

	private UltraCheckEditor chkIsTakeAway;

	private UltraCheckEditor chkIsSpecialOrder;

	public frmKitchenScreens()
	{
		InitializeComponent();
		TableName = "POS_KitchenScreens";
		IDCol = "KitchenScreenID";
		NoCol = "KitchenScreenNo";
		DateCol = "GetDate()";
	}

	public frmKitchenScreens(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void FillData()
	{
		...
		{
			DataTable dataTable = KitchenScreens.Select(RowID, "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			((Control)(object)txtCode).Text = drMaster["KitchenScreenNo"].ToString();
			((Control)(object)txtArabicName).Text = drMaster["KitchenScreenNameAr"].ToString();
			((Control)(object)txtEnglishName).Text = drMaster["KitchenScreenNameEn"].ToString();
			((UltraToggleEditorBase)chkIsDineIn).Checked = bool.Parse(drMaster["IsDineIn"].ToString());
			((UltraToggleEditorBase)chkIsDelivery).Checked = bool.Parse(drMaster["IsDelivery"].ToString());
			((UltraToggleEditorBase)chkIsTakeAway).Checked = bool.Parse(drMaster["IsTakeAway"].ToString());
			((UltraToggleEditorBase)chkIsSpecialOrder).Checked = bool.Parse(drMaster["IsSpecialOrder"].ToString());
			((UltraToggleEditorBase)chkPackingScreen).Checked = bool.Parse(drMaster["IsPackingScreen"].ToString());
			((TextEditorControlBase)cboChecksCount).Value = drMaster["CheckCount"];
			dtItemsDetails = KitchenScreensItems.SelectByKitchenScreenID(drMaster["KitchenScreenID"].ToString(), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void SetControls(bool NavMode)
	{
		...
		((Control)(object)chkIsDineIn).Enabled = !NavMode;
		((Control)(object)chkIsDelivery).Enabled = !NavMode;
		((Control)(object)chkIsTakeAway).Enabled = !NavMode;
		((Control)(object)chkIsSpecialOrder).Enabled = !NavMode;
		((Control)(object)chkPackingScreen).Enabled = !NavMode;
		((EditorButtonControlBase)cboChecksCount).ReadOnly = NavMode;
	...
	public override void ClearControls()
	{
		...
		((UltraToggleEditorBase)chkIsDineIn).Checked = false;
		((UltraToggleEditorBase)chkIsDelivery).Checked = false;
		((UltraToggleEditorBase)chkIsTakeAway).Checked = false;
		((UltraToggleEditorBase)chkIsSpecialOrder).Checked = false;
		((UltraToggleEditorBase)chkPackingScreen).Checked = false;
		cboChecksCount.SelectedIndex = -1;
		((Control)(object)txtCode).Text = (Adding ? KitchenScreens.GetCode(IsFromServer: true) : "");
		TreeFunctions.SetAllTreeNodesCheckState(Checked: false, TreeItems);
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال كود شاشة المطبخ", "Please Enter Leave permission Rule");
			((TextEditorControlBase)txtCode).Focus();
			return false;
		}
		if (((Control)(object)txtArabicName).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال إسم  شاشة المطبخ", "Please Enter Leave permission Rule Arabic Name");
			((TextEditorControlBase)txtArabicName).Focus();
			return false;
		}
		if (cboChecksCount.SelectedIndex == -1)
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال عدد الشيكات  ", "Please Enter Checks Count");
			((TextEditorControlBase)cboChecksCount).Focus();
			return false;
		}
		if (Main.CheckForValue("POS_KitchenScreens", "KitchenScreenNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["KitchenScreenNo"].ToString(), IsFromServer: true) > 0)
		{
			string code = KitchenScreens.GetCode(IsFromServer: true);
	...
	public string InsertItems(string _KitchenScreenID)
	{
		string text = "";
		for (int i = 0; i < ((DisposableObjectCollectionBase)TreeItems.Nodes).Count; i++)
		{
			text = ((((DisposableObjectCollectionBase)TreeItems.Nodes[i].Nodes).Count != 0 || Convert.ToBoolean(((SubObjectBase)TreeItems.Nodes[i]).Tag) || TreeItems.Nodes[i].CheckedState != CheckState.Checked) ? (text + GetNodeCheckedChildsIDs(TreeItems.Nodes[i], _KitchenScreenID)) : (text + " EXEC POS_KitchenScreensItems_Insert_Update -1," + _KitchenScreenID + "," + ((KeyedSubObjectBase)TreeItems.Nodes[i]).Key + ",0," + GlobalVariables.CurrentBranchID + "," + GlobalVariables.UserID + "; "));
		}
		return text;
	}

	public string GetNodeCheckedChildsIDs(UltraTreeNode Node, string _KitchenScreenID)
	{
		string text = "";
		for (int i = 0; i < ((DisposableObjectCollectionBase)Node.Nodes).Count; i++)
		{
			text = ((((DisposableObjectCollectionBase)Node.Nodes[i].Nodes).Count != 0 || Convert.ToBoolean(((SubObjectBase)Node.Nodes[i]).Tag) || Node.Nodes[i].CheckedState != CheckState.Checked) ? (text + GetNodeCheckedChildsIDs(Node.Nodes[i], _KitchenScreenID)) : (text + " EXEC POS_KitchenScreensItems_Insert_Update -1," + _KitchenScreenID + "," + ((KeyedSubObjectBase)Node.Nodes[i]).Key + ",0," + GlobalVariables.CurrentBranchID + "," + GlobalVariables.UserID + "; "));
		}
		return text;
	}
	...
	public override void AddData()
	{
		...
		try
		{
			int num = KitchenScreens.Insert_Update("-1", ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((UltraToggleEditorBase)chkIsDineIn).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsDelivery).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsTakeAway).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsSpecialOrder).Checked ? "1" : "0", ((UltraToggleEditorBase)chkPackingScreen).Checked ? "1" : "0", (cboChecksCount.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboChecksCount).Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
			string nodeCheckedIDs = GetNodeCheckedIDs();
			if (nodeCheckedIDs != ",")
			{
				string text = " _DELETE ";
				text = text + "' POS_KitchenScreensItems',' ItemID in (" + nodeCheckedIDs.Substring(1, nodeCheckedIDs.Length - 2) + ") and KitchenScreenID <> " + num + "'";
				Main.SyncExecuteNonQuery(text);
			}
			string text2 = InsertItems(num.ToString());
			if (text2 != "")
			{
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = KitchenScreens.Insert_Update(drMaster["KitchenScreenID"].ToString(), ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((UltraToggleEditorBase)chkIsDineIn).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsDelivery).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsTakeAway).Checked ? "1" : "0", ((UltraToggleEditorBase)chkIsSpecialOrder).Checked ? "1" : "0", ((UltraToggleEditorBase)chkPackingScreen).Checked ? "1" : "0", (cboChecksCount.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboChecksCount).Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
			string nodeCheckedIDs = GetNodeCheckedIDs();
			if (nodeCheckedIDs != ",")
			{
				string text = " _DELETE ";
			...
			KitchenScreensItems.DeleteByKitchenScreenID(num.ToString(), GlobalVariables.UserID, IsFromServer: true);
			string text2 = InsertItems(num.ToString());
			if (text2 != "")
			{
				Main.SyncExecuteQuery_DataTable_Trans(text2);
			}
			Main.EndBulkTrans(FromServer: true);
		}
		catch
	...
	{
		KitchenScreensItems.DeleteByKitchenScreenID(drMaster["KitchenScreenID"].ToString(), GlobalVariables.UserID, IsFromServer: true);
		KitchenScreens.Delete(drMaster["KitchenScreenID"].ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public string GetNodeCheckedIDs()
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)TreeItems.Nodes).Count; i++)
		{
			text = ((((DisposableObjectCollectionBase)TreeItems.Nodes[i].Nodes).Count != 0 || Convert.ToBoolean(((SubObjectBase)TreeItems.Nodes[i]).Tag) || TreeItems.Nodes[i].CheckedState != CheckState.Checked) ? (text + GetNodeCheckedChildsIDs(TreeItems.Nodes[i])) : (text + ((KeyedSubObjectBase)TreeItems.Nodes[i]).Key + ","));
		}
		return text;
	}
	...
	{
		dtSearchResult = SearchFunctions.KitchenScreensReport(IsFromServer: true);
		if (dtSearchResult.Rows.Count > 0)
		{
			RowID = dtSearchResult.Rows[0]["KitchenScreenID"].ToString();
			FillData();
		}
	}
	...
	public void SetCheckedItems(DataTable _dtItems)
	{
		for (int i = 0; i < _dtItems.Rows.Count; i++)
		{
			UltraTreeNode nodeByKey = TreeItems.GetNodeByKey(_dtItems.Rows[i]["ItemID"].ToString());
	...
	private void txtMaxCount_KeyPress(object sender, KeyPressEventArgs e)
	{
		GlobalFunctions.CheckForIntegers(sender, e);
	}

	private void chkPackingScreen_CheckedChanged(object sender, EventArgs e)
	{
		((Control)(object)TreeItems).Enabled = !((UltraToggleEditorBase)chkPackingScreen).Checked;
		((Control)(object)chkAll).Enabled = !((UltraToggleEditorBase)chkPackingScreen).Checked;
		if (!((UltraToggleEditorBase)chkPackingScreen).Checked)
		{
			((UltraToggleEditorBase)chkAll).Checked = false;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.MasterData.frmKitchenScreens));
		...
		this.lblMaxCount = new UltraLabel();
		this.chkPackingScreen = new UltraCheckEditor();
		this.cboChecksCount = new UltraComboEditor();
		this.chkIsDineIn = new UltraCheckEditor();
		this.chkIsDelivery = new UltraCheckEditor();
		this.chkIsTakeAway = new UltraCheckEditor();
		this.chkIsSpecialOrder = new UltraCheckEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.chkPackingScreen).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.cboChecksCount).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.chkIsDineIn).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.chkIsDelivery).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.chkIsTakeAway).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.chkIsSpecialOrder).BeginInit();
		base.SuspendLayout();
		...
		((System.Windows.Forms.Control)(object)this.UGBDetails).Controls.Add((System.Windows.Forms.Control)(object)this.btnItemsSearch);
		((System.Windows.Forms.Control)(object)this.UGBDetails).Controls.Add((System.Windows.Forms.Control)(object)this.txtItems);
		((System.Windows.Forms.Control)(object)this.UGBDetails).Controls.Add((System.Windows.Forms.Control)(object)this.TreeItems);
		...
		this.lblMaxCount.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblMaxCount).Name = "lblMaxCount";
		((ControlBase)this.lblMaxCount).WrapText = false;
		resources.ApplyResources(this.chkPackingScreen, "chkPackingScreen");
		((System.Windows.Forms.Control)(object)this.chkPackingScreen).Name = "chkPackingScreen";
		((UltraToggleEditorBase)this.chkPackingScreen).CheckedChanged += new System.EventHandler(chkPackingScreen_CheckedChanged);
		resources.ApplyResources(this.cboChecksCount, "cboChecksCount");
		this.cboChecksCount.AutoCompleteMode = (AutoCompleteMode)4;
		val13.DataValue = "6";
		resources.ApplyResources(val13, "valueListItem3");
		((SubObjectBase)val13).ForceApplyResources = "";
		val14.DataValue = "9";
		resources.ApplyResources(val14, "valueListItem5");
		((SubObjectBase)val14).ForceApplyResources = "";
		val15.DataValue = "12";
		resources.ApplyResources(val15, "valueListItem6");
		((SubObjectBase)val15).ForceApplyResources = "";
		val16.DataValue = "24";
		resources.ApplyResources(val16, "valueListItem7");
		((SubObjectBase)val16).ForceApplyResources = "";
		this.cboChecksCount.Items.AddRange((ValueListItem[])(object)new ValueListItem[4] { val13, val14, val15, val16 });
		((System.Windows.Forms.Control)(object)this.cboChecksCount).Name = "cboChecksCount";
		resources.ApplyResources(this.chkIsDineIn, "chkIsDineIn");
		((System.Windows.Forms.Control)(object)this.chkIsDineIn).Name = "chkIsDineIn";
		((UltraToggleEditorBase)this.chkIsDineIn).CheckedChanged += new System.EventHandler(chkPackingScreen_CheckedChanged);
		resources.ApplyResources(this.chkIsDelivery, "chkIsDelivery");
		((System.Windows.Forms.Control)(object)this.chkIsDelivery).Name = "chkIsDelivery";
		((UltraToggleEditorBase)this.chkIsDelivery).CheckedChanged += new System.EventHandler(chkPackingScreen_CheckedChanged);
		resources.ApplyResources(this.chkIsTakeAway, "chkIsTakeAway");
		((System.Windows.Forms.Control)(object)this.chkIsTakeAway).Name = "chkIsTakeAway";
		((UltraToggleEditorBase)this.chkIsTakeAway).CheckedChanged += new System.EventHandler(chkPackingScreen_CheckedChanged);
		resources.ApplyResources(this.chkIsSpecialOrder, "chkIsSpecialOrder");
		((System.Windows.Forms.Control)(object)this.chkIsSpecialOrder).Name = "chkIsSpecialOrder";
		((UltraToggleEditorBase)this.chkIsSpecialOrder).CheckedChanged += new System.EventHandler(chkPackingScreen_CheckedChanged);
		resources.ApplyResources(this, "$this");
		base.Controls.Add((System.Windows.Forms.Control)(object)this.cboChecksCount);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkIsSpecialOrder);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkIsTakeAway);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkIsDelivery);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkIsDineIn);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkPackingScreen);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblMaxCount);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblMaxCount, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkPackingScreen, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkIsDineIn, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkIsDelivery, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkIsTakeAway, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkIsSpecialOrder, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.cboChecksCount, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.chkPackingScreen).EndInit();
		((System.ComponentModel.ISupportInitialize)this.cboChecksCount).EndInit();
		((System.ComponentModel.ISupportInitialize)this.chkIsDineIn).EndInit();
		((System.ComponentModel.ISupportInitialize)this.chkIsDelivery).EndInit();
		((System.ComponentModel.ISupportInitialize)this.chkIsTakeAway).EndInit();
		((System.ComponentModel.ISupportInitialize)this.chkIsSpecialOrder).EndInit();
