...
public class frmUpdateParent : frmDetails
{
	...
	{
		dtItems = Services.SelectGroups(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		GlobalFunctions.FillCombo(cboHeader, dtItems, "ServiceID", "ServiceName");
	...
	public override void SaveData()
	{
		...
		try
		{
			Services.UpdateParentID(RowID, ((TextEditorControlBase)cboHeader).Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CustomsClearence.MasterData.frmUpdateParent));
