...
public class frmQuotationsDeliveryNotesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmQuotationsDeliveryNotesRep()
	{
		...
		TreeItems2IDCol = "QuotationDeliveryNoteID";
		TreeItems2NameCol = "QuotationDeliveryNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = QuotationsDeliveryNotes.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى امر تسليم ليتم عرضها ", "There is no chosen Delivery Note to be shown in the report, please check Invoice to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@QuotationDeliveryNoteIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Reports.frmQuotationsDeliveryNotesRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 8, 2, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 8, 2, 0, 0, 0, 0);
		...
		base.Name = "frmQuotationsDeliveryNotesRep";
