...
public class frmQuotationsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmQuotationsRep()
	{
		...
		TreeItems2IDCol = "QuotationID";
		TreeItems2NameCol = "QuotaionNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = Quotations.FillRepTree(Branches, Items, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى امر شغل ليتم عرضه ", "There is no chosen Work Order to be shown in the report, please check Orders to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@QuotationIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Reports.frmQuotationsRep));
