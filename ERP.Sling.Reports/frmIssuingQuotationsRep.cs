...
public class frmIssuingQuotationsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmIssuingQuotationsRep()
	{
	...
	public override void FillData()
	{
		...
		dtItems2 = Quotations.FillRepTree(Branches, "-1", dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى فاتوره ليتم عرضها ", "There is no chosen Quotation to be shown in the report, please check Quotations to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Reports.frmIssuingQuotationsRep));
		...
		base.Name = "frmIssuingQuotationsRep";
