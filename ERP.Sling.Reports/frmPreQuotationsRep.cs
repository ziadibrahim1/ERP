...
public class frmPreQuotationsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmPreQuotationsRep()
	{
		...
		TreeItems2IDCol = "PreQuotationID";
		TreeItems2NameCol = "PreQuotationNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = PreQuotations.FillRepTree(Branches, Items, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى عرض سعر ليتم عرضها ", "There is no chosen Quotation to be shown in the report, please check Quotations to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@PreQuotationIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Reports.frmPreQuotationsRep));
