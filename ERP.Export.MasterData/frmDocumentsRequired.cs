...
public class frmDocumentsRequired : frmGrid
{
	...
	public frmDocumentsRequired()
	{
		InitializeComponent();
		TableName = "EXP_DocumentsRequired";
		IDCol = "DocumentRequiredID";
	}
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtCode).Text = (Adding ? DocumentsRequired.GetCode(IsFromServer: true) : "");
	...
	{
		dataTable = DocumentsRequired.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DocumentRequiredCode"].Header).Caption = (GlobalVariables.IsArabic ? "الكود" : "Code");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DocumentRequiredCode"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DocumentRequiredCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DocumentRequiredNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " اسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DocumentRequiredNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DocumentRequiredNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DocumentRequiredNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "اسم بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DocumentRequiredNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DocumentRequiredNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtCode).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["DocumentRequiredCode"].Value.ToString();
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["DocumentRequiredNameAr"].Value.ToString();
		((Control)(object)txtEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["DocumentRequiredNameEn"].Value.ToString();
	}
	...
	public override bool ValidateData()
	{
		...
		if (Main.CheckForValue("EXP_DocumentsRequired", "DocumentRequiredCode", ((Control)(object)txtCode).Text, Adding ? "0" : ((UltraGridBase)ULGData).ActiveRow.Cells["DocumentRequiredCode"].Value.ToString(), IsFromServer: true) > 0)
		{
			string code = DocumentsRequired.GetCode(IsFromServer: true);
			GlobalVariables.QuestionMB.Show("رقم هذه الوثيقة متواجد من قبل \n سوف يتم الحفظ برقم " + code, "The Document code Already Exists It Will Be Saved With No. : " + code);
	...
	{
		DocumentsRequired.Insert_Update("-1", ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		DocumentsRequired.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["DocumentRequiredID"].Value.ToString(), ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		DocumentsRequired.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["DocumentRequiredID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Export.MasterData.frmDocumentsRequired));
		...
		base.Name = "frmDocumentsRequired";
