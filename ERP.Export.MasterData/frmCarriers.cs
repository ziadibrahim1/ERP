...
public class frmCarriers : frmGrid
{
	...
	private UltraLabel lblLineAccount;
	...
	private UltraLabel lblLineSubAccount;
	...
	public override void SetControls(bool NavMode)
	{
		...
		((Control)(object)lblLineSubAccount).Visible = UseSubAccounts;
	...
	{
		dataTable = Carriers.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		InitGrid();
	}
	...
	public override void InitGrid()
	{
		...
		base.InitGrid();
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CarrierID"].DefaultCellValue = -1;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CarrierNameAr"].Header).Caption = (GlobalVariables.IsArabic ? "الإسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CarrierNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CarrierNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CarrierNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "الإسم بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CarrierNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CarrierNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AccountID"].Header).Caption = (GlobalVariables.IsArabic ? "حساب الخط" : "Carrier Account");
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SubAccountID"].Header).Caption = (GlobalVariables.IsArabic ? "الحساب التحليلى" : "Carrier SubAccount");
	...
	{
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["CarrierNameAr"].Value.ToString();
		((Control)(object)txtEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["CarrierNameEn"].Value.ToString();
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال إسم الخط بالعربية", "Please Insert Line Arabic Name");
			((TextEditorControlBase)txtArabicName).Focus();
			return false;
		}
		if (cboAccount.SelectedIndex == -1)
		{
			GlobalVariables.InformationMB.Show("برجاء إختيار إسم حساب الخط", "Please Select Line Account Name");
	...
	{
		Carriers.Insert_Update("-1", ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((TextEditorControlBase)cboAccount).Value.ToString(), (cboSubAccount.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSubAccount).Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		Carriers.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["CarrierID"].Value.ToString(), ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, ((TextEditorControlBase)cboAccount).Value.ToString(), (cboSubAccount.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSubAccount).Value.ToString(), ((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString().Equals("True") ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		Carriers.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["CarrierID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
		ClearControls();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Export.MasterData.frmCarriers));
		...
		this.lblLineAccount = new UltraLabel();
		...
		this.lblLineSubAccount = new UltraLabel();
		...
		resources.ApplyResources(this.lblLineAccount, "lblLineAccount");
		this.lblLineAccount.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblLineAccount).Name = "lblLineAccount";
		((ControlBase)this.lblLineAccount).WrapText = false;
		...
		resources.ApplyResources(this.lblLineSubAccount, "lblLineSubAccount");
		this.lblLineSubAccount.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblLineSubAccount).Name = "lblLineSubAccount";
		((ControlBase)this.lblLineSubAccount).WrapText = false;
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblLineSubAccount);
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblLineAccount);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblLineAccount, 0);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblLineSubAccount, 0);
