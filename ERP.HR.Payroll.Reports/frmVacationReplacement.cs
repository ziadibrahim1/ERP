...
public class frmVacationReplacement : frmReportTree2010
{
	private IContainer components = null;

	public frmVacationReplacement()
	{
		InitializeComponent();
	...
	public override void ShowReport()
	{
		...
		if (dtpFromDate.DateTime.Year != dtpToDate.DateTime.Year)
		{
			GlobalVariables.InformationMB.Show("برجاء إختيار نفس العام ف كلا التاريخين", "Please Choose The Same Year In Both Dates");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Payroll.Reports.frmVacationReplacement));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2019, 11, 3, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2019, 11, 3, 0, 0, 0, 0);
		...
		base.dtpToDate.MaskInput = "mm/yyyy";
		...
		base.Name = "frmVacationReplacement";
