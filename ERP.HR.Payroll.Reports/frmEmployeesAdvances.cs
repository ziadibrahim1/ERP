...
public class frmEmployeesAdvances : frmReportTree2010
{
	...
	public frmEmployeesAdvances()
	{
		...
		dtItems2 = AdvancesTypes.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		TreeItems2IDCol = "AdvanceTypeID";
		TreeItems2NameCol = "AdvanceTypeName";
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " طباعه سلف الموظفين " : "Print Employees Advances ");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesAdvancesPaid_A.rpt" : "Rep_HR_EmployeesAdvancesPaid_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesAdvancesPaid_A_nologo.rpt" : "Rep_HR_EmployeesAdvancesPaid_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار نوع سلف  ", "There is no chosen Advance Type to be shown in the report, please check Advance Types to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@AdvanceTypeIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Payroll.Reports.frmEmployeesAdvances));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2019, 2, 7, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2019, 2, 7, 0, 0, 0, 0);
		...
		((System.Windows.Forms.Control)(object)base.chkAll2).TabStop = false;
