...
public class frmEmployeesAllowancesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeesAllowancesRep()
	{
		InitializeComponent();
		...
		dtItems2 = Allowances.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		TreeItems2IDCol = "AllowanceID";
		TreeItems2NameCol = "AllowanceName";
	}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى بدل  ", "There is no chosen Allowance to be shown in the report, please check Allowances to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@AllowanceIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Payroll.Reports.frmEmployeesAllowancesRep));
		...
		base.Name = "frmEmployeesAllowancesRep";
