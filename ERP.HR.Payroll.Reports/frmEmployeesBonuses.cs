...
public class frmEmployeesBonuses : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeesBonuses()
	{
		InitializeComponent();
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " طباعه مكافأت الموظفين " : "Print Employees Bonuses ");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesBonusDetails_A.rpt" : "Rep_HR_EmployeesBonusDetails_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesBonusDetails_A_nologo.rpt" : "Rep_HR_EmployeesBonusDetails_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Payroll.Reports.frmEmployeesBonuses));
