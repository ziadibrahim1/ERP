...
public class frmEmployeesHealthInsurance : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeesHealthInsurance()
	{
		InitializeComponent();
		...
		dtItems2 = HealthInsuranceTypes.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		TreeItems2IDCol = "HealthInsuranceTypeID";
		TreeItems2NameCol = "HealthInsuranceTypeName";
	}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار نوع التأمين الصحي    ", "There is no chosen Health Insurance Type to be shown in the report, please check Social Insurance Offices to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@HealthInsuranceTypeIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Payroll.Reports.frmEmployeesHealthInsurance));
		...
		base.Name = "frmEmployeesHealthInsurance";
