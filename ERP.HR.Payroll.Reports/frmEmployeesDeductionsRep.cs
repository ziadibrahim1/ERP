...
public class frmEmployeesDeductionsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeesDeductionsRep()
	{
		InitializeComponent();
		...
		dtItems2 = Deductions.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		TreeItems2IDCol = "DeductionID";
		TreeItems2NameCol = "DeductionName";
	}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار استقطاع  ", "There is no chosen Deduction to be shown in the report, please check Deductions to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@DeductionIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Payroll.Reports.frmEmployeesDeductionsRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 10, 2, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 10, 2, 0, 0, 0, 0);
		...
		base.Name = "frmEmployeesDeductionsRep";
