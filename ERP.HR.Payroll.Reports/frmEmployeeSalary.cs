...
public class frmEmployeeSalary : frmReportTree2010
{
	...
	public frmEmployeeSalary()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " طباعه كشف مرتبات 1 " : "Print Salary List 1 ");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? " طباعه كشف مرتبات 2 " : "Print Salary List 2 ");
		cboReportType.Items.Add((object)3, GlobalVariables.IsArabic ? "طباعه كل التفاصيل" : "Print With All Details");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesSalaryHistorySummary_A.rpt" : "Rep_HR_EmployeesSalaryHistorySummary_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesSalaryHistorySummary_A_nologo.rpt" : "Rep_HR_EmployeesSalaryHistorySummary_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesSalaryHistorySummaryPrint2_A.rpt" : "Rep_HR_EmployeesSalaryHistorySummaryPrint2_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesSalaryHistorySummaryPrint2_A_nologo.rpt" : "Rep_HR_EmployeesSalaryHistorySummaryPrint2_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "3")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesSalaryHistoryPrint_A.rpt" : "Rep_HR_EmployeesSalaryHistoryPrint_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesSalaryHistoryPrint_A_nologo.rpt" : "Rep_HR_EmployeesSalaryHistoryPrint_E_nologo.rpt");
		}
		return base.GetReportName();
	}

	public override void dtpFromDate_ValueChanged(object sender, EventArgs e)
	{
	}

	public override void dtpToDate_ValueChanged(object sender, EventArgs e)
	{
	}
	...
	public override void ShowReport()
	{
		...
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Details"))
		{
			GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items, "Rep_HR_EmployeesAllowancesHistory");
			GlobalVariables.ReportDocument.SetParameterValue("@FromDate", dtpFromDate.DateTime, "Rep_HR_EmployeesAllowancesHistory");
			GlobalVariables.ReportDocument.SetParameterValue("@ToDate", dtpToDate.DateTime, "Rep_HR_EmployeesAllowancesHistory");
			...
			GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items, "Rep_HR_EmployeesDeductionsHistory");
			GlobalVariables.ReportDocument.SetParameterValue("@FromDate", dtpFromDate.DateTime, "Rep_HR_EmployeesDeductionsHistory");
			GlobalVariables.ReportDocument.SetParameterValue("@ToDate", dtpToDate.DateTime, "Rep_HR_EmployeesDeductionsHistory");
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Payroll.Reports.frmEmployeeSalary));
