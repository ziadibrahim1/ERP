...
public class frmEmployeesInsurance : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeesInsurance()
	{
		InitializeComponent();
		...
		dtItems2 = SocialInssuranceOffices.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		TreeItems2IDCol = "SocialInssuranceOfficeID";
		TreeItems2NameCol = "SocialInssuranceOfficeName";
	}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مكتب تأمينات  ", "There is no chosen Social Insurance Office to be shown in the report, please check Social Insurance Offices to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@SocialInssuranceOfficeIDs", Items2);
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("EmployeesSalaryHistory"))
		{
	...
	private void cboReportType_ValueChanged(object sender, EventArgs e)
	{
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("EmployeesSalaryHistory"))
		{
			...
			bool visible = (((Control)(object)ultraLabel2).Visible = true);
		...
		else
		{
			...
			bool visible = (((Control)(object)ultraLabel2).Visible = false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Payroll.Reports.frmEmployeesInsurance));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 7, 9, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 7, 9, 0, 0, 0, 0);
		...
		base.Name = "frmEmployeesInsurance";
