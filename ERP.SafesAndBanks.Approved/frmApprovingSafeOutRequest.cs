...
public class frmApprovingSafeOutRequest : frmPosted
{
	private IContainer components = null;

	public frmApprovingSafeOutRequest()
	{
		InitializeComponent();
	...
	{
		dtsource = SafeOutRequests.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			{
				text = text + " EXEC SB_SafeOutRequests_SetApprove  1," + (bool.Parse(((UltraGridBase)ULGData).Rows[i].Cells["IsRefused"].Value.ToString()) ? "1" : "0") + "," + ((UltraGridBase)ULGData).Rows[i].Cells["SafeOutRequestID"].Value.ToString() + " ; ";
			}
		}
		if (text != "")
		{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SafesAndBanks.Approved.frmApprovingSafeOutRequest));
		...
		base.Name = "frmApprovingSafeOutRequest";
