...
public class frmApprovingCustodys : frmPosted
{
	private IContainer components = null;

	public frmApprovingCustodys()
	{
		InitializeComponent();
		NoCol = "CustodyNo";
	}
	...
	{
		dtsource = Custody.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			Custody.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد عهد لإعتمادها " : "There are No Custody To Approve");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.CustodyReport(0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SafesAndBanks.Approved.frmApprovingCustodys));
		...
		base.Name = "frmApprovingCustodys";
