...
public class frmUnApprovingBankOutRequest : frmPosted
{
	private IContainer components = null;

	public frmUnApprovingBankOutRequest()
	{
		InitializeComponent();
	...
	{
		dtsource = BankOutRequests.SelectByApproved(GlobalVariables.BranchIDs, "1", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			{
				text = text + " EXEC SB_BankOutRequests_SetApprove  0,0," + ((UltraGridBase)ULGData).Rows[i].Cells["BankOutRequestID"].Value.ToString() + " ; ";
			}
		}
		if (text != "")
		{
		...
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد طلبات لفك إعتمادها " : "There are No Requests to UnApprove");
		}
	}
	...
	public override void ClickCellButton()
	{
		if (((UltraGridBase)ULGData).ActiveRow != null)
		{
			...
			((Control)(object)frmBankOutRequests2.lblTitle).Text = (GlobalVariables.IsArabic ? "طلب صرف بنك" : "Bank Out Request");
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SafesAndBanks.Approved.frmUnApprovingBankOutRequest));
		...
		base.Name = "frmUnApprovingBankOutRequest";
