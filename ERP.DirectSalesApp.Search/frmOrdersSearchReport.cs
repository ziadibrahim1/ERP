...
namespace ERP.DirectSalesApp.Search;

public class frmOrdersSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmOrdersSearchReport()
	{
		InitializeComponent();
	}

	public frmOrdersSearchReport(DataTable dt, string idColumnName, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OrderNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الاذن " : "Order No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OrderNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15) - GlobalVariables.ScrollWidth;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OrderDate"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OrderDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الاذن" : "Date");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OrderDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SalesManName"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SalesManName"].Header).Caption = (GlobalVariables.IsArabic ? "اسم رجل البيع" : "SalesMan Name");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SalesManName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
