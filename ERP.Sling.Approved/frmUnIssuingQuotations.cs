...
public class frmUnIssuingQuotations : frmPosted
{
	private IContainer components = null;

	public frmUnIssuingQuotations()
	{
		InitializeComponent();
		NoCol = "QuotaionNo";
		((Control)(object)btnPost).Text = (GlobalVariables.IsArabic ? "ارتجاع" : "UnIssue");
	}

	public override void FillGrid()
	{
		dtsource = Quotations.SelectByIssued(GlobalVariables.BranchIDs, "1", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Issued"].Header).Caption = "";
	...
	{
		if (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key != "Issued")
		{
	...
	public override void btnPost_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			try
			{
				Quotations.SetIssued("0", "Null", "," + ((UltraGridBase)ULGData).Rows[i].Cells["QuotationID"].Value.ToString() + ",");
				if (((UltraGridBase)ULGData).Rows[i].Cells["StockControlJVID"].Value != DBNull.Value)
				{
					JVDetails.DeleteVirtualByJVID(((UltraGridBase)ULGData).Rows[i].Cells["StockControlJVID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: false);
					JV.DeleteVirtual(((UltraGridBase)ULGData).Rows[i].Cells["StockControlJVID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: false);
				}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Approved.frmUnIssuingQuotations));
		...
		base.Name = "frmUnIssuingQuotations";
