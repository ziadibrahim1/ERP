...
public class frmApprovingPreQuotations : frmPosted
{
	private IContainer components = null;

	public frmApprovingPreQuotations()
	{
		InitializeComponent();
	...
	{
		dtsource = PreQuotations.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PreQuotationNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الاذن " : "PreQuotation No");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			PreQuotations.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد عروض أسعار أصناف لإعتمادها " : "There are No Items Quotations to be Approved");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.SLNPreQuotationsReport(0, 0, -1);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Approved.frmApprovingPreQuotations));
		...
		base.Name = "frmApprovingPreQuotations";
