...
public class frmApprovingInvoices : frmPosted
{
	private IContainer components = null;

	public frmApprovingInvoices()
	{
		InitializeComponent();
		NoCol = "InvoiceNo";
	}
	...
	{
		dtsource = Invoices.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			Invoices.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد فواتير لإعتمادها " : "There are No Invoices to Approve");
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Approved.frmApprovingInvoices));
		...
		base.Name = "frmApprovingInvoices";
