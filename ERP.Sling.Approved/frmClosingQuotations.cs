...
public class frmClosingQuotations : frmPosted
{
	private IContainer components = null;

	public frmClosingQuotations()
	{
		InitializeComponent();
		NoCol = "QuotaionNo";
	}
	...
	{
		dtsource = Quotations.SelectByClosed(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			Quotations.SetClosed("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد أوامر تشغيل لاغلاقها " : "There are No Orders to be Closed");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.SLNQuotationsReport(-1, 0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Approved.frmClosingQuotations));
		...
		base.Name = "frmClosingQuotations";
