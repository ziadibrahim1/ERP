...
public class frmUnClosingQuotations : frmPosted
{
	private IContainer components = null;

	public frmUnClosingQuotations()
	{
		InitializeComponent();
		NoCol = "QuotaionNo";
		((Control)(object)btnPost).Text = (GlobalVariables.IsArabic ? " إعادة فتح" : "UnClose");
	}

	public override void FillGrid()
	{
		dtsource = Quotations.SelectByClosed(GlobalVariables.BranchIDs, "1", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["QuotaionNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.125) - GlobalVariables.ScrollWidth;
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Closed"].Header).Caption = "";
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			Quotations.SetClosed("0", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد أوامر تشغيل لإعادة فتحها " : "There are No Orders to be UnClosed");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.SLNQuotationsReport(-1, 0, 1);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Approved.frmUnClosingQuotations));
		...
		base.Name = "frmUnClosingQuotations";
