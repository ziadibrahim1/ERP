...
public class frmClientCreditNoteSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmClientCreditNoteSearchReport()
	{
		InitializeComponent();
	}

	public frmClientCreditNoteSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
