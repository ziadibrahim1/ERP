...
public class frmLnsInvoicesSearch : frmSearch
{
	private IContainer components = null;

	public frmLnsInvoicesSearch()
	{
		InitializeComponent();
	}

	public frmLnsInvoicesSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InvoiceNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.17) - GlobalVariables.ScrollWidth;
