...
public class frmReservationsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmReservationsSearchReport()
	{
		InitializeComponent();
	}

	public frmReservationsSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SubAccountName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.18);
