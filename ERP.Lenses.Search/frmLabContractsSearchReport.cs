...
public class frmLabContractsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmLabContractsSearchReport()
	{
		InitializeComponent();
	}

	public frmLabContractsSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["LabContractDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.18);
