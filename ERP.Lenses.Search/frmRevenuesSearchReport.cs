...
public class frmRevenuesSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmRevenuesSearchReport()
	{
		InitializeComponent();
	}

	public frmRevenuesSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RevenueNo"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RevenueNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الاذن " : "Revenue No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RevenueNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RevenueDate"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RevenueDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الاذن" : "Date");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RevenueDate"].MaskInput = "dd/mm/yyyy hh:mm:ss tt";
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RevenueDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.13);
