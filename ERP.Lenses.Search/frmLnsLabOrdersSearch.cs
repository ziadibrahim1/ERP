...
public class frmLnsLabOrdersSearch : frmSearch
{
	private IContainer components = null;

	public frmLnsLabOrdersSearch()
	{
		InitializeComponent();
	}

	public frmLnsLabOrdersSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["LabOrderNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.12) - GlobalVariables.ScrollWidth;
