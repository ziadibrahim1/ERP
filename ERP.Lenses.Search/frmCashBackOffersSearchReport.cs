...
public class frmCashBackOffersSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmCashBackOffersSearchReport()
	{
		InitializeComponent();
	}

	public frmCashBackOffersSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OfferCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OfferName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
