...
public class frmVisaTypesReturnsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmVisaTypesReturnsSearchReport()
	{
		InitializeComponent();
	}

	public frmVisaTypesReturnsSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VisaTypeReturnNo"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VisaTypeReturnNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الاذن " : "Revenue No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VisaTypeReturnNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VisaTypeReturnDate"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VisaTypeReturnDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الاذن" : "Date");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VisaTypeReturnDate"].MaskInput = "dd/mm/yyyy hh:mm:ss tt";
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VisaTypeReturnDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.13);
