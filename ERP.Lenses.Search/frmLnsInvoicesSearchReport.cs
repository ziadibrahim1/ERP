...
public class frmLnsInvoicesSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmLnsInvoicesSearchReport()
	{
		InitializeComponent();
	}

	public frmLnsInvoicesSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InvoiceDate"].MaskInput = "dd/mm/yyyy hh:mm:ss tt";
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InvoiceDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.13);
