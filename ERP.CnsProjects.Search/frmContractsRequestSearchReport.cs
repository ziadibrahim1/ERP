...
public class frmContractsRequestSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmContractsRequestSearchReport()
	{
		InitializeComponent();
	}

	public frmContractsRequestSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
