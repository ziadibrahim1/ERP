...
public class frmProjectSearchReport : frmSearch
{
	private IContainer components = null;

	public frmProjectSearchReport()
	{
		InitializeComponent();
	}

	public frmProjectSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ProjectName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.3);
