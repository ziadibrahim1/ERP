...
public class frmContractSearch : frmSearch
{
	...
	public frmContractSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ContractCode"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الاذن " : "Contract No");
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ContractDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الاذن" : "Date");
