...
public class frmBlanksAdditionsDiscount : frmHeaderDetails
{
	...
	public frmBlanksAdditionsDiscount()
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_000b: Expected O, but got Unknown
		InitializeComponent();
		TableName = "Lns_BlanksAdditionsDiscount";
		IDCol = "BlankAdditionDiscountID";
		NoCol = "BlankAdditionDiscountNo";
		DateCol = "FromDate";
	}

	public frmBlanksAdditionsDiscount(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void PrepareData()
	{
		...
		dtDetails = BlanksAdditionsDiscountDetails.SelectByBlankAdditionDiscountID("0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BlankAdditionDiscountDetailID"].DefaultCellValue = -1;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BlankAdditionID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.7) - GlobalVariables.ScrollWidth;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DiscountPercentage"].Width = (int)((double)((Control)(object)ULGData).Width * 0.3);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BlankAdditionID"].Header).Caption = (GlobalVariables.IsArabic ? "الاضافة" : "Blank Addition");
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BlankAdditionID"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DiscountPercentage"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BlankAdditionID"].ValueList = (IValueList)(object)vlBlankAdditions;
	...
	public override void FillData()
	{
		...
		{
			DataTable dataTable = BlanksAdditionsDiscount.Select(RowID, GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((Control)(object)txtCode).Text = drMaster["BlankAdditionDiscountNo"].ToString();
			...
			dtDetails = BlanksAdditionsDiscountDetails.SelectByBlankAdditionDiscountID(drMaster["BlankAdditionDiscountID"].ToString(), GlobalVariables.IsArabic ? "1" : "0");
			((UltraGridBase)ULGData).DataSource = dtDetails;
			InitGrid();
		}
		else
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtCode).Text = (Adding ? BlanksAdditionsDiscount.GetCodeByBranchID(dtpFromDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
	...
	public override bool ValidateData()
	{
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("Lns_BlanksAdditionsDiscount", "BlankAdditionDiscountNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["BlankAdditionDiscountNo"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpFromDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
			string codeByBranchID = BlanksAdditionsDiscount.GetCodeByBranchID(dtpFromDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		...
		{
			if (((UltraGridBase)ULGData).Rows[i].Cells["BlankAdditionID"].Value == DBNull.Value)
			{
				GlobalVariables.InformationMB.Show("برجاء ادخال اسم الصنف  ", "Please Enter Item Name");
				ULGData.ActiveCell = ((UltraGridBase)ULGData).Rows[i].Cells["BlankAdditionID"];
				return false;
			}
			...
			{
				if (i != j && ((UltraGridBase)ULGData).Rows[i].Cells["BlankAdditionID"].Value.ToString() == ((UltraGridBase)ULGData).Rows[j].Cells["BlankAdditionID"].Value.ToString())
				{
					GlobalVariables.InformationMB.Show("لا يمكن تكرار الاضافة  ", "Cannot Duplicate The Same Blank Addition");
					ULGData.ActiveCell = ((UltraGridBase)ULGData).Rows[i].Cells["BlankAdditionID"];
					return false;
				}
			}
	...
	public override void AddData()
	{
		...
		try
		{
			int num = BlanksAdditionsDiscount.Insert_Update("-1", ((Control)(object)txtCode).Text, dtpFromDate.DateTime.ToString(GlobalVariables.DateLongFormate), dtpToDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((TextEditorControlBase)cboPriceType).Value.ToString(), ((Control)(object)txtNotes).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				((UltraGridBase)ULGData).Rows[i].Cells["BlankAdditionDiscountID"].Value = num;
				((UltraGridBase)ULGData).Rows[i].Cells["BlankAdditionDiscountDetailID"].Value = -1;
			...
			BlanksAdditionsDiscountDetails.Insert_UpdateByTable((DataTable)((UltraGridBase)ULGData).DataSource, GlobalVariables.UserID);
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = BlanksAdditionsDiscount.Insert_Update(drMaster["BlankAdditionDiscountID"].ToString(), ((Control)(object)txtCode).Text, dtpFromDate.DateTime.ToString(GlobalVariables.DateLongFormate), dtpToDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((TextEditorControlBase)cboPriceType).Value.ToString(), ((Control)(object)txtNotes).Text, bool.Parse(drMaster["Deleted"].ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			string text = ",";
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				((UltraGridBase)ULGData).Rows[i].Cells["BlankAdditionDiscountID"].Value = num;
				((UltraGridBase)ULGData).Rows[i].Cells["BranchID"].Value = GlobalVariables.CurrentBranchID;
				((UltraGridBase)ULGData).Rows[i].Cells["DiscountPercentage"].Value = ((((UltraGridBase)ULGData).Rows[i].Cells["DiscountPercentage"].Value != DBNull.Value && decimal.Parse(((UltraGridBase)ULGData).Rows[i].Cells["DiscountPercentage"].Value.ToString()) == 0m) ? "0.00000001" : ((UltraGridBase)ULGData).Rows[i].Cells["DiscountPercentage"].Value);
				text = text + ((UltraGridBase)ULGData).Rows[i].Cells["BlankAdditionDiscountDetailID"].Value.ToString() + ",";
			}
			Main.DeleteForUpdate("Lns_BlanksAdditionsDiscountDetails", "BlankAdditionDiscountID", drMaster["BlankAdditionDiscountID"].ToString(), "BlankAdditionDiscountDetailID", text);
			BlanksAdditionsDiscountDetails.Insert_UpdateByTable((DataTable)((UltraGridBase)ULGData).DataSource, GlobalVariables.UserID);
			Main.EndBulkTrans(FromServer: false);
		}
		catch
	...
	public override void DeleteData()
	{
		...
		try
		{
			BlanksAdditionsDiscount.DeleteVirtual(drMaster["BlankAdditionDiscountID"].ToString(), GlobalVariables.UserID);
			BlanksAdditionsDiscountDetails.DeleteVirtualByBlankAdditionDiscountID(drMaster["BlankAdditionDiscountID"].ToString(), GlobalVariables.UserID);
			Main.EndBulkTrans(FromServer: false);
		}
		catch
		{
	...
	public override void btnPrintClick()
	{
		if (RowID != "")
		{
			...
			{
				GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_Lns_BlanksAdditionsDiscount_A.rpt" : "Rep_Lns_BlanksAdditionsDiscount_E.rpt"));
			}
			frmReporViwer frmReporViwer2 = new frmReporViwer();
			GlobalVariables.ReportDocument.SetParameterValue("@BlankAdditionDiscountIDs", "," + RowID + ",");
	...
	{
		dtSearchResult = SearchFunctions.BlankAdditionsDiscountReport(-1, 0);
		if (dtSearchResult.Rows.Count > 0)
		{
			RowID = dtSearchResult.Rows[0]["BlankAdditionDiscountID"].ToString();
			FillData();
		}
	}
	...
	{
		if (e.KeyCode == Keys.F8 && (Adding || Updating) && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "BlankAdditionID")
		{
			...
			if (num != 0)
			{
				((UltraGridBase)ULGData).ActiveRow.Cells["BlankAdditionID"].Value = num;
			}
		}
	}
	...
	private void btnSelectItems_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < dtSearchResult.Rows.Count; i++)
		{
			...
			((UltraGridBase)ULGData).ActiveRow.Cells["BlankAdditionID"].Value = dtSearchResult.Rows[i]["BlankAdditionID"];
			if (((Control)(object)txtPercentage).Text != "" && decimal.Parse(((Control)(object)txtPercentage).Text) > 0m && ((UltraToggleEditorBase)chkPercentage).Checked)
			{
	...
	private void dtpFromDate_ValueChanged(object sender, EventArgs e)
	{
		if (Adding)
		{
			((Control)(object)txtCode).Text = BlanksAdditionsDiscount.GetCodeByBranchID(dtpFromDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.LensesProductions.Transactions.frmBlanksAdditionsDiscount));
		...
		base.Name = "frmBlanksAdditionsDiscount";
