...
public class frmProjectsSalariesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmProjectsSalariesRep()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى من المشروعات ليتم عرض الأجور ", "There is no choosen Project to be shown in the report, please check Safe to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CnsProjects.Reports.frmProjectsSalariesRep));
		...
		base.Name = "frmProjectsSalariesRep";
