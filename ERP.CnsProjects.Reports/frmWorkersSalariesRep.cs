...
public class frmWorkersSalariesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmWorkersSalariesRep()
	{
		TreeItemsIDCol = "WorkerID";
		TreeItemsNameCol = "WorkerName";
		InitializeComponent();
	...
	{
		dtItems = Workers.FillCombo("1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeFunctions.FillTreeOneLevel(TreeItems, dtItems, "WorkerID", "WorkerName");
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى من العمال ليتم عرض الأجور ", "There is no choosen Worker to be shown in the report, please check Safe to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@BranchIDs", Branches);
		GlobalVariables.ReportDocument.SetParameterValue("@WorkersIDs", Items);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CnsProjects.Reports.frmWorkersSalariesRep));
		...
		base.Name = "frmWorkersSalariesRep";
