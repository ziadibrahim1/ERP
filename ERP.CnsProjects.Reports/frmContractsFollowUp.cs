...
public class frmContractsFollowUp : frmReportTree2010
{
	private IContainer components = null;

	public frmContractsFollowUp()
	{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsTransactions_CnsProjectCosts_A.rpt" : "Rep_SC_ItemsTransactions_CnsProjectCosts_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsTransactions_CnsProjectCosts_A_nologo.rpt" : "Rep_SC_ItemsTransactions_CnsProjectCosts_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CnsProjects.Reports.frmContractsFollowUp));
