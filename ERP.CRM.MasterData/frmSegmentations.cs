...
public class frmSegmentations : frmGrid
{
	...
	public frmSegmentations()
	{
		InitializeComponent();
		TableName = "CRM_Segmentations";
		IDCol = "SegmentationID";
	}
	...
	{
		dataTable = Segmentations.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SegmentationNameAr"].Header).Caption = (GlobalVariables.IsArabic ? "القطاع بالعربية" : "Segmentation In Arabic");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SegmentationNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SegmentationNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SegmentationNameEn"].Header).Caption = (GlobalVariables.IsArabic ? " القطاع بالإنجليزية" : "Quesion In English");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SegmentationNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SegmentationNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["SegmentationNameAr"].Value.ToString();
		((Control)(object)txtEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["SegmentationNameEn"].Value.ToString();
	}
	...
	{
		Segmentations.Insert_Update("-1", ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		Segmentations.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["SegmentationID"].Value.ToString(), ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		Segmentations.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["SegmentationID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}

	private void txtSegmentationCode_KeyPress(object sender, KeyPressEventArgs e)
	{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CRM.MasterData.frmSegmentations));
