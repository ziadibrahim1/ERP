...
public class frmUpdateParent : frmDetails
{
	...
	{
		dtItems = Customers.SelectGroups(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		GlobalFunctions.FillCombo(cboHeader, dtItems, "CustomerID", "CustomerName");
	...
	public override void SaveData()
	{
		...
		try
		{
			Customers.UpdateParentID(RowID, ((TextEditorControlBase)cboHeader).Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CRM.MasterData.frmUpdateParent));
