...
public class frmChooseClientParent : frmDetails
{
	...
	public frmChooseClientParent()
	{
		InitializeComponent();
	}

	public frmChooseClientParent(string ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	{
		dtItems = SubAccounts.SelectGroups(GlobalVariables.ClientSubAccountTypeIDs, GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CRM.MasterData.frmChooseClientParent));
		...
		base.Name = "frmChooseClientParent";
