...
public class frmSubCostCenterSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmSubCostCenterSearchReport()
	{
		InitializeComponent();
	}

	public frmSubCostCenterSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SubCostCenterNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
