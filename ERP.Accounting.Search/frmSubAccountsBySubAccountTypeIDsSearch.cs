...
public class frmSubAccountsBySubAccountTypeIDsSearch : frmSearch
{
	private IContainer components = null;

	public frmSubAccountsBySubAccountTypeIDsSearch()
	{
		InitializeComponent();
	}

	public frmSubAccountsBySubAccountTypeIDsSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
