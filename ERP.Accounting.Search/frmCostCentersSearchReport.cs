...
public class frmCostCentersSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmCostCentersSearchReport()
	{
		InitializeComponent();
	}

	public frmCostCentersSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CostCenterNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
