...
public class frmApprovingAssetsAcquisitions : frmPosted
{
	private IContainer components = null;

	public frmApprovingAssetsAcquisitions()
	{
		InitializeComponent();
	...
	{
		dtsource = AssetsAcquisitions.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			AssetsAcquisitions.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا يوجد أذونات إقتناء لإعتمادها " : "There are No Acquisitions to Approve");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.AssetsAcquisitionsReport(0, 0, -1);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.FixedAssets.Approved.frmApprovingAssetsAcquisitions));
		...
		base.Name = "frmApprovingAssetsAcquisitions";
