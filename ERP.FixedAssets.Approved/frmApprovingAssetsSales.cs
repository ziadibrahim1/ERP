...
public class frmApprovingAssetsSales : frmPosted
{
	private IContainer components = null;

	public frmApprovingAssetsSales()
	{
		InitializeComponent();
		NoCol = "AssetSaleNo";
	}
	...
	{
		dtsource = AssetsSales.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			AssetsSales.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد مبيعات لإعتمادها " : "There are No Sales to Approve");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.AssetsSalesReport(0, 0, -1);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.FixedAssets.Approved.frmApprovingAssetsSales));
		...
		base.Name = "frmApprovingAssetsSales";
