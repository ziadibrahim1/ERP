...
public class frmTakeAwayChecksClosing : frmBase
{
	...
	public frmTakeAwayChecksClosing()
	{
		InitializeComponent();
	}

	public frmTakeAwayChecksClosing(bool Discount2Visible, int CLIENTID, object SUBACCOUNTID, bool GetOnlineBalance)
		: this()
	{
		this.GetOnlineBalance = GetOnlineBalance;
	...
	{
		((Control)(object)txtPaidAmount).Text = decimal.Parse((decimal.Parse((((Control)(object)txtCashAmount).Text == "" || ((Control)(object)txtCashAmount).Text == ".") ? "0" : ((Control)(object)txtCashAmount).Text) + decimal.Parse((((Control)(object)txtOnAccountAmount).Text == "" || ((Control)(object)txtOnAccountAmount).Text == ".") ? "0" : ((Control)(object)txtOnAccountAmount).Text) + decimal.Parse((((Control)(object)txtVisaAmount).Text == "" || ((Control)(object)txtVisaAmount).Text == ".") ? "0" : ((Control)(object)txtVisaAmount).Text)).ToString()).ToString(GlobalVariables.txtDecimalFormate);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Transactions.frmTakeAwayChecksClosing));
		...
		base.Name = "frmTakeAwayChecksClosing";
