...
public class frmPOSClientCreditNote : frmHeaderDetails
{
	...
	public override void FillData()
	{
		...
		{
			DataTable dataTable = ClientCreditNote.Select(RowID, GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void btnPrintClick()
	{
		if (RowID != "")
		{
			GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_Lns_ClientCreditNote_A.rpt" : "Rep_Lns_ClientCreditNote_E.rpt"));
	...
	private void cboSubAccountName_ValueChanged(object sender, EventArgs e)
	{
		...
		if (cboSubAccountName.SelectedIndex != -1)
		{
			...
			((Control)(object)txtBrabnchBalance).Text = Math.Round(SubAccounts.Balance(((TextEditorControlBase)cboSubAccountName).Value.ToString(), text, Adding ? ("," + GlobalVariables.CurrentBranchID + ",") : drMaster["BranchID"].ToString(), dtPOSDefaultData.Rows[0]["CurrencyID"].ToString(), IsFromServer: false, 0), 2).ToString();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Transactions.frmPOSClientCreditNote));
		...
		base.Name = "frmPOSClientCreditNote";
