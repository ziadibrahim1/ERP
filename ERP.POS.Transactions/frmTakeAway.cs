...
public class frmTakeAway : frmBase
{
	...
	{
		dtRoom = Rooms.SelectByType("0", "0", "1", "0", "," + GlobalVariables.CurrentBranchID + ",", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		CreateRooms();
	}
	...
	{
		frmTakeAwayChecks frmTakeAwayChecks2 = new frmTakeAwayChecks(int.Parse(((Control)sender).Tag.ToString()));
		frmTakeAwayChecks2.Tag = base.Tag;
		frmTakeAwayChecks2.MdiParent = base.MdiParent;
		frmTakeAwayChecks2.TopLevel = false;
		frmTakeAwayChecks2.Parent = base.Parent;
		frmTakeAwayChecks2.Width = base.Parent.Width;
		frmTakeAwayChecks2.Height = base.Parent.Height;
		((Control)(object)frmTakeAwayChecks2.lblTitle).Text = ((Control)sender).Text;
		frmTakeAwayChecks2.CanAdd = CanAdd;
		frmTakeAwayChecks2.CanUpdate = CanUpdate;
		frmTakeAwayChecks2.CanDelete = CanDelete;
		frmTakeAwayChecks2.CanDiscount = CanDiscount;
		frmTakeAwayChecks2.CanCloseCheck = CanCloseCheck;
		frmTakeAwayChecks2.CanMergeCheck = CanMergeCheck;
		frmTakeAwayChecks2.CanSplitCheck = CanSplitCheck;
		frmTakeAwayChecks2.CanSearching = CanSearching;
		frmTakeAwayChecks2.CanExport = CanExport;
		frmTakeAwayChecks2.CanPrint = CanPrint;
		frmTakeAwayChecks2.CanPrintReport = CanPrintReport;
		frmTakeAwayChecks2.CanViewReport = CanViewReport;
		frmTakeAwayChecks2.Show();
		frmTakeAwayChecks2.BringToFront();
		Dispose();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Transactions.frmTakeAway));
		Appearance val = new Appearance();
