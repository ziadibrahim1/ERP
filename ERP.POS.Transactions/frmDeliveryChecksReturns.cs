...
public class frmDeliveryChecksReturns : frmHeaderDetails
{
	...
	private UltraLabel lblDeliveryCharge;

	private UltraTextEditor txtDeliveryCharge;
	...
	public frmDeliveryChecksReturns()
	{
	...
	public frmDeliveryChecksReturns(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void PrepareData()
	{
		...
		dtPOSChecks = Checks.FillCombo(GlobalVariables.BranchIDs, "1", "0", (GlobalFunctions.GetDefault("ClientReturnPeriod") == "") ? "0" : GlobalFunctions.GetDefault("ClientReturnPeriod"));
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((Control)(object)txtDeliveryCharge).Text = decimal.Parse(drMaster["DeliveryCharge"].ToString()).ToString(GlobalVariables.txtDecimalFormate);
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)txtDeliveryCharge).ReadOnly = NavMode;
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtCode).Text = (Adding ? ChecksReturns.GetCodeByBranchID("0", "1", "0", dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
		((Control)(object)txtTotal).Text = "0";
		((Control)(object)txtPaidAmount).Text = "0";
		((Control)(object)txtRestAmount).Text = "0";
		((Control)(object)txtDeliveryCharge).Text = "0";
		WithoutSalesJVRoom = false;
		((TextEditorControlBase)cboClient).ValueChanged -= cboClient_ValueChanged;
		((TextEditorControlBase)cboClientCode).ValueChanged -= cboClientCode_ValueChanged;
		UltraComboEditor obj = cboClientCode;
	...
	public override bool ValidateData()
	{
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("POS_ChecksReturns", "ReturnNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["ReturnNo"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), " And IsDineIn =0 And IsDelivery=1 And IsTakeAway=0  ") > 0)
		{
			string codeByBranchID = ChecksReturns.GetCodeByBranchID("0", "1", "0", dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		...
		if (decimal.Parse(((Control)(object)txtPaidAmount).Text) > decimal.Parse(((Control)(object)txtTotal).Text) + decimal.Parse(((Control)(object)txtDeliveryCharge).Text))
		{
		...
		if (decimal.Parse(((Control)(object)txtTotal).Text) + decimal.Parse(((Control)(object)txtDeliveryCharge).Text) != decimal.Parse(((Control)(object)txtPaidAmount).Text) && cboClient.SelectedIndex == -1)
		{
	...
	public override void AddData()
	{
		...
		try
		{
			num = ChecksReturns.Insert_Update("-1", ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((TextEditorControlBase)cboCheckNo).Value.ToString(), "0", "1", "0", ShiftDetailID.ToString(), ShiftDetailUserID.ToString(), (dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["ClientID"] == DBNull.Value) ? "Null" : dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["ClientID"].ToString(), (dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["SubAccountID"] == DBNull.Value) ? "Null" : dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["SubAccountID"].ToString(), dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["CurrencyID"].ToString(), dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["ExchangeRate"].ToString(), ((Control)(object)txtNotes).Text, (((Control)(object)txtTotal).Text == "") ? "0" : ((Control)(object)txtTotal).Text, (((Control)(object)txtDeliveryCharge).Text == "") ? "0" : ((Control)(object)txtDeliveryCharge).Text, (((Control)(object)txtPaidAmount).Text == "") ? "0" : ((Control)(object)txtPaidAmount).Text, (((Control)(object)txtRestAmount).Text == "") ? "0" : ((Control)(object)txtRestAmount).Text, dtPOSChecks.Select("CheckID=" + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["RoomID"].ToString(), GlobalVariables.UserID, "Null", "Null", "Null", "Null", "0", "Null", "Null", "1", "Null", "Null", "0", "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = ChecksReturns.Insert_Update(drMaster["ReturnID"].ToString(), ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((TextEditorControlBase)cboCheckNo).Value.ToString(), "0", "1", "0", ShiftDetailID.ToString(), ShiftDetailUserID.ToString(), (dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["ClientID"] == DBNull.Value) ? "Null" : dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["ClientID"].ToString(), (dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["SubAccountID"] == DBNull.Value) ? "Null" : dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["SubAccountID"].ToString(), dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["CurrencyID"].ToString(), dtPOSChecks.Select(" CheckID= " + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["ExchangeRate"].ToString(), ((Control)(object)txtNotes).Text, (((Control)(object)txtTotal).Text == "") ? "0" : ((Control)(object)txtTotal).Text, (((Control)(object)txtDeliveryCharge).Text == "") ? "0" : ((Control)(object)txtDeliveryCharge).Text, (((Control)(object)txtPaidAmount).Text == "") ? "0" : ((Control)(object)txtPaidAmount).Text, (((Control)(object)txtRestAmount).Text == "") ? "0" : ((Control)(object)txtRestAmount).Text, dtPOSChecks.Select("CheckID=" + ((TextEditorControlBase)cboCheckNo).Value.ToString())[0]["RoomID"].ToString(), GlobalVariables.UserID, "Null", "Null", "Null", "Null", "0", "Null", "Null", "1", (drMaster["StockControlJVID"] == DBNull.Value) ? "Null" : drMaster["StockControlJVID"].ToString(), (drMaster["SalesJVID"] == DBNull.Value) ? "Null" : drMaster["SalesJVID"].ToString(), bool.Parse(drMaster["Approved"].ToString()) ? "1" : "0", "1", bool.Parse(drMaster["Deleted"].ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
	...
	{
		dtSearchResult = SearchFunctions.ChecksReturnsReport("0", "1", "0", -1, 0);
	...
	private void CalculateTotals()
	{
		...
		((Control)(object)txtRestAmount).Text = decimal.Parse((decimal.Parse(num.ToString()) + decimal.Parse((((Control)(object)txtDeliveryCharge).Text == "" || ((Control)(object)txtDeliveryCharge).Text == ".") ? "0" : ((Control)(object)txtDeliveryCharge).Text) - decimal.Parse((((Control)(object)txtPaidAmount).Text == "" || ((Control)(object)txtPaidAmount).Text == ".") ? "0" : ((Control)(object)txtPaidAmount).Text)).ToString()).ToString(GlobalVariables.txtDecimalFormate);
	}

	private void txtPaidAmount_ValueChanged(object sender, EventArgs e)
	{
		((Control)(object)txtRestAmount).Text = decimal.Parse((decimal.Parse(((Control)(object)txtTotal).Text) + decimal.Parse((((Control)(object)txtDeliveryCharge).Text == "" || ((Control)(object)txtDeliveryCharge).Text == ".") ? "0" : ((Control)(object)txtDeliveryCharge).Text) - decimal.Parse((((Control)(object)txtPaidAmount).Text == "" || ((Control)(object)txtPaidAmount).Text == ".") ? "0" : ((Control)(object)txtPaidAmount).Text)).ToString()).ToString(GlobalVariables.txtDecimalFormate);
	}

	private void txtDeliveryCharge_ValueChanged(object sender, EventArgs e)
	{
		((Control)(object)txtRestAmount).Text = decimal.Parse((decimal.Parse(((Control)(object)txtTotal).Text) + decimal.Parse((((Control)(object)txtDeliveryCharge).Text == "" || ((Control)(object)txtDeliveryCharge).Text == ".") ? "0" : ((Control)(object)txtDeliveryCharge).Text) - decimal.Parse((((Control)(object)txtPaidAmount).Text == "" || ((Control)(object)txtPaidAmount).Text == ".") ? "0" : ((Control)(object)txtPaidAmount).Text)).ToString()).ToString(GlobalVariables.txtDecimalFormate);
	}
	...
	private void cboCheckNo_ValueChanged(object sender, EventArgs e)
	{
		if (cboCheckNo.SelectedIndex > -1)
		{
			...
			string text = (((Control)(object)txtDeliveryCharge).Text = "0");
			string text3 = (((Control)(object)obj5).Text = text);
			string text5 = (((Control)(object)obj4).Text = text3);
			((Control)(object)obj3).Text = text5;
			InitGrid();
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Transactions.frmDeliveryChecksReturns));
		...
		this.lblDeliveryCharge = new UltraLabel();
		this.txtDeliveryCharge = new UltraTextEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.txtDeliveryCharge).BeginInit();
		...
		this.lblDeliveryCharge.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblDeliveryCharge).Name = "lblDeliveryCharge";
		((ControlBase)this.lblDeliveryCharge).WrapText = false;
		resources.ApplyResources(this.txtDeliveryCharge, "txtDeliveryCharge");
		((System.Windows.Forms.Control)(object)this.txtDeliveryCharge).Name = "txtDeliveryCharge";
		((System.Windows.Forms.Control)(object)this.txtDeliveryCharge).TabStop = false;
		((TextEditorControlBase)this.txtDeliveryCharge).ValueChanged += new System.EventHandler(txtDeliveryCharge_ValueChanged);
		((System.Windows.Forms.Control)(object)this.txtDeliveryCharge).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txtPaidAmount_KeyPress);
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblDeliveryCharge);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtDeliveryCharge);
		...
		base.Name = "frmDeliveryChecksReturns";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtDeliveryCharge, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblDeliveryCharge, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.txtDeliveryCharge).EndInit();
