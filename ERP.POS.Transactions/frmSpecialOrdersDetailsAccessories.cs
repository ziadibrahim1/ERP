...
public class frmSpecialOrdersDetailsAccessories : frmBase
{
	private DataTable dtItemsAccessories;

	private DataTable dtUnits;

	public DataTable dtSpecialOrdersDetailsAccessories;

	public int AccessoriesCount = 0;

	private int StoreID;

	private int SpecialOrdersDetailID;
	...
	public frmSpecialOrdersDetailsAccessories()
	{
	...
	public frmSpecialOrdersDetailsAccessories(int accessoriescount, int itemid, int storeid, int specialdetailid, bool canedit, bool enforceAccessories)
		: this()
	{
		ItemID = itemid;
		AccessoriesCount = accessoriescount;
		StoreID = storeid;
		SpecialOrdersDetailID = specialdetailid;
		CanEdit = canedit;
	...
	{
		((UltraGridBase)ULGData).DataSource = dtSpecialOrdersDetailsAccessories;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SpecialOrderDetailAccessoryID"].DefaultCellValue = -1;
	...
	{
		object obj = dtSpecialOrdersDetailsAccessories.Compute(" Sum(AccessoriesCount) ", "");
		if (obj == DBNull.Value)
		{
	...
	public void btnItems_Click(object sender, EventArgs e)
	{
		...
		((UltraGridBase)ULGData).ActiveRow.Cells["SpecialOrderDetailID"].Value = SpecialOrdersDetailID;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].AddNew();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Transactions.frmSpecialOrdersDetailsAccessories));
		...
		resources.ApplyResources(val, "appearance13");
		...
		base.Name = "frmSpecialOrdersDetailsAccessories";
