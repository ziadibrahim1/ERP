...
public class frmDeliveryChecksClosing : frmBase
{
	...
	public UltraTextEditor txtDeliveryChargeValue;
	...
	public frmDeliveryChecksClosing()
	{
		InitializeComponent();
	}

	public frmDeliveryChecksClosing(bool Discount2Visible, int CLIENTID, object SUBACCOUNTID, bool _GetOnlineBalance)
		: this()
	{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Transactions.frmDeliveryChecksClosing));
		...
		((ControlBase)this.ClientBalance).WrapText = false;
		...
		base.Name = "frmDeliveryChecksClosing";
