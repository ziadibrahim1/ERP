...
public class frmDineIn : frmBase
{
	...
	{
		frmRoomManagement frmRoomManagement2 = new frmRoomManagement(int.Parse(((Control)sender).Tag.ToString()));
		frmRoomManagement2.Tag = base.Tag;
		frmRoomManagement2.MdiParent = base.MdiParent;
		frmRoomManagement2.TopLevel = false;
		frmRoomManagement2.Parent = base.Parent;
		frmRoomManagement2.Resize -= frmRoomManagement2.frmRoomDesign_Resize;
		frmRoomManagement2.Width = base.Parent.Width;
		frmRoomManagement2.Height = base.Parent.Height;
		frmRoomManagement2.Resize += frmRoomManagement2.frmRoomDesign_Resize;
		((Control)(object)frmRoomManagement2.lblTitle).Text = ((Control)sender).Text;
		frmRoomManagement2.CanAdd = CanAdd;
		frmRoomManagement2.CanUpdate = CanUpdate;
		frmRoomManagement2.CanDelete = CanDelete;
		frmRoomManagement2.CanDiscount = CanDiscount;
		frmRoomManagement2.CanCloseCheck = CanCloseCheck;
		frmRoomManagement2.CanMergeCheck = CanMergeCheck;
		frmRoomManagement2.CanSplitCheck = CanSplitCheck;
		frmRoomManagement2.CanSearching = CanSearching;
		frmRoomManagement2.CanExport = CanExport;
		frmRoomManagement2.CanPrint = CanPrint;
		frmRoomManagement2.CanPrintReport = CanPrintReport;
		frmRoomManagement2.CanViewReport = CanViewReport;
		frmRoomManagement2.CanMinimunCharge = CanMinimunCharge;
		frmRoomManagement2.Show();
		frmRoomManagement2.BringToFront();
		Dispose();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Transactions.frmDineIn));
		Appearance val = new Appearance();
