...
public class frmDelivery : frmBase
{
	...
	{
		dtRoom = Rooms.SelectByType("0", "1", "0", "0", "," + GlobalVariables.CurrentBranchID + ",", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		CreateRooms();
	}
	...
	{
		frmDeliveryManagement frmDeliveryManagement2 = new frmDeliveryManagement(int.Parse(((Control)sender).Tag.ToString()));
		frmDeliveryManagement2.Tag = base.Tag;
		frmDeliveryManagement2.MdiParent = base.MdiParent;
		frmDeliveryManagement2.TopLevel = false;
		frmDeliveryManagement2.Parent = base.Parent;
		frmDeliveryManagement2.Width = base.Parent.Width;
		frmDeliveryManagement2.Height = base.Parent.Height;
		((Control)(object)frmDeliveryManagement2.lblTitle).Text = ((Control)sender).Text;
		frmDeliveryManagement2.CanAdd = CanAdd;
		frmDeliveryManagement2.CanUpdate = CanUpdate;
		frmDeliveryManagement2.CanDelete = CanDelete;
		frmDeliveryManagement2.CanDiscount = CanDiscount;
		frmDeliveryManagement2.CanCloseCheck = CanCloseCheck;
		frmDeliveryManagement2.CanMergeCheck = CanMergeCheck;
		frmDeliveryManagement2.CanSplitCheck = CanSplitCheck;
		frmDeliveryManagement2.CanSearching = CanSearching;
		frmDeliveryManagement2.CanExport = CanExport;
		frmDeliveryManagement2.CanPrint = CanPrint;
		frmDeliveryManagement2.CanPrintReport = CanPrintReport;
		frmDeliveryManagement2.CanViewReport = CanViewReport;
		frmDeliveryManagement2.Show();
		frmDeliveryManagement2.BringToFront();
		Dispose();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Transactions.frmDelivery));
		Appearance val = new Appearance();
