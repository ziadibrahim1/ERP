...
public class frmPatientStatement : frmReportTree2010
{
	private IContainer components = null;

	public frmPatientStatement()
	{
		dtItems = Patients.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItemsParentIDCol = "ParentID";
		TreeItemsIDCol = "PatientID";
		TreeItemsNameCol = "PatientName";
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@PatientIDs", Items);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Clinics.Reports.frmPatientStatement));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 5, 29, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 5, 29, 0, 0, 0, 0);
