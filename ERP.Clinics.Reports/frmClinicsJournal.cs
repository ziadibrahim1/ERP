...
public class frmClinicsJournal : frmReportTree2010
{
	private IContainer components = null;

	public frmClinicsJournal()
	{
		...
		dtItems2 = Doctors.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "DoctorID";
		TreeItems2NameCol = "DoctorName";
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى طبيب  ", "There is no chosen Doctor to be shown in the report, please check Doctors to be shown in report");
			return;
		}
		...
		GlobalVariables.ReportDocument.SetParameterValue("@DoctorIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Clinics.Reports.frmClinicsJournal));
