...
public class frmItemCard : frmReportTree2010
{
	...
	public override string GetReportName()
	{
		...
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCard_A.rpt" : "Rep_SC_ItemsCard_E.rpt");
		}
		return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCard_A_nologo.rpt" : "Rep_SC_ItemsCard_E_nologo.rpt");
	}
	...
	public override void btnPreview_Click(object sender, EventArgs e)
	{
		try
		{
			...
			{
				GlobalVariables.InformationMB.Show(" برجاء تحديث تقرير كارتة الصنف ", "Please Update Item Card Reports");
				return;
			}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmItemCard));
