...
public class frmItemDiscount : frmReportTree2010
{
	private IContainer components = null;

	public frmItemDiscount()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "خصومات الأصناف" : "Item Discount");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsDiscountSummary_A.rpt" : "Rep_SC_ItemsDiscountSummary_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsDiscountSummary_A_nologo.rpt" : "Rep_SC_ItemsDiscountSummary_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmItemDiscount));
