...
public class frmItemsNoEnoughQtyInMain : frmReportTree2010
{
	...
	public frmItemsNoEnoughQtyInMain()
	{
	...
	public override void FormLoad()
	{
		...
		GlobalFunctions.FillCombo(cboBranch, dtBranches, "BranchID", GlobalVariables.IsArabic ? "BranchNameAr" : "BranchNameEn");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsHaveNoEnoughQtyInMainBranch_A.rpt" : "Rep_SC_ItemsHaveNoEnoughQtyInMainBranch_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsHaveNoEnoughQtyInMainBranch_A_nologo.rpt" : "Rep_SC_ItemsHaveNoEnoughQtyInMainBranch_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى فرع  ", "There is no choosen Branch to be shown in the report, please check items to be shown in report");
			return;
		}
		...
		GlobalVariables.ReportDocument.SetParameterValue("@BranchID", ((TextEditorControlBase)cboBranch).Value);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmItemsNoEnoughQtyInMain));
		...
		resources.ApplyResources(val14, "appearance27");
		...
		resources.ApplyResources(val15, "appearance28");
		...
		resources.ApplyResources(val16, "appearance29");
		...
		this.cboBranch.AutoCompleteMode = (AutoCompleteMode)2;
		...
		base.Name = "frmItemsNoEnoughQtyInMain";
