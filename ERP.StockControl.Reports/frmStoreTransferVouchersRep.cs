...
{
	public DataTable dtDestinationStores;

	public string DestinationStores;

	public string TreeDestinationStoresParentIDCol = "ParentID";

	public string TreeDestinationStoresIDCol = "StoreID";

	public string TreeDestinationStoresNameCol = (GlobalVariables.IsArabic ? "StoreNameAr" : "StoreNameEn");

	public string TreeDestinationStoresIsMainCol = "IsMain";

	private IContainer components = null;

	public UltraButton btnDestinationStoreSearch;

	public UltraTextEditor txtDestinationStore;

	public UltraTree TreeDestinationStores;

	protected internal UltraCheckEditor chkAllDestinationStores;
	...
	{
		dtDestinationStores = Stores.Select("-1", ViewAllBranches ? "-1" : GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		...
		if (dtItems2 != null)
		{
			...
			TreeFunctions.FillTreeOneLevel(TreeDestinationStores, dtItems2, TreeDestinationStoresIDCol, TreeDestinationStoresNameCol);
		}
		((UltraToggleEditorBase)chkAllDestinationStores).Checked = true;
	...
	public override void ShowReport()
	{
		...
		if (((UltraToggleEditorBase)chkAllDestinationStores).Checked)
		{
			DestinationStores = "-1";
		}
		else
		{
			DestinationStores = TreeFunctions.GetTreeCheckedNodesIDs(TreeDestinationStores);
		}
		if (Items.Equals(","))
		{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مخزن من  ", "There is no choosen Source Store to be shown in the report, please check items to be shown in report");
			return;
		}
		if (DestinationStores.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مخزن الى   ", "There is no choosen Destination Store to be shown in the report, please check items to be shown in report");
			return;
		}
		...
		GlobalVariables.ReportDocument.SetParameterValue("@SourceStoreIDs", Items2);
		GlobalVariables.ReportDocument.SetParameterValue("@DestinationStoreIDs", DestinationStores);
	...
	private void btnSuppliersSearch_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < dtSearchResult.Rows.Count; i++)
		{
			TreeDestinationStores.GetNodeByKey(dtSearchResult.Rows[i][TreeDestinationStoresIDCol].ToString()).CheckedState = CheckState.Checked;
		}
	}

	private void chkAllSubAccounts_CheckedChanged(object sender, EventArgs e)
	{
		TreeFunctions.SetAllTreeNodesCheckState(((UltraToggleEditorBase)chkAllDestinationStores).Checked, TreeDestinationStores);
	}

	private void TreeDestinationStores_AfterCheck(object sender, NodeEventArgs e)
	{
		//IL_000e: Unknown result type (might be due to invalid IL or missing references)
		//IL_0018: Expected O, but got Unknown
		//IL_00c7: Unknown result type (might be due to invalid IL or missing references)
		//IL_00d1: Expected O, but got Unknown
		TreeDestinationStores.AfterCheck -= new AfterNodeChangedEventHandler(TreeDestinationStores_AfterCheck);
		...
		((UltraToggleEditorBase)chkAllDestinationStores).CheckedChanged -= chkAllSubAccounts_CheckedChanged;
		SetCheckBoxAllState(TreeDestinationStores, chkAllDestinationStores);
		((UltraToggleEditorBase)chkAllDestinationStores).CheckedChanged += chkAllSubAccounts_CheckedChanged;
		TreeDestinationStores.AfterCheck += new AfterNodeChangedEventHandler(TreeDestinationStores_AfterCheck);
	}

	private void txtDestinationStore_ValueChanged(object sender, EventArgs e)
	{
		DataView dataView = new DataView(dtDestinationStores);
		dataView.RowFilter = TreeDestinationStoresNameCol + " Like '%" + ((Control)(object)txtDestinationStore).Text.Trim() + "%' " + ((TreeDestinationStoresNameCol != null && TreeDestinationStoresNameCol != "") ? (" OR " + TreeDestinationStoresNameCol + " Like '" + ((Control)(object)txtDestinationStore).Text.Trim() + "%' ") : "");
		dataView.RowStateFilter = DataViewRowState.CurrentRows;
		if (dataView.ToTable().Rows.Count > 0)
		{
			TreeDestinationStores.Override.ActiveNodeAppearance.BackColor = Color.Gray;
			TreeDestinationStores.ActiveNode = TreeDestinationStores.GetNodeByKey(dataView.ToTable().Rows[0][TreeDestinationStoresIDCol].ToString());
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmStoreTransferVouchersRep));
		...
		this.btnDestinationStoreSearch = new UltraButton();
		this.txtDestinationStore = new UltraTextEditor();
		this.TreeDestinationStores = new UltraTree();
		this.chkAllDestinationStores = new UltraCheckEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.txtDestinationStore).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.TreeDestinationStores).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.chkAllDestinationStores).BeginInit();
		base.SuspendLayout();
		...
		resources.ApplyResources(this.btnDestinationStoreSearch, "btnDestinationStoreSearch");
		...
		((ControlBase)this.btnDestinationStoreSearch).Appearance = (AppearanceBase)(object)val6;
		((System.Windows.Forms.Control)(object)this.btnDestinationStoreSearch).Name = "btnDestinationStoreSearch";
		((System.Windows.Forms.Control)(object)this.btnDestinationStoreSearch).Click += new System.EventHandler(btnSuppliersSearch_Click);
		resources.ApplyResources(this.txtDestinationStore, "txtDestinationStore");
		((System.Windows.Forms.Control)(object)this.txtDestinationStore).Name = "txtDestinationStore";
		((TextEditorControlBase)this.txtDestinationStore).ValueChanged += new System.EventHandler(txtDestinationStore_ValueChanged);
		resources.ApplyResources(this.TreeDestinationStores, "TreeDestinationStores");
		...
		this.TreeDestinationStores.Appearance = (AppearanceBase)(object)val7;
		((System.Windows.Forms.Control)(object)this.TreeDestinationStores).Name = "TreeDestinationStores";
		val8.NodeStyle = (NodeStyle)1;
		this.TreeDestinationStores.Override = val8;
		((UltraControlBase)this.TreeDestinationStores).UseAppStyling = false;
		this.TreeDestinationStores.AfterCheck += new AfterNodeChangedEventHandler(TreeDestinationStores_AfterCheck);
		resources.ApplyResources(this.chkAllDestinationStores, "chkAllDestinationStores");
		...
		((UltraToggleEditorBase)this.chkAllDestinationStores).Appearance = (AppearanceBase)(object)val9;
		((System.Windows.Forms.Control)(object)this.chkAllDestinationStores).BackColor = System.Drawing.Color.Transparent;
		((UltraToggleEditorBase)this.chkAllDestinationStores).BackColorInternal = System.Drawing.Color.Transparent;
		((System.Windows.Forms.Control)(object)this.chkAllDestinationStores).Name = "chkAllDestinationStores";
		((UltraControlBase)this.chkAllDestinationStores).UseAppStyling = false;
		((UltraToggleEditorBase)this.chkAllDestinationStores).CheckedChanged += new System.EventHandler(chkAllSubAccounts_CheckedChanged);
		resources.ApplyResources(this, "$this");
		base.Controls.Add((System.Windows.Forms.Control)(object)this.btnDestinationStoreSearch);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtDestinationStore);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.TreeDestinationStores);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkAllDestinationStores);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkAllDestinationStores, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.TreeDestinationStores, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtDestinationStore, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.btnDestinationStoreSearch, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.txtDestinationStore).EndInit();
		((System.ComponentModel.ISupportInitialize)this.TreeDestinationStores).EndInit();
		((System.ComponentModel.ISupportInitialize)this.chkAllDestinationStores).EndInit();
