...
public class frmItemsPrices : frmReportTree2010
{
	...
	public frmItemsPrices()
	{
		...
		InitializeComponent();
		dtItems2 = PricesTypes.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItems2IDCol = "PriceTypeID";
		TreeItems2NameCol = (GlobalVariables.IsArabic ? "PriceNameAr" : "PriceNameEn");
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " قائمة اسعار الاصناف" : "Item Price List");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? "مقارنة اسعار الاصناف " : "Item Price List Compare");
		cboReportType.Items.Add((object)3, GlobalVariables.IsArabic ? "قائمة اسعار مجموعات الاصناف " : "Price List Items Groups");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsPriceList_A.rpt" : "Rep_SC_ItemsPriceList_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsPriceList_A_nologo.rpt" : "Rep_SC_ItemsPriceList_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsPricesCompare_A.rpt" : "Rep_SC_ItemsPricesCompare_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsPricesCompare_A_nologo.rpt" : "Rep_SC_ItemsPricesCompare_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "3")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsGroupPriceList_A.rpt" : "Rep_SC_ItemsGroupPriceList_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsGroupPriceList_A_nologo.rpt" : "Rep_SC_ItemsGroupPriceList_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@PriceTypeIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmItemsPrices));
		...
		resources.ApplyResources(((AppearanceBase)val6).FontData, "appearance11.FontData");
		resources.ApplyResources(val6, "appearance11");
		((SubObjectBase)val6).ForceApplyResources = "FontData|";
		((UltraToggleEditorBase)this.chkIsSalesItem).Appearance = (AppearanceBase)(object)val6;
		...
		((UltraToggleEditorBase)this.chkIsProductionItem).Appearance = (AppearanceBase)(object)val8;
		...
		((UltraToggleEditorBase)this.chkIsItem).Appearance = (AppearanceBase)(object)val9;
		...
		resources.ApplyResources(((AppearanceBase)val11).FontData, "appearance12.FontData");
		resources.ApplyResources(val11, "appearance12");
		((SubObjectBase)val11).ForceApplyResources = "FontData|";
		((UltraToggleEditorBase)this.chkIsService).Appearance = (AppearanceBase)(object)val11;
		...
		((UltraToggleEditorBase)this.chkIsNotSalesItem).Appearance = (AppearanceBase)(object)val13;
		...
		resources.ApplyResources(((AppearanceBase)val14).FontData, "appearance4.FontData");
		resources.ApplyResources(val14, "appearance4");
		((SubObjectBase)val14).ForceApplyResources = "FontData|";
		((UltraToggleEditorBase)this.chkIsNotDirectItem).Appearance = (AppearanceBase)(object)val14;
		...
		resources.ApplyResources(((AppearanceBase)val15).FontData, "appearance1.FontData");
		resources.ApplyResources(val15, "appearance1");
		((SubObjectBase)val15).ForceApplyResources = "FontData|";
		((UltraToggleEditorBase)this.chkIsNotProductionItem).Appearance = (AppearanceBase)(object)val15;
		...
		resources.ApplyResources(((AppearanceBase)val16).FontData, "appearance41.FontData");
		resources.ApplyResources(val16, "appearance41");
		((SubObjectBase)val16).ForceApplyResources = "FontData|";
		((UltraToggleEditorBase)this.chkIsNotActive).Appearance = (AppearanceBase)(object)val16;
