...
public class frmGoodReceiptNotesNotInvoiced : frmReportTree2010
{
	private IContainer components = null;

	public frmGoodReceiptNotesNotInvoiced()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "أذونات إضافه ليست لها فواتير" : "Good Receipt Notes Not Invoiced");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_GoodReceiptNotesNotInvoiced_A.rpt" : "Rep_SC_GoodReceiptNotesNotInvoiced_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_GoodReceiptNotesNotInvoiced_A_nologo.rpt" : "Rep_SC_GoodReceiptNotesNotInvoiced_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmGoodReceiptNotesNotInvoiced));
		...
		base.Name = "frmGoodReceiptNotesNotInvoiced";
