...
public class frmItemCardByPSInvoice : frmReportTree2010
{
	private IContainer components = null;

	public frmItemCardByPSInvoice()
	{
		...
		TreeItems2IDCol = "PSInvoiceID";
		TreeItems2NameCol = "PSInvoiceNo";
		TreeItems2IsMainCol = "IsMain";
		InitializeComponent();
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "كارتة صنف على اصناف فاتورة مشتريات" : "Item Card By Item Purchase Invoice");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? "اجمالى حركات صنف على اصناف فاتورة مشتريات" : "Item Card By Item Purchas Invoice Summary");
		cboReportType.Items.Add((object)3, GlobalVariables.IsArabic ? "اجمالى حركات مجموعة اصناف على اصناف فاتورة مشتريات" : "Group Item Card By Item Purchase Invoice Summary");
	...
	{
		GetBranches();
		dtItems2 = PSInvoices.FillRepTree(Branches, "-1", dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCard_ByPSInvoice_A.rpt" : "Rep_SC_ItemsCard_ByPSInvoice_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCard_ByPSInvoice_A_nologo.rpt" : "Rep_SC_ItemsCard_ByPSInvoice_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCard_ByPSInvoice_Summary_A.rpt" : "Rep_SC_ItemsCard_ByPSInvoice_Summary_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCard_ByPSInvoice_Summary_A_nologo.rpt" : "Rep_SC_ItemsCard_ByPSInvoice_Summary_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "3")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCard_ByPSInvoice_SummaryByGroup_A.rpt" : "Rep_SC_ItemsCard_ByPSInvoice_SummaryByGroup_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCard_ByPSInvoice_SummaryByGroup_A_nologo.rpt" : "Rep_SC_ItemsCard_ByPSInvoice_SummaryByGroup_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Branches.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى فرع  ", "There is no choosen Branch to be shown in the report, please check Branch to be shown in report");
			return;
		}
		if (Items.Equals(","))
		{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@PSInvoiceIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmItemCardByPSInvoice));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2013, 9, 8, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		resources.ApplyResources(base.dtpFromDate, "dtpFromDate");
		base.dtpFromDate.Value = new System.DateTime(2013, 9, 8, 0, 0, 0, 0);
		...
		base.Name = "frmItemCardByPSInvoice";
