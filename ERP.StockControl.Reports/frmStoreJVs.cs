...
public class frmStoreJVs : frmReportTree2010
{
	...
	public frmStoreJVs()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "قيد الصرف للاقسام" : "Department Issue JV");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_MaterialIssueVouchers_JV_A.rpt" : "Rep_SC_MaterialIssueVouchers_JV_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_MaterialIssueVouchers_JV_A_nologo.rpt" : "Rep_SC_MaterialIssueVouchers_JV_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmStoreJVs));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2015, 3, 12, 0, 0, 0, 0);
		resources.ApplyResources(base.dtpFromDate, "dtpFromDate");
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2015, 3, 12, 0, 0, 0, 0);
