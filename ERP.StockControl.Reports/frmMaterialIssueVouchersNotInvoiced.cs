...
public class frmMaterialIssueVouchersNotInvoiced : frmReportTree2010
{
	private IContainer components = null;

	public frmMaterialIssueVouchersNotInvoiced()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "أذونات صرف ليست لها فواتير" : "Material Issue Vouchers Not Invoiced");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_MaterialIssueVouchersNotInvoiced_A.rpt" : "Rep_SC_MaterialIssueVouchersNotInvoiced_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_MaterialIssueVouchersNotInvoiced_A_nologo.rpt" : "Rep_SC_MaterialIssueVouchersNotInvoiced_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmMaterialIssueVouchersNotInvoiced));
		...
		base.Name = "frmMaterialIssueVouchersNotInvoiced";
