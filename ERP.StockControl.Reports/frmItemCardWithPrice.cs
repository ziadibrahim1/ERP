...
public class frmItemCardWithPrice : frmReportTree2010
{
	private IContainer components = null;

	public frmItemCardWithPrice()
	{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCardWithPrice_A.rpt" : "Rep_SC_ItemsCardWithPrice_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCardWithPrice_A_nologo.rpt" : "Rep_SC_ItemsCardWithPrice_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCardWithPriceBatchNo_A.rpt" : "Rep_SC_ItemsCardWithPriceBatchNo_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsCardWithPriceBatchNo_A_nologo.rpt" : "Rep_SC_ItemsCardWithPriceBatchNo_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmItemCardWithPrice));
		...
		base.Name = "frmItemCardWithPrice";
