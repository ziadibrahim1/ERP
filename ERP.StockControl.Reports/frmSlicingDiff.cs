...
public class frmSlicingDiff : frmReportTree2010
{
	private IContainer components = null;

	public frmSlicingDiff()
	{
		dtItems = AnimalParts.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "إنحراف معياري" : "Standardization Deflection");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? " إنحراف معياري مجمع بنوع اللحم" : "Standardization Deflection Group By Meat Type");
		cboReportType.Items.Add((object)3, GlobalVariables.IsArabic ? "إنحراف مورد" : "Supplier Deflection");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SCR_SlicingDeflection_A.rpt" : "Rep_SCR_SlicingDeflection_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SCR_SlicingDeflection_A_nologo.rpt" : "Rep_SCR_SlicingDeflection_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SCR_SlicingDeflectionGroupByMeatType_A.rpt" : "Rep_SCR_SlicingDeflectionGroupByMeatType_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SCR_SlicingDeflectionGroupByMeatType_A_nologo.rpt" : "Rep_SCR_SlicingDeflectionGroupByMeatType_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmSlicingDiff));
