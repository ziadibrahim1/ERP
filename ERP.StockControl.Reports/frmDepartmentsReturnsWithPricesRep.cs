...
public class frmDepartmentsReturnsWithPricesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmDepartmentsReturnsWithPricesRep()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى قسم  ", "There is no chosen Departmen to be shown in the report, please check Departments to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@BranchIDs", Branches);
		GlobalVariables.ReportDocument.SetParameterValue("@DepartmentIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmDepartmentsReturnsWithPricesRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2017, 5, 7, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2017, 5, 7, 0, 0, 0, 0);
		...
		base.Name = "frmDepartmentsReturnsWithPricesRep";
