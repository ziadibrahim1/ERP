...
public class frmSuppliersReturnsWithPricesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmSuppliersReturnsWithPricesRep()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مورد  ", "There is no chosen Supplier to be shown in the report, please check Suppliers to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmSuppliersReturnsWithPricesRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2022, 5, 9, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2022, 5, 9, 0, 0, 0, 0);
		...
		base.Name = "frmSuppliersReturnsWithPricesRep";
