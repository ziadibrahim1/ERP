...
public class frmStoreTakingsCost : frmReportTree2010
{
	private IContainer components = null;

	public frmStoreTakingsCost()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى جرد ليتم عرضها ", "There is no chosen Store Taking to be shown in the report, please check Store Taking to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Reports.frmStoreTakingsCost));
