...
public class frmRecipeManufacturingRep : frmReportTree2010
{
	private IContainer components = null;

	public frmRecipeManufacturingRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "RecipeManufacturingID";
		TreeItems2NameCol = "RecipeManufacturingNo";
	...
	{
		GetBranches();
		dtItems2 = RecipeManufacturing.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SCR_RecipeManufacturing_A.rpt" : "Rep_SCR_RecipeManufacturing_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SCR_RecipeManufacturing_A_nologo.rpt" : "Rep_SCR_RecipeManufacturing_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@RecipeManufacturingIDs", Items2);
		...
		if (GroupNamePath != "")
		{
			...
			if (text.IndexOf(TreeItems2IDCol) >= 0)
			{
				string s = GroupNamePath.Replace(text, "").Replace(",", "").Replace("[", "")
					.Replace("]", "");
				frmRecipeManufacturing frmRecipeManufacturing2 = new frmRecipeManufacturing(int.Parse(s));
	...
	public override void btnItems2Search_Click(object sender, EventArgs e)
	{
		...
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["RecipeManufacturingID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.TransactionsReports.frmRecipeManufacturingRep));
		...
		base.Name = "frmRecipeManufacturingRep";
