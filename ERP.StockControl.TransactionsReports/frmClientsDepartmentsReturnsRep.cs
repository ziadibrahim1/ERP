...
public class frmClientsDepartmentsReturnsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmClientsDepartmentsReturnsRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "ReturnID";
		TreeItems2NameCol = "ReturnNo";
	...
	{
		GetBranches();
		dtItems2 = ClientsDepartmentsReturns.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ClientsDepartmentsReturns_A.rpt" : "Rep_SC_ClientsDepartmentsReturns_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ClientsDepartmentsReturns_A_nologo.rpt" : "Rep_SC_ClientsDepartmentsReturns_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@ClientsDepartmentsReturnIDs", Items2);
		...
		if (GroupNamePath != "")
		{
			...
			if (text.IndexOf(TreeItems2IDCol) >= 0)
			{
				string s = GroupNamePath.Replace(text, "").Replace(",", "").Replace("[", "")
					.Replace("]", "");
				frmClientsDepartmentsReturns frmClientsDepartmentsReturns2 = new frmClientsDepartmentsReturns(int.Parse(s));
	...
	public override void btnItems2Search_Click(object sender, EventArgs e)
	{
		...
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["ReturnID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.TransactionsReports.frmClientsDepartmentsReturnsRep));
		...
		base.Name = "frmClientsDepartmentsReturnsRep";
