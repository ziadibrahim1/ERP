...
public class frmStoreRevaluationsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmStoreRevaluationsRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "StoreRevaluationVoucherID";
		TreeItems2NameCol = "StoreRevaluationVoucherNo";
	...
	{
		GetBranches();
		dtItems2 = StoreRevaluationVouchers.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_StoreRevaluationVouchers_A.rpt" : "Rep_SC_StoreRevaluationVouchers_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_StoreRevaluationVouchers_A_nologo.rpt" : "Rep_SC_StoreRevaluationVouchers_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@StoreRevaluationVoucherIDs", Items2);
		...
		if (GroupNamePath != "")
		{
			...
			if (text.IndexOf(TreeItems2IDCol) >= 0)
			{
				string s = GroupNamePath.Replace(text, "").Replace(",", "").Replace("[", "")
					.Replace("]", "");
				frmStoreRevaluations frmStoreRevaluations2 = new frmStoreRevaluations(int.Parse(s));
				frmStoreRevaluations2.StartPosition = FormStartPosition.CenterParent;
				((Control)(object)frmStoreRevaluations2.lblTitle).Text = (GlobalVariables.IsArabic ? "اعادة تقيم مخزون" : "Store Revaluations");
				frmStoreRevaluations2.ShowDialog();
	...
	public override void btnItems2Search_Click(object sender, EventArgs e)
	{
		...
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["StoreRevaluationVoucherID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.TransactionsReports.frmStoreRevaluationsRep));
		...
		base.Name = "frmStoreRevaluationsRep";
