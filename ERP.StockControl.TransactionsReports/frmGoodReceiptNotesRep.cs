...
public class frmGoodReceiptNotesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmGoodReceiptNotesRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "GoodReceiptNoteID";
		TreeItems2NameCol = "GoodReceiptNoteNo";
	...
	{
		GetBranches();
		dtItems2 = GoodReceiptNotes.FillRepTree(Branches, "-1", "-1", dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_GoodReceiptNotes_A.rpt" : "Rep_SC_GoodReceiptNotes_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_GoodReceiptNotes_A_nologo.rpt" : "Rep_SC_GoodReceiptNotes_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@GoodReceiptNoteIDs", Items2);
		...
		if (GroupNamePath != "")
		{
			...
			if (text.IndexOf(TreeItems2IDCol) >= 0)
			{
				string s = GroupNamePath.Replace(text, "").Replace(",", "").Replace("[", "")
					.Replace("]", "");
				frmGoodReceiptNotes frmGoodReceiptNotes2 = new frmGoodReceiptNotes(int.Parse(s));
				frmGoodReceiptNotes2.StartPosition = FormStartPosition.CenterParent;
				((Control)(object)frmGoodReceiptNotes2.lblTitle).Text = (GlobalVariables.IsArabic ? "اذونــــات الاضـــافـــة" : "Good Receipt Notes");
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.TransactionsReports.frmGoodReceiptNotesRep));
		...
		base.Name = "frmGoodReceiptNotesRep";
