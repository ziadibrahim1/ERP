...
public class frmSuppliersReturnsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmSuppliersReturnsRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "SupplierReturnID";
		TreeItems2NameCol = "SupplierReturnNo";
	...
	{
		GetBranches();
		dtItems2 = SuppliersReturns.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_SuppliersReturns_A.rpt" : "Rep_SC_SuppliersReturns_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_SuppliersReturns_A_nologo.rpt" : "Rep_SC_SuppliersReturns_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@SuppliersReturnIDs", Items2);
		...
		if (GroupNamePath != "")
		{
			...
			if (text.IndexOf(TreeItems2IDCol) >= 0)
			{
				string s = GroupNamePath.Replace(text, "").Replace(",", "").Replace("[", "")
					.Replace("]", "");
				frmSuppliersReturns frmSuppliersReturns2 = new frmSuppliersReturns(int.Parse(s));
				frmSuppliersReturns2.StartPosition = FormStartPosition.CenterParent;
				((Control)(object)frmSuppliersReturns2.lblTitle).Text = (GlobalVariables.IsArabic ? "مـــرتـــجـــع  مــــورد" : "Suppliers Returns");
	...
	public override void btnItems2Search_Click(object sender, EventArgs e)
	{
		...
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["SupplierReturnID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.TransactionsReports.frmSuppliersReturnsRep));
		...
		base.Name = "frmSuppliersReturnsRep";
