...
public class frmMaterialIssueVouchersRep : frmReportTree2010
{
	private IContainer components = null;

	public frmMaterialIssueVouchersRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "MaterialIssueVoucherID";
		TreeItems2NameCol = "MaterialIssueVoucherNo";
	...
	{
		GetBranches();
		dtItems2 = MaterialIssueVouchers.FillRepTree(Branches, "-1", dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_MaterialIssueVouchers_A.rpt" : "Rep_SC_MaterialIssueVouchers_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_MaterialIssueVouchers_A_nologo.rpt" : "Rep_SC_MaterialIssueVouchers_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@MaterialIssueVoucherIDs", Items2);
		...
		if (GroupNamePath != "")
		{
			...
			if (text.IndexOf(TreeItems2IDCol) >= 0)
			{
				string s = GroupNamePath.Replace(text, "").Replace(",", "").Replace("[", "")
					.Replace("]", "");
				frmMaterialIssueVouchers frmMaterialIssueVouchers2 = new frmMaterialIssueVouchers(int.Parse(s));
				frmMaterialIssueVouchers2.StartPosition = FormStartPosition.CenterParent;
				((Control)(object)frmMaterialIssueVouchers2.lblTitle).Text = (GlobalVariables.IsArabic ? "اذونــــات الــــصـــرف" : "Material Issue Vouchers");
	...
	public override void btnItems2Search_Click(object sender, EventArgs e)
	{
		...
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["MaterialIssueVoucherID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.TransactionsReports.frmMaterialIssueVouchersRep));
		...
		base.Name = "frmMaterialIssueVouchersRep";
