...
public class frmOperationsServices : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationsServices()
	{
		...
		dtItems2 = Services.FillTree(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "ServiceID";
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى خدمة ليتم عرضها ", "There is no chosen Service to be shown in the report, please check Services to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@ServiceIDs", Items2);
	...
	{
		dtSearchResult = SearchFunctions.CSTServicesSearchReport(IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CustomsClearence.Reports.frmOperationsServices));
		...
		base.Name = "frmOperationsServices";
