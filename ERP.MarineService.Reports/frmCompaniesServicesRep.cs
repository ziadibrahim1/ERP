...
public class frmCompaniesServicesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmCompaniesServicesRep()
	{
		TreeItemsIDCol = "OperationID";
		TreeItemsNameCol = "OperationNo";
		TreeItemsNumberCol = "OperationNo";
		TreeItems2IDCol = "CompanyID";
		TreeItems2NameCol = "CompanyName";
		TreeItems2NumberCol = "CompanyName";
		InitializeComponent();
	...
	{
		base.FormLoad();
		dtItems2 = Companies.FillRepTree(GlobalVariables.IsArabic ? "1" : "0");
	...
	{
		return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_MS_CompaniesOperationsServices.rpt" : "Rep_MS_CompaniesOperationsServices.rpt");
	}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى شركة ليتم عرضها ", "There is no choosen Company to be shown in the report.");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@OperationIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@CompanyIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmCompaniesServicesRep));
		...
		base.Name = "frmCompaniesServicesRep";
