...
public class frmCreditAging : frmReportTree2010
{
	private IContainer components = null;

	public frmCreditAging()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى حساب  ", "There is no chosen account to be shown in the report, please check account to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى حساب تحليلي  ", "There is no chosen SubAccount to be shown in the report, please check SubAccount to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmCreditAging));
