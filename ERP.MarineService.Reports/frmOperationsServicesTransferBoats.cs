...
public class frmOperationsServicesTransferBoats : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationsServicesTransferBoats()
	{
		TreeItemsIDCol = "OperationID";
		TreeItemsNameCol = "OperationNo";
		TreeItemsNumberCol = "OperationNo";
		TreeItems2IDCol = "VesselID";
		TreeItems2NameCol = "VesselName";
		TreeItems2NumberCol = "VesselName";
		InitializeComponent();
	...
	{
		base.FormLoad();
		dtItems2 = Vessels.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مركب ليتم عرضها ", "There is no choosen Boat to be shown in the report.");
			return;
		}
		...
		GlobalVariables.ReportDocument.SetParameterValue("@VesselIDs", ((UltraToggleEditorBase)chkAll2).Checked ? "-1" : Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOperationsServicesTransferBoats));
		...
		base.Name = "frmOperationsServicesTransferBoats";
