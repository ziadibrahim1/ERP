...
public class frmOperationsInvoicesPaymentsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationsInvoicesPaymentsRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "OperationInvoicePaymentID";
		TreeItems2NameCol = "OperationInvoicePaymentNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = OperationsInvoicesPayments.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@OperationInvoicePaymentIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOperationsInvoicesPaymentsRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 8, 28, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 8, 28, 0, 0, 0, 0);
		...
		base.Name = "frmOperationsInvoicesPaymentsRep";
