...
public class frmOperationTasksExpenses : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationTasksExpenses()
	{
		TreeItemsIDCol = "ExpenseID";
		TreeItemsNameCol = "ExpenseName";
		TreeItemsNumberCol = "ExpenseName";
	...
	{
		base.FormLoad();
		dtItems = Expenses.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مصروف ليتم عرضها ", "There is no choosen Expenses to be shown in the report.");
			return;
		}
		if (Items2.Equals(","))
		{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@ExpenseIDs", ((UltraToggleEditorBase)chkAll).Checked ? "-1" : Items);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOperationTasksExpenses));
		...
		base.Name = "frmOperationTasksExpenses";
