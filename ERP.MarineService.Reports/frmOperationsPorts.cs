...
public class frmOperationsPorts : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationsPorts()
	{
		TreeItemsIDCol = "OperationID";
		TreeItemsNameCol = "OperationNo";
		TreeItemsNumberCol = "OperationNo";
		TreeItems2IDCol = "SeaPortID";
		TreeItems2NameCol = "SeaPortName";
		TreeItems2NumberCol = "SeaPortName";
		InitializeComponent();
	...
	{
		base.FormLoad();
		dtItems2 = SeaPorts.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى ميناء ليتم عرضها ", "There is no choosen Port to be shown in the report.");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@EntrySeaPortIDs", ((UltraToggleEditorBase)chkAll2).Checked ? "-1" : Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOperationsPorts));
