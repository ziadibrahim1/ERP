...
public class frmShipChandlersNotInvoiced : frmReportTree2010
{
	private IContainer components = null;

	public frmShipChandlersNotInvoiced()
	{
		...
		dtItems2 = SubAccounts.FillReportTreeBySubAccountTypeIDs(GlobalVariables.OwnerSubAccountTypeIDs + GlobalVariables.CharterSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.AgentSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.CaptainSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.SeaManSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.ClientSubAccountTypeIDs.Remove(0, 1), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى عميل  ", "There is no chosen Client to be shown in the report, please check Clients to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmShipChandlersNotInvoiced));
		...
		base.Name = "frmShipChandlersNotInvoiced";
