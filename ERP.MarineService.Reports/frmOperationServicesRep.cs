...
public class frmOperationServicesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationServicesRep()
	{
	...
	public override void ShowReport()
	{
		...
		if (dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Import"))
		{
		...
		if (dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Export"))
		{
			GlobalVariables.ReportDocument.SetParameterValue("@BranchIDs", Branches);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOperationServicesRep));
		...
		base.Name = "frmOperationServicesRep";
