...
public class frmOwnersOperations : frmReportTree2010
{
	private IContainer components = null;

	public frmOwnersOperations()
	{
		TreeItems2IDCol = "SubAccountID";
		TreeItems2NameCol = "OwnerName";
		TreeItems2NumberCol = "OwnerName";
		InitializeComponent();
	...
	{
		base.FormLoad();
		dtItems2 = Owners.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مالك ليتم عرضه ", "There is no chosen Owner to be shown in the report.");
			return;
		}
		...
		GlobalVariables.ReportDocument.SetParameterValue("@OwnerSubAccountIDs", ((UltraToggleEditorBase)chkAll2).Checked ? "-1" : Items2);
	...
	{
		dtSearchResult = SearchFunctions.OwnersSearchReport(GlobalVariables.CurrentBranchID, IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOwnersOperations));
