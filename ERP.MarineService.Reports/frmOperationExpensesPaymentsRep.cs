...
public class frmOperationExpensesPaymentsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationExpensesPaymentsRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "OperationExpensePaymentID";
		TreeItems2NameCol = "OperationExpensePaymentNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = OperationsExpensesPayments.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@OperationExpensePaymentIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOperationExpensesPaymentsRep));
		...
		base.Name = "frmOperationExpensesPaymentsRep";
