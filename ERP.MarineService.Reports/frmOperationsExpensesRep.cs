...
public class frmOperationsExpensesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationsExpensesRep()
	{
		dtItems = Expenses.FillTree(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItemsParentIDCol = "ParentID";
		TreeItemsIDCol = "ExpenseID";
		TreeItemsNameCol = "Name";
		TreeItemsIsMainCol = "IsMain";
		dtItems2 = SubAccounts.FillReportTreeBySubAccountTypeIDs("-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مورد  ", "There is no chosen SubAccount to be shown in the report, please check SubAccount to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@BranchIDs", Branches);
		GlobalVariables.ReportDocument.SetParameterValue("@ExpenseIDs", Items);
	...
	{
		dtSearchResult = SearchFunctions.MS_ExpensesSearchReport(IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOperationsExpensesRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2017, 4, 20, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2017, 4, 20, 0, 0, 0, 0);
		...
		base.Name = "frmOperationsExpensesRep";
