...
public class frmOperationTasksRep : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationTasksRep()
	{
		TreeItemsIDCol = "OperationID";
		TreeItemsNameCol = "OperationNo";
		TreeItemsNumberCol = "OperationNo";
		TreeItems2IDCol = "User_ID";
		TreeItems2NameCol = "UserName";
		TreeItems2NumberCol = "UserName";
		InitializeComponent();
	...
	{
		base.FormLoad();
		dtItems2 = Users.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void FillData()
	{
		...
		dtItems = Operations.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"), GlobalVariables.IsArabic ? "1" : "0");
		if (dtItems != null)
		{
	...
	{
		return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_MS_OperationsTasks_E.rpt" : "Rep_MS_OperationsTasks_E.rpt");
	}
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى عملية ليتم عرضها ", "There is no choosen Operation to be shown in the report.");
			return;
		}
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مستخدم ليتم عرضها ", "There is no choosen User to be shown in the report.");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@OperationIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@UserIDs", ((UltraToggleEditorBase)chkAll2).Checked ? "-1" : Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOperationTasksRep));
		...
		base.Name = "frmOperationTasksRep";
