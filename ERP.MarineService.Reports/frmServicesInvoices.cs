...
public class frmServicesInvoices : frmReportTree2010
{
	...
	public override void FillData()
	{
		...
		dtItems2 = OperationsInvoices.FillRepTree(Branches, Items, "1", dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ReportDoubleClick(string GroupNamePath, frmReporViwer frmViewer)
	{
		if (GroupNamePath != "")
		{
			...
			if (text.IndexOf("OperationInvoiceID") >= 0)
			{
				...
				((Control)(object)frmOperationInvoices2.lblTitle).Text = (GlobalVariables.IsArabic ? "فاتورة خدمات" : "Services Invoice");
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmServicesInvoices));
