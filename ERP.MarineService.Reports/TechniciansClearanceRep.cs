...
public class TechniciansClearanceRep : frmReportTree2010
{
	private IContainer components = null;

	public TechniciansClearanceRep()
	{
		TreeItems2IDCol = "TechnicianID";
		TreeItems2NameCol = "TechnicianName";
		TreeItems2NumberCol = "TechnicianName";
		InitializeComponent();
	...
	{
		base.FormLoad();
		dtItems2 = Technicians.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى فني ليتم عرضه ", "There is no chosen Technician to be shown in the report.");
			return;
		}
		...
		GlobalVariables.ReportDocument.SetParameterValue("@TechnicianIDs", ((UltraToggleEditorBase)chkAll2).Checked ? "-1" : Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.TechniciansClearanceRep));
		...
		base.Name = "TechniciansClearanceRep";
