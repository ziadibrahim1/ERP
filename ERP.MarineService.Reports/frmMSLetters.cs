...
public class frmMSLetters : frmReportTree2010
{
	...
	public override void ShowReport()
	{
		...
		string[] array = new string[GlobalVariables.ReportDocument.ParameterFields.Count];
		for (int i = 0; i < GlobalVariables.ReportDocument.ParameterFields.Count; i++)
		{
			if (GlobalVariables.ReportDocument.ParameterFields[i].ReportName.Length <= 0)
			{
				if (GlobalVariables.ReportDocument.ParameterFields[i].ParameterValueType == ParameterValueKind.StringParameter)
				{
					GlobalVariables.ReportDocument.SetParameterValue(i, "-1");
				}
				else
				{
					GlobalVariables.ReportDocument.SetParameterValue(i, 1);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmMSLetters));
