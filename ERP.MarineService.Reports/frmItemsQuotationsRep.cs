...
public class frmItemsQuotationsRep : frmReportTree2010
{
	...
	public frmItemsQuotationsRep()
	{
		TreeItemsIDCol = "OperationID";
		TreeItemsNameCol = "OperationNo";
		TreeItemsNumberCol = "OperationNo";
		TreeItems2IDCol = "ItemQuotationID";
		TreeItems2NameCol = "ItemQuotation";
		TreeItems2NumberCol = "ItemQuotation";
		InitializeComponent();
	...
	{
		GetBranches();
		Items2 = TreeFunctions.GetTreeCheckedNodesIDs(TreeItems);
		dtItems2 = ItemsQuotations.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"), GlobalVariables.IsArabic ? "1" : "0");
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى عرض ليتم عرضه ", "There is no choosen Quotation to be shown in the report.");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@ItemQuotationIDs", ((UltraToggleEditorBase)chkAll2).Checked ? "-1" : Items2);
		GlobalVariables.ReportDocument.SetParameterValue("@IsArabic", ((UltraToggleEditorBase)chkIsArabic).Checked);
		if (cboReportType.SelectedIndex > -1 && dtReports != null && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("ItemsQuotations"))
		{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmItemsQuotationsRep));
		...
		base.Name = "frmItemsQuotationsRep";
