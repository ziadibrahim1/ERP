...
public class frmAgencyTransferRep : frmReportTree2010
{
	...
	private UltraComboEditor cboAgents;
	...
	public override void FillData()
	{
		...
		GlobalFunctions.FillCombo(cboAgents, dtAgents, "SubAccountID", "AgentName");
	...
	{
		return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_MS_OperationServices.rpt" : "Rep_MS_OperationServices.rpt");
	}

	public override void ShowReport()
	{
		if (cboAgents.SelectedIndex == -1)
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "برجاء إختيار الوكيل" : "Please Select Agent");
			((TextEditorControlBase)cboAgents).Focus();
			cboAgents.DropDown();
			return;
		}
		if (cboVessels.SelectedIndex == -1)
		{
			...
			((TextEditorControlBase)cboVessels).Focus();
			cboVessels.DropDown();
			return;
		}
		if (cboCompanies.SelectedIndex == -1)
		{
			...
			((TextEditorControlBase)cboCompanies).Focus();
			cboCompanies.DropDown();
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@SubAccountID", int.Parse(((TextEditorControlBase)cboAgents).Value.ToString()));
		GlobalVariables.ReportDocument.SetParameterValue("@VesselID", int.Parse(((TextEditorControlBase)cboVessels).Value.ToString()));
		GlobalVariables.ReportDocument.SetParameterValue("@CompanyID", int.Parse(((TextEditorControlBase)cboCompanies).Value.ToString()));
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmAgencyTransferRep));
		Appearance val = new Appearance();
		Appearance val2 = new Appearance();
		Appearance val3 = new Appearance();
		Appearance val4 = new Appearance();
		Appearance val5 = new Appearance();
		this.cboAgents = new UltraComboEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.cboAgents).BeginInit();
		...
		base.dtpFromDate.DateTime = new System.DateTime(2016, 4, 26, 0, 0, 0, 0);
		resources.ApplyResources(base.dtpFromDate, "dtpFromDate");
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2016, 4, 26, 0, 0, 0, 0);
		...
		((TextEditorControlBase)this.cboAgents).AlwaysInEditMode = true;
		resources.ApplyResources(this.cboAgents, "cboAgents");
		this.cboAgents.AutoCompleteMode = (AutoCompleteMode)4;
		((System.Windows.Forms.Control)(object)this.cboAgents).Name = "cboAgents";
		...
		((TextEditorControlBase)this.cboVessels).AlwaysInEditMode = true;
		...
		((TextEditorControlBase)this.cboCompanies).AlwaysInEditMode = true;
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.cboAgents);
		...
		base.Name = "frmAgencyTransferRep";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.cboAgents, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.cboAgents).EndInit();
