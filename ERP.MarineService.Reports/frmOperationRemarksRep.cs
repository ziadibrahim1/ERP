...
public class frmOperationRemarksRep : frmReportTree2010
{
	private IContainer components = null;

	public frmOperationRemarksRep()
	{
		TreeItemsIDCol = "User_ID";
		TreeItemsNameCol = "UserName";
		TreeItemsNumberCol = "UserName";
	...
	public override void FormLoad()
	{
		...
		TreeFunctions.FillTreeOneLevel(TreeItems, dtItems2, TreeItemsIDCol, TreeItemsNameCol);
	}
	...
	{
		return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_MS_OperationsRemarks_E.rpt" : "Rep_MS_OperationsRemarks_E.rpt");
	}
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مستخدم ليتم عرضها ", "There is no choosen From User to be shown in the report.");
			return;
		}
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مستخدم ليتم عرضها ", "There is no choosen To User to be shown in the report.");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@FromUserIDs", ((UltraToggleEditorBase)chkAll).Checked ? "-1" : Items);
		GlobalVariables.ReportDocument.SetParameterValue("@ToUserIDs", ((UltraToggleEditorBase)chkAll2).Checked ? "-1" : Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmOperationRemarksRep));
		...
		base.Name = "frmOperationRemarksRep";
