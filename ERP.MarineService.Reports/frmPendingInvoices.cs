...
public class frmPendingInvoices : frmReportTree2010
{
	private IContainer components = null;

	public frmPendingInvoices()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى عميل ليتم عرضه ", "There is no chosen Client to be shown in the report, please check Client to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@VesselIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Reports.frmPendingInvoices));
