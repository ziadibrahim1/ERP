...
public class frmReportsOptions : frmBase
{
	private bool IsLogoChanged = false;

	private bool IsFooterChanged = false;

	private bool IsWaterMarkChaned = false;
	...
	private UltraPictureBox pbWaterMark;

	private UltraButton btnWaterMark;

	private UltraLabel lblWaterMark;
	...
	private NumericUpDown txtZoomFactor;

	private UltraTextEditor txtReportPathLocal;

	private UltraTextEditor txtReportPathRemote;

	private UltraLabel ultraLabel5;

	private UltraLabel ultraLabel4;

	private UltraButton btnReportPathLocal;

	private UltraButton btnReportPathRemote;

	public frmReportsOptions()
	{
		InitializeComponent();
	}
	...
	private void btnWaterMark_Click(object sender, EventArgs e)
	{
		if (ofdPicture.ShowDialog() == DialogResult.OK)
		{
			pbWaterMark.Image = Image.FromFile(ofdPicture.FileName);
			IsWaterMarkChaned = true;
		}
	}

	private void frmReportsOptions_Load(object sender, EventArgs e)
	{
		FillData();
	}
	...
	private void FillData()
	{
		...
		((Control)(object)txtReportPathRemote).Text = GlobalFunctions.GetDefault("ReportPathRemote");
		((Control)(object)txtReportPathLocal).Text = GlobalFunctions.GetDefault("ReportPathLocal");
		txtZoomFactor.Value = Convert.ToDecimal(GlobalFunctions.GetDefault("ReportZoomFactor"));
		DataTable dataTable = Defaults.Select();
		picbCompanyLogo.Image = ((dataTable.Rows[0]["Logo"] == DBNull.Value) ? null : GetImage((byte[])dataTable.Rows[0]["Logo"]));
		...
		pbWaterMark.Image = ((dataTable.Rows[0]["WaterMarkLogo"] == DBNull.Value) ? null : GetImage((byte[])dataTable.Rows[0]["WaterMarkLogo"]));
		pbWaterMark.ScaleImage = (ScaleImage)1;
		IsLogoChanged = false;
		IsFooterChanged = false;
		IsWaterMarkChaned = false;
	}
	...
	private void UpdateData()
	{
		...
		GlobalFunctions.SetDefault("ReportPathRemote", ((Control)(object)txtReportPathRemote).Text);
		GlobalFunctions.SetDefault("ReportPathLocal", ((Control)(object)txtReportPathLocal).Text);
		GlobalFunctions.SetDefault("ReportZoomFactor", txtZoomFactor.Value.ToString());
		GlobalVariables.ReportsPath = ((Control)(object)txtReportPath).Text;
		if (IsLogoChanged)
		{
			if (picbCompanyLogo.Image != null)
			{
				Defaults.UpdateLogo((Image)picbCompanyLogo.Image);
			}
			else
			{
				Main.ExecuteNonQuery("Update Defaults Set Logo = null");
			}
		}
		if (IsFooterChanged)
		{
			...
			{
				Defaults.UpdateFooterLogo((Image)picbFooterLogo.Image);
			}
			else
			{
				Main.ExecuteNonQuery("Update Defaults Set FooterLogo = null");
			}
		}
		if (IsWaterMarkChaned)
		{
			if (pbWaterMark.Image != null)
			{
				Defaults.UpdateWaterMark((Image)pbWaterMark.Image);
			}
			else
			{
				Main.ExecuteNonQuery("Update Defaults Set WaterMarkLogo = null");
			}
		}
		GlobalVariables.InformationMB.Show("تــم تخزين البيانات بنجــــاح", "Updates were saved successfully");
		GlobalVariables.drDefaults = Defaults.Select().Rows[0];
	}
	...
	private void PictureBox_MouseDoubleClick(object sender, MouseEventArgs e)
	{
		...
		if (GlobalVariables.MessageBoxResult == 'Y')
		{
			...
			else if (sender.Equals(picbFooterLogo))
			{
				IsFooterChanged = true;
			}
			else if (sender.Equals(pbWaterMark))
			{
				IsWaterMarkChaned = true;
			}
		}
	...
	private void btnReportPathRemote_Click(object sender, EventArgs e)
	{
		if (fbdPath.ShowDialog() == DialogResult.OK)
		{
			((Control)(object)txtReportPathRemote).Text = fbdPath.SelectedPath + "\\";
		}
	}

	private void btnReportPathLocal_Click(object sender, EventArgs e)
	{
		if (fbdPath.ShowDialog() == DialogResult.OK)
		{
			((Control)(object)txtReportPathLocal).Text = fbdPath.SelectedPath + "\\";
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SystemOptions.GeneralOptions.frmReportsOptions));
		...
		this.txtZoomFactor = new System.Windows.Forms.NumericUpDown();
		this.txtReportPathLocal = new UltraTextEditor();
		this.txtReportPathRemote = new UltraTextEditor();
		this.txtReportPath = new UltraTextEditor();
		this.pbWaterMark = new UltraPictureBox();
		this.btnWaterMark = new UltraButton();
		this.lblWaterMark = new UltraLabel();
		this.label8 = new UltraLabel();
		...
		this.btnReportPathLocal = new UltraButton();
		this.label7 = new UltraLabel();
		this.btnReportPathRemote = new UltraButton();
		...
		((System.ComponentModel.ISupportInitialize)this.txtZoomFactor).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.txtReportPathLocal).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.txtReportPathRemote).BeginInit();
		...
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add(this.txtZoomFactor);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.txtReportPathLocal);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.txtReportPathRemote);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.txtReportPath);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.pbWaterMark);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.btnWaterMark);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.lblWaterMark);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.label8);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.btnFooterPath);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.ultraLabel5);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.picbFooterLogo);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.ultraLabel4);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.ultraLabel3);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.ultraLabel2);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.btnReportPathLocal);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.label7);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.btnReportPathRemote);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.picbCompanyLogo);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.btnReportPath);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Controls.Add((System.Windows.Forms.Control)(object)this.btnImagePath);
		((System.Windows.Forms.Control)(object)this.tbGeneral).Name = "tbGeneral";
		resources.ApplyResources(this.txtZoomFactor, "txtZoomFactor");
		this.txtZoomFactor.Maximum = new decimal(new int[4] { 300, 0, 0, 0 });
		this.txtZoomFactor.Minimum = new decimal(new int[4] { 50, 0, 0, 0 });
		this.txtZoomFactor.Name = "txtZoomFactor";
		this.txtZoomFactor.Value = new decimal(new int[4] { 50, 0, 0, 0 });
		resources.ApplyResources(this.txtReportPathLocal, "txtReportPathLocal");
		((System.Windows.Forms.Control)(object)this.txtReportPathLocal).Name = "txtReportPathLocal";
		resources.ApplyResources(this.txtReportPathRemote, "txtReportPathRemote");
		((System.Windows.Forms.Control)(object)this.txtReportPathRemote).Name = "txtReportPathRemote";
		...
		resources.ApplyResources(this.pbWaterMark, "pbWaterMark");
		((AppearanceBase)val).BackColor = System.Drawing.Color.Transparent;
		resources.ApplyResources(val, "appearance1");
		this.pbWaterMark.Appearance = (AppearanceBase)(object)val;
		this.pbWaterMark.BorderShadowColor = System.Drawing.Color.Empty;
		this.pbWaterMark.BorderStyle = (UIElementBorderStyle)2;
		((System.Windows.Forms.Control)(object)this.pbWaterMark).Name = "pbWaterMark";
		((System.Windows.Forms.Control)(object)this.pbWaterMark).MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(PictureBox_MouseDoubleClick);
		resources.ApplyResources(this.btnWaterMark, "btnWaterMark");
		((System.Windows.Forms.Control)(object)this.btnWaterMark).Name = "btnWaterMark";
		((System.Windows.Forms.Control)(object)this.btnWaterMark).Click += new System.EventHandler(btnWaterMark_Click);
		resources.ApplyResources(this.lblWaterMark, "lblWaterMark");
		((AppearanceBase)val2).BackColor = System.Drawing.Color.Transparent;
		resources.ApplyResources(val2, "appearance2");
		((ControlBase)this.lblWaterMark).Appearance = (AppearanceBase)(object)val2;
		this.lblWaterMark.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblWaterMark).Name = "lblWaterMark";
		((ControlBase)this.lblWaterMark).WrapText = false;
		resources.ApplyResources(this.label8, "label8");
		((AppearanceBase)val3).BackColor = System.Drawing.Color.Transparent;
		resources.ApplyResources(val3, "appearance3");
		((ControlBase)this.label8).Appearance = (AppearanceBase)(object)val3;
		this.label8.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.label8).Name = "label8";
		((ControlBase)this.label8).WrapText = false;
		...
		((ControlBase)this.ultraLabel5).Appearance = (AppearanceBase)(object)val4;
		...
		this.picbFooterLogo.Appearance = (AppearanceBase)(object)val5;
		...
		((System.Windows.Forms.Control)(object)this.picbFooterLogo).MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(PictureBox_MouseDoubleClick);
		...
		((ControlBase)this.ultraLabel4).Appearance = (AppearanceBase)(object)val6;
		...
		resources.ApplyResources(this.btnReportPathLocal, "btnReportPathLocal");
		((System.Windows.Forms.Control)(object)this.btnReportPathLocal).Name = "btnReportPathLocal";
		((System.Windows.Forms.Control)(object)this.btnReportPathLocal).Click += new System.EventHandler(btnReportPathLocal_Click);
		resources.ApplyResources(this.label7, "label7");
		((AppearanceBase)val9).BackColor = System.Drawing.Color.Transparent;
		resources.ApplyResources(val9, "appearance9");
		((ControlBase)this.label7).Appearance = (AppearanceBase)(object)val9;
		this.label7.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.label7).Name = "label7";
		((ControlBase)this.label7).WrapText = false;
		resources.ApplyResources(this.btnReportPathRemote, "btnReportPathRemote");
		((System.Windows.Forms.Control)(object)this.btnReportPathRemote).Name = "btnReportPathRemote";
		((System.Windows.Forms.Control)(object)this.btnReportPathRemote).Click += new System.EventHandler(btnReportPathRemote_Click);
		resources.ApplyResources(this.picbCompanyLogo, "picbCompanyLogo");
		((AppearanceBase)val10).BackColor = System.Drawing.Color.Transparent;
		resources.ApplyResources(val10, "appearance10");
		this.picbCompanyLogo.Appearance = (AppearanceBase)(object)val10;
		...
		((UltraTabControlBase)this.tcSystemDefaults).Appearance = (AppearanceBase)(object)val56;
		...
		((System.Windows.Forms.Control)(object)this.tcSystemDefaults).Controls.Add((System.Windows.Forms.Control)(object)this.tbGeneral);
		...
		((UltraTabControlBase)this.tcSystemDefaults).TabOrientation = (TabOrientation)2;
		val57.TabPage = this.tbGeneral;
		((UltraTabControlBase)this.tcSystemDefaults).Tabs.AddRange((UltraTab[])(object)new UltraTab[1] { val57 });
		...
		base.Name = "frmReportsOptions";
		base.Load += new System.EventHandler(frmReportsOptions_Load);
		...
		((System.ComponentModel.ISupportInitialize)this.txtZoomFactor).EndInit();
		((System.ComponentModel.ISupportInitialize)this.txtReportPathLocal).EndInit();
		((System.ComponentModel.ISupportInitialize)this.txtReportPathRemote).EndInit();
