...
public class frmEmployeeAbsent : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeeAbsent()
	{
		InitializeComponent();
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_Employees_Absent_A.rpt" : "Rep_HR_Employees_Absent_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_Employees_Absent_A_nologo.rpt" : "Rep_HR_Employees_Absent_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Attendance.Reports.frmEmployeeAbsent));
