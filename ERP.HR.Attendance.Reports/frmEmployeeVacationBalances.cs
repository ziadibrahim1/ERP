...
namespace ERP.HR.Attendance.Reports;

public class frmEmployeeVacationBalances : frmReportTree2010
{
	private DataTable dtYears;

	private IContainer components = null;

	public UltraComboEditor cboYear;

	private UltraLabel lblYears;

	public frmEmployeeVacationBalances()
	{
		InitializeComponent();
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "الاجازات" : "Vacations");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_VacationBalances_A.rpt" : "Rep_HR_VacationBalances_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_VacationBalances_A_nologo.rpt" : "Rep_HR_VacationBalances_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Year") && cboYear.SelectedIndex == -1)
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى سنة  ", "There is no chosen Year to be shown in the report, please check Year to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items);
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows.Count != 0 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Year"))
		{
			GlobalVariables.ReportDocument.SetParameterValue("@YearID", ((TextEditorControlBase)cboYear).Value.ToString());
		}
		else if (cboReportType.SelectedIndex > -1 && dtReports.Rows.Count != 0 && !dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Year"))
		{
	...
	{
		UltraLabel obj = lblYears;
		bool visible = (((Control)(object)cboYear).Visible = cboReportType.SelectedIndex > -1 && dtReports.Rows.Count != 0 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Year"));
		((Control)(object)obj).Visible = visible;
		UltraLabel obj2 = ultraLabel1;
		UltraLabel obj3 = ultraLabel2;
		UltraDateTimeEditor obj4 = dtpFromDate;
		bool flag2 = (((Control)(object)dtpToDate).Visible = cboReportType.SelectedIndex > -1 && dtReports.Rows.Count != 0 && !dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Year"));
		bool flag4 = (((Control)(object)obj4).Visible = flag2);
		visible = (((Control)(object)obj3).Visible = flag4);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Attendance.Reports.frmEmployeeVacationBalances));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2016, 1, 11, 0, 0, 0, 0);
		resources.ApplyResources(base.dtpFromDate, "dtpFromDate");
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2016, 1, 11, 0, 0, 0, 0);
		...
		this.cboYear.AutoCompleteMode = (AutoCompleteMode)2;
		resources.ApplyResources(this.cboYear, "cboYear");
		((System.Windows.Forms.Control)(object)this.cboYear).Name = "cboYear";
		((TextEditorControlBase)this.cboYear).Nullable = false;
		resources.ApplyResources(this.lblYears, "lblYears");
		((System.Windows.Forms.Control)(object)this.lblYears).Name = "lblYears";
		resources.ApplyResources(this, "$this");
		base.Controls.Add((System.Windows.Forms.Control)(object)this.cboYear);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblYears);
		base.Name = "frmEmployeeVacationBalances";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblYears, 0);
