...
public class frmShiftsPlansEmployee : frmReportTree2010
{
	private IContainer components = null;

	public frmShiftsPlansEmployee()
	{
		InitializeComponent();
		...
		dtItems2 = ShiftsPlans.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		TreeItems2IDCol = "ShiftPlanID";
		TreeItems2NameCol = "ShiftPlanName";
	}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى خطة عمل  ", "There is no chosen Shift Plan to be shown in the report, please check Shift Plans to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@ShiftPlanIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Attendance.Reports.frmShiftsPlansEmployee));
		...
		base.Name = "frmShiftsPlansEmployee";
