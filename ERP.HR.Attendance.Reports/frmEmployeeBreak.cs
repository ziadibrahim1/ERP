...
public class frmEmployeeBreak : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeeBreak()
	{
		InitializeComponent();
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesAttendance_A.rpt" : "Rep_HR_EmployeesAttendance_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesAttendance_A_nologo.rpt" : "Rep_HR_EmployeesAttendance_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Attendance.Reports.frmEmployeeBreak));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2016, 6, 22, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2016, 6, 22, 0, 0, 0, 0);
