...
public class frmEmployeeExtraTime : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeeExtraTime()
	{
		InitializeComponent();
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_Employees_ExtraTime_A.rpt" : "Rep_HR_Employees_ExtraTime_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_Employees_ExtraTime_A_nologo.rpt" : "Rep_HR_Employees_ExtraTime_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Attendance.Reports.frmEmployeeExtraTime));
		...
		base.Name = "frmEmployeeExtraTime";
