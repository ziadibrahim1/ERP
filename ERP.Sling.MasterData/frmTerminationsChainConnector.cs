...
public class frmTerminationsChainConnector : frmGrid
{
	...
	public frmTerminationsChainConnector()
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_000b: Expected O, but got Unknown
		InitializeComponent();
		TableName = "SLN_TerminationsChainConnector";
		IDCol = "TerminationsChainConnectorID";
	}
	...
	{
		dataTable = TerminationsChainConnector.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationChainConnectorItemID"].Header).Caption = (GlobalVariables.IsArabic ? "الصنف" : "Item");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationChainConnectorItemID"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationChainConnectorItemID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationChainConnectorItemID"].ValueList = (IValueList)(object)vlItems;
	}
	...
	public override void AfterRowActivate()
	{
		...
		((TextEditorControlBase)cboItems).Value = ((UltraGridBase)ULGData).ActiveRow.Cells["TerminationChainConnectorItemID"].Value;
	}
	...
	public override bool ValidateData()
	{
		...
		if (Main.CheckForValue("SLN_TerminationsChainConnector", "TerminationChainConnectorItemID", ((TextEditorControlBase)cboItems).Value.ToString(), Updating ? ((UltraGridBase)ULGData).ActiveRow.Cells["TerminationChainConnectorItemID"].Value.ToString() : "", IsFromServer: true) > 0)
		{
	...
	{
		TerminationsChainConnector.Insert_Update("-1", (cboItems.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboItems).Value.ToString(), ((Control)(object)txtDiameter).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		TerminationsChainConnector.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["TerminationsChainConnectorID"].Value.ToString(), (cboItems.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboItems).Value.ToString(), ((Control)(object)txtDiameter).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		TerminationsChainConnector.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["TerminationsChainConnectorID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.MasterData.frmTerminationsChainConnector));
		...
		base.Name = "frmTerminationsChainConnector";
