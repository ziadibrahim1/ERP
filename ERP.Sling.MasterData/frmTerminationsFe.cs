...
public class frmTerminationsFe : frmGrid
{
	...
	private ValueList vlTerminationTypes = new ValueList();
	...
	private UltraLabel lblTerminationType;

	private UltraComboEditor cboTerminationType;

	public frmTerminationsFe()
	{
		...
		InitializeComponent();
		TableName = "SLN_TerminationsFe";
		IDCol = "TerminationsFeID";
	}
	...
	public override void PrepareData()
	{
		...
		DataView dataView = new DataView(dtTerminationTypes);
		dataView.RowFilter = " TerminationTypeID =1 or  TerminationTypeID =2";
		DataTable dataTable = dataView.ToTable();
		GlobalFunctions.FillCombo(cboTerminationType, dataTable, "TerminationTypeID", "TerminationTypeName");
		vlTerminationTypes.ValueListItems.Clear();
		for (int j = 0; j < dataTable.Rows.Count; j++)
		{
			vlTerminationTypes.ValueListItems.Add(dataTable.Rows[j]["TerminationTypeID"], dataTable.Rows[j]["TerminationTypeName"].ToString());
		}
	}
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)cboTerminationType).ReadOnly = NavMode;
	...
	public override void ClearControls()
	{
		...
		cboTerminationType.SelectedIndex = -1;
	}

	public override void FillData()
	{
		dataTable = TerminationsFe.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Diameter"].Width = (int)((double)((Control)(object)ULGData).Width * 0.25) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationFeItemID"].Header).Caption = (GlobalVariables.IsArabic ? "الصنف" : "Item");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationFeItemID"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationFeItemID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationFeItemID"].ValueList = (IValueList)(object)vlItems;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationTypeID"].Header).Caption = (GlobalVariables.IsArabic ? "النوع" : "Termination Type");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationTypeID"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationTypeID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.25);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TerminationTypeID"].ValueList = (IValueList)(object)vlTerminationTypes;
	}
	...
	public override void AfterRowActivate()
	{
		...
		((TextEditorControlBase)cboItems).Value = ((UltraGridBase)ULGData).ActiveRow.Cells["TerminationFeItemID"].Value;
		((TextEditorControlBase)cboTerminationType).Value = ((UltraGridBase)ULGData).ActiveRow.Cells["TerminationTypeID"].Value;
	}
	...
	public override bool ValidateData()
	{
		...
		if (cboTerminationType.SelectedIndex == -1)
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "برجاء إختيار النوع" : "Please Select Type");
			((TextEditorControlBase)cboTerminationType).Focus();
			cboTerminationType.DropDown();
			return false;
		}
		if (Main.CheckForValue("SLN_TerminationsFe", "TerminationFeItemID", ((TextEditorControlBase)cboItems).Value.ToString(), Updating ? ((UltraGridBase)ULGData).ActiveRow.Cells["TerminationFeItemID"].Value.ToString() : "", IsFromServer: true) > 0)
		{
	...
	{
		TerminationsFe.Insert_Update("-1", (cboItems.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboItems).Value.ToString(), ((Control)(object)txtDiameter).Text, (cboTerminationType.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboTerminationType).Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		TerminationsFe.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["TerminationsFeID"].Value.ToString(), (cboItems.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboItems).Value.ToString(), ((Control)(object)txtDiameter).Text, (cboTerminationType.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboTerminationType).Value.ToString(), bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		TerminationsFe.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["TerminationsFeID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public override void btnRefreshDataClick()
	{
		...
		dtTerminationTypes = TerminationsTypes.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		GlobalFunctions.FillCombo(cboTerminationType, dtTerminationTypes, "TerminationTypeID", "TerminationTypeName");
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.MasterData.frmTerminationsFe));
		...
		this.lblTerminationType = new UltraLabel();
		this.cboTerminationType = new UltraComboEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.cboTerminationType).BeginInit();
		base.SuspendLayout();
		...
		resources.ApplyResources(this.lblTerminationType, "lblTerminationType");
		this.lblTerminationType.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblTerminationType).Name = "lblTerminationType";
		((ControlBase)this.lblTerminationType).WrapText = false;
		resources.ApplyResources(this.cboTerminationType, "cboTerminationType");
		this.cboTerminationType.AutoCompleteMode = (AutoCompleteMode)4;
		((System.Windows.Forms.Control)(object)this.cboTerminationType).Name = "cboTerminationType";
		base.AcceptButton = null;
		resources.ApplyResources(this, "$this");
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblTerminationType);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.cboTerminationType);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.cboTerminationType, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblTerminationType, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.cboTerminationType).EndInit();
