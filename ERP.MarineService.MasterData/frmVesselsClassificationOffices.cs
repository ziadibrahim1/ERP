...
public class frmVesselsClassificationOffices : frmGrid
{
	...
	public frmVesselsClassificationOffices()
	{
		InitializeComponent();
		TableName = "MS_VesselsClassificationOffices";
		IDCol = "VesselClassificationOfficeID";
	}
	...
	{
		((Control)(object)txtCode).Text = (Adding ? VesselsClassificationOffices.GetCode(IsFromServer: true) : "");
	...
	{
		dataTable = VesselsClassificationOffices.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VesselClassificationOfficeCode"].Header).Caption = (GlobalVariables.IsArabic ? "كود " : "code");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VesselClassificationOfficeCode"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VesselClassificationOfficeCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VesselClassificationOfficeNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " اسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VesselClassificationOfficeNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VesselClassificationOfficeNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VesselClassificationOfficeNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "اسم بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VesselClassificationOfficeNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VesselClassificationOfficeNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtCode).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["VesselClassificationOfficeCode"].Value.ToString();
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["VesselClassificationOfficeNameAr"].Value.ToString();
		((Control)(object)txtEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["VesselClassificationOfficeNameEn"].Value.ToString();
	}
	...
	{
		VesselsClassificationOffices.Insert_Update("-1", ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		VesselsClassificationOffices.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["VesselClassificationOfficeID"].Value.ToString(), ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		VesselsClassificationOffices.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["VesselClassificationOfficeID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.MasterData.frmVesselsClassificationOffices));
		...
		base.Name = "frmVesselsClassificationOffices";
