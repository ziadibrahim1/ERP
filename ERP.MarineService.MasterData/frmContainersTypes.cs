...
public class frmContainersTypes : frmGrid
{
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)txtContainerType).ReadOnly = NavMode;
		((TextEditorControlBase)txtContainerType).Focus();
	}

	public override void ClearControls()
	{
		((TextEditorControlBase)txtContainerType).Clear();
	}
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ContainerType"].Header).Caption = (GlobalVariables.IsArabic ? " نوع الحاوية" : "Container Type");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ContainerType"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ContainerType"].Width = ((Control)(object)ULGData).Width - GlobalVariables.ScrollWidth;
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtContainerType).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ContainerType"].Value.ToString();
	}

	public override bool ValidateData()
	{
		if (((Control)(object)txtContainerType).Text == "")
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال نوع الحاوية", "Please Enter Container Type");
			return false;
		}
	...
	{
		ContainersTypes.Insert_Update("-1", ((Control)(object)txtContainerType).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		ContainersTypes.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["ContainerTypeID"].Value.ToString(), ((Control)(object)txtContainerType).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.MasterData.frmContainersTypes));
