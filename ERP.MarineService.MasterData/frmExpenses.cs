...
public class frmExpenses : frmGrid
{
	...
	private UltraCheckEditor chkEDHS;
	...
	public override void SetControls(bool NavMode)
	{
		...
		((Control)(object)chkEDHS).Enabled = !NavMode;
	...
	public override void ClearControls()
	{
		...
		((UltraToggleEditorBase)chkEDHS).Checked = false;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsEDHS"].Header).Caption = (GlobalVariables.IsArabic ? "EDHS" : "EDHS");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsEDHS"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsEDHS"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
	}
	...
	public override void AfterRowActivate()
	{
		...
		((UltraToggleEditorBase)chkEDHS).Checked = bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["IsEDHS"].Value.ToString());
	}
	...
	{
		Expenses.Insert_Update("-1", ((Control)(object)txtExpenseArabicName).Text, (((Control)(object)txtExpenseEnglishName).Text == "") ? "Null" : ((Control)(object)txtExpenseEnglishName).Text, ((TextEditorControlBase)cboExpenseAccount).Value.ToString(), (cboExpenseSubAccount.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboExpenseSubAccount).Value.ToString(), ((UltraToggleEditorBase)chkEDHS).Checked ? "1" : "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		Expenses.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["ExpenseID"].Value.ToString(), ((Control)(object)txtExpenseArabicName).Text, (((Control)(object)txtExpenseEnglishName).Text == "") ? "Null" : ((Control)(object)txtExpenseEnglishName).Text, ((TextEditorControlBase)cboExpenseAccount).Value.ToString(), (cboExpenseSubAccount.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboExpenseSubAccount).Value.ToString(), ((UltraToggleEditorBase)chkEDHS).Checked ? "1" : "0", ((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString().Equals("True") ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.MasterData.frmExpenses));
		...
		this.chkEDHS = new UltraCheckEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.chkEDHS).BeginInit();
		base.SuspendLayout();
		...
		resources.ApplyResources(this.chkEDHS, "chkEDHS");
		((System.Windows.Forms.Control)(object)this.chkEDHS).Name = "chkEDHS";
		base.AcceptButton = null;
		resources.ApplyResources(this, "$this");
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkEDHS);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkEDHS, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.chkEDHS).EndInit();
