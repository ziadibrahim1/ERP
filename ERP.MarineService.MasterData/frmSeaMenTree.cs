...
public class frmSeaMenTree : frmTree2
{
	...
	private UltraComboEditor cboSeaMenRanks;

	private UltraLabel lblSeaManRank;
	...
	public override void PrepareData()
	{
		if (TableName != "" && LevelsTable != "")
		{
			...
			dtChart = SubAccounts.FillTreeBySubAccountTypeIDs(GlobalVariables.SeaManSubAccountTypeIDs, "-1", IsFromServer: true);
		...
		dtSubAccountType = SuAccountsTypes.SelectBySuAccountsTypeIDs(GlobalVariables.SeaManSubAccountTypeIDs, GlobalVariables.IsArabic ? "1" : "0");
		...
		dtSeaMenRanks = SeaMenRanks.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		GlobalFunctions.FillCombo(cboSeaMenRanks, dtSeaMenRanks, "SeaManRankID", "SeaManRankName");
	...
	public override void ClearControls()
	{
		...
		if (Adding)
		{
			...
			((Control)(object)txtNo).Text = SeaMen.GetCode(IsFromServer: true);
			((TextEditorControlBase)cboType).Value = 12;
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)cboSeaMenRanks).ReadOnly = NavMode;
	...
	public override void DisplayData()
	{
		...
		if (SelectedNode != null)
		{
			...
			((TextEditorControlBase)cboSeaMenRanks).Clear();
	...
	public void DisplaySeaManData()
	{
		SeaMan = "-1";
		DataTable dataTable = SeaMen.SelectBySubAccountID(((KeyedSubObjectBase)SelectedNode).Key, GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		if (dataTable.Rows.Count > 0)
		{
			DataRow dataRow = dataTable.Rows[0];
			SeaMan = dataRow["SeaManID"].ToString();
			((TextEditorControlBase)cboTitle).Value = dataRow["TitleID"];
			dtpBirthDate.Value = dataRow["BirthDate"];
			((Control)(object)txtNo).Text = dataRow["SeaManNo"].ToString();
			...
			((TextEditorControlBase)cboSeaMenRanks).Value = dataRow["SeaManRankID"].ToString();
	...
	public override int TreeAddData()
	{
		...
		try
		{
			...
			SeaMen.Insert_Update("-1", (((Control)(object)txtNo).Text == "") ? GetCode() : ((Control)(object)txtNo).Text, result.ToString(), (cboTitle.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboTitle).Value.ToString(), dtpBirthDate.DateTime.ToString(GlobalVariables.DateShortFormate), (cboCountry.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboCountry).Value.ToString(), (cboCity.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboCity).Value.ToString(), (cboArea.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboArea).Value.ToString(), (cboNationality.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboNationality).Value.ToString(), ((Control)(object)txtPassportNo).Text, dtpPassportIssueDate.DateTime.ToString(GlobalVariables.DateShortFormate), dtpPassportExpireDate.DateTime.ToString(GlobalVariables.DateShortFormate), ((Control)(object)txtCDCNo).Text, dtpCDCIssueDate.DateTime.ToString(GlobalVariables.DateShortFormate), dtpCDCExpireDate.DateTime.ToString(GlobalVariables.DateShortFormate), ((Control)(object)txtIDNo).Text, dtpIDIssueDate.DateTime.ToString(GlobalVariables.DateShortFormate), ((Control)(object)txtAddress).Text, ((Control)(object)txtTel).Text, ((Control)(object)txtFax).Text, ((Control)(object)txtMobile).Text, ((Control)(object)txtMobile2).Text, ((Control)(object)txtEMail).Text, (cboDefaultAcc.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboDefaultAcc).Value.ToString(), ((Control)(object)txtTaxNo).Text, ((Control)(object)txtNotes).Text, (cboSeaMenRanks.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSeaMenRanks).Value.ToString(), "0", (cboBranch.SelectedIndex == -1) ? GlobalVariables.CurrentBranchID : ((TextEditorControlBase)cboBranch).Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	...
	public override void TreeDeleteData()
	{
		...
		try
		{
			SeaMen.DeleteBySubAccountID(((KeyedSubObjectBase)SelectedNode).Key, GlobalVariables.UserID, IsFromServer: true);
			SubAccounts_Details.DeleteBySubAccountID(((KeyedSubObjectBase)SelectedNode).Key, GlobalVariables.UserID, IsFromServer: true);
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("من فضلك ادخل الحساب الإفتراضي للبحار", "Enter Default SeaMan Account");
			((UltraTabControlBase)tabItemType).SelectedTab = ((UltraTabControlBase)tabItemType).Tabs["SeaMan"];
	...
	{
		int num = SearchFunctions.SeaMenSearch("-1", IsFromServer: true);
		if (num != 0)
		{
	...
	{
		GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_MS_SeaMen_A.rpt" : "Rep_MS_SeaMen_E.rpt"));
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.MasterData.frmSeaMenTree));
		...
		this.cboSeaMenRanks = new UltraComboEditor();
		this.lblSeaManRank = new UltraLabel();
		...
		((System.ComponentModel.ISupportInitialize)this.cboSeaMenRanks).BeginInit();
		...
		((System.Windows.Forms.Control)(object)this.tabItem).Controls.Add((System.Windows.Forms.Control)(object)this.cboSeaMenRanks);
		((System.Windows.Forms.Control)(object)this.tabItem).Controls.Add((System.Windows.Forms.Control)(object)this.lblSeaManRank);
		...
		resources.ApplyResources(val2, "appearance31");
		...
		resources.ApplyResources(val3, "appearance32");
		...
		resources.ApplyResources(val4, "appearance33");
		...
		resources.ApplyResources(val5, "appearance34");
		...
		resources.ApplyResources(val6, "appearance35");
		...
		resources.ApplyResources(val7, "appearance36");
		...
		resources.ApplyResources(val8, "appearance37");
		...
		resources.ApplyResources(val9, "appearance38");
		...
		resources.ApplyResources(this.cboSeaMenRanks, "cboSeaMenRanks");
		this.cboSeaMenRanks.AutoCompleteMode = (AutoCompleteMode)4;
		((System.Windows.Forms.Control)(object)this.cboSeaMenRanks).Name = "cboSeaMenRanks";
		resources.ApplyResources(this.lblSeaManRank, "lblSeaManRank");
		((AppearanceBase)val10).BackColor = System.Drawing.Color.Transparent;
		((AppearanceBase)val10).ForeColor = System.Drawing.Color.Navy;
		resources.ApplyResources(val10, "appearance39");
		((ControlBase)this.lblSeaManRank).Appearance = (AppearanceBase)(object)val10;
		this.lblSeaManRank.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblSeaManRank).Name = "lblSeaManRank";
		((ControlBase)this.lblSeaManRank).WrapText = false;
		...
		this.cboDefaultAcc.AutoCompleteMode = (AutoCompleteMode)4;
		...
		((ControlBase)this.lblClientAccount).Appearance = (AppearanceBase)(object)val12;
		...
		resources.ApplyResources(val13, "appearance42");
		...
		((ControlBase)this.lblBirthDate).Appearance = (AppearanceBase)(object)val15;
		...
		((ControlBase)this.lblCountry).Appearance = (AppearanceBase)(object)val16;
		...
		((ControlBase)this.lblClintSupplierTitle).Appearance = (AppearanceBase)(object)val17;
		...
		((ControlBase)this.lblMobile2).Appearance = (AppearanceBase)(object)val18;
		...
		((ControlBase)this.lblReorder).Appearance = (AppearanceBase)(object)val19;
		...
		((ControlBase)this.lblArea).Appearance = (AppearanceBase)(object)val20;
		...
		((ControlBase)this.lblMax).Appearance = (AppearanceBase)(object)val22;
		...
		((ControlBase)this.lblEMail).Appearance = (AppearanceBase)(object)val23;
		...
		((ControlBase)this.lblCity).Appearance = (AppearanceBase)(object)val24;
		...
		((ControlBase)this.lblAddress).Appearance = (AppearanceBase)(object)val25;
		...
		((ControlBase)this.lblNotes).Appearance = (AppearanceBase)(object)val26;
		...
		val27.NodeStyle = (NodeStyle)1;
		this.TreeAccounts.Override = val27;
		...
		((AppearanceBase)val28).Image = ERP.Properties.Resources.search;
		resources.ApplyResources(val28, "appearance56");
		((ControlBase)this.btnItemsSearch).Appearance = (AppearanceBase)(object)val28;
		...
		((ControlBase)this.lblType).Appearance = (AppearanceBase)(object)val29;
		...
		((AppearanceBase)val30).TextTrimming = (TextTrimming)6;
		((UltraTabControlBase)this.tabItemType).Appearance = (AppearanceBase)(object)val30;
		...
		((KeyedSubObjectBase)val31).Key = "SeaMan";
		val31.TabPage = this.tabItem;
		resources.ApplyResources(val31, "ultraTab2");
		((SubObjectBase)val31).ForceApplyResources = "";
		((KeyedSubObjectBase)val32).Key = "Accounts";
		val32.TabPage = this.tabService;
		resources.ApplyResources(val32, "ultraTab1");
		((SubObjectBase)val32).ForceApplyResources = "";
		((UltraTabControlBase)this.tabItemType).Tabs.AddRange((UltraTab[])(object)new UltraTab[2] { val31, val32 });
		...
		resources.ApplyResources(val33, "appearance58");
		((ControlBase)this.lblBranch).Appearance = (AppearanceBase)(object)val33;
		...
		((System.ComponentModel.ISupportInitialize)this.cboSeaMenRanks).EndInit();
