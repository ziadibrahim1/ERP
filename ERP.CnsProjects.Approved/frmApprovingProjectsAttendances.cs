...
public class frmApprovingProjectsAttendances : frmPosted
{
	private IContainer components = null;

	public frmApprovingProjectsAttendances()
	{
		InitializeComponent();
	...
	{
		dtsource = ProjectsAttendances.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			ProjectsAttendances.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا يوجد حضور لإعتماده " : "There are No Attendance to be Approved");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.CnsProjectAttendanceReport(0, 0, IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CnsProjects.Approved.frmApprovingProjectsAttendances));
		...
		base.Name = "frmApprovingProjectsAttendances";
