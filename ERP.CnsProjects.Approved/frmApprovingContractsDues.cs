...
public class frmApprovingContractsDues : frmPosted
{
	private IContainer components = null;

	public frmApprovingContractsDues()
	{
		InitializeComponent();
	...
	{
		dtsource = ContractsDues.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			ContractsDues.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا يوجد مستخلصات لإعتمادها " : "There are No Contract Dues to be Approved");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.CnsContractsDuesReport(0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CnsProjects.Approved.frmApprovingContractsDues));
		...
		base.Name = "frmApprovingContractsDues";
