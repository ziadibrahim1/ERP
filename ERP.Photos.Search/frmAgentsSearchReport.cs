...
public class frmAgentsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmAgentsSearchReport()
	{
		InitializeComponent();
	}

	public frmAgentsSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["AgentNumber"].Width = (int)((double)((Control)(object)ULGData).Width * 0.18) - GlobalVariables.ScrollWidth;
