...
public class frmItemsCatalogeSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmItemsCatalogeSearchReport()
	{
		InitializeComponent();
	}

	public frmItemsCatalogeSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemCatalogeNumber"].Width = (int)((double)((Control)(object)ULGData).Width * 0.18) - GlobalVariables.ScrollWidth;
