...
public class frmTrackSalesMan : frmReportTree2010
{
	...
	public frmTrackSalesMan()
	{
		...
		((Control)(object)lblReportType).Visible = (((Control)(object)cboReportType).Visible = (((Control)(object)btnNew).Visible = (((Control)(object)btnUpdate).Visible = (((Control)(object)btnDelete).Visible = (((Control)(object)chkIsArabic).Visible = (((Control)(object)chkWithLogo).Visible = false))))));
	}
	...
	public override void ShowReport()
	{
		...
		DataTable visitdata = OrdersDetails.SelectForGMaps(Branches, Items, Items2, Items3, dtpFromDate.DateTime.ToString(GlobalVariables.DateLongFormate), dtpToDate.DateTime.ToString(GlobalVariables.DateLongFormate), GlobalVariables.IsArabic ? "1" : "0");
		GMaps gMaps = new GMaps(visitdata);
		gMaps.Size = new Size(Screen.PrimaryScreen.WorkingArea.Width, Screen.PrimaryScreen.WorkingArea.Height);
		gMaps.Tag = base.Tag;
		gMaps.Location = new Point(0, 0);
		gMaps.ShowDialog();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.DirectSalesApp.Reports.frmTrackSalesMan));
