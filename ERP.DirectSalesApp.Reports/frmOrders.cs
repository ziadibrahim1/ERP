...
public class frmOrders : frmReportTree2010
{
	...
	public frmOrders()
	{
		...
		TreeItems2IDCol = "OrderID";
		TreeItems2NameCol = "OrderNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = Orders.FillRepTree(Branches, Items, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى امر ليتم عرضه ", "There is no chosen Order Of Visits to be shown in the report, please check Order Of Visits to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@OrderIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.DirectSalesApp.Reports.frmOrders));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2021, 3, 14, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2021, 3, 14, 0, 0, 0, 0);
