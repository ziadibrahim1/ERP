...
public class frmShiftsPlansSearch : frmSearch
{
	private IContainer components = null;

	public frmShiftsPlansSearch()
	{
		InitializeComponent();
	}

	public frmShiftsPlansSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ShiftPlanNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.25);
