...
public class frmSalesNotIssued : frmReportTree2010
{
	private IContainer components = null;

	public frmSalesNotIssued()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "الفواتير لم تصرف بالكامل" : "Invoices Not Issued");
	}
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_SLInvoicesNotIssued_A.rpt" : "Rep_SL_SLInvoicesNotIssued_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_SLInvoicesNotIssued_A_nologo.rpt" : "Rep_SL_SLInvoicesNotIssued_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Reports.frmSalesNotIssued));
