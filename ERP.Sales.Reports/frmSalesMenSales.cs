...
public class frmSalesMenSales : frmReportTree2010
{
	private IContainer components = null;

	public frmSalesMenSales()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى رجل بيع  ", "There is no choosen SalesMan to be shown in the report, please check SalesMen to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@SalesMenSubAccountIDs", Items);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Reports.frmSalesMenSales));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2016, 9, 8, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2016, 9, 8, 0, 0, 0, 0);
