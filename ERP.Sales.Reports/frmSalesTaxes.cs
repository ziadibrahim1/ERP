...
public class frmSalesTaxes : frmReportTree2010
{
	private IContainer components = null;

	public frmSalesTaxes()
	{
		dtItems = Taxs.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItemsParentIDCol = "ParentID";
		TreeItemsIDCol = "TaxID";
		TreeItemsNameCol = (GlobalVariables.IsArabic ? "TaxNameAr" : "TaxNameEn");
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "ضرائب المبيعات" : "Sales Taxes");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_SalesTax_A.rpt" : "Rep_SL_SalesTax_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_SalesTax_A_nologo.rpt" : "Rep_SL_SalesTax_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى ضريبه  ", "There is no choosen Tax to be shown in the report, please check Taxes to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@TaxIDs", Items);
	...
	{
		dtSearchResult = SearchFunctions.TaxsReport(IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Reports.frmSalesTaxes));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2022, 12, 26, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2022, 12, 26, 0, 0, 0, 0);
