...
public class frmClientSupplierStatementRep : frmReportTree2010
{
	private bool UseCurrency;

	private IContainer components = null;

	public frmClientSupplierStatementRep()
	{
		UseCurrency = int.Parse(Main.ExecuteQuery_DataTable("Select Count(*) as SA from Currency ").Rows[0][0].ToString()) > 1;
		dtItems = SubAccounts.FillReportTreeBySubAccountTypeIDs(",5,", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	{
		dtSearchResult = SearchFunctions.SubAccountsBySubAccountTypeIDsReport(",5,", "-1", IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Reports.frmClientSupplierStatementRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2017, 12, 12, 0, 0, 0, 0);
		resources.ApplyResources(base.dtpFromDate, "dtpFromDate");
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2017, 12, 12, 0, 0, 0, 0);
		...
		base.Name = "frmClientSupplierStatementRep";
