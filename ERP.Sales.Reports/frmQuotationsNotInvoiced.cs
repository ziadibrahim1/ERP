...
public class frmQuotationsNotInvoiced : frmReportTree2010
{
	private IContainer components = null;

	public frmQuotationsNotInvoiced()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "عروض اسعار ليست لها فواتير" : "Quotations Not Invoiced");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_QuotationsNotInvoiced_A.rpt" : "Rep_SL_QuotationsNotInvoiced_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_QuotationsNotInvoiced_A_nologo.rpt" : "Rep_SL_QuotationsNotInvoiced_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Reports.frmQuotationsNotInvoiced));
		...
		base.Name = "frmQuotationsNotInvoiced";
