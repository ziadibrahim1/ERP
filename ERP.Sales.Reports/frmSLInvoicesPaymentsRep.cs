...
public class frmSLInvoicesPaymentsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmSLInvoicesPaymentsRep()
	{
		...
		TreeItems2IDCol = "SLInvoicePaymentID";
		TreeItems2NameCol = "SLInvoicePaymentNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = SLInvoicesPayments.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@SLInvoicePaymentIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Reports.frmSLInvoicesPaymentsRep));
		...
		base.Name = "frmSLInvoicesPaymentsRep";
