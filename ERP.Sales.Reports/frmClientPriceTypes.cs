...
public class frmClientPriceTypes : frmReportTree2010
{
	private IContainer components = null;

	public frmClientPriceTypes()
	{
	...
	{
		return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_A_SubAccountsPriceTypes_A.rpt" : "Rep_A_SubAccountsPriceTypes_E.rpt");
	}
	...
	public override void ShowReport()
	{
		...
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مجموعه سعريه  ", "There is no chosen Price Type to be shown in the report, please check items to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Reports.frmClientPriceTypes));
