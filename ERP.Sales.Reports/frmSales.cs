...
public class frmSales : frmReportTree2010
{
	...
	public frmSales()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "مبيعات الأصناف تفصيلي" : "Item Sales Detailed");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? "مبيعات الأصناف إجمالي" : "Item Sales Summary");
		if (GlobalFunctions.GetOption("UsingBatchNoAndValidityPeriod"))
		{
			cboReportType.Items.Add((object)3, GlobalVariables.IsArabic ? "مبيعات الأصناف إجمالي لكل تشغيله" : "Item Sales Summary For Each Batch No.");
		}
		cboReportType.Items.Add((object)4, GlobalVariables.IsArabic ? "مبيعات العميل تفصيلي" : "Client Sales Detailed");
		cboReportType.Items.Add((object)5, GlobalVariables.IsArabic ? "مبيعات العميل تفصيلي مجمع بالصنف" : "Client Sales Detailed Group By Item");
		cboReportType.Items.Add((object)6, GlobalVariables.IsArabic ? "يومية المبيعات" : "Sales Journal");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ItemsSalesDetails_A.rpt" : "Rep_SL_ItemsSalesDetails_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ItemsSalesDetails_A_nologo.rpt" : "Rep_SL_ItemsSalesDetails_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ItemsSales_A.rpt" : "Rep_SL_ItemsSales_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ItemsSales_A_nologo.rpt" : "Rep_SL_ItemsSales_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "3")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ItemsSalesByBatchNo_A.rpt" : "Rep_SL_ItemsSalesByBatchNo_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ItemsSalesByBatchNo_A_nologo.rpt" : "Rep_SL_ItemsSalesByBatchNo_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "4")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ClientSalesDetails_A.rpt" : "Rep_SL_ClientSalesDetails_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ClientSalesDetails_A_nologo.rpt" : "Rep_SL_ClientSalesDetails_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "5")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ClientSalesGroupByItem_A.rpt" : "Rep_SL_ClientSalesGroupByItem_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_ClientSalesGroupByItem_A_nologo.rpt" : "Rep_SL_ClientSalesGroupByItem_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "6")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_SLInvoicesPolicySummary_A.rpt" : "Rep_SL_SLInvoicesPolicySummary_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SL_SLInvoicesPolicySummary_A.rpt" : "Rep_SL_SLInvoicesPolicySummary_E.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Reports.frmSales));
