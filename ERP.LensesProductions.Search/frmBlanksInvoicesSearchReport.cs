...
public class frmBlanksInvoicesSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmBlanksInvoicesSearchReport()
	{
		InitializeComponent();
	}

	public frmBlanksInvoicesSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BlankInvoiceDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الاذن" : "Date");
