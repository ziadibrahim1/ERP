...
public class frmSalesQuotations : frmReportTree2010
{
	private IContainer components = null;

	public frmSalesQuotations()
	{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_Production_Quotations_A.rpt" : "Rep_Pro_Production_Quotations_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_Production_Quotations_A_nologo.rpt" : "Rep_Pro_Production_Quotations_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmSalesQuotations));
