...
public class frmMaintenanceTracing : frmReportTree2010
{
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@SentToMaintenance", ((UltraToggleEditorBase)chkSentToMaintenance).Checked ? "1" : "0");
		GlobalVariables.ReportDocument.SetParameterValue("@MaintenanceReceived", ((UltraToggleEditorBase)chkMaintenanceReceived).Checked ? "1" : "0");
		GlobalVariables.ReportDocument.SetParameterValue("@SentToBranch", ((UltraToggleEditorBase)chkSentToBranch).Checked ? "1" : "0");
		GlobalVariables.ReportDocument.SetParameterValue("@BranchReceived", ((UltraToggleEditorBase)chkBranchReceived).Checked ? "1" : "0");
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmMaintenanceTracing));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 9, 17, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 9, 17, 0, 0, 0, 0);
		...
		base.Name = "frmMaintenanceTracing";
