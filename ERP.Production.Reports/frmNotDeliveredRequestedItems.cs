...
public class frmNotDeliveredRequestedItems : frmReportTree2010
{
	private IContainer components = null;

	public frmNotDeliveredRequestedItems()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "اصناف غير مسلمة للعميل " : "Not Delivered Requested Items");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ProductionRequestsDetails_NotDelevered_A.rpt" : "Rep_Pro_ProductionRequestsDetails_NotDelevered_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ProductionRequestsDetails_NotDelevered_A_nologo.rpt" : "Rep_Pro_ProductionRequestsDetails_NotDelevered_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmNotDeliveredRequestedItems));
		...
		base.Name = "frmNotDeliveredRequestedItems";
