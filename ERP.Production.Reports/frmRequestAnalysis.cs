...
public class frmRequestAnalysis : frmReportTree2010
{
	private IContainer components = null;

	public frmRequestAnalysis()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "تحليل الخامات للطلبيات " : "Expecting Materials Production Requestes");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ProductionRequests_Analysis_A.rpt" : "Rep_Pro_ProductionRequests_Analysis_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ProductionRequests_Analysis_A_nologo.rpt" : "Rep_Pro_ProductionRequests_Analysis_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmRequestAnalysis));
