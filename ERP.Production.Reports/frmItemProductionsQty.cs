...
public class frmItemProductionsQty : frmReportTree2010
{
	private IContainer components = null;

	public frmItemProductionsQty()
	{
		TreeItemsParentIDCol = "ParentID";
		TreeItemsIDCol = "LineID";
		TreeItemsNameCol = "LineName";
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "الكمية المنتجة للاصناف " : "Item Production Quantity");
	...
	{
		base.FormLoad();
		dtItems = Lines.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		dtItems2 = BusinessLayer.StockControl.Items.FillTree("-1", "-1", "0", "-1", "-1", "0", "1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		if (dtItems != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ItemProductionsQty_A.rpt" : "Rep_Pro_ItemProductionsQty_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ItemProductionsQty_A_nologo.rpt" : "Rep_Pro_ItemProductionsQty_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى خط ليتم عرضه ", "There is no chosen Line to be shown in the report, please check Lines to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى صنف ليتم عرضه ", "There is no chosen Item to be shown in the report, please check Items to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@BranchIDs", Branches);
		GlobalVariables.ReportDocument.SetParameterValue("@LineIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@ItemIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmItemProductionsQty));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2019, 2, 3, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2019, 2, 3, 0, 0, 0, 0);
		...
		base.Name = "frmItemProductionsQty";
