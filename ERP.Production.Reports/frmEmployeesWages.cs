...
public class frmEmployeesWages : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeesWages()
	{
	...
	{
		GetBranches();
		dtItems2 = Employees.FillCombo(GlobalVariables.EmployeeSubAccountTypeIDs, "-1", "-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى عامل ليتم عرضه ", "There is no chosen Worker to be shown in the report, please check Workers to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmEmployeesWages));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 9, 9, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 9, 9, 0, 0, 0, 0);
