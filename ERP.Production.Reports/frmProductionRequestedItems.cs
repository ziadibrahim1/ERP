...
public class frmProductionRequestedItems : frmReportTree2010
{
	private IContainer components = null;

	public frmProductionRequestedItems()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "اصناف مطلوب إنتاجها " : "Production Requested Items");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? "اصناف مطلوب إنتاجها مجمع بالصنف " : "Production Requested Items Group BY Item");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ProductionRequestsDetails_NotInProduction_A.rpt" : "Rep_Pro_ProductionRequestsDetails_NotInProduction_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ProductionRequestsDetails_NotInProduction_A_nologo.rpt" : "Rep_Pro_ProductionRequestsDetails_NotInProduction_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ProductionRequestsDetails_NotInProductionByItem_A.rpt" : "Rep_Pro_ProductionRequestsDetails_NotInProductionByItem_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ProductionRequestsDetails_NotInProductionByItem_A_nologo.rpt" : "Rep_Pro_ProductionRequestsDetails_NotInProductionByItem_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@ProductionRequestIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmProductionRequestedItems));
		...
		base.Name = "frmProductionRequestedItems";
