...
public class frmItemsCatalogeCostRep : frmReportTree2010
{
	private IContainer components = null;

	public frmItemsCatalogeCostRep()
	{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ItemsCataloge_ExpectedCost_A.rpt" : "Rep_Pro_ItemsCataloge_ExpectedCost_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ItemsCataloge_ExpectedCost_A_nologo.rpt" : "Rep_Pro_ItemsCataloge_ExpectedCost_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى وصفة انتاج ليتم عرضه ", "There is no chosen item catalog to be shown in the report, please check items catalogs to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmItemsCatalogeCostRep));
		...
		base.Name = "frmItemsCatalogeCostRep";
