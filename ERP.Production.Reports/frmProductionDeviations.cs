...
public class frmProductionDeviations : frmReportTree2010
{
	private IContainer components = null;

	public frmProductionDeviations()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "ProductionID";
		TreeItems2NameCol = "ProductionNo";
		TreeItems2IsMainCol = "IsMain";
		TreeItemsIDCol = "ItemCatalogeID";
		TreeItemsNameCol = "ItemCatalogeName";
		InitializeComponent();
	}

	public override void FormLoad()
	{
		dtItems = ItemsCataloge.FillRepTree(((UltraToggleEditorBase)chkIsArabic).Checked ? "1" : "0", IsFromServer: false);
		if (dtItems != null)
		{
	...
	{
		GetBranches();
		dtItems2 = Productions.FillRepTree(Branches, "-1", dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى وصفة انتاج ليتم عرضها ", "There is no chosen Item Catalog to be shown in the report, please check Item Catalog to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@ItemCatalogeIDs", Items);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmProductionDeviations));
		...
		base.Name = "frmProductionDeviations";
