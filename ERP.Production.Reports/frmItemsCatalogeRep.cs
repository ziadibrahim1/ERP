...
public class frmItemsCatalogeRep : frmReportTree2010
{
	private IContainer components = null;

	public frmItemsCatalogeRep()
	{
		TreeItems2IDCol = "ItemCatalogeID";
		TreeItems2NameCol = "ItemCatalogeName";
		InitializeComponent();
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "طباعه كل التفاصيل " : "Print All Details");
	...
	{
		dtItems2 = ItemsCataloge.FillRepTree(((UltraToggleEditorBase)chkIsArabic).Checked ? "1" : "0", IsFromServer: false);
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ItemsCataloge_A.rpt" : "Rep_Pro_ItemsCataloge_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Pro_ItemsCataloge_A_nologo.rpt" : "Rep_Pro_ItemsCataloge_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى إذن ليتم عرضه ", "There is no chosen Voucher to be shown in the report, please check Vouchers to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@ItemCatalogeIDs", Items2);
		GlobalVariables.ReportDocument.SetParameterValue("@IsArabic", ((UltraToggleEditorBase)chkIsArabic).Checked);
		GlobalVariables.ReportDocument.SetParameterValue("@ItemCatalogeIDs", Items2, "Rep_Pro_ItemsCatalogeInput");
		GlobalVariables.ReportDocument.SetParameterValue("@IsoCode", text);
		GlobalVariables.ReportDocument.SetParameterValue("@IsArabic", ((UltraToggleEditorBase)chkIsArabic).Checked, "Rep_Pro_ItemsCatalogeInput");
	...
	{
		dtSearchResult = SearchFunctions.ItemsCatalogeReport(IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmItemsCatalogeRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2014, 12, 29, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2014, 12, 29, 0, 0, 0, 0);
