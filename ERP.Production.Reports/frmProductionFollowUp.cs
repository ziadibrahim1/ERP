...
public class frmProductionFollowUp : frmReportTree2010
{
	private IContainer components = null;

	public frmProductionFollowUp()
	{
	...
	{
		dtSearchResult = SearchFunctions.LinesReport(IsFromServer: false);
		for (int i = 0; i < dtSearchResult.Rows.Count; i++)
		{
			TreeItems.GetNodeByKey(dtSearchResult.Rows[i]["LineID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Reports.frmProductionFollowUp));
		...
		base.Name = "frmProductionFollowUp";
