...
public class frmProductSentToMaintenance : frmPosted
{
	private IContainer components = null;

	public frmProductSentToMaintenance()
	{
		InitializeComponent();
	...
	{
		dtsource = ProductMaintenance.SelectBySentToMaintenance(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentToMaintenanceDriverName"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentToMaintenanceDriverName"].Header).Caption = (GlobalVariables.IsArabic ? "السائق" : "Sent To Maintenance by Driver");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentToMaintenanceDriverName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentToMaintenance"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentToMaintenance"].Header).Caption = "";
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentToMaintenance"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentToMaintenance"].AllowRowFiltering = (DefaultableBoolean)2;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentToMaintenance"].Header.CheckBoxVisibility = (HeaderCheckBoxVisibility)2;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SentToMaintenance"].Header.CheckBoxAlignment = (HeaderCheckBoxAlignment)2;
	}

	public override void SelectFullRow()
	{
		if (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key != "SentToMaintenance" && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key != "SentToMaintenanceDriverName" && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key != "SentToMaintenanceDate")
		{
	...
	public override void SaveData()
	{
		...
		{
			if (((UltraGridBase)ULGData).Rows[i].Cells["SentToMaintenance"].Value.Equals(true))
			{
				...
				ProductMaintenance.SetSentToMaintenance(productMaintenanceID, "1", ((UltraGridBase)ULGData).Rows[i].Cells["SentToMaintenanceDate"].Value.ToString(), ((UltraGridBase)ULGData).Rows[i].Cells["SentToMaintenanceDriverName"].Value.ToString(), GlobalVariables.UserID);
			}
		}
		if (text != ",")
		{
	...
	{
		DataTable dataTable = SearchFunctions.ProductMaintenanceReport(0, 0, 0, 0, 0, 0);
		for (int i = 0; i < dataTable.Rows.Count; i++)
		{
			for (int j = 0; j < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; j++)
			{
				...
				{
					((UltraGridBase)ULGData).Rows[j].Cells["SentToMaintenance"].Value = true;
				}
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Production.Transactions.frmProductSentToMaintenance));
