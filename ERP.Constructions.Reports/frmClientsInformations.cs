...
public class frmClientsInformations : frmReportTree2010
{
	private IContainer components = null;

	public frmClientsInformations()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "طباعه ملف العملاء" : "Print Clients Informations");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Con_ClientsInformations_A.rpt" : "Rep_Con_ClientsInformations_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Con_ClientsInformations_A_nologo.rpt" : "Rep_Con_ClientsInformations_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مبنى ليتم عرضه ", "There is no choosen Building to be shown in the report, please check Building to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Constructions.Reports.frmClientsInformations));
		...
		base.Name = "frmClientsInformations";
