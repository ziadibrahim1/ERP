...
public class frmPayedInstallments : frmReportTree2010
{
	...
	public frmPayedInstallments()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "الدفعات المستلمة " : " Payed Installments ");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Con_PayedInstallments_A.rpt" : "Rep_Con_PayedInstallments_E.rpt");
			}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Constructions.Reports.frmPayedInstallments));
		...
		base.Name = "frmPayedInstallments";
