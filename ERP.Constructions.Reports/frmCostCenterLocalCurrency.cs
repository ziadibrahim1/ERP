...
public class frmCostCenterLocalCurrency : frmReportTree2010
{
	private IContainer components = null;

	public frmCostCenterLocalCurrency()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "كشف حساب مركز تكلفة " : " Cost Center Statement ");
	...
	public override string GetReportName()
	{
		...
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_A_CostCenterLocalCurrency_A.rpt" : "Rep_A_CostCenterLocalCurrency_E.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مركز تكلفة  ", "There is no choosen Cost Center to be shown in the report, please check Cost Center to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Constructions.Reports.frmCostCenterLocalCurrency));
		...
		base.Name = "frmCostCenterLocalCurrency";
