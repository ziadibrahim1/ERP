...
public class frmBuildingsUnitsInformation : frmReportTree2010
{
	private IContainer components = null;

	public frmBuildingsUnitsInformation()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "BuildingID";
		TreeItems2NameCol = "BuildingNo";
		TreeItems2IsMainCol = "IsMain";
		InitializeComponent();
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "بيانات وحدات المبانى " : " Buildings Units Informations ");
		cboReportType.SelectedIndex = 0;
	}

	public override void FormLoad()
	{
		dtItems2 = Buildings.FillRepTree(GlobalVariables.IsArabic ? "1" : "0");
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Con_BuildingsUnitsInformationByBuilding_A.rpt" : "Rep_Con_BuildingsUnitsInformationByBuilding_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Con_BuildingsUnitsInformationByBuilding_A_nologo.rpt" : "Rep_Con_BuildingsUnitsInformationByBuilding_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مبنى  ", "There is no choosen Building to be shown in the report, please check Building to be shown in report");
			return;
		}
		string text = "";
		for (int i = 0; i < ((DisposableObjectCollectionBase)TreeItems2.Nodes).Count; i++)
		{
			...
			{
				text = text + TreeItems2.Nodes[i].Text + " , ";
			}
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@BuildingIDs", Items2);
		GlobalVariables.ReportDocument.SetParameterValue("@BuildingsNames", text);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Constructions.Reports.frmBuildingsUnitsInformation));
		...
		base.Name = "frmBuildingsUnitsInformation";
