...
public class frmClientStatement : frmReportTree2010
{
	...
	public frmClientStatement()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "كشف حساب العميل " : " Client Statement ");
	...
	public override string GetReportName()
	{
		...
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Con_ContractsInstallments_A.rpt" : "Rep_Con_ContractsInstallments_A.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Constructions.Reports.frmClientStatement));
		...
		base.Name = "frmClientStatement";
		base.Load += new System.EventHandler(frmClientStatement_Load);
