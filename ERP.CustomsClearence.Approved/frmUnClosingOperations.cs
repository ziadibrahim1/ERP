...
public class frmUnClosingOperations : frmPosted
{
	private IContainer components = null;

	public frmUnClosingOperations()
	{
		InitializeComponent();
		NoCol = "OperationNo";
		((Control)(object)btnPost).Text = (GlobalVariables.IsArabic ? "فك إغلاق" : "UnClose");
	}

	public override void FillGrid()
	{
		dtsource = Operations.SelectByClosed(GlobalVariables.BranchIDs, "1", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CertificateDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الشهادة" : "Certificate Date");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CertificateDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			Operations.SetClose("0", text, GlobalVariables.UserID);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد عمليات لفك إغلاقها " : "There are No Operations to UnClose");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.CSTOperationsReport(-1, 1, IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CustomsClearence.Approved.frmUnApprovingOperations));
		...
		base.Name = "frmUnApprovingOperations";
