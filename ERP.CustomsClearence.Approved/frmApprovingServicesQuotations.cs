...
public class frmApprovingServicesQuotations : frmPosted
{
	...
	public override void SaveData()
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			{
				text = text + "exec CST_ServicesQuotations_SetApproveWithLog 1 , " + ((UltraGridBase)ULGData).Rows[i].Cells["ServiceQuotationID"].Value.ToString() + ", " + GlobalVariables.UserID + " ; ";
			}
		}
		if (text != "")
		{
	...
	{
		DataTable dataTable = SearchFunctions.CSTServicesQuotationsReport(DateTime.Now.AddYears(-10).ToString(GlobalVariables.DateShortFormate), 0, 0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CustomsClearence.Approved.frmApprovingServicesQuotations));
