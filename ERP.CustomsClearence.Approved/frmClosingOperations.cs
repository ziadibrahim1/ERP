...
public class frmClosingOperations : frmPosted
{
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			Operations.SetClose("1", text, GlobalVariables.UserID);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد عمليات لإغلاقها " : "There are No Operations to Close");
		}
	}
