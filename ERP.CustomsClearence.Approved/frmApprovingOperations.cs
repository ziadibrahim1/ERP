...
public class frmApprovingOperations : frmPosted
{
	private IContainer components = null;

	public frmApprovingOperations()
	{
		InitializeComponent();
		NoCol = "OperationNo";
	}
	...
	{
		dtsource = Operations.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			Operations.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد عمليات لإعتمادها " : "There are No Operations to Approve");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.CSTOperationsReport(0, -1, IsFromServer: false);
