...
public class frmUnApprovingOperations : frmPosted
{
	private IContainer components = null;

	public frmUnApprovingOperations()
	{
		InitializeComponent();
		NoCol = "OperationNo";
	...
	{
		dtsource = Operations.SelectByApproved(GlobalVariables.BranchIDs, "1", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			Operations.SetApprove("0", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد عمليات لفك إعتمادها " : "There are No Operations to UnApprove");
		}
	}
