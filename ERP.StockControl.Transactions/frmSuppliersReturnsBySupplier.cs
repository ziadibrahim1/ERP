...
public class frmSuppliersReturnsBySupplier : frmDetails
{
	...
	public frmSuppliersReturnsBySupplier()
	{
		...
		InitializeComponent();
		((Control)(object)lblHeader).Text = (GlobalVariables.IsArabic ? "المورد" : "Supplier");
	...
	public override void PrepareData()
	{
		...
		dtClients = SubAccounts.FillComboBySubAccountTypeIDs(GlobalVariables.SupplierSubAccountTypeIDs, "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		...
		dtDetails = SuppliersReturnsDetails.FillBySubAccountID("0", GlobalVariables.IsArabic ? "1" : "0");
		InitGrid();
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemBarCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.06);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["GoodReceiptNoteNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.08);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["GoodReceiptNoteDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.08);
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["GoodReceiptNoteNo"].Header).Caption = (GlobalVariables.IsArabic ? "اذن اضافة رقم" : "Good Receipt Note No");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["GoodReceiptNoteDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ اذن الاضافه" : "Good Receipt Note Date");
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["GoodReceiptNoteDate"].MaskInput = "dd/mm/yyyy hh:mm:ss tt";
	}
	...
	public override void DisplayData()
	{
		...
		{
			base.DisplayData();
			dtDetails = SuppliersReturnsDetails.FillBySubAccountID(((TextEditorControlBase)cboHeader).Value.ToString(), GlobalVariables.IsArabic ? "1" : "0");
			InitGrid();
		}
	}
	...
	public override bool ValidateData()
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			if (((UltraGridBase)ULGData).Rows[i].Cells["Qty"].Value != DBNull.Value && decimal.Parse(((UltraGridBase)ULGData).Rows[i].Cells["Qty"].Value.ToString()) > 0m)
			{
				...
				if (dtpDate.DateTime < DateTime.Parse(((UltraGridBase)ULGData).Rows[i].Cells["GoodReceiptNoteDate"].Value.ToString()))
				{
					GlobalVariables.InformationMB.Show("تاريخ المرتجع أقل من تاريخ إذن الاضافه ", "Return Date Before Good Receipt Note");
					((GridItemBase)((UltraGridBase)ULGData).Rows[i].Cells["GoodReceiptNoteDate"]).Selected = true;
					return false;
				}
			}
		}
	...
	public override void SaveData()
	{
		...
		try
		{
			int num = 0;
			int num2 = 0;
			DataRow[] array = ((DataTable)((UltraGridBase)ULGData).DataSource).Select("Qty > 0", "GoodReceiptNoteID ASC");
			if (array.Length != 0)
			{
				for (int i = 0; i < array.Length; i++)
				{
					if (num != int.Parse(array[i]["GoodReceiptNoteID"].ToString()))
					{
						num = int.Parse(array[i]["GoodReceiptNoteID"].ToString());
						decimal num3 = default(decimal);
						for (int j = 0; j < array.Length; j++)
						{
							if (num == int.Parse(array[j]["GoodReceiptNoteID"].ToString()))
							{
								num3 += decimal.Parse(array[j]["Qty"].ToString()) * (decimal.Parse(array[j]["ReturnPrice"].ToString()) - decimal.Parse(array[j]["TotalDiscount"].ToString()) + decimal.Parse(array[j]["TableTaxValue"].ToString()) + decimal.Parse(array[j]["TaxValue"].ToString()) + decimal.Parse(array[j]["GrowthTaxValue"].ToString()) - decimal.Parse(array[j]["CommercialTaxValue"].ToString()) - decimal.Parse(array[j]["StampsValue"].ToString()) + decimal.Parse(array[j]["GrowthFees"].ToString()));
							}
						}
						num2 = SuppliersReturns.Insert_Update("-1", SuppliersReturns.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID), dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), "0", "Null", num.ToString(), ((TextEditorControlBase)cboHeader).Value.ToString(), (array[i]["CurrencyID"] == DBNull.Value) ? "Null" : array[i]["CurrencyID"].ToString(), (array[i]["ExchangeRate"] == DBNull.Value) ? "0" : array[i]["ExchangeRate"].ToString(), "Null", num3.ToString(), "Null", "Null", "0", "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
					}
					int num4 = SuppliersReturnsDetails.Insert_Update("-1", num2.ToString(), array[i]["ItemID"].ToString(), (array[i]["ColorID"] == DBNull.Value) ? "1" : array[i]["ColorID"].ToString(), (array[i]["ItemSizeID"] == DBNull.Value) ? "1" : array[i]["ItemSizeID"].ToString(), (array[i]["BatchID"] == DBNull.Value) ? "Null" : array[i]["BatchID"].ToString(), array[i]["Qty"].ToString(), (array[i]["UnitID"] == DBNull.Value) ? "Null" : array[i]["UnitID"].ToString(), (array[i]["UnitPrice"] == DBNull.Value) ? "0" : array[i]["UnitPrice"].ToString(), (array[i]["ReturnPrice"] == DBNull.Value) ? "0" : array[i]["ReturnPrice"].ToString(), (array[i]["TotalDiscount"] == DBNull.Value) ? "0" : array[i]["TotalDiscount"].ToString(), (array[i]["TableTaxID"] == DBNull.Value) ? "Null" : array[i]["TableTaxID"].ToString(), (array[i]["TableTaxValue"] == DBNull.Value) ? "0" : array[i]["TableTaxValue"].ToString(), (array[i]["TaxID"] == DBNull.Value) ? "Null" : array[i]["TaxID"].ToString(), (array[i]["TaxValue"] == DBNull.Value) ? "0" : array[i]["TaxValue"].ToString(), (array[i]["GrowthTaxID"] == DBNull.Value) ? "Null" : array[i]["GrowthTaxID"].ToString(), (array[i]["GrowthTaxValue"] == DBNull.Value) ? "0" : array[i]["GrowthTaxValue"].ToString(), (array[i]["CommercialTaxValue"] == DBNull.Value) ? "0" : array[i]["CommercialTaxValue"].ToString(), (array[i]["StampsValue"] == DBNull.Value) ? "0" : array[i]["StampsValue"].ToString(), (array[i]["GrowthFees"] == DBNull.Value) ? "0" : array[i]["GrowthFees"].ToString(), (array[i]["StoreID"] == DBNull.Value) ? "Null" : array[i]["StoreID"].ToString(), (array[i]["Notes"] == DBNull.Value) ? "Null" : array[i]["Notes"].ToString(), (array[i]["GoodReceiptNoteID"] == DBNull.Value) ? "Null" : array[i]["GoodReceiptNoteID"].ToString(), (array[i]["GoodReceiptNoteDetailID"] == DBNull.Value) ? "Null" : array[i]["GoodReceiptNoteDetailID"].ToString(), GlobalFunctions.GetServerDateTimeNow().ToString(GlobalVariables.DateLongFormate), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
					if (i == array.Length - 1 || num != int.Parse(array[i + 1]["GoodReceiptNoteID"].ToString()))
					{
						SuppliersReturns.GenerateJvs("," + num2 + ",", GlobalVariables.UserID);
					}
				}
			}
		...
		if (flag)
		{
			...
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				if (((UltraGridBase)ULGData).Rows[i].Cells["ItemBarCode"].Text == text && ((UltraGridBase)ULGData).Rows[i].Cells["BatchID"].Text == text4 && ((UltraGridBase)ULGData).Rows[i].Cells["ColorID"].Value.ToString() == text2 && ((UltraGridBase)ULGData).Rows[i].Cells["ItemSizeID"].Value.ToString() == text3 && ((UltraGridBase)ULGData).Rows[i].Cells["UnitID"].Value.ToString() == text5 && decimal.Parse(((UltraGridBase)ULGData).Rows[i].Cells["Qty"].Value.ToString()) + decimal.Parse(s) <= decimal.Parse(((UltraGridBase)ULGData).Rows[i].Cells["MaxAllowedQty"].Value.ToString()))
				{
					ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
					rowIndex = i;
					if (decimal.Parse(((UltraGridBase)ULGData).Rows[rowIndex].Cells["Qty"].Value.ToString()) + decimal.Parse(s) > decimal.Parse(((UltraGridBase)ULGData).Rows[rowIndex].Cells["MaxAllowedQty"].Value.ToString()))
					{
						GlobalVariables.InformationMB.Show(" الحد الاقصى للكمية المرتجعة " + ((UltraGridBase)ULGData).Rows[rowIndex].Cells["MaxAllowedQty"].Value.ToString(), " Max Allowed Returned Quantity " + ((UltraGridBase)ULGData).Rows[rowIndex].Cells["MaxAllowedQty"].Value.ToString());
						((UltraGridBase)ULGData).Rows[rowIndex].Cells["Qty"].Value = ((UltraGridBase)ULGData).Rows[rowIndex].Cells["MaxAllowedQty"].Value;
					}
					else
					{
						((UltraGridBase)ULGData).Rows[rowIndex].Cells["Qty"].Value = decimal.Parse(((UltraGridBase)ULGData).Rows[rowIndex].Cells["Qty"].Value.ToString()) + decimal.Parse(s);
					}
	...
	private void txtBarCode_KeyUp(object sender, KeyEventArgs e)
	{
		...
		else
		{
			...
			{
				ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
				if (decimal.Parse(((UltraGridBase)ULGData).Rows[rowIndex].Cells["Qty"].Value.ToString()) + decimal.Parse(frmEnterQuantity2.Value) > decimal.Parse(((UltraGridBase)ULGData).Rows[rowIndex].Cells["MaxAllowedQty"].Value.ToString()))
				{
					GlobalVariables.InformationMB.Show(" الحد الاقصى للكمية المرتجعة " + ((UltraGridBase)ULGData).Rows[rowIndex].Cells["MaxAllowedQty"].Value.ToString(), " Max Allowed Returned Quantity " + ((UltraGridBase)ULGData).Rows[rowIndex].Cells["MaxAllowedQty"].Value.ToString());
					((UltraGridBase)ULGData).Rows[rowIndex].Cells["Qty"].Value = ((UltraGridBase)ULGData).Rows[rowIndex].Cells["MaxAllowedQty"].Value;
				}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.Transactions.frmSuppliersReturnsBySupplier));
		...
		base.Name = "frmSuppliersReturnsBySupplier";
