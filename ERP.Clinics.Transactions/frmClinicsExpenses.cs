...
public class frmClinicsExpenses : frmHeaderDetails
{
	...
	public override void PrepareData()
	{
		...
		GlobalFunctions.FillCombo(cboPatient, dtPatients, "PatientID", "PatientName");
	}
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((TextEditorControlBase)cboPatient).ValueChanged -= cboPatient_ValueChanged;
			...
			((TextEditorControlBase)cboPatient).Value = drMaster["PatientID"];
			((TextEditorControlBase)cboPatient).ValueChanged += cboPatient_ValueChanged;
			((TextEditorControlBase)cboSubAccountName).ValueChanged += cboSubAccountName_ValueChanged;
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)cboPatient).ReadOnly = NavMode;
	...
	{
		dtSearchResult = SearchFunctions.ClinicsExpensesReport(-1, 0);
	...
	private void cboPatient_ValueChanged(object sender, EventArgs e)
	{
		if (cboPatient.SelectedIndex > -1)
		{
			((TextEditorControlBase)cboSubAccountName).Value = ((dtPatients.Select(" PatientID= " + ((TextEditorControlBase)cboPatient).Value.ToString())[0]["SubAccountID"] == DBNull.Value) ? dtPOSDefaultData.Rows[0]["DefaultSubAccountID"] : dtPatients.Select(" cboPatient= " + ((TextEditorControlBase)cboPatient).Value.ToString())[0]["SubAccountID"]);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Clinics.Transactions.frmClinicsExpenses));
		...
		this.cboPatient.AutoCompleteMode = (AutoCompleteMode)2;
		((System.Windows.Forms.Control)(object)this.cboPatient).Name = "cboPatient";
		((System.Windows.Forms.Control)(object)this.cboPatient).TabStop = false;
