...
public class frmReservationsPayments : frmHeaderDetails
{
	...
	private UltraComboEditor cboReservations;
	...
	public frmReservationsPayments()
	{
		InitializeComponent();
		TableName = "CL_ReservationsPayments";
		IDCol = "ReservationPaymentID";
		NoCol = "ReservationPaymentNo";
		DateCol = "ReservationPaymentDate";
	}

	public frmReservationsPayments(int _ReservationID, decimal restamount)
		: this()
	{
	...
	public override void PrepareData()
	{
		...
		dtReservations = Reservations.FillCombo(GlobalVariables.BranchIDs);
		GlobalFunctions.FillCombo(cboReservations, dtReservations, "ReservationID", "ReservationNo");
	...
	public override void FillData()
	{
		...
		DataTable dataTable = ReservationsPayments.Select(RowID, GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((TextEditorControlBase)cboReservations).Value = drMaster["ReservationID"];
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)cboReservations).ReadOnly = Reservation_ID != 0 || !Adding;
		...
		{
			num = int.Parse(((TextEditorControlBase)cboReservations).Value.ToString());
		}
		if (Adding || Updating)
		{
			DataView dataView2 = new DataView(dtReservations);
			dataView2.RowFilter = " BranchID= " + GlobalVariables.CurrentBranchID;
			GlobalFunctions.FillCombo(cboReservations, dataView2.ToTable(), "ReservationID", "ReservationNo");
		}
		else
		{
			GlobalFunctions.FillCombo(cboReservations, dtReservations, "ReservationID", "ReservationNo");
		...
		if (num > 0)
		{
			((TextEditorControlBase)cboReservations).Value = num;
		}
	}
	...
	public override void ClearControls()
	{
		...
		if (Reservation_ID != 0)
		{
			((TextEditorControlBase)cboReservations).Value = Reservation_ID.ToString();
		}
	...
	public override bool ValidateData()
	{
		...
		if (cboReservations.SelectedIndex == -1)
		{
			...
			((TextEditorControlBase)cboReservations).Focus();
			return false;
		}
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("CL_ReservationsPayments", "ReservationPaymentNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["ReservationPaymentNo"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
		...
		decimal num = Reservations.GetPaidAmount(Adding ? "-1" : drMaster["ReservationPaymentID"].ToString(), ((TextEditorControlBase)cboReservations).Value.ToString()) + decimal.Parse(((Control)(object)txtTotal).Text);
		decimal num2 = decimal.Parse(dtReservations.Select(" ReservationID = " + ((TextEditorControlBase)cboReservations).Value.ToString())[0]["NetPrice"].ToString());
		if (num > num2)
		{
	...
	public override void AddData()
	{
		...
		try
		{
			num = ReservationsPayments.Insert_Update("-1", ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), (cboVisaType.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboVisaType).Value.ToString(), (((Control)(object)txtVisaNo).Text == "") ? "Null" : ((Control)(object)txtVisaNo).Text, ((Control)(object)txtTotal).Text, (cboReservations.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboReservations).Value.ToString(), GlobalVariables.UserID, ((Control)(object)txtNotes).Text, ShiftDetailID, ShiftDetailUserID, "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			Reservations.UpdatePaidAmount(((TextEditorControlBase)cboReservations).Value.ToString(), GlobalVariables.UserID);
			ShiftsDetails.ClinicReservationPaymentsJVAdding(num.ToString(), ShiftDetailID, GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
		...
		try
		{
			...
			reportDocument.SetParameterValue("@ReservationPaymentID", num);
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = ReservationsPayments.Insert_Update(drMaster["ReservationPaymentID"].ToString(), ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), (cboVisaType.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboVisaType).Value.ToString(), (((Control)(object)txtVisaNo).Text == "") ? "Null" : ((Control)(object)txtVisaNo).Text, ((Control)(object)txtTotal).Text, (cboReservations.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboReservations).Value.ToString(), (drMaster["User_ID"] == DBNull.Value) ? "Null" : drMaster["User_ID"].ToString(), ((Control)(object)txtNotes).Text, ShiftDetailID, ShiftDetailUserID, "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
	...
	{
		((TextEditorControlBase)cboReservations).Value = SearchFunctions.LnsLabOrdersSearch(GlobalVariables.BranchIDs, -1, 0);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Clinics.Transactions.frmReservationsPayments));
		...
		this.cboReservations = new UltraComboEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.cboReservations).BeginInit();
		...
		resources.ApplyResources(this.cboReservations, "cboReservations");
		this.cboReservations.AutoCompleteMode = (AutoCompleteMode)2;
		((System.Windows.Forms.Control)(object)this.cboReservations).Name = "cboReservations";
		((System.Windows.Forms.Control)(object)this.cboReservations).TabStop = false;
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.cboReservations);
		...
		base.Name = "frmReservationsPayments";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.cboReservations, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.cboReservations).EndInit();
