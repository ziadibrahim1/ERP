...
namespace ERP.HMS.Reports;

public class frmFrontOfficeRep : frmReportTree2010
{
	private IContainer components = null;

	public frmFrontOfficeRep()
	{
		InitializeComponent();
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "البيانات اليوميه " : " Daily Data ");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HMS_FrontOfficeData_E.rpt" : "Rep_HMS_FrontOfficeData_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HMS_FrontOfficeData_E_nologo.rpt" : "Rep_HMS_FrontOfficeData_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HMS.Reports.frmFrontOfficeRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2022, 8, 16, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2022, 8, 16, 0, 0, 0, 0);
