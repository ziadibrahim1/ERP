...
public class frmUnApprovingEmployeesExtraTimes : frmPosted
{
	private IContainer components = null;

	public frmUnApprovingEmployeesExtraTimes()
	{
		InitializeComponent();
	...
	{
		dtsource = EmployeesExtraTimes.SelectByApproved("1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			EmployeesExtraTimes.SetApprove("0", text, IsFromServer: true);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد طلبات إضافى لإلغاء إعتمادها " : "There are No Overtime to UnApprove");
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Payroll.Approved.frmUnApprovingEmployeesExtraTimes));
		...
		base.Name = "frmUnApprovingEmployeesExtraTimes";
