...
public class frmExpOperationsSearch : frmSearch
{
	private IContainer components = null;

	public frmExpOperationsSearch()
	{
		InitializeComponent();
	}

	public frmExpOperationsSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
