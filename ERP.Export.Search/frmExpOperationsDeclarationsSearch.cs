...
public class frmExpOperationsDeclarationsSearch : frmSearch
{
	private IContainer components = null;

	public frmExpOperationsDeclarationsSearch()
	{
		InitializeComponent();
	}

	public frmExpOperationsDeclarationsSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationDeclarationDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
