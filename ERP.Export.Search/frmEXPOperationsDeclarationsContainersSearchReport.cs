...
public class frmEXPOperationsDeclarationsContainersSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmEXPOperationsDeclarationsContainersSearchReport()
	{
		InitializeComponent();
	}

	public frmEXPOperationsDeclarationsContainersSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationDeclarationNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.48) - GlobalVariables.ScrollWidth;
