...
public class frmSLInvoicesTruckSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmSLInvoicesTruckSearchReport()
	{
		InitializeComponent();
	}

	public frmSLInvoicesTruckSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
