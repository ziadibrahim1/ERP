...
public class frmSLInvoicesSearch : frmSearch
{
	private IContainer components = null;

	public frmSLInvoicesSearch()
	{
		InitializeComponent();
	}

	public frmSLInvoicesSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SLInvoiceNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15) - GlobalVariables.ScrollWidth;
