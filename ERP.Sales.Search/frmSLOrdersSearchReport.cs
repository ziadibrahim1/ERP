...
public class frmSLOrdersSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmSLOrdersSearchReport()
	{
		InitializeComponent();
	}

	public frmSLOrdersSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SLOrderNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.13) - GlobalVariables.ScrollWidth;
