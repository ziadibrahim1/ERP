...
namespace ERP.Export.Reports;

public class frmExpOperationsDeclarationsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmExpOperationsDeclarationsRep()
	{
		...
		TreeItems2IDCol = "OperationDeclarationID";
		TreeItems2NameCol = "OperationDeclarationNo";
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى طلب شحن ليتم عرضه ", "There is no chosen Declaration to be shown in the report, please check Declarations to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@OperationDeclarationIDs", Items2);
	...
	public void FillDeclarations()
	{
		...
		dtItems2 = OperationsDeclarations.FillRepTree(Branches, Items);
		if (dtItems2 != null)
		{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Export.Reports.frmExpOperationsDeclarationsRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2017, 5, 22, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2017, 5, 22, 0, 0, 0, 0);
		...
		base.Name = "frmExpOperationsDeclarationsRep";
