...
public class frmSLNPreQuotationsSlings : frmBase
{
	...
	private int PreQuotationDetailID;
	...
	private DataTable dtPreQuotationsDetailsSlings = new DataTable();

	private DataTable dtPreQuotationsDetailsSlingsMaterials = new DataTable();
	...
	public frmSLNPreQuotationsSlings()
	{
	...
	public frmSLNPreQuotationsSlings(int prequotationid, int prequotationdetailid, decimal totalqty, string Desc, bool navmode, DateTime voucherdate, DataTable dtprequotationdetailsling, DataTable dtprequotationdetailslingmaterial)
		: this()
	{
		PreQuotationID = prequotationid;
		PreQuotationDetailID = prequotationdetailid;
		NavMode = navmode;
		VoucherDate = voucherdate;
		dtPreQuotationsDetailsSlings = dtprequotationdetailsling;
		dtPreQuotationsDetailsSlingsMaterials = dtprequotationdetailslingmaterial;
		TotalQty = totalqty;
	...
	public void DisplayData()
	{
		...
		if (dtPreQuotationsDetailsSlings.Select(" PreQuotationDetailID= " + PreQuotationDetailID).Length != 0)
		{
			DataRow dataRow = dtPreQuotationsDetailsSlings.Select(" PreQuotationDetailID= " + PreQuotationDetailID)[0];
		...
		dataView.RowFilter = " PreQuotationDetailID= " + PreQuotationDetailID;
	...
	public void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PreQuotationDetailSlingMaterialD"].DefaultCellValue = -1;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PreQuotationDetailID"].DefaultCellValue = PreQuotationDetailID;
	...
	private void btnSave_Click(object sender, EventArgs e)
	{
		...
		{
			dtPreQuotationsDetailsSlings.AcceptChanges();
			dtPreQuotationsDetailsSlingsMaterials.AcceptChanges();
			if (dtPreQuotationsDetailsSlings.Rows.Count > 0 && dtPreQuotationsDetailsSlings.Select(" PreQuotationDetailID= " + PreQuotationDetailID).Length != 0)
			{
				DataRow dataRow = dtPreQuotationsDetailsSlings.Select(" PreQuotationDetailID= " + PreQuotationDetailID)[0];
			...
			{
				DataRow dataRow2 = dtPreQuotationsDetailsSlings.NewRow();
				dataRow2["PreQuotationDetailSlingID"] = -1;
				dataRow2["PreQuotationDetailID"] = PreQuotationDetailID;
				dataRow2["PreQuotationID"] = PreQuotationID;
				...
				dtPreQuotationsDetailsSlings.Rows.Add(dataRow2);
			}
			dtPreQuotationsDetailsSlings.AcceptChanges();
			dtPreQuotationsDetailsSlingsMaterials.AcceptChanges();
	...
	{
		if (dtPreQuotationsDetailsSlingsMaterials.Select("PreQuotationDetailID = " + PreQuotationDetailID).Length != 0 && dtPreQuotationsDetailsSlings.Select("PreQuotationDetailID = " + PreQuotationDetailID).Length == 0)
		{
			DataRow[] array = dtPreQuotationsDetailsSlingsMaterials.Select("PreQuotationDetailID = " + PreQuotationDetailID);
	...
	private void btnCreateStock_Click(object sender, EventArgs e)
	{
		...
		{
			if (int.Parse(dtPreQuotationsDetailsSlingsMaterials.Rows[i]["PreQuotationDetailID"].ToString()) == PreQuotationDetailID)
			{
				dtPreQuotationsDetailsSlingsMaterials.Rows[i].Delete();
			}
		}
		if (cboWireType.SelectedIndex > -1)
		{
		...
		if (dtWireTypesDetails.Select(" Diameter= " + ((Control)(object)txtDiameter).Text).Length != 0)
		{
			...
			((UltraGridBase)ULGData).ActiveRow.Cells["PreQuotationDetailID"].Value = PreQuotationDetailID;
			((UltraGridBase)ULGData).ActiveRow.Cells["PreQuotationID"].Value = PreQuotationID;
			if (UsingBatchNoAndValidityPeriod)
			{
	...
	{
		if (NavMode || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "Qty" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "TotalCostPrice" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "BatchID" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "ColorID" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "ItemSizeID")
		{
	...
	private void ULGData_CellListSelect(object sender, CellEventArgs e)
	{
		...
		if (((KeyedSubObjectBase)e.Cell.Column).Key == "MaterialTypeID" && e.Cell.Column.ValueList.SelectedItemIndex >= 0)
		{
			...
			e.Cell.Row.Cells["PreQuotationDetailID"].Value = PreQuotationDetailID;
			e.Cell.Row.Cells["PreQuotationID"].Value = PreQuotationID;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Transactions.frmSLNPreQuotationsSlings));
		...
		base.Name = "frmSLNPreQuotationsSlings";
