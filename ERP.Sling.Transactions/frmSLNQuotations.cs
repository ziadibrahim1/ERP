...
public class frmSLNQuotations : frmHeaderDetails
{
	private DataTable dtPreQuotations;

	private DataTable dtPreQuotationsDetails;
	...
	public DataTable dtQuotationsDetailsSlings = new DataTable();

	public DataTable dtQuotationsDetailsSlingsMaterials = new DataTable();
	...
	private UltraComboEditor cboPreQuotations;

	private UltraLabel lblPreQuotation;

	public UltraButton btnPreQuotationsSearch;
	...
	public frmSLNQuotations()
	{
		...
		InitializeComponent();
		TableName = "SLN_Quotations";
		IDCol = "QuotationID";
		NoCol = "QuotaionNo";
		DateCol = "QuotationDate";
	}

	public frmSLNQuotations(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	{
		base.PrepareData();
		((Control)(object)lblPreQuotation).Text = GlobalFunctions.GetFormName("Sling", "Transactions", "frmSLNPreQuotations");
		dtPreQuotations = PreQuotations.FillCombo(GlobalVariables.BranchIDs);
		GlobalFunctions.FillCombo(cboPreQuotations, dtPreQuotations, "PreQuotationID", "PreQuotationNo");
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((Control)(object)txtCode).Text = drMaster["QuotaionNo"].ToString();
			...
			((TextEditorControlBase)cboCurrency).ValueChanged += cboCurrency_ValueChanged;
			((TextEditorControlBase)cboPreQuotations).ValueChanged -= cboPreQuotations_ValueChanged;
			((TextEditorControlBase)cboPreQuotations).Value = drMaster["PreQuotationID"];
			((TextEditorControlBase)cboPreQuotations).ValueChanged += cboPreQuotations_ValueChanged;
			...
			((TextEditorControlBase)cboClient).ValueChanged += cboClient_ValueChanged;
			((TextEditorControlBase)cboUsers).Value = drMaster["ApprovedUserID"];
			dtpExpectedDeliveryDate.Value = drMaster["ExpectedDeliveryDate"];
			if (bool.Parse(drMaster["HasInvoice"].ToString()))
			{
				((EditorButtonControlBase)txtProfitPercentage).ReadOnly = true;
			...
			dtQuotationsDetailsSlings = QuotationsDetailsSlings.SelectByQuotationID(drMaster["QuotationID"].ToString(), GlobalVariables.IsArabic ? "1" : "0");
			dtQuotationsDetailsSlingsMaterials = QuotationsDetailsSlingsMaterials.SelectByQuotationID(drMaster["QuotationID"].ToString(), GlobalVariables.IsArabic ? "1" : "0");
			((UltraGridBase)ULGData).DataSource = dtDetails;
			InitGrid();
			if (drMaster["Approved"].Equals(true) || drMaster["IsDetailIssued"].Equals(true) || !CanEditFromServer)
			{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PrintedItemNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.04);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PrintedItemNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الطباعه" : "ID No.");
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemBarCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.06) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ProfitPercentage"].Width = (int)((double)((Control)(object)ULGData).Width * 0.04);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Discount"].Width = (int)((double)((Control)(object)ULGData).Width * 0.06);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ManufacturingNotes"].Width = (int)((double)((Control)(object)ULGData).Width * 0.07);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["HasInvoice"].DefaultCellValue = false;
	}
	...
	public override void SetControls(bool NavMode)
	{
		...
		((Control)(object)btnPreQuotationsSearch).Visible = !NavMode;
		((EditorButtonControlBase)cboPreQuotations).ReadOnly = NavMode;
		if (Adding || Updating)
		{
	...
	public override void ClearControls()
	{
		...
		((TextEditorControlBase)cboCurrency).ValueChanged += cboCurrency_ValueChanged;
		((TextEditorControlBase)cboPreQuotations).ValueChanged -= cboPreQuotations_ValueChanged;
		cboPreQuotations.SelectedIndex = -1;
		((TextEditorControlBase)cboPreQuotations).ValueChanged += cboPreQuotations_ValueChanged;
		dtQuotationsDetailsSlings.Rows.Clear();
		dtQuotationsDetailsSlingsMaterials.Rows.Clear();
		dtQuotationsDetailsSlingsMaterials = QuotationsDetailsSlingsMaterials.SelectByQuotationID("0", GlobalVariables.IsArabic ? "1" : "0");
		dtQuotationsDetailsSlings = QuotationsDetailsSlings.SelectByQuotationID("0", GlobalVariables.IsArabic ? "1" : "0");
	}
	...
	public override void btnPrintClick()
	{
		if (RowID != "")
		{
			...
			{
				GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_SLN_Quotations_A.rpt" : "Rep_SLN_Quotations_E.rpt"));
			}
	...
	{
		dtSearchResult = SearchFunctions.SLNQuotationsReport(-1, 0, -1);
	...
	public override void btnRefreshDataClick()
	{
		...
		object value3 = ((TextEditorControlBase)cboPreQuotations).Value;
		object value4 = ((TextEditorControlBase)cboUsers).Value;
		object value5 = ((TextEditorControlBase)cboClientContacts).Value;
		...
		dtClients = SubAccounts.FillComboBySubAccountTypeIDs(GlobalVariables.ClientSubAccountTypeIDs, "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		GlobalFunctions.FillCombo(cboClient, dtClients, "SubAccountID", "SubAccountName");
		((TextEditorControlBase)cboPreQuotations).Value = value3;
		((TextEditorControlBase)cboCurrency).Value = value;
		((TextEditorControlBase)cboClient).Value = value2;
		((TextEditorControlBase)cboUsers).Value = value4;
		((TextEditorControlBase)cboClientContacts).Value = value5;
	...
	public override bool ValidateData()
	{
		...
		if (cboPreQuotations.SelectedIndex == -1)
		{
			GlobalVariables.InformationMB.Show("برجاء إختيار عرض", "Please Select A PreQuotation");
			((TextEditorControlBase)cboPreQuotations).Focus();
			cboPreQuotations.DropDown();
			return false;
		}
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("SLN_Quotations", "QuotaionNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["QuotaionNo"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
	...
	public override void UpdateData()
	{
		...
		try
		{
			int num = Quotations.Insert_Update(drMaster["QuotationID"].ToString(), ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((TextEditorControlBase)cboPreQuotations).Value.ToString(), ((TextEditorControlBase)cboClient).Value.ToString(), (cboClientContacts.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboClientContacts).Value.ToString(), (((Control)(object)txtClientOrderNo).Text == "") ? "Null" : ((Control)(object)txtClientOrderNo).Text, ((TextEditorControlBase)cboCurrency).Value.ToString(), (((Control)(object)txtExchangeRate).Text == "" || ((Control)(object)txtExchangeRate).Text == ".") ? "0" : ((Control)(object)txtExchangeRate).Text, (((Control)(object)txtProfitPercentage).Text == "" || ((Control)(object)txtProfitPercentage).Text == ".") ? "0" : ((Control)(object)txtProfitPercentage).Text, (((Control)(object)txtTotalPrice).Text == "" || ((Control)(object)txtTotalPrice).Text == ".") ? "0" : ((Control)(object)txtTotalPrice).Text, (((Control)(object)txtDiscBeforeTaxValue).Text == "" || ((Control)(object)txtDiscBeforeTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text, (((Control)(object)txtDiscBeforeTaxRatio).Text == "" || ((Control)(object)txtDiscBeforeTaxRatio).Text == ".") ? "0" : ((Control)(object)txtDiscBeforeTaxRatio).Text, (((Control)(object)txtNetprice).Text == "" || ((Control)(object)txtNetprice).Text == ".") ? "0" : ((Control)(object)txtNetprice).Text, (((Control)(object)txtTotalCost).Text == "" || ((Control)(object)txtTotalCost).Text == ".") ? "0" : ((Control)(object)txtTotalCost).Text, ((Control)(object)txtDeliveryPlace).Text, (dtpExpectedDeliveryDate.Value == null) ? "Null" : dtpExpectedDeliveryDate.DateTime.ToString(GlobalVariables.DateLongFormate), bool.Parse(drMaster["IsDetailIssued"].ToString()) ? "1" : "0", (drMaster["DetailIssueDate"] == DBNull.Value) ? "Null" : drMaster["DetailIssueDate"].ToString(), bool.Parse(drMaster["IsMaterialIssued"].ToString()) ? "1" : "0", (drMaster["MaterialIssueDate"] == DBNull.Value) ? "Null" : drMaster["MaterialIssueDate"].ToString(), ((Control)(object)txtValidityDays).Text, ((Control)(object)txtTermsOfPayment).Text, ((Control)(object)txtNotes).Text, drMaster["User_ID"].ToString(), (cboUsers.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboUsers).Value.ToString(), bool.Parse(drMaster["Closed"].ToString()) ? "1" : "0", (drMaster["StockControlJVID"] == DBNull.Value) ? "Null" : drMaster["StockControlJVID"].ToString(), (drMaster["SalesJVID"] == DBNull.Value) ? "Null" : drMaster["SalesJVID"].ToString(), bool.Parse(drMaster["Approved"].ToString()) ? "1" : "0", "1", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			string text = ",";
			for (int i = 0; i < dtQuotationsDetailsSlingsMaterials.Rows.Count; i++)
			{
				text = text + dtQuotationsDetailsSlingsMaterials.Rows[i]["QuotationDetailSlingMaterialD"].ToString() + ",";
			}
			Main.DeleteForUpdate("SLN_QuotationsDetailsSlingsMaterials", "QuotationID", drMaster["QuotationID"].ToString(), "QuotationDetailSlingMaterialD", text);
			string text2 = ",";
			for (int j = 0; j < dtQuotationsDetailsSlings.Rows.Count; j++)
			{
				text2 = text2 + dtQuotationsDetailsSlings.Rows[j]["QuotationDetailSlingID"].ToString() + ",";
			}
			Main.DeleteForUpdate("SLN_QuotationsDetailsSlings", "QuotationID", drMaster["QuotationID"].ToString(), "QuotationDetailSlingID", text2);
			string text3 = ",";
			for (int k = 0; k < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; k++)
			{
				text3 = text3 + ((UltraGridBase)ULGData).Rows[k].Cells["QuotationDetailID"].Value.ToString() + ",";
			}
			Main.DeleteForUpdate("SLN_QuotationsDetails", "QuotationID", drMaster["QuotationID"].ToString(), "QuotationDetailID", text3);
			ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
	...
	public override void DeleteData()
	{
		...
		try
		{
			...
			QuotationsDetailsSlings.DeleteVirtualByQuotationID(drMaster["QuotationID"].ToString(), GlobalVariables.UserID);
			QuotationsDetailsSlingsMaterials.DeleteVirtualByQuotationID(drMaster["QuotationID"].ToString(), GlobalVariables.UserID);
			Main.EndBulkTrans(FromServer: false);
			ItemsTransactions.ManageInThread();
		}
		catch
	...
	private void ULGData_AfterRowInsert(object sender, RowEventArgs e)
	{
		...
		{
			e.Row.Cells["QuotationDetailID"].Value = ++newID;
		}
	...
	public override void SelectFullRow(object sender, EventArgs e)
	{
		...
		if (Convert.ToBoolean(((UltraGridBase)ULGData).ActiveRow.Cells["HasInvoice"].Value))
		{
			((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
		}
		else if (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "UnitCostPrice" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "TotalCostPrice" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "Discount" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "NetPrice")
		{
			((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
		}
	...
	private void ULGData_AfterRowsDeleted(object sender, EventArgs e)
	{
		...
		((UltraGridBase)ULGData).UpdateData();
		for (int i = 0; i < dtQuotationsDetailsSlings.Rows.Count; i++)
		{
			if (dtQuotationsDetailsSlings.Rows[i]["QuotationDetailID"] != DBNull.Value && ArDetailIDs.Contains(dtQuotationsDetailsSlings.Rows[i]["QuotationDetailID"]))
			{
				dtQuotationsDetailsSlings.Rows[i].Delete();
				dtQuotationsDetailsSlings.Rows[i].AcceptChanges();
				i--;
			}
		}
		for (int j = 0; j < dtQuotationsDetailsSlingsMaterials.Rows.Count; j++)
		{
			if (dtQuotationsDetailsSlingsMaterials.Rows[j]["QuotationDetailID"] != DBNull.Value && ArDetailIDs.Contains(dtQuotationsDetailsSlingsMaterials.Rows[j]["QuotationDetailID"]))
			{
				dtQuotationsDetailsSlingsMaterials.Rows[j].Delete();
				dtQuotationsDetailsSlingsMaterials.Rows[j].AcceptChanges();
				j--;
			}
		}
		CalcTotalQty();
	...
	private void ULGData_ClickCellButton(object sender, CellEventArgs e)
	{
		...
		frmSLNQuotationsSlings frmSLNQuotationsSlings2 = new frmSLNQuotationsSlings(Adding ? (-1) : int.Parse(drMaster["QuotationID"].ToString()), int.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["QuotationDetailID"].Value.ToString()), decimal.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Qty"].Value.ToString()), ((UltraGridBase)ULGData).ActiveRow.Cells["Notes"].Value.ToString(), !Adding && !Updating, dtpDate.DateTime, dtQuotationsDetailsSlings, dtQuotationsDetailsSlingsMaterials);
		frmSLNQuotationsSlings2.WindowState = FormWindowState.Maximized;
		((Control)(object)frmSLNQuotationsSlings2.lblTitle).Text = (GlobalVariables.IsArabic ? "Sling Manufacturing" : "Sling Manufacturing");
		DialogResult dialogResult = frmSLNQuotationsSlings2.ShowDialog();
		ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
		((UltraGridBase)ULGData).ActiveRow.Cells["Qty"].Value = frmSLNQuotationsSlings2.TotalQty;
		((UltraGridBase)ULGData).ActiveRow.Cells["Notes"].Value = frmSLNQuotationsSlings2.SlingDesc;
		ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
		DataView dataView = new DataView(dtQuotationsDetailsSlingsMaterials);
		dataView.RowFilter = " QuotationDetailID= " + ((UltraGridBase)ULGData).ActiveRow.Cells["QuotationDetailID"].Value.ToString();
		object obj = dataView.ToTable().Compute(" Sum(TotalCostPrice) ", "");
		if (frmSLNQuotationsSlings2.Saved && obj != DBNull.Value)
		{
			ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
			((UltraGridBase)ULGData).ActiveRow.Cells["TotalCostPrice"].Value = obj.ToString();
			((UltraGridBase)ULGData).ActiveRow.Cells["UnitCostPrice"].Value = ((frmSLNQuotationsSlings2.TotalQty == 0m) ? 0m : (decimal.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["TotalCostPrice"].Value.ToString()) / decimal.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Qty"].Value.ToString())));
			if (decimal.Parse((((Control)(object)txtExchangeRate).Text == "" || ((Control)(object)txtExchangeRate).Text == ".") ? "0" : ((Control)(object)txtExchangeRate).Text) == 0m)
			{
	...
	private void btnPreQuotationsSearch_Click(object sender, EventArgs e)
	{
		int num = SearchFunctions.SLNPreQuotationsSearch(-1, 0, 0);
		if (num != 0)
		{
			((TextEditorControlBase)cboPreQuotations).Value = num;
		}
	}

	private void cboPreQuotations_ValueChanged(object sender, EventArgs e)
	{
		((TextEditorControlBase)cboPreQuotations).ValueChanged -= cboPreQuotations_ValueChanged;
		((TextEditorControlBase)cboCurrency).ValueChanged -= cboCurrency_ValueChanged;
		((TextEditorControlBase)cboClient).ValueChanged -= cboClient_ValueChanged;
		if (cboPreQuotations.SelectedIndex > -1)
		{
			DataRow dataRow = dtPreQuotations.Select("PreQuotationID = " + ((TextEditorControlBase)cboPreQuotations).Value.ToString())[0];
			...
			((TextEditorControlBase)cboClientContacts).Value = dataRow["ClientContactID"];
			((TextEditorControlBase)cboCurrency).Value = dataRow["CurrencyID"];
			((Control)(object)txtClientOrderNo).Text = dataRow["ClientOrderNo"].ToString();
			((Control)(object)txtNotes).Text = dataRow["Notes"].ToString();
			((Control)(object)txtTermsOfPayment).Text = dataRow["TermsOfPayment"].ToString();
			((Control)(object)txtDeliveryPlace).Text = dataRow["DeliveryPlace"].ToString();
			((Control)(object)txtProfitPercentage).Text = decimal.Parse(dataRow["ProfitPercentage"].ToString()).ToString(GlobalVariables.txtDecimalFormate);
			((Control)(object)txtTotalCost).Text = decimal.Parse(dataRow["TotalCost"].ToString()).ToString(GlobalVariables.txtDecimalFormate);
			((Control)(object)txtTotalPrice).Text = decimal.Parse(dataRow["TotalPrice"].ToString()).ToString(GlobalVariables.txtDecimalFormate);
			((Control)(object)txtDiscBeforeTaxValue).Text = decimal.Parse(dataRow["DiscountBeforeTaxValue"].ToString()).ToString(GlobalVariables.txtDecimalFormate);
			((Control)(object)txtDiscBeforeTaxRatio).Text = decimal.Parse(dataRow["DiscountbeforeTaxRatio"].ToString()).ToString(GlobalVariables.txtDecimalFormate);
			((Control)(object)txtNetprice).Text = decimal.Parse(dataRow["NetPrice"].ToString()).ToString(GlobalVariables.txtDecimalFormate);
			...
			dtpExpectedDeliveryDate.Value = dataRow["ExpectedDeliveryDate"];
			dtPreQuotationsDetails = QuotationsDetails.FillByPreQuotationID(((TextEditorControlBase)cboPreQuotations).Value.ToString(), GlobalVariables.IsArabic ? "1" : "0");
			dtQuotationsDetailsSlings = QuotationsDetailsSlings.FillByPreQuotationID(((TextEditorControlBase)cboPreQuotations).Value.ToString(), GlobalVariables.IsArabic ? "1" : "0");
			dtQuotationsDetailsSlingsMaterials = QuotationsDetailsSlingsMaterials.FillByPreQuotationID(((TextEditorControlBase)cboPreQuotations).Value.ToString(), GlobalVariables.IsArabic ? "1" : "0");
			for (int i = 0; i < dtPreQuotationsDetails.Rows.Count; i++)
			{
				int num = int.Parse(dtPreQuotationsDetails.Rows[i]["QuotationDetailID"].ToString());
				dtPreQuotationsDetails.Rows[i]["QuotationDetailID"] = ++newID;
				for (int j = 0; j < dtQuotationsDetailsSlings.Rows.Count; j++)
				{
					if (int.Parse(dtQuotationsDetailsSlings.Rows[j]["QuotationDetailID"].ToString()) == num)
					{
						dtQuotationsDetailsSlings.Rows[j]["QuotationDetailID"] = dtPreQuotationsDetails.Rows[i]["QuotationDetailID"];
					}
				}
				for (int k = 0; k < dtQuotationsDetailsSlingsMaterials.Rows.Count; k++)
				{
					if (int.Parse(dtQuotationsDetailsSlingsMaterials.Rows[k]["QuotationDetailID"].ToString()) == num)
					{
						dtQuotationsDetailsSlingsMaterials.Rows[k]["QuotationDetailID"] = dtPreQuotationsDetails.Rows[i]["QuotationDetailID"];
					}
				}
			}
			((UltraGridBase)ULGData).DataSource = dtPreQuotationsDetails.Copy();
			CalcTotalQty();
			CalculateTotalPrice();
			CalculateTotalCostPrice();
		}
	...
	public override void ULGData_BeforeRowsDeleted(object sender, BeforeRowsDeletedEventArgs e)
	{
		...
		{
			if (e.Rows[i].Cells["QuotationDetailID"].Value != DBNull.Value)
			{
				ArDetailIDs.Add(e.Rows[i].Cells["QuotationDetailID"].Value);
			}
			if (Convert.ToBoolean(e.Rows[i].Cells["HasInvoice"].Value))
			{
				GlobalVariables.InformationMB.Show("لايمكن حذف هذاالصنف لانه تم عمل فاتورة عليه", "Cannot Delete this Item Because It Has An Invoice");
	...
	public override void btnDeleteClick()
	{
		...
		if (bool.Parse(drMaster["HasInvoice"].ToString()))
		{
			GlobalVariables.InformationMB.Show("لا يمكن حذف هذه الحركة لوجود فاتورة على هذا الاذن برجاء حذف الفاتورة اولا", "Cannot Delete This Transaction Because There Is An Invoice Was Made on This order Please Delete The Invoice First   ");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sling.Transactions.frmSLNQuotations));
		...
		this.cboPreQuotations = new UltraComboEditor();
		this.lblPreQuotation = new UltraLabel();
		this.btnPreQuotationsSearch = new UltraButton();
		...
		((System.ComponentModel.ISupportInitialize)this.cboPreQuotations).BeginInit();
		...
		resources.ApplyResources(this.cboPreQuotations, "cboPreQuotations");
		this.cboPreQuotations.AutoCompleteMode = (AutoCompleteMode)4;
		((System.Windows.Forms.Control)(object)this.cboPreQuotations).Name = "cboPreQuotations";
		((TextEditorControlBase)this.cboPreQuotations).ValueChanged += new System.EventHandler(cboPreQuotations_ValueChanged);
		resources.ApplyResources(this.lblPreQuotation, "lblPreQuotation");
		this.lblPreQuotation.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblPreQuotation).Name = "lblPreQuotation";
		((ControlBase)this.lblPreQuotation).WrapText = false;
		resources.ApplyResources(this.btnPreQuotationsSearch, "btnPreQuotationsSearch");
		((AppearanceBase)val10).Image = ERP.Properties.Resources.search;
		resources.ApplyResources(val10, "appearance12");
		((ControlBase)this.btnPreQuotationsSearch).Appearance = (AppearanceBase)(object)val10;
		((System.Windows.Forms.Control)(object)this.btnPreQuotationsSearch).Name = "btnPreQuotationsSearch";
		((System.Windows.Forms.Control)(object)this.btnPreQuotationsSearch).Click += new System.EventHandler(btnPreQuotationsSearch_Click);
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.cboPreQuotations);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblPreQuotation);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.btnPreQuotationsSearch);
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.btnPreQuotationsSearch, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblPreQuotation, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.cboPreQuotations, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.cboPreQuotations).EndInit();
