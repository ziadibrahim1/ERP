...
public class frmEmployeesSearch : frmSearch
{
	private IContainer components = null;

	public frmEmployeesSearch()
	{
		InitializeComponent();
	}

	public frmEmployeesSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["JobName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
