...
public class frmAdministrativeStructureSearch : frmSearch
{
	private IContainer components = null;

	public frmAdministrativeStructureSearch()
	{
		InitializeComponent();
	}

	public frmAdministrativeStructureSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
