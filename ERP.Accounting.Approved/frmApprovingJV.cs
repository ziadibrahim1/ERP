...
public class frmApprovingJV : frmPosted
{
	private IContainer components = null;

	public frmApprovingJV()
	{
		InitializeComponent();
		NoCol = "JVNo";
	}
	...
	{
		dtsource = JV.Search("," + GlobalVariables.CurrentBranchID + ",", DateTime.Now.AddYears(-20).ToString(GlobalVariables.DateShortFormate), DateTime.Now.AddYears(20).ToString(GlobalVariables.DateShortFormate), "0", "0", GlobalVariables.IsArabic ? "1" : "0", GlobalVariables.SeeingInvisibleAcounts ? "1" : "0");
	...
	{
		DataTable dataTable = SearchFunctions.JVReport(GlobalVariables.BranchIDs, 0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Accounting.Approved.frmApprovingJV));
