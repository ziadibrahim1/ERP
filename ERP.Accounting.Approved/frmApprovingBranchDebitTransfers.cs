...
public class frmApprovingBranchDebitTransfers : frmPosted
{
	private IContainer components = null;

	public frmApprovingBranchDebitTransfers()
	{
		InitializeComponent();
	...
	{
		dtsource = BranchDebitTransfers.Search("," + GlobalVariables.CurrentBranchID + ",", DateTime.Now.AddYears(-20).ToString(GlobalVariables.DateShortFormate), DateTime.Now.AddYears(20).ToString(GlobalVariables.DateShortFormate), "0", "0", GlobalVariables.IsArabic ? "1" : "0", GlobalVariables.SeeingInvisibleAcounts ? "1" : "0", IsFromServer: false);
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			BranchDebitTransfers.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد تحويل مديونيه بين الفروع لإعتمادها " : "There are No Branch Debit Transfer to Approve");
		}
	}
	...
	public override void ClickCellButton()
	{
		if (((UltraGridBase)ULGData).ActiveRow != null)
		{
			...
			((Control)(object)frmBranchDebitTransfer2.lblTitle).Text = (GlobalVariables.IsArabic ? "تحويل مديونية بين الفروع" : "Branch Debit Transfer");
	...
	{
		DataTable dataTable = SearchFunctions.BranchDebitTransfersReport(0, 0, IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Accounting.Approved.frmApprovingBranchDebitTransfers));
		...
		base.Name = "frmApprovingBranchDebitTransfers";
