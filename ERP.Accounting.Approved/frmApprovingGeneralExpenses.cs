...
public class frmApprovingGeneralExpenses : frmPosted
{
	private IContainer components = null;

	public frmApprovingGeneralExpenses()
	{
		InitializeComponent();
	...
	{
		dtsource = GeneralExpenses.Search("," + GlobalVariables.CurrentBranchID + ",", DateTime.Now.AddYears(-20).ToString(GlobalVariables.DateShortFormate), DateTime.Now.AddYears(20).ToString(GlobalVariables.DateShortFormate), "0", "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			GeneralExpenses.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد مصروفات اداريه لإعتمادها " : "There are No General Expenses to Approve");
		}
	}
	...
	public override void ClickCellButton()
	{
		if (((UltraGridBase)ULGData).ActiveRow != null)
		{
			...
			((Control)(object)frmGeneralExpenses2.lblTitle).Text = (GlobalVariables.IsArabic ? "مصروفات اداريه" : "General Expenses");
	...
	{
		DataTable dataTable = SearchFunctions.GeneralExpensesSearchReport(0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Accounting.Approved.frmApprovingGeneralExpenses));
		...
		base.Name = "frmApprovingGeneralExpenses";
