...
public class frmApprovingForeignCurrencySettlements : frmPosted
{
	private IContainer components = null;

	public frmApprovingForeignCurrencySettlements()
	{
		InitializeComponent();
	...
	{
		dtsource = ForeignCurrencySettlements.Search("0", "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			ForeignCurrencySettlements.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد تسوية عملات اجنبية لإعتمادها " : "There are No  Foreign Currency Settlements to Approve");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.ForeignCurrencySettlementsSearchReport(0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Accounting.Approved.frmApprovingForeignCurrencySettlements));
		...
		base.Name = "frmApprovingForeignCurrencySettlements";
