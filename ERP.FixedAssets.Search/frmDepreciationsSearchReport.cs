...
public class frmDepreciationsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmDepreciationsSearchReport()
	{
		InitializeComponent();
	}

	public frmDepreciationsSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DepreciationNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DepreciationDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
