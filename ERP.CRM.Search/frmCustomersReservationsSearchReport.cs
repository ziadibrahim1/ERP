...
public class frmCustomersReservationsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmCustomersReservationsSearchReport()
	{
		InitializeComponent();
	}

	public frmCustomersReservationsSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ReceivingDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.08);
