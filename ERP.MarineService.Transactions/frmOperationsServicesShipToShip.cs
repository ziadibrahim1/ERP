...
public class frmOperationsServicesShipToShip : frmDetails
{
	...
	private UltraLabel lblArrivalDate;
	...
	public frmOperationsServicesShipToShip()
	{
		InitializeComponent();
	}

	public frmOperationsServicesShipToShip(DataTable DTServices, string OPERATIONSERVICEID, string OPERATIONID, string SERVICEID, bool READONLY)
		: this()
	{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Selected"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExportDeclarationNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.3);
	...
	public override void DisplayData()
	{
		...
		{
			dtDetails = OperationsServicesShipToShip.SelectByOperationServiceID(OperationServiceID.ToString(), GlobalVariables.IsArabic ? "1" : "0");
			if (dtDetails.Rows.Count > 0)
			{
				((TextEditorControlBase)cboFromVessel).Value = dtDetails.Rows[0]["FromVesselID"];
				dtpDate.Value = dtDetails.Rows[0]["FromVesselArrivalDate"];
				((TextEditorControlBase)txtNotes).Value = dtDetails.Rows[0]["Notes"];
			}
			dtCargoDetails = OperationsServicesCargos.SelectForShipToShip(OperationID, OperationServiceID);
			InitGrid();
		}
	}
	...
	public override void SaveData()
	{
		...
		try
		{
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				if (bool.Parse(((UltraGridBase)ULGData).Rows[i].Cells["Selected"].Value.ToString()))
				{
					OperationsServicesShipToShip.Insert_Update(((UltraGridBase)ULGData).Rows[i].Cells["OperationServiceShipToShipID"].Value.ToString(), OperationServiceID, OperationID, ((TextEditorControlBase)cboFromVessel).Value.ToString(), dtpDate.Value.ToString(), ((UltraGridBase)ULGData).Rows[i].Cells["OperationServiceCargoID"].Value.ToString(), ((Control)(object)txtNotes).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
				}
				else if (!bool.Parse(((UltraGridBase)ULGData).Rows[i].Cells["Selected"].Value.ToString()) && !((UltraGridBase)ULGData).Rows[i].Cells["OperationServiceShipToShipID"].Value.ToString().Equals("-1"))
				{
					OperationsServicesShipToShip.Delete(((UltraGridBase)ULGData).Rows[i].Cells["OperationServiceShipToShipID"].Value.ToString(), GlobalVariables.UserID);
				}
			}
	...
	private void btnVesselSearch_Click(object sender, EventArgs e)
	{
		...
		if (num != 0)
		{
			((TextEditorControlBase)cboFromVessel).Value = num;
		}
	}

	private void lblfromVessel_Click(object sender, EventArgs e)
	{
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmOperationsServicesShipToShip));
		...
		this.lblArrivalDate = new UltraLabel();
		...
		((System.Windows.Forms.Control)(object)this.lblfromVessel).Click += new System.EventHandler(lblfromVessel_Click);
		resources.ApplyResources(this.cboFromVessel, "cboFromVessel");
		((TextEditorControlBase)this.cboFromVessel).AlwaysInEditMode = true;
		...
		this.lblArrivalDate.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblArrivalDate).Name = "lblArrivalDate";
		((ControlBase)this.lblArrivalDate).WrapText = false;
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblArrivalDate);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.dtpDate);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.btnVesselSearch);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.lblfromVessel);
		base.Controls.Add((System.Windows.Forms.Control)(object)this.cboFromVessel);
		...
		base.Name = "frmOperationsServicesShipToShip";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.cboFromVessel, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblfromVessel, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.btnVesselSearch, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.dtpDate, 0);
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.lblArrivalDate, 0);
