...
public class frmInsertSeaManTransfer : frmBase
{
	...
	public UltraGroupBox UGBTransferData;
	...
	private UltraComboEditor cboToVessel;

	private UltraLabel lblToVessel;

	private UltraComboEditor cboFromVessel;

	private UltraLabel lblFromVessel;

	public frmInsertSeaManTransfer()
	{
		InitializeComponent();
	}

	public frmInsertSeaManTransfer(string OPERATIONID, string OPERATIONSERVICEID, string VESSELID)
		: this()
	{
	...
	public override void PrepareData()
	{
		...
		GlobalFunctions.FillCombo(cboFromVessel, dtVessels, "VesselID", "VesselName");
		GlobalFunctions.FillCombo(cboToVessel, dtVessels, "VesselID", "VesselName");
		((TextEditorControlBase)cboFromVessel).Value = VesselID;
		((TextEditorControlBase)cboToVessel).Value = VesselID;
	}
	...
	public bool ValidateData()
	{
		...
		{
			if (cboFromVessel.SelectedIndex == -1)
			{
				GlobalVariables.InformationMB.Show("برجاء إختيار من باخرة", "Please Select From Vessel");
				((TextEditorControlBase)cboFromVessel).Focus();
				return false;
			}
			if (cboToVessel.SelectedIndex == -1)
			{
				GlobalVariables.InformationMB.Show("برجاء إختيار الى باخرة", "Please Select To Vessel");
				((TextEditorControlBase)cboToVessel).Focus();
				return false;
			}
			if (((TextEditorControlBase)cboToVessel).Value.ToString() == ((TextEditorControlBase)cboFromVessel).Value.ToString())
			{
				GlobalVariables.InformationMB.Show("لايمكن أن يكون الباخرة المحول منها البحار نفس الباخرة المحول اليها البحار", "SeaMan From Vessel Cannot be the Same To Vessel");
				((TextEditorControlBase)cboToVessel).Focus();
				return false;
			}
			if (((TextEditorControlBase)cboToVessel).Value.ToString() != VesselID && ((TextEditorControlBase)cboFromVessel).Value.ToString() != VesselID)
			{
				GlobalVariables.InformationMB.Show(" لابد من إختيار الباخرة " + dtVessels.Select(" VesselID= " + VesselID)[0]["VesselName"].ToString() + " على الاقل ", " Please Select Vessel " + dtVessels.Select(" VesselID= " + VesselID)[0]["VesselName"].ToString() + " At Least ");
				((TextEditorControlBase)cboToVessel).Focus();
				return false;
			}
		}
	...
	private void btnSave_Click(object sender, EventArgs e)
	{
		...
		try
		{
			OperationsServicesTransfers.Insert_Update("-1", (OperationServiceID == "") ? "Null" : OperationServiceID, (OperationID == "") ? "Null" : OperationID, ((TextEditorControlBase)cboFromVessel).Value.ToString(), ((TextEditorControlBase)cboToVessel).Value.ToString(), SubAccountID, ((Control)(object)txtNotes).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmInsertSeaManTransfer));
		...
		this.UGBTransferData = new UltraGroupBox();
		this.cboToVessel = new UltraComboEditor();
		this.lblToVessel = new UltraLabel();
		this.cboFromVessel = new UltraComboEditor();
		this.txtNotes = new UltraTextEditor();
		this.lblFromVessel = new UltraLabel();
		...
		((System.ComponentModel.ISupportInitialize)this.UGBTransferData).BeginInit();
		((System.Windows.Forms.Control)(object)this.UGBTransferData).SuspendLayout();
		((System.ComponentModel.ISupportInitialize)this.cboToVessel).BeginInit();
		((System.ComponentModel.ISupportInitialize)this.cboFromVessel).BeginInit();
		...
		resources.ApplyResources(this.UGBTransferData, "UGBTransferData");
		this.UGBTransferData.CaptionAlignment = (GroupBoxCaptionAlignment)1;
		((System.Windows.Forms.Control)(object)this.UGBTransferData).Controls.Add((System.Windows.Forms.Control)(object)this.cboToVessel);
		((System.Windows.Forms.Control)(object)this.UGBTransferData).Controls.Add((System.Windows.Forms.Control)(object)this.lblToVessel);
		((System.Windows.Forms.Control)(object)this.UGBTransferData).Controls.Add((System.Windows.Forms.Control)(object)this.cboFromVessel);
		((System.Windows.Forms.Control)(object)this.UGBTransferData).Controls.Add((System.Windows.Forms.Control)(object)this.txtNotes);
		((System.Windows.Forms.Control)(object)this.UGBTransferData).Controls.Add((System.Windows.Forms.Control)(object)this.lblFromVessel);
		((System.Windows.Forms.Control)(object)this.UGBTransferData).Controls.Add((System.Windows.Forms.Control)(object)this.lblNotes);
		((System.Windows.Forms.Control)(object)this.UGBTransferData).Name = "UGBTransferData";
		resources.ApplyResources(this.cboToVessel, "cboToVessel");
		this.cboToVessel.AutoCompleteMode = (AutoCompleteMode)4;
		((System.Windows.Forms.Control)(object)this.cboToVessel).Name = "cboToVessel";
		resources.ApplyResources(this.lblToVessel, "lblToVessel");
		...
		((ControlBase)this.lblToVessel).Appearance = (AppearanceBase)(object)val16;
		this.lblToVessel.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblToVessel).Name = "lblToVessel";
		((ControlBase)this.lblToVessel).WrapText = false;
		resources.ApplyResources(this.cboFromVessel, "cboFromVessel");
		this.cboFromVessel.AutoCompleteMode = (AutoCompleteMode)4;
		((System.Windows.Forms.Control)(object)this.cboFromVessel).Name = "cboFromVessel";
		resources.ApplyResources(this.txtNotes, "txtNotes");
		((System.Windows.Forms.Control)(object)this.txtNotes).Name = "txtNotes";
		resources.ApplyResources(this.lblFromVessel, "lblFromVessel");
		...
		((ControlBase)this.lblFromVessel).Appearance = (AppearanceBase)(object)val17;
		this.lblFromVessel.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblFromVessel).Name = "lblFromVessel";
		((ControlBase)this.lblFromVessel).WrapText = false;
		resources.ApplyResources(this.lblNotes, "lblNotes");
		this.lblNotes.AutoEllipsis = false;
		((System.Windows.Forms.Control)(object)this.lblNotes).Name = "lblNotes";
		((ControlBase)this.lblNotes).WrapText = false;
		resources.ApplyResources(this, "$this");
		base.Controls.Add((System.Windows.Forms.Control)(object)this.UGBTransferData);
		...
		base.Name = "frmInsertSeaManTransfer";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.UGBTransferData, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.UGBTransferData).EndInit();
		((System.Windows.Forms.Control)(object)this.UGBTransferData).ResumeLayout(false);
		((System.Windows.Forms.Control)(object)this.UGBTransferData).PerformLayout();
		((System.ComponentModel.ISupportInitialize)this.cboToVessel).EndInit();
		((System.ComponentModel.ISupportInitialize)this.cboFromVessel).EndInit();
