...
public class frmOperationsServicesSeaManBooking : frmDetails
{
	...
	public frmOperationsServicesSeaManBooking()
	{
	...
	public frmOperationsServicesSeaManBooking(DataTable DTServices, string OPERATIONSERVICEID, string OPERATIONID, string SERVICEID, bool READONLY)
		: this()
	{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationServiceSeaManBookingID"].DefaultCellValue = -1;
	...
	public override void DisplayData()
	{
		...
		{
			dtDetails = OperationsServicesSeaManBooking.SelectByOperationServiceID(OperationServiceID.ToString(), GlobalVariables.IsArabic ? "1" : "0");
			InitGrid();
		}
	}
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا يمكن اضافه جديد على هذه الخدمه لوجود فاتورة" : "Cannot add new entries on this serivce because it is related to an invoice");
			return false;
		}
		...
		if (NoInvoice)
		{
			...
			try
			{
				...
				for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
				{
					...
					text = text + ((UltraGridBase)ULGData).Rows[i].Cells["OperationServiceSeaManBookingID"].Value.ToString() + ",";
				}
				Main.SyncDeleteForUpdate("MS_OperationsServicesSeaManBooking", "OperationServiceID", OperationServiceID, "OperationServiceSeaManBookingID", text, IsFromServer: false);
				if (((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count > 0)
				{
					OperationsServicesSeaManBooking.Insert_UpdateByTable((DataTable)((UltraGridBase)ULGData).DataSource, GlobalVariables.UserID);
				}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmOperationsServicesSeaManBooking));
		...
		base.Name = "frmOperationsServicesSeaManBooking";
