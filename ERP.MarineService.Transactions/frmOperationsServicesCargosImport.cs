...
public class frmOperationsServicesCargosImport : frmDetails
{
	...
	public frmOperationsServicesCargosImport()
	{
	...
	public frmOperationsServicesCargosImport(DataTable DTServices, string OPERATIONSERVICEID, string OPERATIONID, string SERVICEID, bool READONLY)
		: this()
	{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["LoadTypeID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BillNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BillDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DeliveryNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DeliveryDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InTallySheet"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CustomFees"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DepositAmount"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DepositDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExpectedReturnDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsReturned"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExportDeclarationNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الاستيراد" : "Import No");
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["LoadingDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ التفريغ" : "Off Loading Date");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BillNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم البوليصة" : "BL No.");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BillDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ البوليصة" : "BL Date");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DeliveryNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم اذن التسليم" : "Delivery No.");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DeliveryDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ اذن التسليم" : "Delivery Date");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsReImport"].Header).Caption = (GlobalVariables.IsArabic ? "إعادة إستيراد" : "Temp. Import");
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CustomFees"].Header).Caption = (GlobalVariables.IsArabic ? "رسوم جمارك" : "Custom Fees");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DepositAmount"].Header).Caption = (GlobalVariables.IsArabic ? "قيمة التامين" : "Deposit Amount");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DepositDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ التامين" : "Deposit Date");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExpectedReturnDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الرجوع المتوقع" : "Expected Return Date");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsReturned"].Header).Caption = (GlobalVariables.IsArabic ? "مرتجع" : "Returned");
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ReturnDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الارتجاع" : "Returned Date");
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InTallySheet"].Header).Caption = (GlobalVariables.IsArabic ? "متضمنه في البيان" : "In Tally Sheet");
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsReImport"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Qty"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["LoadedQty"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CustomFees"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DepositAmount"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DepositDate"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExpectedReturnDate"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsReturned"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ReturnDate"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BillNo"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["BillDate"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DeliveryNo"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DeliveryDate"].Hidden = false;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InTallySheet"].Hidden = false;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CustomFees"].DefaultCellValue = 0;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DepositAmount"].DefaultCellValue = 0;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Weight"].DefaultCellValue = 0;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsReturned"].DefaultCellValue = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsReImport"].DefaultCellValue = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InTallySheet"].DefaultCellValue = false;
	}
	...
	public override void SaveData()
	{
		...
		try
		{
			...
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				...
				((UltraGridBase)ULGData).Rows[i].Cells["IsExportDeclaration"].Value = false;
	...
	public override void SelectFullRow(object sender, EventArgs e)
	{
		...
		else if (((UltraGridBase)ULGData).ActiveRow != null && ULGData.ActiveCell != null && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "CustomFees" && bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["IsReImport"].Value.ToString()))
		{
			((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
		}
		else if (((UltraGridBase)ULGData).ActiveRow != null && ULGData.ActiveCell != null && ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "ExpectedReturnDate" && (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "DepositAmount" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "DepositDate") && !bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["IsReImport"].Value.ToString()))
		{
			((GridItemBase)((UltraGridBase)ULGData).ActiveRow).Selected = true;
		}
	}
	...
	public override void ULGData_CellChange(object sender, CellEventArgs e)
	{
		...
		if (((KeyedSubObjectBase)e.Cell.Column).Key == "IsReImport")
		{
			...
			{
				e.Cell.Row.Cells["CustomFees"].Value = 0;
			}
			else
			{
				e.Cell.Row.Cells["DepositAmount"].Value = 0;
				e.Cell.Row.Cells["DepositDate"].Value = DBNull.Value;
			}
			ULGData.CellChange += new CellEventHandler(ULGData_CellChange);
			ULGData.AfterCellUpdate += new CellEventHandler(ULGData_AfterCellUpdate);
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmOperationsServicesCargosImport));
		...
		base.Name = "frmOperationsServicesCargosImport";
