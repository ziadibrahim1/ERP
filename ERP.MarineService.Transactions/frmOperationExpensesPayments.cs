...
public class frmOperationExpensesPayments : frmHeaderDetails
{
	...
	public frmOperationExpensesPayments()
	{
		InitializeComponent();
		TableName = "MS_OperationsExpensesPayments";
		IDCol = "OperationExpensePaymentID";
		NoCol = "OperationExpensePaymentNo";
		DateCol = "OperationExpensePaymentDate";
		((Control)(object)btnJV3).Text = (((Control)(object)btnJV2).Text = (((Control)(object)btnJV).Text = (GlobalVariables.IsArabic ? "قيد " : "JV")));
	}

	public frmOperationExpensesPayments(int ID)
		: this()
	{
		RowID = ID.ToString();
	}
	...
	public override void PrepareData()
	{
		...
		DataView dataView = new DataView(dtBanks);
		dataView.RowFilter = "CurrencyID =" + dtCurrency.Rows[0]["CurrencyID"].ToString();
		dataView.RowStateFilter = DataViewRowState.CurrentRows;
		GlobalFunctions.FillCombo(cboBank, dataView.ToTable(), "BankID", "BankName");
		...
		dtDetails = OperationsExpensesPaymentsDetails.SelectByOperationExpensePaymentID("0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void FillData()
	{
		if (SubAccountID != "0")
		{
			drMaster = null;
			btnAddClick();
			((TextEditorControlBase)cboSubAccountName).Value = SubAccountID;
			DisplayData();
			bool adding = Adding;
		...
		{
			DataTable dataTable = OperationsExpensesPayments.Select(RowID, GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((Control)(object)txtCode).Text = drMaster["OperationExpensePaymentNo"].ToString();
			dtpDate.Value = (DateTime)drMaster["OperationExpensePaymentDate"];
			...
			dtDetails = OperationsExpensesPaymentsDetails.SelectByOperationExpensePaymentID(drMaster["OperationExpensePaymentID"].ToString(), GlobalVariables.IsArabic ? "1" : "0");
			((UltraGridBase)ULGData).DataSource = dtDetails;
			InitGrid();
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)cboAccountName).ReadOnly = !Adding;
		((EditorButtonControlBase)cboSubAccountName).ReadOnly = !Adding;
		...
		((Control)(object)btnAccountSearch).Visible = Adding;
		((Control)(object)btnSubAccountSearch).Visible = Adding;
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtCode).Text = (Adding ? OperationsExpensesPayments.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PaidDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PaidDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ المصروف" : "Expense Date");
	...
	public override bool ValidateData()
	{
		...
		if (Updating && DateTime.Parse(drMaster["OperationExpensePaymentDate"].ToString()).Year != dtpDate.DateTime.Year)
		{
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("MS_OperationsExpensesPayments", "OperationExpensePaymentNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["OperationExpensePaymentNo"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
			string codeByBranchID = OperationsExpensesPayments.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		...
		else
		{
			...
			if (decimal.Parse(((Control)(object)txtTotal).Text) > 0m && decimal.Parse(((Control)(object)txtTotal).Text) - decimal.Parse(((Control)(object)txtDebitBalance).Text) - decimal.Parse((((Control)(object)txtCreditBalance).Text == "" || ((Control)(object)txtCreditBalance).Text == ".") ? "0" : ((Control)(object)txtCreditBalance).Text) > decimal.Parse(((Control)(object)txtPaidAmount).Text))
			{
	...
	public override void AddData()
	{
		...
		try
		{
			string text = ((((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count == 0) ? "" : (GlobalVariables.IsArabic ? "  سداد  مصروفات عمليات رقم  " : " Operation Expense Payment No "));
			int num = OperationsExpensesPayments.Insert_Update("-1", ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((TextEditorControlBase)cboAccountName).Value.ToString(), ((TextEditorControlBase)cboSubAccountName).Value.ToString(), rbIsCheck.Checked ? "1" : "0", rbPayable.Checked ? "1" : "0", rbIsSafe.Checked ? "1" : "0", (cboSafe.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSafe).Value.ToString(), ((TextEditorControlBase)cboCurrency).Value.ToString(), ((Control)(object)txtExchangeRate).Text, rbIsCheck.Checked ? ((Control)(object)txtCheckNo).Text : "Null", rbIsCheck.Checked ? dtpCheckDate.DateTime.ToString(GlobalVariables.DateLongFormate) : "Null", (!rbIsCheck.Checked && !rbPayable.Checked) ? "Null" : ((cboBank.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboBank).Value.ToString()), ((Control)(object)txtChargedPerson).Text, ((Control)(object)txtDebitBalance).Text, (((Control)(object)txtCreditBalance).Text == "" || ((Control)(object)txtCreditBalance).Text == ".") ? "0" : ((Control)(object)txtCreditBalance).Text, ((Control)(object)txtPaidAmount).Text, ((Control)(object)txtNotes).Text, ((Control)(object)txtTotal).Text, ((Control)(object)txtPayingBank).Text, (cboBinderSafe.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboBinderSafe).Value.ToString(), "Null", "Null", "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				OperationsExpensesPaymentsDetails.Insert_Update("-1", num.ToString(), ((UltraGridBase)ULGData).Rows[i].Cells["OperationExpenseID"].Value.ToString(), ((UltraGridBase)ULGData).Rows[i].Cells["PaidAmount"].Value.ToString(), ((UltraGridBase)ULGData).Rows[i].Cells["Notes"].Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
				text = ((i != ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count - 1) ? (text + ((UltraGridBase)ULGData).Rows[i].Cells["ExpenseNo"].Value.ToString() + ",") : (text + ((UltraGridBase)ULGData).Rows[i].Cells["ExpenseNo"].Value.ToString()));
			}
			if (((Control)(object)txtPaidAmount).Text != "" && decimal.Parse(((Control)(object)txtPaidAmount).Text) > 0m)
			{
				if (rbIsSafe.Checked)
				{
					...
					SafeOutDetails.Insert_Update("-1", num2.ToString(), ((Control)(object)txtPaidAmount).Text, ((TextEditorControlBase)cboAccountName).Value.ToString(), ((TextEditorControlBase)cboSubAccountName).Value.ToString(), "Null", "Null", "0", text, GlobalVariables.CurrentBranchID, "0", GlobalVariables.UserID);
					dtJvDetails = JVDetails.Select("0", "-1", GlobalVariables.IsArabic ? "1" : "0");
					DataRow dataRow = dtJvDetails.NewRow();
					dataRow["JVDetailID"] = "-1";
					dataRow["AccountID"] = ((TextEditorControlBase)cboAccountName).Value.ToString();
					dataRow["SubAccountID"] = ((TextEditorControlBase)cboSubAccountName).Value.ToString();
					...
					Main.ExecuteNonQuery(" Update MS_OperationsExpensesPayments  set SafeOutID= " + num2 + " Where OperationExpensePaymentID=" + num);
				}
				else
				{
					...
					BankOutDetails.Insert_Update("-1", num4.ToString(), ((Control)(object)txtPaidAmount).Text, ((TextEditorControlBase)cboAccountName).Value.ToString(), ((TextEditorControlBase)cboSubAccountName).Value.ToString(), "Null", "Null", "0", text, GlobalVariables.CurrentBranchID, "0", GlobalVariables.UserID);
					dtJvDetails = JVDetails.Select("0", "-1", GlobalVariables.IsArabic ? "1" : "0");
					DataRow dataRow2 = dtJvDetails.NewRow();
					dataRow2["JVDetailID"] = "-1";
					dataRow2["AccountID"] = ((TextEditorControlBase)cboAccountName).Value.ToString();
					dataRow2["SubAccountID"] = ((TextEditorControlBase)cboSubAccountName).Value.ToString();
					...
					Main.ExecuteNonQuery(" Update MS_OperationsExpensesPayments  set BankOutID= " + num4 + " Where OperationExpensePaymentID=" + num);
				}
			}
	...
	public override void UpdateData()
	{
		...
		try
		{
			string text = ((((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count == 0) ? "" : (GlobalVariables.IsArabic ? "  سداد مصروفات عمليات رقم  " : " Operation Expenses Payment No "));
			int num = OperationsExpensesPayments.Insert_Update(drMaster["OperationExpensePaymentID"].ToString(), ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((TextEditorControlBase)cboAccountName).Value.ToString(), ((TextEditorControlBase)cboSubAccountName).Value.ToString(), rbIsCheck.Checked ? "1" : "0", rbPayable.Checked ? "1" : "0", rbIsSafe.Checked ? "1" : "0", (cboSafe.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSafe).Value.ToString(), ((TextEditorControlBase)cboCurrency).Value.ToString(), ((Control)(object)txtExchangeRate).Text, rbIsCheck.Checked ? ((Control)(object)txtCheckNo).Text : "Null", rbIsCheck.Checked ? dtpCheckDate.DateTime.ToString(GlobalVariables.DateLongFormate) : "Null", (!rbIsCheck.Checked && !rbPayable.Checked) ? "Null" : ((cboBank.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboBank).Value.ToString()), ((Control)(object)txtChargedPerson).Text, ((Control)(object)txtDebitBalance).Text, (((Control)(object)txtCreditBalance).Text == "" || ((Control)(object)txtCreditBalance).Text == ".") ? "0" : ((Control)(object)txtCreditBalance).Text, ((Control)(object)txtPaidAmount).Text, ((Control)(object)txtNotes).Text, ((Control)(object)txtTotal).Text, ((Control)(object)txtPayingBank).Text, (cboBinderSafe.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboBinderSafe).Value.ToString(), (drMaster["BankOutID"] == DBNull.Value) ? "Null" : drMaster["BankOutID"].ToString(), (drMaster["SafeOutID"] == DBNull.Value) ? "Null" : drMaster["SafeOutID"].ToString(), "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			string text2 = ",";
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				text2 = text2 + ((UltraGridBase)ULGData).Rows[i].Cells["OperationExpensePaymentDetailID"].Value.ToString() + ",";
			}
			Main.DeleteForUpdate("MS_OperationsExpensesPaymentsDetails", "OperationExpensePaymentID", drMaster["OperationExpensePaymentID"].ToString(), "OperationExpensePaymentDetailID", text2);
			for (int j = 0; j < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; j++)
			{
				OperationsExpensesPaymentsDetails.Insert_Update(((UltraGridBase)ULGData).Rows[j].Cells["OperationExpensePaymentDetailID"].Value.ToString(), num.ToString(), ((UltraGridBase)ULGData).Rows[j].Cells["OperationExpenseID"].Value.ToString(), ((UltraGridBase)ULGData).Rows[j].Cells["PaidAmount"].Value.ToString(), ((UltraGridBase)ULGData).Rows[j].Cells["Notes"].Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
				text = ((j != ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count - 1) ? (text + ((UltraGridBase)ULGData).Rows[j].Cells["ExpenseNo"].Value.ToString() + ",") : (text + ((UltraGridBase)ULGData).Rows[j].Cells["ExpenseNo"].Value.ToString()));
			}
			...
			else if (rbIsSafe.Checked && drMaster != null && bool.Parse(drMaster["IsSafe"].ToString()))
			{
				if (((Control)(object)txtPaidAmount).Text != "" && decimal.Parse(((Control)(object)txtPaidAmount).Text) == 0m)
				{
					if (drMaster["SafeOutID"] != DBNull.Value)
					{
						...
						Main.ExecuteNonQuery(" Update MS_OperationsExpensesPayments  set SafeOutID=Null  Where OperationExpensePaymentID=" + num);
					}
				}
				else
				{
					...
					SafeOutDetails.Insert_Update("-1", num6.ToString(), ((Control)(object)txtPaidAmount).Text, ((TextEditorControlBase)cboAccountName).Value.ToString(), ((TextEditorControlBase)cboSubAccountName).Value.ToString(), "Null", "Null", "0", text, GlobalVariables.CurrentBranchID, "0", GlobalVariables.UserID);
					JVDetails.DeleteByJVID(dtSafeOut.Rows[0]["JVID"].ToString(), GlobalVariables.UserID);
					dtJvDetails = JVDetails.Select("0", "-1", GlobalVariables.IsArabic ? "1" : "0");
					DataRow dataRow3 = dtJvDetails.NewRow();
					dataRow3["JVDetailID"] = "-1";
					dataRow3["AccountID"] = ((TextEditorControlBase)cboAccountName).Value.ToString();
					dataRow3["SubAccountID"] = ((TextEditorControlBase)cboSubAccountName).Value.ToString();
					...
					Main.ExecuteNonQuery(" Update MS_OperationsExpensesPayments  set SafeOutID= " + num6 + " Where OperationExpensePaymentID=" + num);
				}
			}
			else if (!rbIsSafe.Checked && drMaster != null && !bool.Parse(drMaster["IsSafe"].ToString()))
			{
				if (((Control)(object)txtPaidAmount).Text != "" && decimal.Parse(((Control)(object)txtPaidAmount).Text) == 0m)
				{
					if (drMaster["BankOutID"] != DBNull.Value)
					{
						...
						Main.ExecuteNonQuery(" Update MS_OperationsExpensesPayments  set BankOutID=Null  Where OperationExpensePaymentID=" + num);
					}
				}
				else
				{
					...
					BankOutDetails.Insert_Update("-1", num8.ToString(), ((Control)(object)txtPaidAmount).Text, ((TextEditorControlBase)cboAccountName).Value.ToString(), ((TextEditorControlBase)cboSubAccountName).Value.ToString(), "Null", "Null", "0", text, GlobalVariables.CurrentBranchID, "0", GlobalVariables.UserID);
					...
					dataRow4["AccountID"] = ((TextEditorControlBase)cboAccountName).Value.ToString();
					dataRow4["SubAccountID"] = ((TextEditorControlBase)cboSubAccountName).Value.ToString();
	...
	public override void DeleteData()
	{
		...
		try
		{
			...
			OperationsExpensesPaymentsDetails.DeleteVirtualByOperationExpensePaymentID(drMaster["OperationExpensePaymentID"].ToString(), GlobalVariables.UserID);
			OperationsExpensesPayments.DeleteVirtual(drMaster["OperationExpensePaymentID"].ToString(), GlobalVariables.UserID);
			Main.EndBulkTrans(FromServer: false);
		}
		catch
		{
	...
	{
		dtSearchResult = SearchFunctions.OperationExpensesPaymentsSearchReport();
		if (dtSearchResult.Rows.Count > 0)
		{
			RowID = dtSearchResult.Rows[0]["OperationExpensePaymentID"].ToString();
			FillData();
		}
	}
	...
	public override void SelectFullRow(object sender, EventArgs e)
	{
		...
		if (ULGData.ActiveCell != null && (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "ExpenseNo" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "PaidDate" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "NetPrice"))
		{
	...
	private void dtpJVDate_ValueChanged(object sender, EventArgs e)
	{
		...
		if (Adding)
		{
			((Control)(object)txtCode).Text = OperationsExpensesPayments.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		}
	}
	...
	private void CalculateSubAccountBalance()
	{
		if (cboSubAccountName.SelectedIndex > -1 && cboCurrency.SelectedIndex > -1 && Adding)
		{
			decimal num = default(decimal);
			...
			num = SubAccounts.Balance(((TextEditorControlBase)cboSubAccountName).Value.ToString(), "-1", "," + GlobalVariables.CurrentBranchID + ",", ((TextEditorControlBase)cboCurrency).Value.ToString(), IsFromServer: false, 0);
			num2 = OperationsExpensesPayments.GetInvoicesBalancesBySubAccountID(((TextEditorControlBase)cboSubAccountName).Value.ToString(), GlobalVariables.CurrentBranchID);
			if (num + num2 < 0m)
			{
	...
	public override void btnRefreshDataClick()
	{
		...
		object value3 = ((TextEditorControlBase)cboSubAccountName).Value;
		...
		((TextEditorControlBase)cboSubAccountName).Value = value3;
	...
	private void btnSelectInvoice_Click(object sender, EventArgs e)
	{
		if (cboSubAccountName.SelectedIndex != -1)
		{
			dtSearchResult = SearchFunctions.OperationExpensesForOperationExpensesPaymentsReport(int.Parse(((TextEditorControlBase)cboSubAccountName).Value.ToString()), "," + GlobalVariables.CurrentBranchID + ",");
			for (int i = 0; i < dtSearchResult.Rows.Count; i++)
			{
				if (dtDetails.Select(" OperationExpenseID= " + dtSearchResult.Rows[i]["OperationExpenseID"].ToString()).Length == 0)
				{
					DataRow dataRow = dtDetails.NewRow();
					dataRow["OperationExpenseID"] = dtSearchResult.Rows[i]["OperationExpenseID"];
					dataRow["ExpenseNo"] = dtSearchResult.Rows[i]["ExpenseNo"];
					dataRow["PaidDate"] = dtSearchResult.Rows[i]["PaidDate"];
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmOperationExpensesPayments));
		...
		((TextEditorControlBase)this.cboSafe).ValueChanged += new System.EventHandler(cboSafe_ValueChanged);
		...
		((System.Windows.Forms.Control)(object)this.btnSubAccountSearch).Click += new System.EventHandler(btnSupplierSearch_Click);
		...
		((EditorButtonControlBase)this.cboSubAccountName).ReadOnly = true;
		...
		((ControlBase)this.btnAccountSearch).Appearance = (AppearanceBase)(object)val14;
		...
		((EditorButtonControlBase)this.cboAccountName).ReadOnly = true;
		...
		base.Name = "frmOperationExpensesPayments";
