...
public class frmPROTasksReports : frmBase
{
	...
	public frmPROTasksReports(string TaskID, string serviceID, string companyID)
		: this()
	{
		RowID = TaskID;
		ServiceID = serviceID;
	...
	public override void PrepareData()
	{
		...
		{
			vlReports.ValueListItems.Add(dtReports.Rows[i]["ReportID"], dtReports.Rows[i]["ReportName"].ToString());
		}
		if (RowID == "-1")
		{
			dtDetails = OperationsServicesStepsTasksReports.SelectByOperationServiceID(ServiceID, GlobalVariables.IsArabic ? "1" : "0");
		}
		else
		{
			dtDetails = OperationsServicesStepsTasksReports.SelectByOperationServiceStepTaskID(RowID, GlobalVariables.IsArabic ? "1" : "0");
		}
	...
	public void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Print"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ReportID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ReportID"].Header).Caption = (GlobalVariables.IsArabic ? "الخطاب" : "Letter");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ReportID"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ReportID"].ValueList = (IValueList)(object)vlReports;
	...
	{
		if (((KeyedSubObjectBase)e.Cell.Column).Key == "Print")
		{
			GlobalVariables.ReportDocument = new ReportDocument();
			GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + dtReports.Select("ReportID=" + e.Cell.Row.Cells["ReportID"].Value)[0]["Rep_E"]);
			frmReporViwer frmReporViwer2 = new frmReporViwer();
			GlobalVariables.ReportDocument.SetParameterValue("@OperationServiceStepTaskID", e.Cell.Row.Cells["OperationServiceStepTaskID"].Value);
			GlobalVariables.ReportDocument.SetParameterValue("@CompanyID", CompanyID);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmPROTasksReports));
