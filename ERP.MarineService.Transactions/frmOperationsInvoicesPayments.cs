...
public class frmOperationsInvoicesPayments : frmHeaderDetails
{
	...
	private UltraTextEditor txtTotalPaidAmountForeign;

	private UltraLabel ultraLabel1;

	public frmOperationsInvoicesPayments()
	{
		InitializeComponent();
		TableName = "MS_OperationsInvoicesPayments";
		IDCol = "OperationInvoicePaymentID";
		NoCol = "OperationInvoicePaymentNo";
		DateCol = "OperationInvoicePaymentDate";
		((Control)(object)btnJV3).Text = (((Control)(object)btnJV2).Text = (((Control)(object)btnJV).Text = (GlobalVariables.IsArabic ? "قيد " : "JV")));
	}

	public frmOperationsInvoicesPayments(int ID)
		: this()
	{
		RowID = ID.ToString();
	}

	public frmOperationsInvoicesPayments(string subaccountid)
		: this()
	{
	...
	public override void PrepareData()
	{
		...
		dtpDate.ValueChanged += dtpJVDate_ValueChanged;
		dtClients = SubAccounts.FillComboBySubAccountTypeIDsForMarineService(GlobalVariables.OwnerSubAccountTypeIDs + GlobalVariables.CharterSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.AgentSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.CaptainSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.SeaManSubAccountTypeIDs.Remove(0, 1), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		...
		dtDetails = OperationsInvoicesPaymentsDetails.SelectByOperationInvoicePaymentID("0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void FillData()
	{
		...
		{
			DataTable dataTable = OperationsInvoicesPayments.Select(RowID, GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((Control)(object)txtCode).Text = drMaster["OperationInvoicePaymentNo"].ToString();
			dtpDate.Value = (DateTime)drMaster["OperationInvoicePaymentDate"];
			...
			((Control)(object)txtTotalPaidAmountForeign).Text = decimal.Parse(drMaster["TotalPaidAmountForeign"].ToString()).ToString(GlobalVariables.txtDecimalFormate);
			...
			dtDetails = OperationsInvoicesPaymentsDetails.SelectByOperationInvoicePaymentID(drMaster["OperationInvoicePaymentID"].ToString(), GlobalVariables.IsArabic ? "1" : "0");
			((UltraGridBase)ULGData).DataSource = dtDetails;
			InitGrid();
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)txtTotalPaidAmountForeign).ReadOnly = NavMode;
		...
		((Control)(object)btnSelectInvoice).Visible = Adding || Updating;
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtCode).Text = (Adding ? OperationsInvoicesPayments.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
		...
		((Control)(object)txtTotalPaidAmountForeign).Text = "0";
	...
	public override void InitGrid()
	{
		base.InitGrid();
		((UltraGridBase)ULGData).DisplayLayout.Override.AllowAddNew = (AllowAddNew)2;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationInvoicePaymentDetailID"].DefaultCellValue = -1;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationInvoiceNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationinvoiceDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("لقد قمت بإختيار تاريخ الشيك تاريخ يقع في فتره ماليه مغلقة", "The Date you choosed For Check Date\n\r exists in closed fisical period");
			return false;
		}
		if (Updating && DateTime.Parse(drMaster["OperationInvoicePaymentDate"].ToString()).Year != dtpDate.DateTime.Year)
		{
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("MS_OperationsInvoicesPayments", "OperationInvoicePaymentNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["OperationInvoicePaymentNo"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
			string codeByBranchID = OperationsInvoicesPayments.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		...
		else
		{
			...
			{
				GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "من فضلك قم بادخال من السيد" : "Please Insert From Mr.");
	...
	public override void AddData()
	{
		...
		try
		{
			string text = ((((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count == 0) ? "" : (GlobalVariables.IsArabic ? "  سداد فاتورة رقم  " : " Invoice Payment No \n"));
			int num = OperationsInvoicesPayments.Insert_Update("-1", ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((TextEditorControlBase)cboClient).Value.ToString(), rbIsCheck.Checked ? "1" : "0", rbDeposit.Checked ? "1" : "0", rbIsSafe.Checked ? "1" : "0", (cboSafe.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSafe).Value.ToString(), ((TextEditorControlBase)cboCurrency).Value.ToString(), ((Control)(object)txtExchangeRate).Text, rbIsCheck.Checked ? ((Control)(object)txtCheckNo).Text : "Null", rbIsCheck.Checked ? dtpCheckDate.DateTime.ToString(GlobalVariables.DateLongFormate) : "Null", (!rbIsCheck.Checked && !rbDeposit.Checked) ? "Null" : ((cboBank.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboBank).Value.ToString()), ((Control)(object)txtChargedPerson).Text, ((Control)(object)txtDebitBalance).Text, ((Control)(object)txtCreditBalance).Text, ((Control)(object)txtPaidAmount).Text, ((Control)(object)txtTotalPaidAmountForeign).Text, ((Control)(object)txtNotes).Text, ((Control)(object)txtTotal).Text, ((Control)(object)txtReceivingBank).Text, (cboBinderSafe.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboBinderSafe).Value.ToString(), "Null", "Null", "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				OperationsInvoicesPaymentsDetails.Insert_Update("-1", num.ToString(), ((UltraGridBase)ULGData).Rows[i].Cells["OperationInvoiceID"].Value.ToString(), ((UltraGridBase)ULGData).Rows[i].Cells["PaidAmount"].Value.ToString(), ((UltraGridBase)ULGData).Rows[i].Cells["Notes"].Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
				text += ((UltraGridBase)ULGData).Rows[i].Cells["OperationInvoiceNo"].Value.ToString();
				if (i != ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count - 1)
				{
					text += "\n";
				}
			}
			if (((Control)(object)txtPaidAmount).Text != "" && decimal.Parse(((Control)(object)txtPaidAmount).Text) > 0m)
			{
				if (rbIsSafe.Checked)
				{
					...
					dataRow["Debit"] = ((Control)(object)txtTotalPaidAmountForeign).Text;
					dataRow["Credit"] = "0";
					...
					dataRow["JVDetailID"] = "-1";
					dataRow["AccountID"] = dtClients.Select(" SubAccountID = " + ((TextEditorControlBase)cboClient).Value.ToString())[0]["DefaultClientAccountID"];
					dataRow["SubAccountID"] = dtClients.Select(" SubAccountID = " + ((TextEditorControlBase)cboClient).Value.ToString())[0]["SubAccountID"];
					dataRow["Debit"] = "0";
					dataRow["Credit"] = ((Control)(object)txtTotalPaidAmountForeign).Text;
					dataRow["CurrencyID"] = ((TextEditorControlBase)cboCurrency).Value.ToString();
					dataRow["ExchangeRate"] = ((Control)(object)txtExchangeRate).Text;
					...
					Main.ExecuteNonQuery(" Update MS_OperationsInvoicesPayments  set SafeInID= " + num2 + " Where OperationInvoicePaymentID=" + num);
				}
				else
				{
					...
					dataRow2["Debit"] = ((Control)(object)txtTotalPaidAmountForeign).Text;
					dataRow2["Credit"] = "0";
					...
					dataRow2["JVDetailID"] = "-1";
					dataRow2["AccountID"] = dtClients.Select(" SubAccountID = " + ((TextEditorControlBase)cboClient).Value.ToString())[0]["DefaultClientAccountID"];
					dataRow2["SubAccountID"] = dtClients.Select(" SubAccountID = " + ((TextEditorControlBase)cboClient).Value.ToString())[0]["SubAccountID"];
					dataRow2["Debit"] = "0";
					dataRow2["Credit"] = ((Control)(object)txtTotalPaidAmountForeign).Text;
					dataRow2["CurrencyID"] = ((TextEditorControlBase)cboCurrency).Value.ToString();
					dataRow2["ExchangeRate"] = ((Control)(object)txtExchangeRate).Text;
					...
					Main.ExecuteNonQuery(" Update MS_OperationsInvoicesPayments  set BankInID= " + num4 + " Where OperationInvoicePaymentID=" + num);
				}
			}
	...
	public override void UpdateData()
	{
		...
		{
			string text = ((((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count == 0) ? "" : (GlobalVariables.IsArabic ? "  سداد فاتورة رقم  " : " Invoice Payment No "));
			int num = OperationsInvoicesPayments.Insert_Update(drMaster["OperationInvoicePaymentID"].ToString(), ((Control)(object)txtCode).Text, dtpDate.DateTime.ToString(GlobalVariables.DateLongFormate), ((TextEditorControlBase)cboClient).Value.ToString(), rbIsCheck.Checked ? "1" : "0", rbDeposit.Checked ? "1" : "0", rbIsSafe.Checked ? "1" : "0", (cboSafe.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboSafe).Value.ToString(), ((TextEditorControlBase)cboCurrency).Value.ToString(), ((Control)(object)txtExchangeRate).Text, rbIsCheck.Checked ? ((Control)(object)txtCheckNo).Text : "Null", rbIsCheck.Checked ? dtpCheckDate.DateTime.ToString(GlobalVariables.DateLongFormate) : "Null", (!rbIsCheck.Checked && !rbDeposit.Checked) ? "Null" : ((cboBank.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboBank).Value.ToString()), ((Control)(object)txtChargedPerson).Text, ((Control)(object)txtDebitBalance).Text, ((Control)(object)txtCreditBalance).Text, ((Control)(object)txtPaidAmount).Text, ((Control)(object)txtTotalPaidAmountForeign).Text, ((Control)(object)txtNotes).Text, ((Control)(object)txtTotal).Text, ((Control)(object)txtReceivingBank).Text, (cboBinderSafe.SelectedIndex == -1) ? "Null" : ((TextEditorControlBase)cboBinderSafe).Value.ToString(), (drMaster["BankInID"] == DBNull.Value) ? "Null" : drMaster["BankInID"].ToString(), (drMaster["SafeInID"] == DBNull.Value) ? "Null" : drMaster["SafeInID"].ToString(), "0", "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
			string text2 = ",";
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				text2 = text2 + ((UltraGridBase)ULGData).Rows[i].Cells["OperationInvoicePaymentDetailID"].Value.ToString() + ",";
			}
			Main.DeleteForUpdate("MS_OperationsInvoicesPaymentsDetails", "OperationInvoicePaymentID", drMaster["OperationInvoicePaymentID"].ToString(), "OperationInvoicePaymentDetailID", text2);
			for (int j = 0; j < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; j++)
			{
				OperationsInvoicesPaymentsDetails.Insert_Update(((UltraGridBase)ULGData).Rows[j].Cells["OperationInvoicePaymentDetailID"].Value.ToString(), num.ToString(), ((UltraGridBase)ULGData).Rows[j].Cells["OperationInvoiceID"].Value.ToString(), ((UltraGridBase)ULGData).Rows[j].Cells["PaidAmount"].Value.ToString(), ((UltraGridBase)ULGData).Rows[j].Cells["Notes"].Value.ToString(), "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID);
				text = ((j != ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count - 1) ? (text + ((UltraGridBase)ULGData).Rows[j].Cells["OperationInvoiceNo"].Value.ToString() + ",") : (text + ((UltraGridBase)ULGData).Rows[j].Cells["OperationInvoiceNo"].Value.ToString()));
			}
			...
			else if (rbIsSafe.Checked && drMaster != null && bool.Parse(drMaster["IsSafe"].ToString()))
			{
				if (((Control)(object)txtPaidAmount).Text != "" && decimal.Parse(((Control)(object)txtPaidAmount).Text) == 0m)
				{
					if (drMaster["SafeInID"] != DBNull.Value)
					{
						...
						Main.ExecuteNonQuery(" Update MS_OperationsInvoicesPayments  set SafeInID=Null  Where OperationInvoicePaymentID=" + num);
					}
				}
				else
				{
					...
					dataRow3["Debit"] = ((Control)(object)txtTotalPaidAmountForeign).Text;
					dataRow3["Credit"] = "0";
					...
					dataRow3["JVDetailID"] = "-1";
					dataRow3["AccountID"] = dtClients.Select(" SubAccountID = " + ((TextEditorControlBase)cboClient).Value.ToString())[0]["DefaultClientAccountID"];
					dataRow3["SubAccountID"] = dtClients.Select(" SubAccountID = " + ((TextEditorControlBase)cboClient).Value.ToString())[0]["SubAccountID"];
					dataRow3["Debit"] = "0";
					dataRow3["Credit"] = ((Control)(object)txtTotalPaidAmountForeign).Text;
					dataRow3["CurrencyID"] = ((TextEditorControlBase)cboCurrency).Value.ToString();
					dataRow3["ExchangeRate"] = ((Control)(object)txtExchangeRate).Text;
					...
					Main.ExecuteNonQuery(" Update MS_OperationsInvoicesPayments  set SafeInID= " + num6 + " Where OperationInvoicePaymentID=" + num);
				}
			}
			else if (!rbIsSafe.Checked && drMaster != null && !bool.Parse(drMaster["IsSafe"].ToString()))
			{
				if (((Control)(object)txtPaidAmount).Text != "" && decimal.Parse(((Control)(object)txtPaidAmount).Text) == 0m)
				{
					if (drMaster["BankInID"] != DBNull.Value)
					{
						...
						Main.ExecuteNonQuery(" Update MS_OperationsInvoicesPayments  set BankInID=Null  Where OperationInvoicePaymentID=" + num);
					}
				}
				else
				{
					...
					dataRow4["Debit"] = ((Control)(object)txtTotalPaidAmountForeign).Text;
					dataRow4["Credit"] = "0";
					...
					dataRow4["JVDetailID"] = "-1";
					dataRow4["AccountID"] = dtClients.Select(" SubAccountID = " + ((TextEditorControlBase)cboClient).Value.ToString())[0]["DefaultClientAccountID"];
					dataRow4["SubAccountID"] = dtClients.Select(" SubAccountID = " + ((TextEditorControlBase)cboClient).Value.ToString())[0]["SubAccountID"];
					dataRow4["Debit"] = "0";
					dataRow4["Credit"] = ((Control)(object)txtTotalPaidAmountForeign).Text;
					dataRow4["CurrencyID"] = ((TextEditorControlBase)cboCurrency).Value.ToString();
					dataRow4["ExchangeRate"] = ((Control)(object)txtExchangeRate).Text;
					...
					if (dtBankIn.Rows[0]["JVID3"] != DBNull.Value && bool.Parse(dtBankIn.Rows[0]["IsCheck"].ToString()) == rbIsCheck.Checked)
					{
						...
						dataRow4["Debit"] = decimal.Parse(((Control)(object)txtTotalPaidAmountForeign).Text) - ((dtBankIn.Rows[0]["CollectionExpense"] == DBNull.Value) ? 0m : decimal.Parse(dtBankIn.Rows[0]["CollectionExpense"].ToString()));
						dataRow4["Credit"] = "0";
						dataRow4["CurrencyID"] = ((TextEditorControlBase)cboCurrency).Value.ToString();
						dataRow4["ExchangeRate"] = ((Control)(object)txtExchangeRate).Text;
						dataRow4["LocalDebit"] = decimal.Parse(dataRow4["Debit"].ToString()) * decimal.Parse(((Control)(object)txtExchangeRate).Text);
	...
	public override void DeleteData()
	{
		...
		try
		{
			...
			OperationsInvoicesPaymentsDetails.DeleteVirtualByOperationInvoicePaymentID(drMaster["OperationInvoicePaymentID"].ToString(), GlobalVariables.UserID);
			OperationsInvoicesPayments.DeleteVirtual(drMaster["OperationInvoicePaymentID"].ToString(), GlobalVariables.UserID);
			Main.EndBulkTrans(FromServer: false);
		}
		catch
		{
	...
	{
		dtSearchResult = SearchFunctions.OperationsInvoicesPaymentsSearchReport();
		if (dtSearchResult.Rows.Count > 0)
		{
			RowID = dtSearchResult.Rows[0]["OperationInvoicePaymentID"].ToString();
			FillData();
		}
	}
	...
	public override void SelectFullRow(object sender, EventArgs e)
	{
		...
		if (ULGData.ActiveCell != null && (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "OperationInvoiceNo" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "OperationinvoiceDate" || ((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "NetPrice"))
		{
	...
	private void ULGData_AfterCellUpdate(object sender, CellEventArgs e)
	{
		...
		if (e.Cell != null && ((KeyedSubObjectBase)e.Cell.Column).Key == "PaidAmount")
		{
			...
			{
				GlobalVariables.InformationMB.Show(" الحد الاقصى للمبلغ المدفوع " + ((UltraGridBase)ULGData).ActiveRow.Cells["MaxPaidAmount"].Value.ToString(), " Max Allowed Paid Amount " + ((UltraGridBase)ULGData).ActiveRow.Cells["MaxPaidAmount"].Value.ToString());
	...
	private void dtpJVDate_ValueChanged(object sender, EventArgs e)
	{
		if (Adding)
		{
			((Control)(object)txtCode).Text = OperationsInvoicesPayments.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		}
	}
	...
	private void CalculateClientBalance()
	{
		if (cboClient.SelectedIndex > -1 && cboCurrency.SelectedIndex > -1 && Adding)
		{
			...
			num = SubAccounts.BalanceLocal(((TextEditorControlBase)cboClient).Value.ToString(), "," + GlobalVariables.CurrentBranchID + ",", IsFromServer: false, 0);
			num2 = OperationsInvoicesPayments.GetInvoicesBalancesBySubAccountID(((TextEditorControlBase)cboClient).Value.ToString(), GlobalVariables.CurrentBranchID, "1");
			decimal num3 = num - num2;
			if (num3 < 0m)
			{
				((Control)(object)txtCreditBalance).Text = decimal.Parse(num3.ToString()).ToString(GlobalVariables.txtDecimalFormate);
			}
			else
			{
				((Control)(object)txtDebitBalance).Text = decimal.Parse(num3.ToString()).ToString(GlobalVariables.txtDecimalFormate);
			}
	...
	private void txtTotalPaidAmountForeign_ValueChanged(object sender, EventArgs e)
	{
		((Control)(object)txtPaidAmount).Text = decimal.Parse((decimal.Parse((((Control)(object)txtTotalPaidAmountForeign).Text == "" || ((Control)(object)txtTotalPaidAmountForeign).Text == ".") ? "0" : ((Control)(object)txtTotalPaidAmountForeign).Text) * decimal.Parse((((Control)(object)txtExchangeRate).Text == "" || ((Control)(object)txtExchangeRate).Text == ".") ? "0" : ((Control)(object)txtExchangeRate).Text)).ToString()).ToString(GlobalVariables.txtDecimalFormate);
	}
	...
	private void txtTotalPaidAmountForeign_KeyPress(object sender, KeyPressEventArgs e)
	{
		GlobalFunctions.CheckForNumbers(sender, e);
	}
	...
	{
		int num = SearchFunctions.MS_Clients("-1", IsFromServer: false);
		if (num != 0)
		{
	...
	private void btnSelectInvoice_Click(object sender, EventArgs e)
	{
		if (cboClient.SelectedIndex != -1)
		{
			dtSearchResult = SearchFunctions.OperationsInvoicesForInvoicesPaymentsReport(int.Parse(((TextEditorControlBase)cboClient).Value.ToString()), "," + GlobalVariables.CurrentBranchID + ",", -1);
			for (int i = 0; i < dtSearchResult.Rows.Count; i++)
			{
				if (dtDetails.Select(" OperationInvoiceID= " + dtSearchResult.Rows[i]["OperationInvoiceID"].ToString()).Length == 0)
				{
					DataRow dataRow = dtDetails.NewRow();
					dataRow["OperationInvoicePaymentDetailID"] = -1;
					dataRow["OperationInvoiceID"] = dtSearchResult.Rows[i]["OperationInvoiceID"];
					dataRow["OperationInvoiceNo"] = dtSearchResult.Rows[i]["OperationInvoiceNo"];
					dataRow["OperationinvoiceDate"] = dtSearchResult.Rows[i]["OperationinvoiceDate"];
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmOperationsInvoicesPayments));
		...
		this.txtTotalPaidAmountForeign = new UltraTextEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.txtTotalPaidAmountForeign).BeginInit();
		base.SuspendLayout();
		...
		resources.ApplyResources(this.txtTotalPaidAmountForeign, "txtTotalPaidAmountForeign");
		((System.Windows.Forms.Control)(object)this.txtTotalPaidAmountForeign).Name = "txtTotalPaidAmountForeign";
		((TextEditorControlBase)this.txtTotalPaidAmountForeign).ValueChanged += new System.EventHandler(txtTotalPaidAmountForeign_ValueChanged);
		((System.Windows.Forms.Control)(object)this.txtTotalPaidAmountForeign).KeyPress += new System.Windows.Forms.KeyPressEventHandler(txtTotalPaidAmountForeign_KeyPress);
		...
		base.Controls.Add((System.Windows.Forms.Control)(object)this.txtTotalPaidAmountForeign);
		...
		base.Name = "frmOperationsInvoicesPayments";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.txtTotalPaidAmountForeign, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.txtTotalPaidAmountForeign).EndInit();
