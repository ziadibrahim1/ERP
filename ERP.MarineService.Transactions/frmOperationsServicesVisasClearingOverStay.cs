...
public class frmOperationsServicesVisasClearingOverStay : frmDetails
{
	...
	public frmOperationsServicesVisasClearingOverStay()
	{
	...
	public frmOperationsServicesVisasClearingOverStay(DataTable DTServices, string OPERATIONSERVICEID, string OPERATIONID, string SERVICEID, bool READONLY)
		: this()
	{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationServiceVisaClearingOverStayID"].DefaultCellValue = -1;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["NameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["NationalityID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SeaManRankID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["FlightDetails"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VisaNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["EnrtyDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الدخول" : "Enrty Date");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["EnrtyDate"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["EnrtyDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExitDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
	}
	...
	public override void DisplayData()
	{
		...
		{
			dtDetails = OperationsServicesVisasClearingOverStay.SelectByOperationServiceID(OperationServiceID.ToString(), GlobalVariables.IsArabic ? "1" : "0");
			InitGrid();
		}
	}
		...
		if (NoInvoice)
		{
			...
			try
			{
				...
				for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
				{
					...
					text = text + ((UltraGridBase)ULGData).Rows[i].Cells["OperationServiceVisaClearingOverStayID"].Value.ToString() + ",";
				}
				Main.SyncDeleteForUpdate("MS_OperationsServicesVisasClearingOverStay", "OperationServiceID", OperationServiceID, "OperationServiceVisaClearingOverStayID", text, IsFromServer: false);
				if (((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count > 0)
				{
					OperationsServicesVisasClearingOverStay.Insert_UpdateByTable((DataTable)((UltraGridBase)ULGData).DataSource, GlobalVariables.UserID);
				}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmOperationsServicesVisasClearingOverStay));
		...
		base.Name = "frmOperationsServicesVisasClearingOverStay";
