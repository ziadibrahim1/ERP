...
public class frmOperationsServicesTransportations : frmDetails
{
	...
	public frmOperationsServicesTransportations()
	{
	...
	public frmOperationsServicesTransportations(DataTable DTServices, string OPERATIONSERVICEID, string OPERATIONID, string SERVICEID, bool READONLY)
		: this()
	{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationServiceTransportationID"].DefaultCellValue = -1;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["NameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["FromPlace"].Header).Caption = (GlobalVariables.IsArabic ? "من موقع" : "From Place");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["FromPlace"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["FromPlace"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ToPlace"].Header).Caption = (GlobalVariables.IsArabic ? " الى موقع" : "To Place");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ToPlace"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ToPlace"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DriverName"].Header).Caption = (GlobalVariables.IsArabic ? "إسم السائق" : "Driver Name");
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VechileNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم السيارة" : "Vechile No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VechileNo"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VechileNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Notes"].Header).Caption = (GlobalVariables.IsArabic ? "ملاحظات" : "Flight Details");
	...
	public override void DisplayData()
	{
		...
		{
			dtDetails = OperationsServicesTransportations.SelectByOperationServiceID(OperationServiceID.ToString(), GlobalVariables.IsArabic ? "1" : "0");
			InitGrid();
		}
	}
	...
	public override bool ValidateData()
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			{
				GlobalVariables.InformationMB.Show("برجاء إختيار من تاريخ", "Please Select From Date ");
				((GridItemBase)((UltraGridBase)ULGData).Rows[i].Cells["FromDate"]).Selected = true;
				return false;
			}
			if (((UltraGridBase)ULGData).Rows[i].Cells["FromPlace"].Value == DBNull.Value)
			{
				GlobalVariables.InformationMB.Show("برجاء إدخال من مكان", "Please Enter From Place ");
				((GridItemBase)((UltraGridBase)ULGData).Rows[i].Cells["FromPlace"]).Selected = true;
				return false;
			}
			if (((UltraGridBase)ULGData).Rows[i].Cells["ToDate"].Value == DBNull.Value)
			{
				GlobalVariables.InformationMB.Show("برجاء إختيار الى تاريخ", "Please Select To Date ");
				((GridItemBase)((UltraGridBase)ULGData).Rows[i].Cells["ToDate"]).Selected = true;
				return false;
			}
			if (((UltraGridBase)ULGData).Rows[i].Cells["ToPlace"].Value == DBNull.Value)
			{
				GlobalVariables.InformationMB.Show("برجاء إدخال الى مكان", "Please Enter To Place ");
				((GridItemBase)((UltraGridBase)ULGData).Rows[i].Cells["ToPlace"]).Selected = true;
				return false;
			}
			if (((UltraGridBase)ULGData).Rows[i].Cells["FromDate"].Value != DBNull.Value && ((UltraGridBase)ULGData).Rows[i].Cells["ToDate"].Value != DBNull.Value && Convert.ToDateTime(((UltraGridBase)ULGData).Rows[i].Cells["FromDate"].Value) > Convert.ToDateTime(((UltraGridBase)ULGData).Rows[i].Cells["ToDate"].Value))
			{
				GlobalVariables.InformationMB.Show("ترتيب التواريخ خاطئ", "The dates are in wrong Order");
			...
			for (int j = 0; j < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; j++)
			{
				...
				{
					GlobalVariables.InformationMB.Show("لا يمكن تكرار إسم البحار", "Can not Duplicate The Same SeaMan");
		...
		if (NoInvoice)
		{
			...
			try
			{
				...
				for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
				{
					...
					text = text + ((UltraGridBase)ULGData).Rows[i].Cells["OperationServiceTransportationID"].Value.ToString() + ",";
				}
				Main.SyncDeleteForUpdate("MS_OperationsServicesTransportations", "OperationServiceID", OperationServiceID, "OperationServiceTransportationID", text, IsFromServer: false);
				if (((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count > 0)
				{
					OperationsServicesTransportations.Insert_UpdateByTable((DataTable)((UltraGridBase)ULGData).DataSource, GlobalVariables.UserID);
				}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmOperationsServicesTransportations));
		...
		base.Name = "frmOperationsServicesTransportations";
