...
public class frmOperationsServicesMedicalAssistance : frmDetails
{
	...
	public frmOperationsServicesMedicalAssistance()
	{
	...
	public frmOperationsServicesMedicalAssistance(DataTable DTServices, string OPERATIONSERVICEID, string OPERATIONID, string SERVICEID, bool READONLY)
		: this()
	{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationServiceMedicalAssistanceID"].DefaultCellValue = -1;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["NameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.25) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SeaManRankID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.25);
	}
	...
	public override void DisplayData()
	{
		...
		{
			dtDetails = OperationsServicesMedicalAssistance.SelectByOperationServiceID(OperationServiceID.ToString(), GlobalVariables.IsArabic ? "1" : "0");
			InitGrid();
		}
	}
		...
		if (NoInvoice)
		{
			...
			try
			{
				...
				for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
				{
					...
					text = text + ((UltraGridBase)ULGData).Rows[i].Cells["OperationServiceMedicalAssistanceID"].Value.ToString() + ",";
				}
				Main.SyncDeleteForUpdate("MS_OperationsServicesMedicalAssistance", "OperationServiceID", OperationServiceID, "OperationServiceMedicalAssistanceID", text, IsFromServer: false);
				if (((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count > 0)
				{
					OperationsServicesMedicalAssistance.Insert_UpdateByTable((DataTable)((UltraGridBase)ULGData).DataSource, GlobalVariables.UserID);
				}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Transactions.frmOperationsServicesMedicalAssistance));
		...
		base.Name = "frmOperationsServicesMedicalAssistance";
