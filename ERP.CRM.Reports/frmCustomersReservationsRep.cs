...
namespace ERP.CRM.Reports;

public class frmCustomersReservationsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmCustomersReservationsRep()
	{
		...
		TreeItems2IDCol = "CustomerReservationID";
		TreeItems2NameCol = "CustomerReservationNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = CustomersReservations.FillRepTree(Branches, Items, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى حجز ليتم عرضها ", "There is no chosen Reservation to be shown in the report, please check Vouchers to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@CustomerReservationIDs", Items2);
	...
	public override void ReportDoubleClick(string GroupNamePath, frmReporViwer frmViewer)
	{
		if (GroupNamePath != "")
		{
			string text = GroupNamePath.Substring(0, GroupNamePath.IndexOf("CustomerReservationID") + 8);
			if (text.IndexOf("CustomerReservationID") >= 0)
			{
				string s = GroupNamePath.Replace(text, "").Replace(",", "").Replace("[", "")
					.Replace("]", "");
				frmCustomersReservations frmCustomersReservations2 = new frmCustomersReservations(int.Parse(s));
				frmCustomersReservations2.StartPosition = FormStartPosition.CenterParent;
				((Control)(object)frmCustomersReservations2.lblTitle).Text = (GlobalVariables.IsArabic ? "حجز عميل" : "Customers Reservations");
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.CRM.Reports.frmCustomersReservationsRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2022, 3, 2, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2022, 3, 2, 0, 0, 0, 0);
		...
		base.Name = "frmCustomersReservationsRep";
