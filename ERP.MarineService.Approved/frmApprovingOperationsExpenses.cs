...
public class frmApprovingOperationsExpenses : frmPosted
{
	private IContainer components = null;

	public frmApprovingOperationsExpenses()
	{
		InitializeComponent();
		NoCol = "ExpenseNo";
	}
	...
	{
		dtsource = OperationsExpenses.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			OperationsExpenses.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد مصروفات لإعتمادها " : "There are No Expenses to be Approved");
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Approved.frmApprovingOperationsExpenses));
		...
		base.Name = "frmApprovingOperationsExpenses";
