...
public class frmApprovingItemsQuotations : frmPosted
{
	private IContainer components = null;

	public frmApprovingItemsQuotations()
	{
		InitializeComponent();
	...
	{
		dtsource = ItemsQuotations.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			ItemsQuotations.SetApprove("1", text);
			FillGrid();
		}
		else
		{
	...
	{
		DataTable dataTable = SearchFunctions.MSItemsQuotationsSearchReport(DateTime.Now.AddYears(-10).ToString(GlobalVariables.DateShortFormate), "-1", 0, -1, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Approved.frmApprovingItemsQuotations));
		...
		base.Name = "frmApprovingItemsQuotations";
