...
public class frmUnApprovingServicesQuotations : frmPosted
{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SubAccountType"].Width = (int)((double)((Control)(object)ULGData).Width * 0.13);
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			ServicesQuotations.SetApprove("0", text);
			FillGrid();
		}
		else
		{
	...
	public override void ClickCellButton()
	{
		if (((UltraGridBase)ULGData).ActiveRow != null)
		{
			...
			((Control)(object)frmServicesQuotations2.lblTitle).Text = (GlobalVariables.IsArabic ? "عــرض ســعـر خدمات" : "Services Quotations");
	...
	{
		DataTable dataTable = SearchFunctions.MSServicesQuotationsReport(DateTime.Now.AddYears(-10).ToString(GlobalVariables.DateShortFormate), "-1", 1, -1, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Approved.frmUnApprovingServicesQuotations));
