...
public class frmApprovingOperationsInvoices : frmPosted
{
	private IContainer components = null;

	public frmApprovingOperationsInvoices()
	{
		InitializeComponent();
	...
	{
		dtsource = OperationsInvoices.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			OperationsInvoices.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد فواتير لإعتمادها " : "There are No Invoices to be Approved");
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.MarineService.Approved.frmApprovingOperationsInvoices));
		...
		base.Name = "frmApprovingOperationsInvoices";
