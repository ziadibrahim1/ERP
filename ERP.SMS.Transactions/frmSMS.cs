...
public class frmSMS : frmBase
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SMS.Transactions.frmSMS));
		...
		((AppearanceBase)val2).Image = resources.GetObject("appearance20.Image");
		resources.ApplyResources(val2, "appearance20");
		...
		((AppearanceBase)val4).Image = resources.GetObject("appearance22.Image");
		resources.ApplyResources(val4, "appearance22");
		...
		resources.ApplyResources(val5, "appearance23");
		...
		((AppearanceBase)val6).Image = resources.GetObject("appearance24.Image");
		resources.ApplyResources(val6, "appearance24");
		...
		((AppearanceBase)val7).Image = resources.GetObject("appearance25.Image");
		...
		((AppearanceBase)val18).Image = resources.GetObject("appearance26.Image");
		resources.ApplyResources(val18, "appearance26");
