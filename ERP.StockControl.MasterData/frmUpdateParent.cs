...
public class frmUpdateParent : frmDetails
{
	...
	{
		dtItems = Items.SelectGroups(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		GlobalFunctions.FillCombo(cboHeader, dtItems, "ItemID", "ItemName");
	...
	public override void SaveData()
	{
		...
		try
		{
			Items.UpdateParentID(RowID, ((TextEditorControlBase)cboHeader).Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.MasterData.frmUpdateParent));
