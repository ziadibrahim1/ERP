...
public class frmItemsSecondClassifications : frmGrid
{
	...
	public frmItemsSecondClassifications()
	{
		InitializeComponent();
		TableName = "SC_ItemsSecondClassifications";
		IDCol = "ItemSecondClassificationID";
	}
	...
	{
		dataTable = ItemsSecondClassifications.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSecondClassificationNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " ألإسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSecondClassificationNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSecondClassificationNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSecondClassificationNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "ألإسم بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSecondClassificationNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSecondClassificationNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtItemArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ItemSecondClassificationNameAr"].Value.ToString();
		((Control)(object)txtItemEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ItemSecondClassificationNameEn"].Value.ToString();
	}
	...
	public override bool ValidateData()
	{
		...
		{
			GlobalVariables.InformationMB.Show("برجاء إدخال ألإسم بالعربية", "Please Enter  Arabic Name");
			((TextEditorControlBase)txtItemArabicName).Focus();
			return false;
		}
	...
	{
		ItemsSecondClassifications.Insert_Update("-1", ((Control)(object)txtItemArabicName).Text, (((Control)(object)txtItemEnglishName).Text == "") ? "Null" : ((Control)(object)txtItemEnglishName).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		ItemsSecondClassifications.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["ItemSecondClassificationID"].Value.ToString(), ((Control)(object)txtItemArabicName).Text, (((Control)(object)txtItemEnglishName).Text == "") ? "Null" : ((Control)(object)txtItemEnglishName).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		ItemsSecondClassifications.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["ItemSecondClassificationID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.MasterData.frmItemsSecondClassifications));
		...
		base.Name = "frmItemsSecondClassifications";
