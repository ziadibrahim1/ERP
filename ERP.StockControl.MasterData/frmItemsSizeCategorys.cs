...
public class frmItemsSizeCategorys : frmGrid
{
	...
	public frmItemsSizeCategorys()
	{
		InitializeComponent();
		TableName = "SC_ItemsSizeCategorys";
		IDCol = "ItemSizeCategoryID";
	}
	...
	{
		dataTable = ItemsSizeCategorys.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSizeCategoryNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " ألإسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSizeCategoryNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSizeCategoryNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSizeCategoryNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "ألإسم بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSizeCategoryNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemSizeCategoryNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtItemArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ItemSizeCategoryNameAr"].Value.ToString();
		((Control)(object)txtItemEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ItemSizeCategoryNameEn"].Value.ToString();
	}
	...
	{
		ItemsSizeCategorys.Insert_Update("-1", ((Control)(object)txtItemArabicName).Text, (((Control)(object)txtItemEnglishName).Text == "") ? "Null" : ((Control)(object)txtItemEnglishName).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		ItemsSizeCategorys.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["ItemSizeCategoryID"].Value.ToString(), ((Control)(object)txtItemArabicName).Text, (((Control)(object)txtItemEnglishName).Text == "") ? "Null" : ((Control)(object)txtItemEnglishName).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		ItemsSizeCategorys.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["ItemSizeCategoryID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.MasterData.frmItemsSizeCategorys));
		...
		base.Name = "frmItemsSizeCategorys";
