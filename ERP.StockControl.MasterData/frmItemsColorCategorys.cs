...
public class frmItemsColorCategorys : frmGrid
{
	...
	public frmItemsColorCategorys()
	{
		InitializeComponent();
		TableName = "SC_ItemsColorCategorys";
		IDCol = "ItemColorCategoryID";
	}
	...
	{
		dataTable = ItemsColorCategorys.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemColorCategoryNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " ألإسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemColorCategoryNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemColorCategoryNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemColorCategoryNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "ألإسم بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemColorCategoryNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemColorCategoryNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtItemArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ItemColorCategoryNameAr"].Value.ToString();
		((Control)(object)txtItemEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ItemColorCategoryNameEn"].Value.ToString();
	}
	...
	{
		ItemsColorCategorys.Insert_Update("-1", ((Control)(object)txtItemArabicName).Text, (((Control)(object)txtItemEnglishName).Text == "") ? "Null" : ((Control)(object)txtItemEnglishName).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		ItemsColorCategorys.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["ItemColorCategoryID"].Value.ToString(), ((Control)(object)txtItemArabicName).Text, (((Control)(object)txtItemEnglishName).Text == "") ? "Null" : ((Control)(object)txtItemEnglishName).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		ItemsColorCategorys.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["ItemColorCategoryID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.MasterData.frmItemsColorCategorys));
		...
		base.Name = "frmItemsColorCategorys";
