...
public class frmAddItemsSize : frmBase
{
	private int ItemID;
	...
	public frmAddItemsSize()
	{
		InitializeComponent();
	}

	public frmAddItemsSize(int ID)
		: this()
	{
		ItemID = ID;
	}
	...
	{
		if (Main.CheckForValue("SC_ItemSizes", "ItemSizeNameAr", ((Control)(object)txtSerial).Text, "", IsFromServer: false) > 0)
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? " متواجد من قبل" : "  Already Exist");
			return;
		}
		SizeID = ItemSizes.Insert_Update("-1", ((Control)(object)txtSerial).Text, ((Control)(object)txtSerial).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
		Close();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.MasterData.frmAddItemsSize));
