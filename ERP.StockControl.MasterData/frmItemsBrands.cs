...
public class frmItemsBrands : frmGrid
{
	...
	{
		dataTable = ItemsBrands.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemBrandNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " ألإسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemBrandNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemBrandNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemBrandNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "ألإسم بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemBrandNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemBrandNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtItemArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ItemBrandNameAr"].Value.ToString();
		((Control)(object)txtItemEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ItemBrandNameEn"].Value.ToString();
	}
	...
	{
		ItemsBrands.Insert_Update("-1", ((Control)(object)txtItemArabicName).Text, (((Control)(object)txtItemEnglishName).Text == "") ? "Null" : ((Control)(object)txtItemEnglishName).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void UpdateData()
	{
		ItemsBrands.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["ItemBrandID"].Value.ToString(), ((Control)(object)txtItemArabicName).Text, (((Control)(object)txtItemEnglishName).Text == "") ? "Null" : ((Control)(object)txtItemEnglishName).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}

	public override void DeleteData()
	{
		ItemsBrands.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["ItemBrandID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.StockControl.MasterData.frmItemsBrands));
