...
public class frmPSInvoicesPaymentsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmPSInvoicesPaymentsRep()
	{
		...
		TreeItems2IDCol = "PSInvoicePaymentID";
		TreeItems2NameCol = "PSInvoicePaymentNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = PSInvoicesPayments.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@PSInvoicePaymentIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Reports.frmPSInvoicesPaymentsRep));
		...
		base.Name = "frmPSInvoicesPaymentsRep";
