...
public class frmPSOrdersRep : frmReportTree2010
{
	private IContainer components = null;

	public frmPSOrdersRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "PSOrderID";
		TreeItems2NameCol = "PSOrderNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = PSOrders.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى أمر ليتم عرضها ", "There is no chosen Order to be shown in the report, please check Order to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@PSOrderIDs", Items2);
	...
	public override void ReportDoubleClick(string GroupNamePath, frmReporViwer frmViewer)
	{
		if (GroupNamePath != "")
		{
			string text = GroupNamePath.Substring(0, GroupNamePath.IndexOf("PSOrderID") + 8);
			if (text.IndexOf("PSOrderID") >= 0)
			{
				string s = GroupNamePath.Replace(text, "").Replace(",", "").Replace("[", "")
					.Replace("]", "");
				frmPSOrders frmPSOrders2 = new frmPSOrders(int.Parse(s));
				frmPSOrders2.StartPosition = FormStartPosition.CenterParent;
				((Control)(object)frmPSOrders2.lblTitle).Text = (GlobalVariables.IsArabic ? "أمر  شــــراء" : "Purchase Order");
	...
	{
		dtSearchResult = SearchFunctions.PSOrdersReport(-1, -1, -1, 0);
		for (int i = 0; i < dtSearchResult.Rows.Count; i++)
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["PSOrderID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Reports.frmPSOrdersRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2019, 10, 31, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2019, 10, 31, 0, 0, 0, 0);
