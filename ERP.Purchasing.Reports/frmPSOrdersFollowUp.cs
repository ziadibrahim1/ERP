...
public class frmPSOrdersFollowUp : frmReportTree2010
{
	private IContainer components = null;

	public frmPSOrdersFollowUp()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مورد  ", "There is no chosen Suppliers to be shown in the report, please check Suppliers to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Reports.frmPSOrdersFollowUp));
