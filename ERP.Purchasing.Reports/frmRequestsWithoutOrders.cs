...
public class frmRequestsWithoutOrders : frmReportTree2010
{
	private IContainer components = null;

	public frmRequestsWithoutOrders()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "طلبات بدون أوامر شراء" : "Purchasing Requests Without Orders");
	}
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_PSRequest_WithoutPSOrders_A.rpt" : "Rep_PS_PSRequest_WithoutPSOrders_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_PSRequest_WithoutPSOrders_A_nologo.rpt" : "Rep_PS_PSRequest_WithoutPSOrders_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Reports.frmRequestsWithoutOrders));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2016, 3, 24, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2016, 3, 24, 0, 0, 0, 0);
		...
		base.Name = "frmRequestsWithoutOrders";
