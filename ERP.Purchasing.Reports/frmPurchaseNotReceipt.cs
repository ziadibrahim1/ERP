...
public class frmPurchaseNotReceipt : frmReportTree2010
{
	private IContainer components = null;

	public frmPurchaseNotReceipt()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " الفواتير الغير مضافه بالكامل تفصيلي" : "Invoices Not Receipt");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_PSInvoicesNotReceipt_A.rpt" : "Rep_PS_PSInvoicesNotReceipt_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_PSInvoicesNotReceipt_A_nologo.rpt" : "Rep_PS_PSInvoicesNotReceipt_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Reports.frmPurchaseNotReceipt));
		...
		base.Name = "frmPurchaseNotReceipt";
