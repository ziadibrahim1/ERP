...
public class frmPSRequestRep : frmReportTree2010
{
	private IContainer components = null;

	public frmPSRequestRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "PSRequestID";
		TreeItems2NameCol = "PSRequestNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = PSRequest.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى طلب ليتم عرضها ", "There is no chosen Request to be shown in the report, please check Request to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@PSRequestIDs", Items2);
	...
	public override void ReportDoubleClick(string GroupNamePath, frmReporViwer frmViewer)
	{
		if (GroupNamePath != "")
		{
			string text = GroupNamePath.Substring(0, GroupNamePath.IndexOf("PSRequestID") + 8);
			if (text.IndexOf("PSRequestID") >= 0)
			{
				string s = GroupNamePath.Replace(text, "").Replace(",", "").Replace("[", "")
					.Replace("]", "");
				frmPSRequest frmPSRequest2 = new frmPSRequest(int.Parse(s));
	...
	public override void btnItems2Search_Click(object sender, EventArgs e)
	{
		...
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["PSRequestID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Reports.frmPSRequestRep));
