...
public class frmPurchase : frmReportTree2010
{
	...
	public frmPurchase()
	{
		...
		dtItems2 = SubAccounts.FillReportTreeBySubAccountTypeIDs(GlobalVariables.SupplierSubAccountTypeIDs, GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "مشتريات الأصناف تفصيلي" : "Item Purchase Detailed");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? "مشتريات الأصناف إجمالي بالعملة المحلية" : "Item Purchase Summary local currency");
		if (GlobalFunctions.GetOption("UsingBatchNoAndValidityPeriod"))
		{
			cboReportType.Items.Add((object)3, GlobalVariables.IsArabic ? "مشتريات الأصناف إجمالي لكل تشغيله بالعملة المحلية" : "Item Purchase Summary local currency For Each Batch No.");
		}
		cboReportType.Items.Add((object)4, GlobalVariables.IsArabic ? "مشتريات من المورد تفصيلي" : "Supplier Purchase Detailed");
		cboReportType.Items.Add((object)5, GlobalVariables.IsArabic ? "مشتريات من المورد استيراد" : "Supplier Purchase Detailed Loacl Currency");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_ItemsPurchaseDetails_A.rpt" : "Rep_PS_ItemsPurchaseDetails_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_ItemsPurchaseDetails_A_nologo.rpt" : "Rep_PS_ItemsPurchaseDetails_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_ItemsPurchase_A.rpt" : "Rep_PS_ItemsPurchase_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_ItemsPurchase_A_nologo.rpt" : "Rep_PS_ItemsPurchase_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "3")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_ItemsPurchaseByBatchNo_A.rpt" : "Rep_PS_ItemsPurchaseByBatchNo_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_ItemsPurchaseByBatchNo_A_nologo.rpt" : "Rep_PS_ItemsPurchaseByBatchNo_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "4")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_SupplierPurchaseDetails_A.rpt" : "Rep_PS_SupplierPurchaseDetails_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_SupplierPurchaseDetails_A_nologo.rpt" : "Rep_PS_SupplierPurchaseDetails_E_nologo.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "5")
		{
			if (((UltraToggleEditorBase)chkWithLogo).Checked)
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_SupplierPurchaseDetailsLoaclCurrency_A.rpt" : "Rep_PS_SupplierPurchaseDetailsLoaclCurrency_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PS_SupplierPurchaseDetailsLoaclCurrency_A_nologo.rpt" : "Rep_PS_SupplierPurchaseDetailsLoaclCurrency_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مورد  ", "There is no choosen Suppliers to be shown in the report, please check Suppliers to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Reports.frmPurchase));
