...
public class frmSuppliersPaymentsMethods : frmReportTree2010
{
	private bool UseCurrency;

	private IContainer components = null;

	public frmSuppliersPaymentsMethods()
	{
		...
		dtItems2 = PaymentMethods.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItems2IDCol = "PaymentMethodID";
		TreeItems2NameCol = "PaymentMethodName";
		InitializeComponent();
	}
	...
	public override void ShowReport()
	{
		...
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى طريقه دفع  ", "There is no chosen Peyment Method to be shown in the report, please check items to be shown in report");
			return;
		}
		...
		GlobalVariables.ReportDocument.SetParameterValue("@PaymentMethodIDs", Items2);
	...
	public void RefreshReport(frmReporViwer frmViewer)
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@BranchIDs", Branches);
		GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@IsClient", "0");
	...
	{
		dtSearchResult = SearchFunctions.PaymentMethodsReport(IsFromServer: false);
		for (int i = 0; i < dtSearchResult.Rows.Count; i++)
		{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Reports.frmSuppliersPaymentsMethods));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2017, 10, 26, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2017, 10, 26, 0, 0, 0, 0);
		...
		base.Name = "frmSuppliersPaymentsMethods";
