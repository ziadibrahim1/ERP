...
public class frmDegrees : frmReportTree2010
{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesDegrees_A.rpt" : "Rep_HR_EmployeesDegrees_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_EmployeesDegrees_A_nologo.rpt" : "Rep_HR_EmployeesDegrees_E_nologo.rpt");
		}
