...
public class frmEmployeeInQuiry : frmReportTree2010
{
	private IContainer components = null;

	public frmEmployeeInQuiry()
	{
		InitializeComponent();
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_Employees_HireDate_A.rpt" : "Rep_HR_Employees_HireDate_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_HR_Employees_HireDate_A_nologo.rpt" : "Rep_HR_Employees_HireDate_E_nologo.rpt");
		}
	...
	{
		if (dtReports != null && dtReports.Rows.Count > 0 && cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("MilitaryServiceStatus"))
		{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.Reports.frmEmployeeInQuiry));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 10, 1, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 10, 1, 0, 0, 0, 0);
