...
public class frmPositions : frmReportTree2010
{
	...
	private void cboReportType_ValueChanged(object sender, EventArgs e)
	{
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("ByDate"))
		{
			...
			UltraLabel obj2 = ultraLabel2;
			UltraDateTimeEditor obj3 = dtpFromDate;
			bool flag = (((Control)(object)dtpToDate).Visible = true);
		...
		{
			UltraLabel obj4 = ultraLabel1;
			UltraLabel obj5 = ultraLabel2;
			UltraDateTimeEditor obj6 = dtpFromDate;
			bool flag = (((Control)(object)dtpToDate).Visible = false);
			bool flag3 = (((Control)(object)obj6).Visible = flag);
			bool visible = (((Control)(object)obj5).Visible = flag3);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.Reports.frmPositions));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2020, 1, 19, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2020, 1, 19, 0, 0, 0, 0);
