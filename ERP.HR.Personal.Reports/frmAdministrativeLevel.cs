...
public class frmAdministrativeLevel : frmReportTree2010
{
	private IContainer components = null;

	public frmAdministrativeLevel()
	{
		InitializeComponent();
		...
		dtItems2 = AdministrativeLevels.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		TreeItems2IDCol = "AdministrativeLevelID";
		TreeItems2NameCol = "AdministrativeLevelName";
	}
	...
	public override void ShowReport()
	{
		...
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("AdminLevels") && Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مستوى إداري ليتم عرض اسماء موظفيه ", "There is no chosen Administrative Level to be shown in the report, please Select Administrative Level to be shown in report");
			return;
		}
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Employees") && Items.Equals(","))
		{
		...
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Employees"))
		{
			GlobalVariables.ReportDocument.SetParameterValue("@SubAccountIDs", Items);
		}
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("AdminLevels"))
		{
			GlobalVariables.ReportDocument.SetParameterValue("@AdministrativeLevelIDs", Items2);
		}
	...
	private void cboReportType_ValueChanged(object sender, EventArgs e)
	{
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("Employees"))
		{
			...
			UltraTree treeItems = TreeItems;
			UltraTextEditor obj2 = txtItems;
			bool flag = (((Control)(object)btnItemsSearch).Visible = true);
			bool flag3 = (((Control)(object)obj2).Visible = flag);
			bool visible = (((Control)(object)treeItems).Visible = flag3);
			((Control)(object)obj).Visible = visible;
			UltraCheckEditor obj3 = chkAll2;
			UltraTree treeItems2 = TreeItems2;
			flag3 = (((Control)(object)txtItems2).Visible = false);
			visible = (((Control)(object)treeItems2).Visible = flag3);
			((Control)(object)obj3).Visible = visible;
		}
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("AdminLevels"))
		{
			UltraCheckEditor obj4 = chkAll;
			UltraTree treeItems3 = TreeItems;
			UltraTextEditor obj5 = txtItems;
			bool flag = (((Control)(object)btnItemsSearch).Visible = false);
			bool flag3 = (((Control)(object)obj5).Visible = flag);
			bool visible = (((Control)(object)treeItems3).Visible = flag3);
			((Control)(object)obj4).Visible = visible;
			UltraCheckEditor obj6 = chkAll2;
			UltraTree treeItems4 = TreeItems2;
			flag3 = (((Control)(object)txtItems2).Visible = true);
			visible = (((Control)(object)treeItems4).Visible = flag3);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.Reports.frmAdministrativeLevel));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2021, 9, 22, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2021, 9, 22, 0, 0, 0, 0);
		...
		base.Name = "frmAdministrativeLevel";
