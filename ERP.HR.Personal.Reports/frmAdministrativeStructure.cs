...
public class frmAdministrativeStructure : frmReportTree2010
{
	...
	public override void ShowReport()
	{
		...
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("AdminStructure") && Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى هيكل إداري ليتم عرض اسماء موظفيه ", "There is no chosen Administrative Structure to be shown in the report, please Select Administrative Structure to be shown in report");
			return;
		}
		...
		if (cboReportType.SelectedIndex > -1 && dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("AdminStructure"))
		{
			GlobalVariables.ReportDocument.SetParameterValue("@AdministrativeStructureIDs", Items2);
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.HR.Personal.Reports.frmAdministrativeStructure));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2021, 9, 20, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2021, 9, 20, 0, 0, 0, 0);
