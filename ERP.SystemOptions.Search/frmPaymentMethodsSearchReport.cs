...
public class frmPaymentMethodsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmPaymentMethodsSearchReport()
	{
		InitializeComponent();
	}

	public frmPaymentMethodsSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PaymentMethodName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.38) - GlobalVariables.ScrollWidth;
