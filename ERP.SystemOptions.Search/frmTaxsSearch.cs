...
public class frmTaxsSearch : frmSearch
{
	private IContainer components = null;

	public frmTaxsSearch()
	{
		InitializeComponent();
	}

	public frmTaxsSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TaxNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4) - GlobalVariables.ScrollWidth;
