...
public class frmSearchSettingName : frmBase
{
	...
	public frmSearchSettingName(string SelectedSettingID, DataTable dt_Setting, string formID)
	{
		FormID = formID;
		InitializeComponent();
		dtSetting = dt_Setting;
		clbSettings.SelectedValueChanged -= clbSettings_SelectedValueChanged;
		Main.Fillclb(clbSettings, dtSetting, "SearchSettingID", "SettingName");
		clbSettings.SelectedValueChanged += clbSettings_SelectedValueChanged;
		...
		else
		{
			...
			{
				clbSettings.SetItemChecked(i, dtSetting.Rows[i]["SearchSettingID"].ToString() == SelectedSettingID);
			}
		}
	...
	private void btnSave_Click(object sender, EventArgs e)
	{
		if (rbNew.Checked)
		{
			...
			SettingID = SearchSetting.Insert_Update("-1", ((Control)(object)txtArName).Text, ((Control)(object)txtEnName).Text, FormID, GlobalVariables.CurrentBranchID, "0", GlobalVariables.UserID, IsFromServer: false);
		}
		Close();
	}
	...
	private void clbSettings_SelectedValueChanged(object sender, EventArgs e)
	{
		for (int i = 0; i < clbSettings.Items.Count; i++)
		{
			...
			{
				SettingID = Convert.ToInt32(dtSetting.Rows[i]["SearchSettingID"]);
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SystemOptions.GeneralData.frmSearchSettingName));
		...
		base.Name = "frmSearchSettingName";
