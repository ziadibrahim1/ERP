...
public class frmGetItemAllowedQty : frmBase
{
	...
	public frmGetItemAllowedQty(string ITEMID, string STOREID, string DATE)
		: this()
	{
		ItemID = ITEMID;
		StoreID = STOREID;
	...
	public void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["UnderProcess"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["UnderProcess"].Header).Caption = (GlobalVariables.IsArabic ? "تحت التصنيع" : "Under Process");
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["UnderProcess"].Hidden = false;
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SystemOptions.GeneralData.frmGetItemAllowedQty));
		...
		base.Name = "frmGetItemAllowedQty";
