...
public class frmColors : frmGrid
{
	...
	public override void SetControls(bool NavMode)
	{
		...
		((Control)(object)btnHeaderSearch).Visible = CanSearching;
	...
	{
		dataTable = Colors.Select("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
	...
	{
		base.InitGrid();
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ColorCode"].Header).Caption = (GlobalVariables.IsArabic ? "كود " : "Code");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ColorCode"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ColorCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ColorNameAr"].Header).Caption = (GlobalVariables.IsArabic ? " اسم بالعربية" : "Name Ar");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ColorNameAr"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ColorNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4);
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ColorNameEn"].Header).Caption = (GlobalVariables.IsArabic ? "اسم بالإنجليزية" : "Name En");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ColorNameEn"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ColorNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.4);
	}

	public override void AfterRowActivate()
	{
		((Control)(object)txtCode).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ColorCode"].Value.ToString();
		((Control)(object)txtArabicName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ColorNameAr"].Value.ToString();
		((Control)(object)txtEnglishName).Text = ((UltraGridBase)ULGData).ActiveRow.Cells["ColorNameEn"].Value.ToString();
	}
	...
	public override bool ValidateData()
	{
		...
		if (dataTable.Select("ColorCode = '" + ((Control)(object)txtCode).Text + "' And ColorID <>" + (Adding ? "-1" : ((UltraGridBase)ULGData).ActiveRow.Cells["ColorID"].Value.ToString())).Length != 0)
		{
			GlobalVariables.InformationMB.Show("لايمكن تكرار الكود  ", "Cannot Duplicate The Code ");
			return false;
		}
		if (dataTable.Select("ColorNameAr = '" + ((Control)(object)txtArabicName).Text + "' And ColorID <>" + (Adding ? "-1" : ((UltraGridBase)ULGData).ActiveRow.Cells["ColorID"].Value.ToString())).Length != 0)
		{
	...
	{
		Colors.Insert_Update("-1", ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public override void btnUpdateClick()
	{
		...
		{
			GlobalVariables.InformationMB.Show("لا يمكن تعديل اللون", "Cannot Update This Color ");
		}
		else
		{
			base.btnUpdateClick();
	...
	{
		Colors.Insert_Update(((UltraGridBase)ULGData).ActiveRow.Cells["ColorID"].Value.ToString(), ((Control)(object)txtCode).Text, ((Control)(object)txtArabicName).Text, (((Control)(object)txtEnglishName).Text == "") ? "Null" : ((Control)(object)txtEnglishName).Text, bool.Parse(((UltraGridBase)ULGData).ActiveRow.Cells["Deleted"].Value.ToString()) ? "1" : "0", GlobalVariables.CurrentBranchID, GlobalVariables.UserID, IsFromServer: true);
	}
	...
	public override void btnDeleteClick()
	{
		if (((UltraGridBase)ULGData).ActiveRow != null && ((UltraGridBase)ULGData).ActiveRow.Cells[IDCol].Value.ToString() == "1")
		{
			GlobalVariables.InformationMB.Show("لا يمكن حذف اللون", "Cannot Delete This Color ");
		}
		else
		{
			base.btnDeleteClick();
	...
	{
		Colors.Delete(((UltraGridBase)ULGData).ActiveRow.Cells["ColorID"].Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	}

	public override void Search()
	{
		int num = SearchFunctions.Colors(IsFromServer: false);
		if (num != 0)
		{
			...
			int num2 = dataTable.Rows.IndexOf(dataTable.Select("ColorID =" + num)[0]);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.SystemOptions.GeneralData.frmColors));
