...
public class frmSLClientCreditNote : frmHeaderDetails
{
	...
	public frmSLClientCreditNote()
	{
		InitializeComponent();
		TableName = "SL_SLClientsCreditNotes";
	...
	public override void PrepareData()
	{
		...
		dtSubAccounts = SubAccounts.FillComboBySubAccountTypeIDsForMarineService(GlobalVariables.OwnerSubAccountTypeIDs + GlobalVariables.CharterSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.AgentSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.CaptainSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.SeaManSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.ClientSubAccountTypeIDs.Remove(0, 1), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void FillData()
	{
		...
		{
			DataTable dataTable = SLClientsCreditNotes.Select(RowID, GlobalVariables.BranchIDs, GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void ClearControls()
	{
		...
		((Control)(object)txtCode).Text = (Adding ? SLClientsCreditNotes.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID) : "");
	...
	public override bool ValidateData()
	{
		...
		if (Main.CheckForValueByBranchIDAndFiscalYearID("SL_SLClientsCreditNotes", "ClientCreditNoteNo", ((Control)(object)txtCode).Text, Adding ? "0" : drMaster["ClientCreditNoteNo"].ToString(), GlobalVariables.CurrentBranchID, DateCol, dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), "") > 0)
		{
			string codeByBranchID = SLClientsCreditNotes.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		...
		{
			GlobalVariables.InformationMB.Show("برجاء تحديد حساب إشعار خصم عميل من حسابات النظام  ", "Please Select Client Credit Note Account From SystemAccounts ");
			return false;
		}
		return true;
	}
	...
	public override void DeleteData()
	{
		...
		try
		{
			SLClientsCreditNotes.DeleteVirtual(drMaster["ClientCreditNoteID"].ToString(), GlobalVariables.UserID);
	...
	public override void btnPrintClick()
	{
		...
		if (Convert.ToBoolean(GlobalVariables.dtSystemModules.Select("ModuleEnName='MarineService'")[0]["Installed"]))
		{
			...
			num = frmCompanySelector2.CompanyID;
			GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_SL_SLClientsCreditNotesMS_A.rpt" : "Rep_SL_SLClientsCreditNotesMS_E.rpt"));
		}
		else
		{
			GlobalVariables.ReportDocument.Load(GlobalVariables.ReportsPath + (GlobalVariables.IsArabic ? "Rep_SL_SLClientsCreditNotes_A.rpt" : "Rep_SL_SLClientsCreditNotes_E.rpt"));
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@ClientCreditNoteIDs", "," + RowID + ",");
		GlobalVariables.ReportDocument.SetParameterValue("@IsArabic", GlobalVariables.IsArabic ? "1" : "0");
		if (num != 0)
		{
			GlobalVariables.ReportDocument.SetParameterValue("@CompanyID", num);
		}
	...
	{
		dtSearchResult = SearchFunctions.SLClientCreditNoteReport(-1, 0);
	...
	{
		int num = SearchFunctions.SubAccountsBySubAccountTypeIDs(GlobalVariables.OwnerSubAccountTypeIDs + GlobalVariables.CharterSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.AgentSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.CaptainSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.SeaManSubAccountTypeIDs.Remove(0, 1) + GlobalVariables.ClientSubAccountTypeIDs.Remove(0, 1), "-1", IsFromServer: false);
		if (num != 0)
		{
			((TextEditorControlBase)cboSubAccountName).Value = num;
		}
	...
	private void cboSubAccountName_ValueChanged(object sender, EventArgs e)
	{
		if (cboSubAccountName.SelectedIndex != -1)
		{
			((TextEditorControlBase)cboAccountName).Value = dtSubAccounts.Select("  SubAccountID =" + ((TextEditorControlBase)cboSubAccountName).Value.ToString())[0]["DefaultClientAccountID"];
		}
		else
		{
			cboAccountName.SelectedIndex = -1;
	...
	private void dtpDate_ValueChanged(object sender, EventArgs e)
	{
		...
		if (Adding || Updating)
		{
			((Control)(object)txtCode).Text = SLClientsCreditNotes.GetCodeByBranchID(dtpDate.DateTime.ToString(GlobalVariables.DateShortFormate), GlobalVariables.CurrentBranchID);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Transactions.frmSLClientCreditNote));
		...
		base.Name = "frmSLClientCreditNote";
