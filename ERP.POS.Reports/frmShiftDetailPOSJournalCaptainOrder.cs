...
public class frmShiftDetailPOSJournalCaptainOrder : frmReportTree2010
{
	private IContainer components = null;

	public frmShiftDetailPOSJournalCaptainOrder()
	{
		InitializeComponent();
		TreeItemsIDCol = "CaptainOrderID";
		TreeItemsNameCol = "CaptainOrderName";
	...
	{
		dtItems = CaptainOrder.FillCombo("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى كابتن اوردر ليتم عرضه ", "There is no choosen Captain Order to be shown in the report, please check Captain Order to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى وردية ليتم عرضها ", "There is no choosen Shift Details to be shown in the report, please check Shift Details to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@ShiftDetailIDs", Items2);
		GlobalVariables.ReportDocument.SetParameterValue("@UserIDs", "-1");
		GlobalVariables.ReportDocument.SetParameterValue("@CaptainOrderIDs", Items);
	...
	public override void btnItems2Search_Click(object sender, EventArgs e)
	{
		...
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["ShiftDetailID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Reports.frmShiftDetailPOSJournalCaptainOrder));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2014, 2, 25, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2014, 2, 25, 0, 0, 0, 0);
		...
		base.Name = "frmShiftDetailPOSJournalCaptainOrder";
