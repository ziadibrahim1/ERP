...
public class frmCaptainOrdeSales : frmReportTree2010
{
	private IContainer components = null;

	public frmCaptainOrdeSales()
	{
		InitializeComponent();
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى صالة ليتم عرضها ", "There is no choosen Hall to be shown in the report, please check Hall to be shown in report");
			return;
		}
		...
		GlobalVariables.ReportDocument.SetParameterValue("@CaptainOrderIDs", ((UltraToggleEditorBase)chkAll).Checked ? "-1" : Items);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Reports.frmCaptainOrdeSales));
