...
public class frmShiftDetailJournalDeliveryMan : frmReportTree2010
{
	private IContainer components = null;

	public frmShiftDetailJournalDeliveryMan()
	{
		InitializeComponent();
		TreeItemsIDCol = "DeliveryManID";
		TreeItemsNameCol = "DeliveryManName";
	...
	{
		dtItems = DeliveryMan.FillCombo("-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى طيار ليتم عرضه ", "There is no choosen Delivery Man to be shown in the report, please check Delivery Man to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@DeliveryManIDs", Items);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Reports.frmShiftDetailJournalDeliveryMan));
		...
		base.Name = "frmShiftDetailJournalDeliveryMan";
