...
public class frmShiftDetailPOSJournal : frmReportTree2010
{
	private IContainer components = null;

	public frmShiftDetailPOSJournal()
	{
		InitializeComponent();
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "يومية الوردية تفصيلي" : "Shift Journal Details");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_POS_ShiftsDetails_POSJournal_A.rpt" : "Rep_POS_ShiftsDetails_POSJournal_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_POS_ShiftsDetails_POSJournal_A_nologo.rpt" : "Rep_POS_ShiftsDetails_POSJournal_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.POS.Reports.frmShiftDetailPOSJournal));
		...
		base.Name = "frmShiftDetailPOSJournal";
