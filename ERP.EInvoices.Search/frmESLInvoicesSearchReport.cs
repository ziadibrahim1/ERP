...
public class frmESLInvoicesSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmESLInvoicesSearchReport()
	{
		InitializeComponent();
	}

	public frmESLInvoicesSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
