...
public class frmSubAccountsSupplierSearch : frmSearch
{
	private IContainer components = null;

	public frmSubAccountsSupplierSearch()
	{
		InitializeComponent();
	}

	public frmSubAccountsSupplierSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ClientSupplierNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم المورد " : "Supplier No");
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ParentName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
