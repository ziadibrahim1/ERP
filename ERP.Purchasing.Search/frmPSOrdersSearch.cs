...
public class frmPSOrdersSearch : frmSearch
{
	private IContainer components = null;

	public frmPSOrdersSearch()
	{
		InitializeComponent();
	}

	public frmPSOrdersSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
