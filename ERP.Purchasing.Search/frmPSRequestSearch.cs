...
public class frmPSRequestSearch : frmSearch
{
	private IContainer components = null;

	public frmPSRequestSearch()
	{
		InitializeComponent();
	}

	public frmPSRequestSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
