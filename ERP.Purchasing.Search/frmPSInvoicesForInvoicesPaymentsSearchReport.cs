...
public class frmPSInvoicesForInvoicesPaymentsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmPSInvoicesForInvoicesPaymentsSearchReport()
	{
		InitializeComponent();
	}

	public frmPSInvoicesForInvoicesPaymentsSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PaidAmount"].Width = (int)((double)((Control)(object)ULGData).Width * 0.075);
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PSOrderNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الطلب" : "Order No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PSOrderNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.075);
