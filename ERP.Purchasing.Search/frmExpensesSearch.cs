...
public class frmExpensesSearch : frmSearch
{
	private IContainer components = null;

	public frmExpensesSearch()
	{
		InitializeComponent();
	}

	public frmExpensesSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExpenseNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ExpenseNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.5);
	}
