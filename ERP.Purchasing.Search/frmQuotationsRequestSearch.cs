...
public class frmQuotationsRequestSearch : frmSearch
{
	private IContainer components = null;

	public frmQuotationsRequestSearch()
	{
		InitializeComponent();
	}

	public frmQuotationsRequestSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
