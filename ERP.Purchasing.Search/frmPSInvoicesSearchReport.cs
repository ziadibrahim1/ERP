...
public class frmPSInvoicesSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmPSInvoicesSearchReport()
	{
		InitializeComponent();
	}

	public frmPSInvoicesSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
