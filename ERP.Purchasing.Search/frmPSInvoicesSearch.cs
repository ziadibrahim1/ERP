...
public class frmPSInvoicesSearch : frmSearch
{
	private IContainer components = null;

	public frmPSInvoicesSearch()
	{
		InitializeComponent();
	}

	public frmPSInvoicesSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PSInvoiceNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15) - GlobalVariables.ScrollWidth;
