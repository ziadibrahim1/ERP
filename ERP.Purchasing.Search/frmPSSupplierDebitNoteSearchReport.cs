...
public class frmPSSupplierDebitNoteSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmPSSupplierDebitNoteSearchReport()
	{
		InitializeComponent();
	}

	public frmPSSupplierDebitNoteSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SupplierDebitNoteNo"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SupplierDebitNoteNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الاذن " : "No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SupplierDebitNoteNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SupplierDebitNoteDate"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SupplierDebitNoteDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الاذن" : "Date");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SupplierDebitNoteDate"].MaskInput = "dd/mm/yyyy hh:mm:ss tt";
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SupplierDebitNoteDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.13);
