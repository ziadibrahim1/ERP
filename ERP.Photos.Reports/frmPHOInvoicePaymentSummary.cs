...
public class frmPHOInvoicePaymentSummary : frmReportTree2010
{
	private IContainer components = null;

	public frmPHOInvoicePaymentSummary()
	{
		dtItems = PhotoTypes.Select("-1", Branches, GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItemsIDCol = "PhotoTypeID";
		TreeItemsNameCol = (GlobalVariables.IsArabic ? "PhotoTypeNameAr" : "PhotoTypeNameEn");
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "InvoicePaymentID";
		TreeItems2NameCol = "InvoicePaymentNo";
	...
	public override void FillData()
	{
		...
		dtItems2 = InvoicesPayments.FillRepTree(Branches, Items, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PHO_InvoicesPayments_Summary_A.rpt" : "Rep_PHO_InvoicesPayments_Summary_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_PHO_InvoicesPayments_Summary_A_nologo.rpt" : "Rep_PHO_InvoicesPayments_Summary_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى فاتورة ليتم عرضها ", "There is no choosen Invoice to be shown in the report, please check items to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@InvoicePaymentIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Photos.Reports.frmPHOInvoicePaymentSummary));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2016, 6, 29, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2016, 6, 29, 0, 0, 0, 0);
		...
		base.Name = "frmPHOInvoicePaymentSummary";
