...
namespace ERP.Purchasing.MasterData;

public class frmSuppliersTree : frmTree2
{
	...
	public override void PrepareData()
	{
		if (TableName != "" && LevelsTable != "")
		{
			...
			dtChart = SubAccounts.FillTreeBySubAccountTypeIDs(GlobalVariables.SupplierSubAccountTypeIDs, GlobalVariables.BranchIDs, IsFromServer: true);
		...
		dtSubAccountType = SuAccountsTypes.SelectBySuAccountsTypeIDs(GlobalVariables.SupplierSubAccountTypeIDs, GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void ClearControls()
	{
		...
		if (Adding)
		{
			...
			((TextEditorControlBase)cboType).Value = 3;
	...
	public override void SetControls(bool NavMode)
	{
		...
		((EditorButtonControlBase)txtLensesProductionDiscountPercentage).ReadOnly = NavMode || !CanModifyPriceType;
	...
	public override bool ValidateData()
	{
		...
		if (cboSupplierAcc.SelectedIndex == -1)
		{
		...
		if (cboClientAcc.SelectedIndex == -1 && (((TextEditorControlBase)cboType).Value.ToString() == "4" || ((TextEditorControlBase)cboType).Value.ToString() == "5" || ((TextEditorControlBase)cboType).Value.ToString() == "7"))
		{
	...
	{
		int num = SearchFunctions.Suppliers("-1", "-1", IsFromServer: true);
		if (num != 0)
		{
	...
	{
		UltraLabel obj = lblClientAccount;
		bool visible = (((Control)(object)cboClientAcc).Visible = ((TextEditorControlBase)cboType).Value.ToString() == "4" || ((TextEditorControlBase)cboType).Value.ToString() == "5" || ((TextEditorControlBase)cboType).Value.ToString() == "7");
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.MasterData.frmSuppliersTree));
		...
		((ControlBase)this.lblBuildingNumber).Appearance = (AppearanceBase)(object)val7;
		...
		((UltraToggleEditorBase)this.chkDiscountTax).Appearance = (AppearanceBase)(object)val8;
		...
		((UltraToggleEditorBase)this.chkIsActive).Appearance = (AppearanceBase)(object)val9;
		...
		((ControlBase)this.ultraLabel2).Appearance = (AppearanceBase)(object)val16;
		...
		((ControlBase)this.lblBirthDate).Appearance = (AppearanceBase)(object)val17;
		...
		((ControlBase)this.lblSupplierAcc).Appearance = (AppearanceBase)(object)val18;
		...
		((ControlBase)this.lblClientAccount).Appearance = (AppearanceBase)(object)val19;
		...
		((ControlBase)this.lblPriceType).Appearance = (AppearanceBase)(object)val20;
		...
		((ControlBase)this.lblClassification).Appearance = (AppearanceBase)(object)val21;
		...
		((ControlBase)this.lblDefaultPaymentMethod).Appearance = (AppearanceBase)(object)val22;
		...
		((ControlBase)this.lblClintSupplierTitle).Appearance = (AppearanceBase)(object)val23;
		...
		((ControlBase)this.lblMax).Appearance = (AppearanceBase)(object)val24;
		...
		((ControlBase)this.lblEMail).Appearance = (AppearanceBase)(object)val25;
		...
		((ControlBase)this.lblDiscountPercentage).Appearance = (AppearanceBase)(object)val26;
		...
		((ControlBase)this.lblCreditLimit).Appearance = (AppearanceBase)(object)val27;
		...
		((ControlBase)this.lblReorder).Appearance = (AppearanceBase)(object)val30;
		...
		((ControlBase)this.lblMin).Appearance = (AppearanceBase)(object)val31;
		...
		((AppearanceBase)val32).BackColor = System.Drawing.SystemColors.ActiveBorder;
		((AppearanceBase)val32).BackColor2 = System.Drawing.SystemColors.ControlDark;
		((AppearanceBase)val32).BackGradientStyle = (GradientStyle)2;
		((AppearanceBase)val32).BorderColor = System.Drawing.SystemColors.Window;
		resources.ApplyResources(val32, "appearance31");
		((SpecialBoxBase)((UltraGridBase)this.ULGContacts).DisplayLayout.GroupByBox).Appearance = (AppearanceBase)(object)val32;
		((AppearanceBase)val33).ForeColor = System.Drawing.SystemColors.GrayText;
		resources.ApplyResources(val33, "appearance32");
		((UltraGridBase)this.ULGContacts).DisplayLayout.GroupByBox.BandLabelAppearance = (AppearanceBase)(object)val33;
		((SpecialBoxBase)((UltraGridBase)this.ULGContacts).DisplayLayout.GroupByBox).BorderStyle = (UIElementBorderStyle)4;
		((AppearanceBase)val34).BackColor = System.Drawing.SystemColors.ControlLightLight;
		((AppearanceBase)val34).BackColor2 = System.Drawing.SystemColors.Control;
		((AppearanceBase)val34).BackGradientStyle = (GradientStyle)3;
		((AppearanceBase)val34).ForeColor = System.Drawing.SystemColors.GrayText;
		resources.ApplyResources(val34, "appearance33");
		((UltraGridBase)this.ULGContacts).DisplayLayout.GroupByBox.PromptAppearance = (AppearanceBase)(object)val34;
		...
		((AppearanceBase)val35).ForeColor = System.Drawing.SystemColors.ControlText;
		resources.ApplyResources(val35, "appearance34");
		((UltraGridBase)this.ULGContacts).DisplayLayout.Override.ActiveCellAppearance = (AppearanceBase)(object)val35;
		((AppearanceBase)val36).BackColor = System.Drawing.SystemColors.Highlight;
		((AppearanceBase)val36).ForeColor = System.Drawing.SystemColors.HighlightText;
		resources.ApplyResources(val36, "appearance35");
		((UltraGridBase)this.ULGContacts).DisplayLayout.Override.ActiveRowAppearance = (AppearanceBase)(object)val36;
		...
		((UltraGridBase)this.ULGContacts).DisplayLayout.Override.CardAreaAppearance = (AppearanceBase)(object)val37;
		((AppearanceBase)val38).BorderColor = System.Drawing.Color.Silver;
		resources.ApplyResources(val38, "appearance37");
		((AppearanceBase)val38).TextTrimming = (TextTrimming)3;
		((UltraGridBase)this.ULGContacts).DisplayLayout.Override.CellAppearance = (AppearanceBase)(object)val38;
		...
		((AppearanceBase)val39).BackColor = System.Drawing.SystemColors.Control;
		((AppearanceBase)val39).BackColor2 = System.Drawing.SystemColors.ControlDark;
		((AppearanceBase)val39).BackGradientAlignment = (GradientAlignment)1;
		((AppearanceBase)val39).BackGradientStyle = (GradientStyle)3;
		((AppearanceBase)val39).BorderColor = System.Drawing.SystemColors.Window;
		resources.ApplyResources(val39, "appearance38");
		((UltraGridBase)this.ULGContacts).DisplayLayout.Override.GroupByRowAppearance = (AppearanceBase)(object)val39;
		...
		((UltraGridBase)this.ULGContacts).DisplayLayout.Override.RowAppearance = (AppearanceBase)(object)val40;
		((UltraGridBase)this.ULGContacts).DisplayLayout.Override.RowSelectors = (DefaultableBoolean)2;
		((AppearanceBase)val41).BackColor = System.Drawing.SystemColors.ControlLight;
		resources.ApplyResources(val41, "appearance40");
		((UltraGridBase)this.ULGContacts).DisplayLayout.Override.TemplateAddRowAppearance = (AppearanceBase)(object)val41;
		...
		((AppearanceBase)val42).BackColor = System.Drawing.SystemColors.ActiveBorder;
		((AppearanceBase)val42).BackColor2 = System.Drawing.SystemColors.ControlDark;
		((AppearanceBase)val42).BackGradientStyle = (GradientStyle)2;
		((AppearanceBase)val42).BorderColor = System.Drawing.SystemColors.Window;
		resources.ApplyResources(val42, "appearance41");
		((SpecialBoxBase)((UltraGridBase)this.ULGCards).DisplayLayout.GroupByBox).Appearance = (AppearanceBase)(object)val42;
		((AppearanceBase)val43).ForeColor = System.Drawing.SystemColors.GrayText;
		resources.ApplyResources(val43, "appearance42");
		((UltraGridBase)this.ULGCards).DisplayLayout.GroupByBox.BandLabelAppearance = (AppearanceBase)(object)val43;
		((SpecialBoxBase)((UltraGridBase)this.ULGCards).DisplayLayout.GroupByBox).BorderStyle = (UIElementBorderStyle)4;
		((AppearanceBase)val44).BackColor = System.Drawing.SystemColors.ControlLightLight;
		((AppearanceBase)val44).BackColor2 = System.Drawing.SystemColors.Control;
		((AppearanceBase)val44).BackGradientStyle = (GradientStyle)3;
		((AppearanceBase)val44).ForeColor = System.Drawing.SystemColors.GrayText;
		resources.ApplyResources(val44, "appearance43");
		((UltraGridBase)this.ULGCards).DisplayLayout.GroupByBox.PromptAppearance = (AppearanceBase)(object)val44;
		...
		((AppearanceBase)val45).ForeColor = System.Drawing.SystemColors.ControlText;
		resources.ApplyResources(val45, "appearance44");
		((UltraGridBase)this.ULGCards).DisplayLayout.Override.ActiveCellAppearance = (AppearanceBase)(object)val45;
		((AppearanceBase)val46).BackColor = System.Drawing.SystemColors.Highlight;
		((AppearanceBase)val46).ForeColor = System.Drawing.SystemColors.HighlightText;
		resources.ApplyResources(val46, "appearance45");
		((UltraGridBase)this.ULGCards).DisplayLayout.Override.ActiveRowAppearance = (AppearanceBase)(object)val46;
		...
		((UltraGridBase)this.ULGCards).DisplayLayout.Override.CardAreaAppearance = (AppearanceBase)(object)val47;
		((AppearanceBase)val48).BorderColor = System.Drawing.Color.Silver;
		resources.ApplyResources(val48, "appearance47");
		((AppearanceBase)val48).TextTrimming = (TextTrimming)3;
		((UltraGridBase)this.ULGCards).DisplayLayout.Override.CellAppearance = (AppearanceBase)(object)val48;
		...
		((AppearanceBase)val49).BackColor = System.Drawing.SystemColors.Control;
		((AppearanceBase)val49).BackColor2 = System.Drawing.SystemColors.ControlDark;
		((AppearanceBase)val49).BackGradientAlignment = (GradientAlignment)1;
		...
		((UltraGridBase)this.ULGCards).DisplayLayout.Override.GroupByRowAppearance = (AppearanceBase)(object)val49;
		...
		((UltraGridBase)this.ULGCards).DisplayLayout.Override.RowAppearance = (AppearanceBase)(object)val50;
		((UltraGridBase)this.ULGCards).DisplayLayout.Override.RowSelectors = (DefaultableBoolean)2;
		((AppearanceBase)val51).BackColor = System.Drawing.SystemColors.ControlLight;
		resources.ApplyResources(val51, "appearance50");
		((UltraGridBase)this.ULGCards).DisplayLayout.Override.TemplateAddRowAppearance = (AppearanceBase)(object)val51;
		...
		((ControlBase)this.lblEINVSubAccountType).Appearance = (AppearanceBase)(object)val52;
		...
		((ControlBase)this.lblDefaultSalesMan).Appearance = (AppearanceBase)(object)val53;
		...
		((ControlBase)this.lblTaxNo).Appearance = (AppearanceBase)(object)val54;
		...
		((ControlBase)this.lblLicenseNo).Appearance = (AppearanceBase)(object)val55;
		...
		((ControlBase)this.lblCompanyName).Appearance = (AppearanceBase)(object)val56;
		...
		((ControlBase)this.lblCommercialRegistrationNo).Appearance = (AppearanceBase)(object)val57;
		...
		((AppearanceBase)val58).BackColor = System.Drawing.SystemColors.ActiveBorder;
		...
		((SpecialBoxBase)((UltraGridBase)this.ULGBanks).DisplayLayout.GroupByBox).Appearance = (AppearanceBase)(object)val58;
		((AppearanceBase)val59).ForeColor = System.Drawing.SystemColors.GrayText;
		resources.ApplyResources(val59, "appearance58");
		((UltraGridBase)this.ULGBanks).DisplayLayout.GroupByBox.BandLabelAppearance = (AppearanceBase)(object)val59;
		((SpecialBoxBase)((UltraGridBase)this.ULGBanks).DisplayLayout.GroupByBox).BorderStyle = (UIElementBorderStyle)4;
		((AppearanceBase)val60).BackColor = System.Drawing.SystemColors.ControlLightLight;
		((AppearanceBase)val60).BackColor2 = System.Drawing.SystemColors.Control;
		((AppearanceBase)val60).BackGradientStyle = (GradientStyle)3;
		((AppearanceBase)val60).ForeColor = System.Drawing.SystemColors.GrayText;
		resources.ApplyResources(val60, "appearance59");
		((UltraGridBase)this.ULGBanks).DisplayLayout.GroupByBox.PromptAppearance = (AppearanceBase)(object)val60;
		...
		((AppearanceBase)val61).ForeColor = System.Drawing.SystemColors.ControlText;
		resources.ApplyResources(val61, "appearance60");
		((UltraGridBase)this.ULGBanks).DisplayLayout.Override.ActiveCellAppearance = (AppearanceBase)(object)val61;
		((AppearanceBase)val62).BackColor = System.Drawing.SystemColors.Highlight;
		((AppearanceBase)val62).ForeColor = System.Drawing.SystemColors.HighlightText;
		resources.ApplyResources(val62, "appearance61");
		((UltraGridBase)this.ULGBanks).DisplayLayout.Override.ActiveRowAppearance = (AppearanceBase)(object)val62;
		...
		((AppearanceBase)val63).BackColor = System.Drawing.SystemColors.Window;
		resources.ApplyResources(val63, "appearance62");
		((UltraGridBase)this.ULGBanks).DisplayLayout.Override.CardAreaAppearance = (AppearanceBase)(object)val63;
		((AppearanceBase)val64).BorderColor = System.Drawing.Color.Silver;
		resources.ApplyResources(val64, "appearance63");
		((AppearanceBase)val64).TextTrimming = (TextTrimming)3;
		((UltraGridBase)this.ULGBanks).DisplayLayout.Override.CellAppearance = (AppearanceBase)(object)val64;
		...
		((AppearanceBase)val65).BackColor = System.Drawing.SystemColors.Control;
		((AppearanceBase)val65).BackColor2 = System.Drawing.SystemColors.ControlDark;
		((AppearanceBase)val65).BackGradientAlignment = (GradientAlignment)1;
		((AppearanceBase)val65).BackGradientStyle = (GradientStyle)3;
		((AppearanceBase)val65).BorderColor = System.Drawing.SystemColors.Window;
		resources.ApplyResources(val65, "appearance64");
		((UltraGridBase)this.ULGBanks).DisplayLayout.Override.GroupByRowAppearance = (AppearanceBase)(object)val65;
		...
		((AppearanceBase)val66).BorderColor = System.Drawing.Color.Silver;
		resources.ApplyResources(val66, "appearance65");
		((UltraGridBase)this.ULGBanks).DisplayLayout.Override.RowAppearance = (AppearanceBase)(object)val66;
		((UltraGridBase)this.ULGBanks).DisplayLayout.Override.RowSelectors = (DefaultableBoolean)2;
		((AppearanceBase)val67).BackColor = System.Drawing.SystemColors.ControlLight;
		resources.ApplyResources(val67, "appearance66");
		((UltraGridBase)this.ULGBanks).DisplayLayout.Override.TemplateAddRowAppearance = (AppearanceBase)(object)val67;
		...
		((ControlBase)this.lblType).Appearance = (AppearanceBase)(object)val68;
		...
		((AppearanceBase)val69).TextTrimming = (TextTrimming)6;
		((UltraTabControlBase)this.tabItemType).Appearance = (AppearanceBase)(object)val69;
		...
		((UltraTabControlBase)this.tabItemType).TabHeaderAreaAppearance = (AppearanceBase)(object)val70;
		resources.ApplyResources(val71, "appearance70");
		((UltraTabControlBase)this.tabItemType).TabListButtonAppearance = (AppearanceBase)(object)val71;
		((UltraTabControlBase)this.tabItemType).TabOrientation = (TabOrientation)1;
		((KeyedSubObjectBase)val72).Key = "Accounts";
		val72.TabPage = this.tabService;
		resources.ApplyResources(val72, "ultraTab1");
		((SubObjectBase)val72).ForceApplyResources = "";
		((KeyedSubObjectBase)val73).Key = "ClientSupplier";
		val73.TabPage = this.tabItem;
		resources.ApplyResources(val73, "ultraTab2");
		((SubObjectBase)val73).ForceApplyResources = "";
		((KeyedSubObjectBase)val74).Key = "Contacts";
		val74.TabPage = this.tabRecipe;
		resources.ApplyResources(val74, "ultraTab3");
		((SubObjectBase)val74).ForceApplyResources = "";
		((KeyedSubObjectBase)val75).Key = "Cards";
		val75.TabPage = this.ultraTabPageControl1;
		resources.ApplyResources(val75, "ultraTab4");
		((SubObjectBase)val75).ForceApplyResources = "";
		((KeyedSubObjectBase)val76).Key = "Company";
		val76.TabPage = this.ultraTabPageControl2;
		resources.ApplyResources(val76, "ultraTab5");
		((SubObjectBase)val76).ForceApplyResources = "";
		((KeyedSubObjectBase)val77).Key = "Banks";
		val77.TabPage = this.ultraTabPageControl3;
		resources.ApplyResources(val77, "ultraTab6");
		((SubObjectBase)val77).ForceApplyResources = "";
		((UltraTabControlBase)this.tabItemType).Tabs.AddRange((UltraTab[])(object)new UltraTab[6] { val72, val73, val74, val75, val76, val77 });
		...
		resources.ApplyResources(val78, "appearance71");
		((ControlBase)this.lblBranch).Appearance = (AppearanceBase)(object)val78;
