...
public class frmLabOrdersSalesMan : frmReportTree2010
{
	private IContainer components = null;

	public frmLabOrdersSalesMan()
	{
		InitializeComponent();
		dtItems = SubAccounts.FillReportTreeEmployeesBySubAccountTypeIDs(GlobalVariables.EmployeeSubAccountTypeIDs, "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		...
		dtItems2 = BusinessLayer.StockControl.Items.FillTree("-1", "-1", "-1", "1", "-1", "-1", "-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "ItemID";
		TreeItems2NameCol = "Name";
		TreeItems2IsMainCol = "IsMain";
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " مبيعات مندوب البيع " : " Sales Of Sales Rep ");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_Invoices_SalesMan_A.rpt" : "Rep_Lns_Invoices_SalesMan_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_Invoices_SalesMan_A_nologo.rpt" : "Rep_Lns_Invoices_SalesMan_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmLabOrdersSalesMan));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2020, 9, 28, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2020, 9, 28, 0, 0, 0, 0);
		...
		base.Name = "frmLabOrdersSalesMan";
