...
public class frmVisaSales : frmReportTree2010
{
	private IContainer components = null;

	public frmVisaSales()
	{
		dtItems2 = VisaTypes.FillCombo(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItems2IDCol = "VisaTypeID";
		TreeItems2NameCol = "VisaTypeName";
		TreeItemsIDCol = "ShiftDetailID";
	...
	{
		GetBranches();
		dtItems = ShiftsDetails.FillComboByDate(Branches, dtpFromDate.DateTime.ToString(GlobalVariables.DateLongFormate), dtpToDate.DateTime.ToString(GlobalVariables.DateLongFormate), "1");
		if (dtItems != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى ورديه  ", "There is no choosen SHift Detail to be shown in the report, please check SHift Details to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى من أنواع كروت الإئتمان  ", "There is no chosen Visa Type to be shown in the report, please check Visa Type to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@ShiftDetailIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@VisaTypeIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmVisaSales));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2015, 7, 7, 0, 0, 0, 0);
		resources.ApplyResources(base.dtpFromDate, "dtpFromDate");
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2015, 7, 7, 0, 0, 0, 0);
