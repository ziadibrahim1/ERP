...
public class frmLnsInvoicesReturnsRep : frmReportTree2010
{
	private IContainer components = null;

	public frmLnsInvoicesReturnsRep()
	{
	...
	public override void FillData()
	{
		...
		dtItems2 = InvoicesReturns.FillRepTree(Branches, Items, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مرتجع ليتم عرضه ", "There is no chosen Return to be shown in the report, please check Vouchers to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@ReturnIDs", Items2);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmLnsInvoicesReturnsRep));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2022, 3, 17, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2022, 3, 17, 0, 0, 0, 0);
		...
		base.Name = "frmLnsInvoicesReturnsRep";
