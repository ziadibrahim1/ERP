...
public class frmLnsInvoicesRep : frmReportTree2010
{
	private IContainer components = null;

	public frmLnsInvoicesRep()
	{
		...
		TreeItemsNumberCol = "SubAccountNumber";
	...
	public override void FillData()
	{
		...
		dtItems2 = Invoices.FillRepTree(Branches, Items, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى فاتوره ليتم عرضها ", "There is no chosen invoices to be shown in the report, please check Vouchers to be shown in report");
			return;
		}
		GlobalFunctions.GenerateVoucherQR(Items2, "Lns_Invoices");
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		frmReporViwer2.Disposed += frmReporViwerDisposing;
	...
	private void frmReporViwerDisposing(object sender, EventArgs e)
	{
		GlobalFunctions.DeleteVoucherQR(Items2, "Lns_Invoices");
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmLnsInvoicesRep));
