...
public class frmInvoicesSalesMan : frmReportTree2010
{
	private IContainer components = null;

	public frmInvoicesSalesMan()
	{
		InitializeComponent();
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى موظف  ", "There is no choosen Employee to be shown in the report, please check items to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmInvoicesSalesMan));
		...
		base.Name = "frmEmployeeAttendance";
