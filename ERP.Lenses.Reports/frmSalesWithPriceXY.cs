...
public class frmSalesWithPriceXY : frmReportTree2010
{
	...
	public frmSalesWithPriceXY()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " X Y مبيعات الأصناف " : "Item Sales Detailed X Y ");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? " مبيعات الأصناف " : "Item Sales Detailed ");
	...
	public override string GetReportName()
	{
		...
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_ItemsSalesXY_WithPrice_A.rpt" : "Rep_Lns_ItemsSalesXY_WithPrice_E.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_ItemsSales_WithPrice_A.rpt" : "Rep_Lns_ItemsSales_WithPrice_E.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		if (!dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("WithBalance") && num == 0)
		{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@PositiveX", (((TextEditorControlBase)cboReportType).Value.ToString() == "2") ? "-1" : ((Control)(object)cboSph).Text);
		GlobalVariables.ReportDocument.SetParameterValue("@PositiveY", (((TextEditorControlBase)cboReportType).Value.ToString() == "2") ? "-1" : ((Control)(object)cboCyl).Text);
		GlobalVariables.ReportDocument.SetParameterValue("@IsArabic", ((UltraToggleEditorBase)chkIsArabic).Checked);
		if (dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("WithBalance"))
		{
	...
	{
		UltraCheckEditor obj = chkAllShiftDetails;
		UltraTree obj2 = treeShiftDetails;
		UltraTextEditor obj3 = txtShiftDetails;
		bool flag = (((Control)(object)btnShiftDetailsSearch).Visible = cboReportType.SelectedIndex > -1 && dtReports.Rows.Count != 0 && !dtReports.Rows[cboReportType.SelectedIndex]["ProcedureName"].Equals("WithBalance"));
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmSalesWithPriceXY));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2019, 1, 3, 0, 0, 0, 0);
		resources.ApplyResources(base.dtpFromDate, "dtpFromDate");
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2019, 1, 3, 0, 0, 0, 0);
		...
		val7.DataValue = "1";
		resources.ApplyResources(val7, "valueListItem1");
		((SubObjectBase)val7).ForceApplyResources = "";
		this.cboCyl.Items.AddRange((ValueListItem[])(object)new ValueListItem[2] { val6, val7 });
		...
		this.cboSph.Items.AddRange((ValueListItem[])(object)new ValueListItem[2] { val8, val9 });
