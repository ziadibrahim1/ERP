...
public class frmInsertItemByKeyboard : frmReportTree2010
{
	private IContainer components = null;

	public frmInsertItemByKeyboard()
	{
		InitializeComponent();
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " مراقبة الادخال الاصناف فى الفاتورة " : " Insert Items By KeyBoard ");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_Invoices_InsertItem_BYKeyBoard_A" : "Rep_Lns_Invoices_InsertItem_BYKeyBoard_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_Invoices_InsertItem_BYKeyBoard_A_nologo.rpt" : "Rep_Lns_Invoices_InsertItem_BYKeyBoard_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmInsertItemByKeyboard));
		...
		base.Name = "frmInsertItemByKeyboard";
