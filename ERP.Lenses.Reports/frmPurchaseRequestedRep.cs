...
public class frmPurchaseRequestedRep : frmReportTree2010
{
	private IContainer components = null;

	private UltraCheckEditor chkNotSent;

	public frmPurchaseRequestedRep()
	{
		TreeItems2ParentIDCol = "ParentID";
		TreeItems2IDCol = "LabOrderID";
		TreeItems2NameCol = "LabOrderNo";
	...
	{
		GetBranches();
		dtItems2 = LabOrders.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"), ((UltraToggleEditorBase)chkNotSent).Checked ? "0" : "1");
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى فاتوره ليتم عرضها ", "There is no chosen Lab Order to be shown in the report, please check  Lab Orders to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@LabOrderIDs", Items2);
	...
	private void chkIsSent_CheckedChanged(object sender, EventArgs e)
	{
		if (!IsLoading)
		{
			FillData();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmPurchaseRequestedRep));
		Appearance val2 = new Appearance();
		Appearance val3 = new Appearance();
		Appearance val4 = new Appearance();
		Appearance val5 = new Appearance();
		this.chkNotSent = new UltraCheckEditor();
		...
		((System.ComponentModel.ISupportInitialize)this.chkNotSent).BeginInit();
		base.SuspendLayout();
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 1, 21, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 1, 21, 0, 0, 0, 0);
		...
		resources.ApplyResources(this.chkNotSent, "chkNotSent");
		((System.Windows.Forms.Control)(object)this.chkNotSent).Name = "chkNotSent";
		((UltraToggleEditorBase)this.chkNotSent).CheckedChanged += new System.EventHandler(chkIsSent_CheckedChanged);
		resources.ApplyResources(this, "$this");
		base.Controls.Add((System.Windows.Forms.Control)(object)this.chkNotSent);
		base.Name = "frmPurchaseRequestedRep";
		...
		base.Controls.SetChildIndex((System.Windows.Forms.Control)(object)this.chkNotSent, 0);
		...
		((System.ComponentModel.ISupportInitialize)this.chkNotSent).EndInit();
