...
public class frmLabLensesBalance : frmReportTree2010
{
	...
	public frmLabLensesBalance()
	{
		dtItems = BusinessLayer.StockControl.Items.FillTreeWithItemType("-1", "-1", "0", "-1", "-1", "0", "-1", "2", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
	...
	{
		dtSearchResult = SearchFunctions.ItemsReport("-1", "-1", "0", "-1", "-1", "0", "-1", "-1", "2", "0", IsFromServer: false);
	...
	private void frmLabLensesBalance_Load(object sender, EventArgs e)
	{
		if (base.DesignMode)
		{
			return;
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmLabLensesBalance));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2019, 1, 23, 0, 0, 0, 0);
		resources.ApplyResources(base.dtpFromDate, "dtpFromDate");
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2019, 1, 23, 0, 0, 0, 0);
		...
		base.Name = "frmLabLensesBalance";
		base.Load += new System.EventHandler(frmLabLensesBalance_Load);
