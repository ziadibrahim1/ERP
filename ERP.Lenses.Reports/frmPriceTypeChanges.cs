...
public class frmPriceTypeChanges : frmReportTree2010
{
	private IContainer components = null;

	public frmPriceTypeChanges()
	{
		InitializeComponent();
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " تفصيلي" : " Detailed");
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_Invoices_ChangedPriceType_A.rpt" : "Rep_Lns_Invoices_ChangedPriceType_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_Invoices_ChangedPriceType_A_nologo.rpt" : "Rep_Lns_Invoices_ChangedPriceType_E_nologo.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmPriceTypeChanges));
