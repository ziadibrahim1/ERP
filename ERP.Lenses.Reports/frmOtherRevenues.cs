...
public class frmOtherRevenues : frmReportTree2010
{
	...
	public frmOtherRevenues()
	{
		...
		TreeItems2IDCol = "RevenueID";
		TreeItems2NameCol = "RevenueNo";
		TreeItems2IsMainCol = "IsMain";
		InitializeComponent();
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "طباعه الايرادات الاخرى" : "Print Other Revenues");
	...
	public override void FillData()
	{
		...
		if (Branches != ",")
		{
			dtItems2 = Revenues.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"));
			if (dtItems2 != null)
			{
	...
	public override string GetReportName()
	{
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "1")
		{
			...
			{
				return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_RevenuesSummary_A.rpt" : "Rep_Lns_RevenuesSummary_E.rpt");
			}
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_RevenuesSummary_A_nologo.rpt" : "Rep_Lns_RevenuesSummary_E_nologo.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		GlobalVariables.ReportDocument.SetParameterValue("@RevenueIDs", Items2);
	...
	public override void btnItems2Search_Click(object sender, EventArgs e)
	{
		...
		{
			TreeItems2.GetNodeByKey(dtSearchResult.Rows[i]["RevenueID"].ToString()).CheckedState = CheckState.Checked;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmOtherRevenues));
