...
public class frmItemExpectedSalesXY : frmReportTree2010
{
	...
	public frmItemExpectedSalesXY()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " X Y الكميات المتوقع بيعها للأصناف" : "Item Expected Sales X Y ");
		cboReportType.Items.Add((object)2, GlobalVariables.IsArabic ? " الكميات المتوقع بيعها للأصناف" : "Item Expected Sales ");
		cboReportType.Items.Add((object)3, GlobalVariables.IsArabic ? " X Y الكميات المتوقع بيعها للأصناف تفصيلي " : "Item Expected Sales Details X Y");
	...
	public override string GetReportName()
	{
		...
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_ItemsImportXY_A.rpt" : "Rep_Lns_ItemsImportXY_E.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "2")
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_ItemsImport_A.rpt" : "Rep_Lns_ItemsImport_E.rpt");
		}
		if (((TextEditorControlBase)cboReportType).Value.ToString() == "3")
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_Lns_ItemsImportDetailsXY_A.rpt" : "Rep_Lns_ItemsImportDetailsXY_E.rpt");
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmItemExpectedSalesXY));
		...
		base.Name = "frmItemExpectedSalesXY";
