...
public class frmItemsOffers : frmReportTree2010
{
	private IContainer components = null;

	public frmItemsOffers()
	{
		...
		TreeItems2IDCol = "OfferID";
		TreeItems2NameCol = "OfferName";
		TreeItems2NumberCol = "OfferCode";
	...
	{
		GetBranches();
		dtItems2 = Offers.FillRepTree(Branches, dtpFromDate.DateTime.Date.ToString(GlobalVariables.DateShortFormate), dtpToDate.DateTime.ToString("MM/dd/yyyy 23:59:59"), GlobalVariables.IsArabic ? "1" : "0");
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى صنف  ", "There is no chosen Items to be shown in the report, please check items to be shown in report");
			return;
		}
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى عرض  ", "There is no chosen Offers to be shown in the report, please check Offers to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@ItemIDs", Items);
		GlobalVariables.ReportDocument.SetParameterValue("@OfferIDs", Items2);
	...
	{
		dtSearchResult = SearchFunctions.LnsOffersReport(-1, -1, -1, IsFromServer: false);
		for (int i = 0; i < dtSearchResult.Rows.Count; i++)
		{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmItemsOffers));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2017, 3, 14, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2017, 3, 14, 0, 0, 0, 0);
