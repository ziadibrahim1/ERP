...
public class frmUsersActivity : frmReportTree2010
{
	private IContainer components = null;

	public frmUsersActivity()
	{
		InitializeComponent();
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى مستخدم ", "There is no chosen User to be shown in the report, please check Users to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmUsersActivity));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 10, 4, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 10, 4, 0, 0, 0, 0);
