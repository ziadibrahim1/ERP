...
public class frmItemStockLevelsXY : frmReportTree2010
{
	...
	public UltraComboEditor cboBranchs;

	public UltraLabel ultraLabel4;

	public frmItemStockLevelsXY()
	{
		...
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? " حدود المخزن" : "Item Stock Levels ");
	...
	public override string GetReportName()
	{
		...
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsStockLevelsXY_A.rpt" : "Rep_SC_ItemsStockLevelsXY_E.rpt");
		}
	...
	public override void ShowReport()
	{
		...
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار الفرع  ", "There is no choosen Branch");
		...
		GlobalVariables.ReportDocument.SetParameterValue("@BranchID", ((TextEditorControlBase)cboBranchs).Value);
		GlobalVariables.ReportDocument.SetParameterValue("@BranchName", ((Control)(object)cboBranchs).Text);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmItemStockLevelsXY));
		...
		val6.DataValue = "0";
		resources.ApplyResources(val6, "valueListItem5");
		((SubObjectBase)val6).ForceApplyResources = "";
		val7.DataValue = "1";
		resources.ApplyResources(val7, "valueListItem6");
		...
		val10.CheckState = System.Windows.Forms.CheckState.Checked;
		val10.DataValue = "0";
		resources.ApplyResources(val10, "valueListItem2");
		...
		this.cboBranchs.Items.AddRange((ValueListItem[])(object)new ValueListItem[2] { val10, val11 });
		((System.Windows.Forms.Control)(object)this.cboBranchs).Name = "cboBranchs";
		((TextEditorControlBase)this.cboBranchs).Nullable = false;
		...
		base.Name = "frmItemStockLevelsXY";
