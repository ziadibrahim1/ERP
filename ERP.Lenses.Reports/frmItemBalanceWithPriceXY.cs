...
public class frmItemBalanceWithPriceXY : frmReportTree2010
{
	...
	public frmItemBalanceWithPriceXY()
	{
	...
	public override string GetReportName()
	{
		...
		{
			return GlobalVariables.ReportsPath + (((UltraToggleEditorBase)chkIsArabic).Checked ? "Rep_SC_ItemsBalanceLnsXY_WithPrice_A.rpt" : "Rep_SC_ItemsBalanceLnsXY_WithPrice_E.rpt");
		}
	...
	private void frmItemBalanceWithPriceXY_Load(object sender, EventArgs e)
	{
		if (base.DesignMode)
		{
			return;
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmItemBalanceWithPriceXY));
		...
		base.Name = "frmItemBalanceWithPriceXY";
		base.Load += new System.EventHandler(frmItemBalanceWithPriceXY_Load);
