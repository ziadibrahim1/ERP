...
public class frmServicesSalesFollowUp : frmReportTree2010
{
	...
	{
		dtItems2 = BusinessLayer.StockControl.Items.FillTree("0", "0", "1", "0", "-1", "0", "0", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		if (dtItems2 != null)
		{
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى خدمة ليتم عرضه ", "There is no chosen Service to be shown in the report, please check Services to be shown in report");
			return;
		}
	...
	{
		dtSearchResult = SearchFunctions.ItemsReport("0", "0", "1", "0", "-1", "0", "0", "0", "-1", "0", IsFromServer: false);
		for (int i = 0; i < dtSearchResult.Rows.Count; i++)
		{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmServicesSalesFollowUp));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 7, 16, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 7, 16, 0, 0, 0, 0);
