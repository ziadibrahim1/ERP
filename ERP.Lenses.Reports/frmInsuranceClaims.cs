...
public class frmInsuranceClaims : frmReportTree2010
{
	private IContainer components = null;

	public frmInsuranceClaims()
	{
	...
	public override void ShowReport()
	{
		...
		if (Items.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار اى كفيل  ", "There is no chosen Sponsor to be shown in the report, please check Sponsors to be shown in report");
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Lenses.Reports.frmInsuranceClaims));
		...
		base.dtpFromDate.DateTime = new System.DateTime(2018, 2, 25, 0, 0, 0, 0);
		base.dtpFromDate.MaskInput = "dd/mm/yyyy";
		base.dtpFromDate.Value = new System.DateTime(2018, 2, 25, 0, 0, 0, 0);
