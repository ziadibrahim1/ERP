...
public class frmApprovingSLOrders : frmPosted
{
	private IContainer components = null;

	public frmApprovingSLOrders()
	{
		InitializeComponent();
		NoCol = "SLOrderNo";
	}
	...
	{
		dtsource = SLOrders.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			SLOrders.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد أوامر بيع لإعتمادها " : "There are No Orders to Approve");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.SLOrdersReport(0, 0, -1, -1);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Approved.frmApprovingSLOrders));
		...
		base.Name = "frmApprovingSLOrders";
