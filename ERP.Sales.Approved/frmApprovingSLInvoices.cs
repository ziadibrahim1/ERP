...
public class frmApprovingSLInvoices : frmPosted
{
	private IContainer components = null;

	public frmApprovingSLInvoices()
	{
		InitializeComponent();
		NoCol = "SLInvoiceNo";
	}
	...
	{
		dtsource = SLInvoices.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	{
		DataTable dataTable = SearchFunctions.SLInvoicesReport(0, 0, -1, -1, -1);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Approved.frmApprovingSLInvoices));
		...
		base.Name = "frmApprovingSLInvoices";
