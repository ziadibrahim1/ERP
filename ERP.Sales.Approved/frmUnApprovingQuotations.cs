...
public class frmUnApprovingQuotations : frmPosted
{
	...
	public override void SaveData()
	{
		...
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد عروض أسعار لفك إعتمادها " : "There are No Quotations to UnApprove");
		}
	}
	...
	public override void ClickCellButton()
	{
		if (((UltraGridBase)ULGData).ActiveRow != null)
		{
			...
			((Control)(object)frmQuotations2.lblTitle).Text = (GlobalVariables.IsArabic ? "عــرض ســعـر" : "Quotations");
	...
	{
		DataTable dataTable = SearchFunctions.SLQuotationstReport(1, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Sales.Approved.frmUnApprovingQuotations));
