...
public class frmUpdateCCParent : frmDetails
{
	...
	public frmUpdateCCParent()
	{
		InitializeComponent();
	}

	public frmUpdateCCParent(string ID, string parentID)
		: this()
	{
		RowID = ID.ToString();
		ParentID = parentID;
	...
	{
		dtItems = CostCenters.SelectGroups(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		GlobalFunctions.FillCombo(cboHeader, dtItems, "CostCenterID", "CostCenterName");
	...
	public override void SaveData()
	{
		...
		try
		{
			CostCenters.UpdateParentID(RowID, ((TextEditorControlBase)cboHeader).Value.ToString(), GlobalVariables.UserID, IsFromServer: true);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Accounting.MasterData.frmUpdateCCParent));
