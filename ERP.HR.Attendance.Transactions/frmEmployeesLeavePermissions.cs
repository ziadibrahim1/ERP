...
public class frmEmployeesLeavePermissions : frmDetails
{
	...
	public frmEmployeesLeavePermissions()
	{
	...
	public override void PrepareData()
	{
		...
		dtDetails = EmployeesLeavePermissions.SelectBySubAccountID("0", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		InitGrid();
	}
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["EmployeeLeavePermissionID"].DefaultCellValue = -1;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsVacation"].DefaultCellValue = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["EmployeeLeavePermissionNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم" : "No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["EmployeeLeavePermissionNo"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["EmployeeLeavePermissionNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsVacation"].Header).Caption = (GlobalVariables.IsArabic ? "من الاجازه" : "FromVacation");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsVacation"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsVacation"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["VacationTypeID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["LeavePermissionAttendanceDate"].Header).Caption = (GlobalVariables.IsArabic ? "يوم الوردية" : "Attendance Date");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["LeavePermissionAttendanceDate"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["LeavePermissionAttendanceDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
	...
	public override void DisplayData()
	{
		...
		if (cboHeader.SelectedIndex > -1)
		{
			...
			dtDetails = EmployeesLeavePermissions.SelectBySubAccountID(((TextEditorControlBase)cboHeader).Value.ToString(), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
			InitGrid();
		}
	}
	...
	public override bool ValidateData()
	{
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			if (((UltraGridBase)ULGData).Rows[i].Cells["EmployeeLeavePermissionID"].Value.ToString() == "-1" && ((UltraGridBase)ULGData).Rows[i].Cells["LeavePermissionAttendanceDate"].Value == DBNull.Value)
			{
				GlobalVariables.InformationMB.Show("برجاء إختيار يوم الوردية", "Please Select Attendance Date");
				((GridItemBase)((UltraGridBase)ULGData).Rows[i].Cells["LeavePermissionAttendanceDate"]).Selected = true;
				return false;
			}
	...
	public override void SaveData()
	{
		...
		try
		{
			...
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				...
				text = text + ((UltraGridBase)ULGData).Rows[i].Cells["EmployeeLeavePermissionID"].Value.ToString() + ",";
			}
			EmployeesLeavePermissions.DeleteForUpdate(((TextEditorControlBase)cboHeader).Value.ToString(), text, IsFromServer: true);
			if (((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count > 0)
			{
				EmployeesLeavePermissions.Insert_UpdateByTable((DataTable)((UltraGridBase)ULGData).DataSource, GlobalVariables.UserID, IsFromServer: true);
			}
			DisplayData();
	...
	public override void SelectFullRow(object sender, EventArgs e)
	{
		...
		if (((KeyedSubObjectBase)ULGData.ActiveCell.Column).Key == "EmployeeLeavePermissionNo")
		{
	...
	private void InitializeComponent()
	{
		...
		((System.Windows.Forms.Control)(object)base.ULGData).Location = new System.Drawing.Point(8, 74);
		((System.Windows.Forms.Control)(object)base.ULGData).Size = new System.Drawing.Size(985, 397);
		...
		((System.Windows.Forms.Control)(object)base.cboHeader).Location = new System.Drawing.Point(509, 47);
		((System.Windows.Forms.Control)(object)base.cboHeader).Size = new System.Drawing.Size(209, 24);
		...
		((System.Windows.Forms.Control)(object)base.lblHeader).Location = new System.Drawing.Point(286, 51);
		...
		((System.Windows.Forms.Control)(object)this.cboEmployeeCode).Location = new System.Drawing.Point(406, 47);
		...
		base.Name = "frmEmployeesLeavePermissions";
