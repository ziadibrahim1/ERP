...
public class frmStoreTransferRequestSearch : frmSearch
{
	private IContainer components = null;

	public frmStoreTransferRequestSearch()
	{
		InitializeComponent();
	}

	public frmStoreTransferRequestSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
