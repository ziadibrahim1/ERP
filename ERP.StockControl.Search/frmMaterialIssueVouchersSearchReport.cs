...
public class frmMaterialIssueVouchersSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmMaterialIssueVouchersSearchReport()
	{
		InitializeComponent();
	}

	public frmMaterialIssueVouchersSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["MaterialIssueVoucherNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.105) - GlobalVariables.ScrollWidth;
