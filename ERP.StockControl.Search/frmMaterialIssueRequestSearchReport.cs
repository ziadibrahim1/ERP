...
public class frmMaterialIssueRequestSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmMaterialIssueRequestSearchReport()
	{
		InitializeComponent();
	}

	public frmMaterialIssueRequestSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["MaterialIssueRequestNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["MaterialIssueRequestDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Notes"].Width = (int)((double)((Control)(object)ULGData).Width * 0.22);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Completed"].Width = (int)((double)((Control)(object)ULGData).Width * 0.08);
	}
