...
public class frmOpeningBalancesSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmOpeningBalancesSearchReport()
	{
		InitializeComponent();
	}

	public frmOpeningBalancesSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OpeningBalanceCode"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OpeningBalanceCode"].Header).Caption = (GlobalVariables.IsArabic ? "كود" : "Code");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OpeningBalanceCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.28) - GlobalVariables.ScrollWidth;
