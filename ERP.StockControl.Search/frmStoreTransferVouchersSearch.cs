...
public class frmStoreTransferVouchersSearch : frmSearch
{
	private IContainer components = null;

	public frmStoreTransferVouchersSearch()
	{
		InitializeComponent();
	}

	public frmStoreTransferVouchersSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
