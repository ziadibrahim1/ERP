...
public class frmItemsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmItemsSearchReport()
	{
		InitializeComponent();
	}

	public frmItemsSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		if (GlobalVariables.IsArabic)
		{
			...
			((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemNameAr"].Width = (int)((double)((Control)(object)ULGData).Width * 0.28);
		...
		else
		{
			...
			((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemNameEn"].Width = (int)((double)((Control)(object)ULGData).Width * 0.28);
