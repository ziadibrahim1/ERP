...
public class frmRecipeManufacturingSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmRecipeManufacturingSearchReport()
	{
		InitializeComponent();
	}

	public frmRecipeManufacturingSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RecipeManufacturingNo"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RecipeManufacturingNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الاذن" : "NO");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["RecipeManufacturingNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
