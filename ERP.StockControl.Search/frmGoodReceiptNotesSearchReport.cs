...
public class frmGoodReceiptNotesSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmGoodReceiptNotesSearchReport()
	{
		InitializeComponent();
	}

	public frmGoodReceiptNotesSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["GoodReceiptNoteNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.13) - GlobalVariables.ScrollWidth;
