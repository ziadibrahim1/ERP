...
public class frmApprovingQuotations : frmPosted
{
	private IContainer components = null;

	public frmApprovingQuotations()
	{
		InitializeComponent();
		NoCol = "QuotationNo";
	}
	...
	{
		dtsource = Quotations.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			Quotations.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد عروض أسعار لإعتمادها " : "There are No Quotations to Approve");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.PSQuotationstReport(0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Approved.frmApprovingQuotations));
		...
		base.Name = "frmApprovingQuotations";
