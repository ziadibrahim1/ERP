...
public class frmClosingPSRequest : frmPosted
{
	private IContainer components = null;

	public frmClosingPSRequest()
	{
		InitializeComponent();
		NoCol = "PSRequestNo";
	}
	...
	{
		dtsource = PSRequest.SelectByClosed(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			{
				PSRequest.SetClosed("1", ((UltraGridBase)ULGData).Rows[i].Cells["PSRequestID"].Value.ToString());
			}
		}
		FillGrid();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Approved.frmClosingPSRequest));
