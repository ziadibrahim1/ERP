...
public class frmUnClosingPSRequest : frmPosted
{
	private IContainer components = null;

	public frmUnClosingPSRequest()
	{
		InitializeComponent();
		NoCol = "PSRequestNo";
		((Control)(object)btnPost).Text = (GlobalVariables.IsArabic ? "فك إغلاق" : "Open");
	}

	public override void FillGrid()
	{
		dtsource = PSRequest.SelectByClosed(GlobalVariables.BranchIDs, "1", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			{
				PSRequest.SetClosed("0", ((UltraGridBase)ULGData).Rows[i].Cells["PSRequestID"].Value.ToString());
			}
		}
		FillGrid();
	}
	...
	{
		DataTable dataTable = SearchFunctions.PSRequestReport(1, 0, 0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Approved.frmUnClosingPSRequest));
		...
		base.Name = "frmUnClosingPSRequest";
