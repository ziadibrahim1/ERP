...
public class frmApprovingPSOrders : frmPosted
{
	private IContainer components = null;

	public frmApprovingPSOrders()
	{
		InitializeComponent();
		NoCol = "PSOrderNo";
	}
	...
	{
		dtsource = PSOrders.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			PSOrders.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد أوامر شراء لإعتمادها " : "There are No Orders to Approve");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.PSOrdersReport(0, 0, -1, -1);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Approved.frmApprovingPSOrders));
		...
		base.Name = "frmApprovingPSOrders";
