...
public class frmApprovingPSInvoices : frmPosted
{
	private IContainer components = null;

	public frmApprovingPSInvoices()
	{
		InitializeComponent();
		NoCol = "PSInvoiceNo";
	}
	...
	{
		dtsource = PSInvoices.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	{
		DataTable dataTable = SearchFunctions.PSInvoicesReport(0, 0, -1);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Approved.frmApprovingPSInvoices));
		...
		base.Name = "frmApprovingPSInvoices";
