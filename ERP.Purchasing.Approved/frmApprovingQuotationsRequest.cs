...
public class frmApprovingQuotationsRequest : frmPosted
{
	private IContainer components = null;

	public frmApprovingQuotationsRequest()
	{
		InitializeComponent();
	...
	{
		dtsource = QuotationsRequest.SelectByApproved(GlobalVariables.BranchIDs, "0", GlobalVariables.IsArabic ? "1" : "0");
	...
	public override void SaveData()
	{
		...
		if (text != ",")
		{
			QuotationsRequest.SetApprove("1", text);
			FillGrid();
		}
		else
		{
			GlobalVariables.InformationMB.Show(GlobalVariables.IsArabic ? "لا توجد عروض أسعار لإعتمادها " : "There are No Quotation Request to Approve");
		}
	}
	...
	{
		DataTable dataTable = SearchFunctions.QuotationsRequestReport(0, 0);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Approved.frmApprovingQuotationsRequest));
		...
		base.Name = "frmApprovingQuotationsRequest";
