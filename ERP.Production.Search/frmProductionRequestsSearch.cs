...
public class frmProductionRequestsSearch : frmSearch
{
	private IContainer components = null;

	public frmProductionRequestsSearch()
	{
		InitializeComponent();
	}

	public frmProductionRequestsSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
