...
public class frmEmployeesPositions : frmDetails
{
	...
	public override void PrepareData()
	{
		...
		{
			vlPosition.ValueListItems.Add(dtPositions.Rows[i]["PositionID"], dtPositions.Rows[i]["PositionName"].ToString());
		}
		dtDetails = EmployeesPositions.SelectBySubAccountID("0", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		InitGrid();
	}
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["EmployeePositionID"].DefaultCellValue = -1;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PositionID"].Header).Caption = (GlobalVariables.IsArabic ? "الوظيفة" : "Position");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PositionID"].Hidden = false;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PositionID"].ValueList = (IValueList)(object)vlPosition;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PositionID"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
	...
	public override void DisplayData()
	{
		...
		if (cboHeader.SelectedIndex > -1)
		{
			...
			((TextEditorControlBase)cboEmployeeCode).ValueChanged += cboEmployeeCode_ValueChanged;
			dtDetails = EmployeesPositions.SelectBySubAccountID(((TextEditorControlBase)cboHeader).Value.ToString(), GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
			...
			if (dtDetails.Rows.Count == 0 && dtEmployeeData.Rows.Count > 0)
			{
				...
				dataRow["EmployeePositionID"] = "-1";
				dataRow["SubAccountID"] = ((TextEditorControlBase)cboHeader).Value;
				dataRow["PositionID"] = dtEmployeeData.Rows[0]["PositionID"];
	...
	public override bool ValidateData()
	{
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			if (((UltraGridBase)ULGData).Rows[i].Cells["PositionID"].Value == DBNull.Value)
			{
				GlobalVariables.InformationMB.Show("برجاء إختيار الوظيفة", "Please Select Position Name");
				((GridItemBase)((UltraGridBase)ULGData).Rows[i].Cells["PositionID"]).Selected = true;
				return false;
			}
		}
	...
	private void InitializeComponent()
	{
		...
		((System.Windows.Forms.Control)(object)base.cboHeader).Location = new System.Drawing.Point(494, 68);
		((System.Windows.Forms.Control)(object)base.cboHeader).Size = new System.Drawing.Size(226, 24);
		...
		((System.Windows.Forms.Control)(object)this.cboEmployeeCode).Location = new System.Drawing.Point(393, 68);
		...
		((System.Windows.Forms.Control)(object)this.cboEmployeeCode).TabIndex = 603;
		...
		base.Name = "frmEmployeesPositions";
