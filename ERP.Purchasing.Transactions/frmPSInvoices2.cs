...
public class frmPSInvoices2 : frmHeaderManyDetails
{
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TotalPrice"].Width = (int)((double)((Control)(object)ULGData).Width * 0.06);
	...
	public override void DisplayData()
	{
		...
		if (drMaster != null)
		{
			...
			((Control)(object)btnJV).Text = (GlobalVariables.IsArabic ? string.Concat("(", drMaster["JVNo"], ")قيد") : string.Concat("No( ", drMaster["JVNo"], " )"));
	...
	private void CalculateTotalsTax()
	{
		...
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			...
			num3 += decimal.Parse(((UltraGridBase)ULGData).Rows[i].Cells["GrowthTaxValue"].Value.ToString());
			num4 += decimal.Parse(((UltraGridBase)ULGData).Rows[i].Cells["TableTaxValue"].Value.ToString());
			num2 += decimal.Parse(((UltraGridBase)ULGData).Rows[i].Cells["Discount"].Value.ToString());
		}
		((Control)(object)txtGrowthTaxTotalValue).Text = decimal.Parse(num3.ToString()).ToString(GlobalVariables.txtDecimalFormate);
		((Control)(object)txtTableTaxTotalValue).Text = decimal.Parse(num4.ToString()).ToString(GlobalVariables.txtDecimalFormate);
	...
	private void CalculateRow(UltraGridRow Row)
	{
		...
		{
			Row.Cells["GrowthTaxValue"].Value = decimal.Parse(dtTaxs.Select(" TaxID= " + Row.Cells["GrowthTaxID"].Value.ToString())[0]["TaxPercent"].ToString()) / 100m * (decimal.Parse(Row.Cells["TotalPrice"].Value.ToString()) - decimal.Parse(Row.Cells["Discount"].Value.ToString()));
		}
		else
		{
	...
	{
		((TextEditorControlBase)txtDiscAfterTaxValue).ValueChanged -= txtDiscAfterTaxValue_ValueChanged;
		((Control)(object)txtDiscAfterTaxValue).Text = decimal.Parse((decimal.Parse((((Control)(object)txtDiscAfterTaxRatio).Text == "" || ((Control)(object)txtDiscAfterTaxRatio).Text == ".") ? "0" : ((Control)(object)txtDiscAfterTaxRatio).Text) / 100m * (decimal.Parse((((Control)(object)txtGrossValue).Text == "" || ((Control)(object)txtGrossValue).Text == ".") ? "0" : ((Control)(object)txtGrossValue).Text) - decimal.Parse((((Control)(object)txtDiscBeforeTaxValue).Text == "" || ((Control)(object)txtDiscBeforeTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text) + decimal.Parse((((Control)(object)txtTableTaxTotalValue).Text == "" || ((Control)(object)txtTableTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTableTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtGrowthTaxTotalValue).Text == "" || ((Control)(object)txtGrowthTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtGrowthTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtTaxTotalValue).Text == "" || ((Control)(object)txtTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTaxTotalValue).Text))).ToString()).ToString(GlobalVariables.txtDecimalFormate);
		if (cboSupplier.SelectedIndex > -1)
		{
		...
		((Control)(object)txtNetprice).Text = decimal.Parse((decimal.Parse((((Control)(object)txtGrossValue).Text == "" || ((Control)(object)txtGrossValue).Text == ".") ? "0" : ((Control)(object)txtGrossValue).Text) - decimal.Parse((((Control)(object)txtDiscBeforeTaxValue).Text == "" || ((Control)(object)txtDiscBeforeTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text) - decimal.Parse((((Control)(object)txtDiscAfterTaxValue).Text == "" || ((Control)(object)txtDiscAfterTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscAfterTaxValue).Text) + decimal.Parse((((Control)(object)txtTaxTotalValue).Text == "" || ((Control)(object)txtTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtTableTaxTotalValue).Text == "" || ((Control)(object)txtTableTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTableTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtGrowthTaxTotalValue).Text == "" || ((Control)(object)txtGrowthTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtGrowthTaxTotalValue).Text) - decimal.Parse((((Control)(object)txtCommercialTax).Text == "" || ((Control)(object)txtCommercialTax).Text == ".") ? "0" : ((Control)(object)txtCommercialTax).Text) - decimal.Parse((((Control)(object)txtStampValue).Text == "" || ((Control)(object)txtStampValue).Text == ".") ? "0" : ((Control)(object)txtStampValue).Text) + decimal.Parse((((Control)(object)txtGrowthFees).Text == "" || ((Control)(object)txtGrowthFees).Text == ".") ? "0" : ((Control)(object)txtGrowthFees).Text)).ToString()).ToString(GlobalVariables.txtDecimalFormate);
		((TextEditorControlBase)txtDiscAfterTaxValue).ValueChanged += txtDiscAfterTaxValue_ValueChanged;
	}
	...
	private void CalculateRowActualUnitPriceAndReturnedPrice(UltraGridRow Row, decimal InvoiceExpense)
	{
		...
		{
			Row.Cells["DiscountAfterTax"].Value = (decimal.Parse(Row.Cells["NetPrice"].Value.ToString()) + decimal.Parse(Row.Cells["TaxValue"].Value.ToString())) / (decimal.Parse((((Control)(object)txtGrossValue).Text == "" || ((Control)(object)txtGrossValue).Text == ".") ? "0" : ((Control)(object)txtGrossValue).Text) - decimal.Parse((((Control)(object)txtDiscBeforeTaxValue).Text == "" || ((Control)(object)txtDiscBeforeTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text) + decimal.Parse((((Control)(object)txtTableTaxTotalValue).Text == "" || ((Control)(object)txtTableTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTableTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtGrowthTaxTotalValue).Text == "" || ((Control)(object)txtGrowthTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtGrowthTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtTaxTotalValue).Text == "" || ((Control)(object)txtTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTaxTotalValue).Text)) * decimal.Parse((((Control)(object)txtDiscAfterTaxValue).Text == "" || ((Control)(object)txtDiscAfterTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscAfterTaxValue).Text);
		}
		else
		{
	...
	public void AddItemInGid()
	{
		...
		int unitTypeID = int.Parse(dtUnits.Select(" UnitID =" + dataRow["UnitID"].ToString())[0]["UnitTypeID"].ToString());
		ValueList unitsValueList = getUnitsValueList(unitTypeID);
	...
	private void cboSupplier_ValueChanged(object sender, EventArgs e)
	{
		...
		((TextEditorControlBase)cboPaymentMethod).Value = dtSuppliers.Select(" SubAccountID= " + ((TextEditorControlBase)cboSupplier).Value)[0]["DefaultPaymentMethodID"];
		UltraTextEditor obj = txtDiscount;
		string text = (((Control)(object)txtDiscBeforeTaxRatio).Text = decimal.Parse(dtSuppliers.Select(" SubAccountID= " + ((TextEditorControlBase)cboSupplier).Value)[0]["DiscountPercentage"].ToString()).ToString(GlobalVariables.txtDecimalFormate));
	...
	private void txtDiscount_ValueChanged(object sender, EventArgs e)
	{
		...
		ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
		decimal result = default(decimal);
		decimal.TryParse(((Control)(object)txtDiscount).Text, out result);
		if (result > 100m)
		{
			result = 100m;
			((Control)(object)txtDiscount).Text = "100";
		}
		for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
		{
			((UltraGridBase)ULGData).Rows[i].Cells["DiscountRatio"].Value = result;
			CalculateRow(((UltraGridBase)ULGData).Rows[i]);
		}
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["DiscountRatio"].DefaultCellValue = result;
		ULGData.AfterCellUpdate += new CellEventHandler(ULGData_AfterCellUpdate);
		((TextEditorControlBase)txtDiscount).ValueChanged += txtDiscount_ValueChanged;
		CalculateGoss();
		CalculateTotalsTax();
	...
	private void txtDiscBeforeTaxValue_ValueChanged(object sender, EventArgs e)
	{
		...
		if (Adding || Updating)
		{
			((TextEditorControlBase)txtDiscBeforeTaxRatio).ValueChanged -= txtDiscBeforeTaxRatio_ValueChanged;
			ULGData.AfterCellUpdate -= new CellEventHandler(ULGData_AfterCellUpdate);
			if (((Control)(object)txtGrossValue).Text != "" && ((Control)(object)txtGrossValue).Text != "." && ((Control)(object)txtGrossValue).Text != "0")
			{
				((Control)(object)txtDiscBeforeTaxRatio).Text = decimal.Parse((decimal.Parse((((Control)(object)txtDiscBeforeTaxValue).Text == "" || ((Control)(object)txtDiscBeforeTaxValue).Text == "." || ((Control)(object)txtDiscBeforeTaxValue).Text == "0") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text) / decimal.Parse(((Control)(object)txtGrossValue).Text) * 100m).ToString()).ToString(GlobalVariables.txtDecimalFormate);
			}
			for (int i = 0; i < ((DisposableObjectCollectionBase)((UltraGridBase)ULGData).Rows).Count; i++)
			{
				CalculateRow(((UltraGridBase)ULGData).Rows[i]);
	...
	private void txtDiscAfterTaxValue_ValueChanged(object sender, EventArgs e)
	{
		...
		{
			((TextEditorControlBase)txtDiscAfterTaxRatio).ValueChanged -= txtDiscAfterTaxRatio_ValueChanged;
			if (decimal.Parse((((Control)(object)txtGrossValue).Text == "" || ((Control)(object)txtGrossValue).Text == ".") ? "0" : ((Control)(object)txtGrossValue).Text) - decimal.Parse((((Control)(object)txtDiscBeforeTaxValue).Text == "" || ((Control)(object)txtDiscBeforeTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text) + decimal.Parse((((Control)(object)txtTaxTotalValue).Text == "" || ((Control)(object)txtTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtTableTaxTotalValue).Text == "" || ((Control)(object)txtTableTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTableTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtGrowthTaxTotalValue).Text == "" || ((Control)(object)txtGrowthTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtGrowthTaxTotalValue).Text) != 0m)
			{
				((Control)(object)txtDiscAfterTaxRatio).Text = decimal.Parse((decimal.Parse((((Control)(object)txtDiscAfterTaxValue).Text == "" || ((Control)(object)txtDiscAfterTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscAfterTaxValue).Text) * 100m / (decimal.Parse((((Control)(object)txtGrossValue).Text == "" || ((Control)(object)txtGrossValue).Text == ".") ? "0" : ((Control)(object)txtGrossValue).Text) - decimal.Parse((((Control)(object)txtDiscBeforeTaxValue).Text == "" || ((Control)(object)txtDiscBeforeTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text) + decimal.Parse((((Control)(object)txtTaxTotalValue).Text == "" || ((Control)(object)txtTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtTableTaxTotalValue).Text == "" || ((Control)(object)txtTableTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTableTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtGrowthTaxTotalValue).Text == "" || ((Control)(object)txtGrowthTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtGrowthTaxTotalValue).Text))).ToString()).ToString(GlobalVariables.txtDecimalFormate);
			}
			((Control)(object)txtNetprice).Text = decimal.Parse((decimal.Parse((((Control)(object)txtGrossValue).Text == "" || ((Control)(object)txtGrossValue).Text == ".") ? "0" : ((Control)(object)txtGrossValue).Text) - decimal.Parse((((Control)(object)txtDiscBeforeTaxValue).Text == "" || ((Control)(object)txtDiscBeforeTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscBeforeTaxValue).Text) - decimal.Parse((((Control)(object)txtDiscAfterTaxValue).Text == "" || ((Control)(object)txtDiscAfterTaxValue).Text == ".") ? "0" : ((Control)(object)txtDiscAfterTaxValue).Text) + decimal.Parse((((Control)(object)txtTaxTotalValue).Text == "" || ((Control)(object)txtTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtTableTaxTotalValue).Text == "" || ((Control)(object)txtTableTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtTableTaxTotalValue).Text) + decimal.Parse((((Control)(object)txtGrowthTaxTotalValue).Text == "" || ((Control)(object)txtGrowthTaxTotalValue).Text == ".") ? "0" : ((Control)(object)txtGrowthTaxTotalValue).Text) - decimal.Parse((((Control)(object)txtCommercialTax).Text == "" || ((Control)(object)txtCommercialTax).Text == ".") ? "0" : ((Control)(object)txtCommercialTax).Text) - decimal.Parse((((Control)(object)txtStampValue).Text == "" || ((Control)(object)txtStampValue).Text == ".") ? "0" : ((Control)(object)txtStampValue).Text) + decimal.Parse((((Control)(object)txtGrowthFees).Text == "" || ((Control)(object)txtGrowthFees).Text == ".") ? "0" : ((Control)(object)txtGrowthFees).Text)).ToString()).ToString(GlobalVariables.txtDecimalFormate);
			((TextEditorControlBase)txtDiscAfterTaxRatio).ValueChanged += txtDiscAfterTaxRatio_ValueChanged;
		}
	...
	public override void ImportGridData()
	{
		...
		for (int i = 0; i < dataTable.Rows.Count; i++)
		{
			...
			if (dataTable.Columns.Contains(GlobalVariables.IsArabic ? "المخزن" : "Store") && dataTable2 != null && dataTable2.Select("StoreName = '" + dataTable.Rows[i][GlobalVariables.IsArabic ? "المخزن" : "Store"].ToString() + "'").Length != 0)
			{
				DataRow dataRow5 = dtStores.Select("StoreName = '" + dataTable.Rows[i][GlobalVariables.IsArabic ? "المخزن" : "Store"].ToString() + "'")[0];
			...
			{
				((UltraGridBase)ULGData).ActiveRow.Cells["Notes"].Value = dataTable.Rows[i][GlobalVariables.IsArabic ? "ملاحظات" : "Notes"].ToString();
			}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.Purchasing.Transactions.frmPSInvoices2));
		...
		((AppearanceBase)val21).Image = resources.GetObject("appearance20.Image");
