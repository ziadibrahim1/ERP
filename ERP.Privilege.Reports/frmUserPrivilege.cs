...
public class frmUserPrivilege : frmReportTree2010
{
	private IContainer components = null;

	public frmUserPrivilege()
	{
		InitializeComponent();
		int num = -1;
		...
		dtItems2 = Users.SelectByGroupLevel(num.ToString(), "1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: true);
		TreeItems2IDCol = "User_ID";
		TreeItems2NameCol = (GlobalVariables.IsArabic ? "UserNameAr" : "UserNameEn");
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "صلاحيات المستخدمين" : "Users Privileges");
	...
	public override void ShowReport()
	{
		...
		if (Items2.Equals(","))
		{
			GlobalVariables.InformationMB.Show("لم تقم باختيار مستخدم ليتم عرض بياناته ", "There is no choosen User to be shown in the report, please check User to be shown in report");
			return;
		}
		frmReporViwer frmReporViwer2 = new frmReporViwer();
		GlobalVariables.ReportDocument.SetParameterValue("@UserIDs", Items2);
