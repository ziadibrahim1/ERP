...
public class frmServicesQuotationsSearch : frmSearch
{
	private IContainer components = null;

	public frmServicesQuotationsSearch()
	{
		InitializeComponent();
	}

	public frmServicesQuotationsSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
