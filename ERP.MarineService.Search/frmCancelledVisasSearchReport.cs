...
public class frmCancelledVisasSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmCancelledVisasSearchReport()
	{
		InitializeComponent();
	}

	public frmCancelledVisasSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
