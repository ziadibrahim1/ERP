...
public class frmRejectedVisasSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmRejectedVisasSearchReport()
	{
		InitializeComponent();
	}

	public frmRejectedVisasSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
