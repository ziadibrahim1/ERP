...
public class frmOperationsInvoicesReport : frmSearchReport
{
	private IContainer components = null;

	public frmOperationsInvoicesReport()
	{
		InitializeComponent();
	}

	public frmOperationsInvoicesReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["OperationInvoiceNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.13);
