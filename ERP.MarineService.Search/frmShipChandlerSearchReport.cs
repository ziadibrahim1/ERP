...
public class frmShipChandlerSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmShipChandlerSearchReport()
	{
		InitializeComponent();
	}

	public frmShipChandlerSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ShipChandlerNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15) - GlobalVariables.ScrollWidth;
