...
public class frmItemsQuotationsSearch : frmSearch
{
	private IContainer components = null;

	public frmItemsQuotationsSearch()
	{
		InitializeComponent();
	}

	public frmItemsQuotationsSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
