...
public class frmShipChandlerSearch : frmSearch
{
	private IContainer components = null;

	public frmShipChandlerSearch()
	{
		InitializeComponent();
	}

	public frmShipChandlerSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ShipChandlerNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الاذن " : "ShipChandler No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ShipChandlerNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.17) - GlobalVariables.ScrollWidth;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ShipChandlerDate"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ShipChandlerDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ الاذن" : "Date");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ShipChandlerDate"].MaskInput = "dd/mm/yyyy hh:mm:ss tt";
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ShipChandlerDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.13);
