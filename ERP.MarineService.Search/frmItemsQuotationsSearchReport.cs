...
public class frmItemsQuotationsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmItemsQuotationsSearchReport()
	{
		InitializeComponent();
	}

	public frmItemsQuotationsSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemQuotationNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.075) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemQuotationValidTo"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemQuotationValidTo"].Header).Caption = (GlobalVariables.IsArabic ? "ساري حتى" : "Valid To");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ItemQuotationValidTo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
