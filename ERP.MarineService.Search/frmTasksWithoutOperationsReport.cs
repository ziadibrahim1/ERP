...
public class frmTasksWithoutOperationsReport : frmSearchReport
{
	private IContainer components = null;

	public frmTasksWithoutOperationsReport()
	{
		InitializeComponent();
	}

	public frmTasksWithoutOperationsReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["IsHold"].Width = (int)((double)((Control)(object)ULGData).Width * 0.08);
