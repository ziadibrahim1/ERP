...
public class frmTechniciansSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmTechniciansSearchReport()
	{
		InitializeComponent();
	}

	public frmTechniciansSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TechnicianNo"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TechnicianNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الفني " : "Technician No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TechnicianNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["TechnicianName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["Mobile"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
