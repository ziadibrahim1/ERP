...
public class frmPOSClientsSearch : frmSearch
{
	private IContainer components = null;

	public frmPOSClientsSearch()
	{
		InitializeComponent();
	}

	public frmPOSClientsSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["ClientCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
