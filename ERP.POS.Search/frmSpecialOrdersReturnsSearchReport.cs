...
public class frmSpecialOrdersReturnsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmSpecialOrdersReturnsSearchReport()
	{
		InitializeComponent();
	}

	public frmSpecialOrdersReturnsSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SpecialOrderNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم الشيك" : "CheckNo");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["SpecialOrderNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2);
