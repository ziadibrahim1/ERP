...
public class frmInvoicesSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmInvoicesSearchReport()
	{
		InitializeComponent();
	}

	public frmInvoicesSearchReport(DataTable dt, string idColumnName, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InvoiceNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم " : "Invoice Number");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InvoiceNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.18) - GlobalVariables.ScrollWidth;
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InvoiceDate"].Hidden = false;
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InvoiceDate"].Header).Caption = (GlobalVariables.IsArabic ? "تاريخ " : "Date");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["InvoiceDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["CurrencyName"].Width = (int)((double)((Control)(object)ULGData).Width * 0.15);
	}
