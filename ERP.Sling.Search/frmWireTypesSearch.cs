...
public class frmWireTypesSearch : frmSearch
{
	private IContainer components = null;

	public frmWireTypesSearch()
	{
		InitializeComponent();
	}

	public frmWireTypesSearch(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["WireTypeCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.2) - GlobalVariables.ScrollWidth;
