...
public class frmMasterLinksSuppliersSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmMasterLinksSuppliersSearchReport()
	{
		InitializeComponent();
	}

	public frmMasterLinksSuppliersSearchReport(DataTable dt, string idColumnName)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["MasterLinkSupplierCode"].Width = (int)((double)((Control)(object)ULGData).Width * 0.18) - GlobalVariables.ScrollWidth;
