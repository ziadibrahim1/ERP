...
public class frmPreQuotationsSearchReport : frmSearchReport
{
	private IContainer components = null;

	public frmPreQuotationsSearchReport()
	{
		InitializeComponent();
	}

	public frmPreQuotationsSearchReport(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
	...
	public override void InitGrid()
	{
		...
		((HeaderBase)((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PreQuotationNo"].Header).Caption = (GlobalVariables.IsArabic ? "رقم العرض " : "Quotation No");
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PreQuotationNo"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1) - GlobalVariables.ScrollWidth;
		...
		((UltraGridBase)ULGData).DisplayLayout.Bands[0].Columns["PreQuotationDate"].Width = (int)((double)((Control)(object)ULGData).Width * 0.1);
