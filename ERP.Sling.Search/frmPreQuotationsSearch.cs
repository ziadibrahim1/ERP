...
public class frmPreQuotationsSearch : frmSearch
{
	private IContainer components = null;

	public frmPreQuotationsSearch()
	{
		InitializeComponent();
	}

	public frmPreQuotationsSearch(DataTable dt, string idColumnName, int ApprovedValue, int DeletedValue)
		: this()
	{
		dtSource = dt;
