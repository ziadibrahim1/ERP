...
namespace ERP.WareHouse.Reports;

public class frmWHItemCard : frmReportTree2010
{
	private IContainer components = null;

	public frmWHItemCard()
	{
		dtItems = BusinessLayer.StockControl.Items.FillTreeWH(GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItemsParentIDCol = "ParentID";
		TreeItemsIDCol = "ItemID";
		TreeItemsNameCol = "Name";
		TreeItemsIsMainCol = "IsMain";
		dtItems2 = BusinessLayer.WareHouse.Company.FillCombo("-1", GlobalVariables.IsArabic ? "1" : "0", IsFromServer: false);
		TreeItems2IDCol = "CompanyID";
		TreeItems2NameCol = "CompanyName";
		InitializeComponent();
		cboReportType.Items.Clear();
		cboReportType.Items.Add((object)1, GlobalVariables.IsArabic ? "كارتة الأصناف تفصيلي" : "Item Card Detailed");
	...
	{
		dtSearchResult = SearchFunctions.ItemsReportWH(IsFromServer: false);
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ERP.WareHouse.Reports.frmWHItemCard));
